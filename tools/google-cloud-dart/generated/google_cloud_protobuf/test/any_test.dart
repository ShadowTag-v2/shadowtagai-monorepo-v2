...
void main() {
  test('pack into and from Duration', () {
    const duration = Duration(seconds: 10, nanos: 100);

    final any = Any.from(duration);
    expect(any.typeName, 'google.protobuf.Duration');

    final actual = any.unpackFrom(DurationExtension.decode);
  ...
  test('json round-tripping', () {
    ...
    final actual = anyCopy.unpackFrom(DurationExtension.decode);
