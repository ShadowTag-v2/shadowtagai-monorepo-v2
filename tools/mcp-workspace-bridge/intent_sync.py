...
def fetch_and_embed_business_intent(
    ...
    try:
        ...
        return {"error": f"Missing dependency: {e}. Run: pip install google-api-python-client google-auth google-genai"}
    ...
    if not files:
        return {"status": "idle", "message": "No PRD_ documents found. Awaiting business intent."}
            ...
            operation = client.file_search_stores.upload_to_file_search_store(
                ...
                config={
                    ...
                    "customMetadata": [
                        ...
                        {"key": "last_modified", "stringValue": file_info.get("modifiedTime", "")[:10]},
