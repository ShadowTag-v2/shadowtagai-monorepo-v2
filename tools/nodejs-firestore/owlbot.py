...
if staging.is_dir():
  try:
    ...
    s.replace(
      "dev/test/gapic_firestore_v1.ts", "firestoreModule\.v1", "firestoreModule"
    )
    s.replace(
    ...
    s.replace(
      "dev/test/gapic_firestore_v1.ts", "\.\./protos/protos.json", "../protos/v1.json"
    )
    s.replace(
      "dev/test/gapic_firestore_admin_v1.ts",
      "\.\./protos/protos.json",
    ...
    s.replace(
      "types/protos/firestore_v1_proto_api.d.ts", 'import Long = require\("long"\);', ""
    )
    s.replace(
