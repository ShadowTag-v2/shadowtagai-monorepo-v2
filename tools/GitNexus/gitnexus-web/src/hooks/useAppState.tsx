...
import type { GraphNode, GraphRelationship, KnowledgeGraph, NodeLabel } from '../core/graph/types';
import type { AgentMessage } from '../core/llm/agent';
import { getActiveProviderConfig, loadSettings, saveSettings } from '../core/llm/settings-service';
import type {
  AgentStreamChunk,
  ChatMessage,
  LLMSettings,
...
import type { ConnectToServerResult, RepoSummary } from '../services/server-connection';
import { connectToServer, fetchRepos } from '../services/server-connection';
...
const AppStateProviderInner = ({ children }: { children: ReactNode }) => {
  ...
  const loadServerGraph = useCallback(
    async (
      nodes: GraphNode[],
      relationships: GraphRelationship[],
      fileContents: Record<string, string>,
