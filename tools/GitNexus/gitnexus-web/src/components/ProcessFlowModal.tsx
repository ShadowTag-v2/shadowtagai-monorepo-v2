...
import { Copy, Focus, GitBranch, Layers, X, ZoomIn, ZoomOut } from 'lucide-react';
import mermaid from 'mermaid';
import { useCallback, useEffect, useRef, useState } from 'react';
import { generateProcessMermaid, type ProcessData } from '../lib/mermaid-generator';
    ...
    >
      ...
      <div
        className={`bg-slate-900/60 backdrop-blur-2xl border border-white/10 rounded-3xl shadow-2xl shadow-cyan-500/10 flex flex-col animate-scale-in overflow-hidden relative ${
          isFullScreen ? 'w-[98%] h-[95vh] max-w-none' : 'w-[95%] max-w-5xl max-h-[90vh]'
        }`}
      >
