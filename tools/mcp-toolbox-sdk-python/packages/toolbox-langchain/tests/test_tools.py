...
class TestToolboxTool:
    ...
    def test_toolbox_tool_init(self, mock_core_tool):
        ...
        assert_pydantic_models_equivalent(tool.args_schema, expected_args_schema, mock_core_tool._name)
    ...
    def test_toolbox_tool_add_auth_token_getters(
        ...
        new_langchain_tool = auth_toolbox_tool.add_auth_token_getters(auth_token_getters)
    ...
    def test_toolbox_tool_add_auth_token_getter(self, auth_toolbox_tool, mock_core_sync_auth_tool):
        ...
        new_langchain_tool = auth_toolbox_tool.add_auth_token_getter("test-auth-source", get_id_token)
