...
function cssCustomPropertyAsNumber(knob: Knob<number>, val: number, container: HTMLElement) {
...
const collection = new MaterialCollection<KnobTypesToKnobs<StoryKnobs>>('Ripple', [
