...
describe('mixinElementInternals()', () => {
  ...
  async function setupTest() {
    const root = env.render(html`<test-element-internals></test-element-internals>`);
    const element = root.querySelector('test-element-internals') as TestElementInternals;
