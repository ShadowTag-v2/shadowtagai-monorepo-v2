...
class ProgressTest(unittest.TestCase):
    ...
    def test_extraction_progress_bar(self):
        ...
        pbar = progress.create_extraction_progress_bar(range(10), "gemini-3.1-flash-lite-preview")

        self.assertIsInstance(pbar, tqdm.tqdm)
        self.assertIn("LangExtract", pbar.desc)
        self.assertIn("gemini-3.1-flash-lite-preview", pbar.desc)
    ...
    def test_model_info_extraction(self):
        ...
        mock_model.model_id = "gemini-3.1-family"
        self.assertEqual(progress.get_model_info(mock_model), "gemini-3.1-family")
    ...
    def test_formatting_functions(self):
        ...
        desc = progress.format_extraction_progress("gemini-3.1-flash-lite-preview")
        self.assertIn("LangExtract", desc)
        self.assertIn("gemini-3.1-flash-lite-preview", desc)
