    ...
    def test_extract_explicit_fence_respected(self):
        ...
        with mock.patch(
            ...
            with mock.patch(
                ...
                with mock.patch("langextract.annotation.Annotator.__init__", return_value=None) as mock_annotator_init:
                    with mock.patch(
                        "langextract.annotation.Annotator.annotate_text",
                        return_value=data.AnnotatedDocument(text=self.test_text, extractions=[]),
                    ):
                ...
                with mock.patch(
                    ...
                    with warnings.catch_warnings(record=True) as w:
                        ...
                        _ = lx.extract(
                            ...
                            model_id="gemini-3.1-flash-lite-preview",
                            api_key="test_key",
                            language_model_params={"gemini_schema": "some_schema"},  # Deprecated
                        )

                        # Should have triggered deprecation warning
                        deprecation_warnings = [
                            warning for warning in w if issubclass(warning.category, FutureWarning) and "gemini_schema" in str(warning.message)
                        ]
