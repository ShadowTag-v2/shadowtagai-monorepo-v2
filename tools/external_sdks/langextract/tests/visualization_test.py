...
class VisualizationTest(absltest.TestCase):
    ...
    def test_build_highlighted_text_single_span_correct_html(self):
        ...
        expected_html = '<span class="lx-highlight lx-current-highlight" data-idx="0" ' 'style="background-color:#ff0000;">Hello</span> world'
    ...
    def test_visualize_basic_document_renders_correctly(self):
        ...
        body_html = (
            'Patient needs <span class="lx-highlight lx-current-highlight"' f' data-idx="0" style="background-color:{med_color};">Aspirin</span>.'
        )
        legend_html = (
            '<div class="lx-legend">Highlights Legend: <span class="lx-label" ' f'style="background-color:{med_color};">MEDICATION</span></div>'
        )
