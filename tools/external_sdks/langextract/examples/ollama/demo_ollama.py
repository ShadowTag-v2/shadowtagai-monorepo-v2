...
def example_romeo_juliet(model_id: str, model_url: str) -> lx.data.AnnotatedDocument | None:
...
def example_medication_ner(model_id: str, model_url: str) -> lx.data.AnnotatedDocument | None:
...
def example_medication_relationships(model_id: str, model_url: str) -> lx.data.AnnotatedDocument | None:
...
def example_shakespeare_dialogue(model_id: str, model_url: str) -> lx.data.AnnotatedDocument | None:
  ...
  """).strip()
    ...
    characters = set(ext.extraction_text for ext in result.extractions if ext.extraction_class == "character")
    if characters:
