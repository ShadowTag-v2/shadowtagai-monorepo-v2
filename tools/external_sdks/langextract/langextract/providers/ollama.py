        ...
        **kwargs,
        ...
        if structured_output_format is not None:
            ...
            if format_type is None:
                format_type = core_types.FormatType.JSON if structured_output_format == "json" else core_types.FormatType.YAML
    ...
    def _ollama_query(
        ...
        **kwargs,
        ...
        try:
            ...
            raise exceptions.InferenceRuntimeError(f"Ollama request failed: {str(e)}", original=e, provider="Ollama") from e
