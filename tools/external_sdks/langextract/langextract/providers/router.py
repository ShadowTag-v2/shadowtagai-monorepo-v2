...
def register(*patterns: str | re.Pattern[str], priority: int = 0) -> typing.Callable[[type[TLanguageModel]], type[TLanguageModel]]:
...
def resolve_provider(provider_name: str) -> type[base_model.BaseLanguageModel]:
    ...
    raise exceptions.InferenceConfigError(f"No provider found matching: {provider_name!r}. Available providers can be listed with list_providers()")
