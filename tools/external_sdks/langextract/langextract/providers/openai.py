...
class OpenAILanguageModel(base_model.BaseLanguageModel):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        try:
            ...
            raise exceptions.InferenceConfigError("OpenAI provider requires openai package. Install with: pip install langextract[openai]") from e
    ...
    def _process_single_prompt(self, prompt: str, config: dict) -> core_types.ScoredOutput:
        ...
        try:
            ...
            raise exceptions.InferenceRuntimeError(f"OpenAI API error: {str(e)}", original=e) from e
