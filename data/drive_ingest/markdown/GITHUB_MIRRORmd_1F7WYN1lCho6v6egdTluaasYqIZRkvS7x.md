...
**Storage location**: `https://github.com/ehanc69/ShadowTag-v2-fastapi-services`
- Remote backup
...
DATE=$(date +%Y%m%d)
REPO_DIR=~/ShadowTag-v2-fastapi-services
...
trap 'cd ~/ShadowTag-v2-fastapi-services && ~/backup_consensus.sh' EXIT
```
...
# Or visit:
# https://github.com/ehanc69/ShadowTag-v2-fastapi-services/tree/claude/voice-consensus-orchestrator-01KnByRibAJhGMpXrun59rp4
```
...
cd ~/ShadowTag-v2-fastapi-services/voice_consensus/archives
...
**Location**: `https://github.com/ehanc69/ShadowTag-v2-fastapi-services`
**What it stores**:
- All code
- Documentation
...
**View tags**: https://github.com/ehanc69/ShadowTag-v2-fastapi-services/tags
...
2. Repository URL: `https://github.com/ehanc69/ShadowTag-v2-fastapi-services`
