# n-autoresearch/Kosmos/BioAgentss VSCode Integration Guide

**Auto-Run-Command Setup for 200-Agent Swarm Development**

## Overview

This guide explains how to use the VSCode `auto-run-command` extension with n-autoresearch/Kosmos/BioAgentss orchestrator to automatically configure your development environment when opening the project.
...
2. **Rule evaluation**:
   ```
   ✓ hasFile: shadowtagai/agents/n-autoresearch/Kosmos/BioAgentss_orchestrator.py
...
n-autoresearch/Kosmos/BioAgentsS_TOTAL_AGENTS=200
n-autoresearch/Kosmos/BioAgentsS_BOOTSTRAP_ROI=3.0          # ROI ≥ 3×
n-autoresearch/Kosmos/BioAgentsS_BOOTSTRAP_LTV_CAC=4.0       # LTV:CAC ≥ 4:1
n-autoresearch/Kosmos/BioAgentsS_BOOTSTRAP_P99_MS=90.0       # p99 ≤ 90ms
```
...
#### 🐒 Start n-autoresearch/Kosmos/BioAgentss Orchestrator
```bash
python3 -m shadowtagai.agents.n-autoresearch/Kosmos/BioAgentss_orchestrator
```
...
```json
{
  ...
  "command": "echo '🐒 n-autoresearch/Kosmos/BioAgentss agent file detected!'",
...
```json
{
  "condition": "hasFile: .env.n-autoresearch/Kosmos/BioAgentss",
  "command": "set -a && source .env.n-autoresearch/Kosmos/BioAgentss && set +a",
  "message": "Loaded n-autoresearch/Kosmos/BioAgentss environment",
  "shellCommand": true
}
```
...
2. Verify condition matches:
   ...
   ls shadowtagai/agents/n-autoresearch/Kosmos/BioAgentss_orchestrator.py  # Should exist
   ```
...
## Integration with n-autoresearch/Kosmos/BioAgentss
...
| `.vscode/tasks.json` | Predefined tasks for n-autoresearch/Kosmos/BioAgentss ops |
| `shadowtagai/agents/n-autoresearch/Kosmos/BioAgentss_orchestrator.py` | 200-agent swarm orchestrator |
...
5. Run task: `Cmd+Shift+P → Tasks: Run Task → 🐒 Start n-autoresearch/Kosmos/BioAgentss Orchestrator`

**Status**: ✅ n-autoresearch/Kosmos/BioAgentss swarm ready for code generation!
