...
**Current State**:
- `app/services/vertex_ai_client.py` uses `gemini-3.1-family-flash`
- `kosmos/core/vertex_client.py` already uses `gemini-3.1-family-flash-exp`
...
```python
# From:
model: str = "gemini-3.1-family-flash"

# To:
model: str = "gemini-3.1-family-flash-exp"
```
...
DEFAULT_MODEL=gemini-3.1-family-flash-exp
GEMINI_PRO_MODEL=gemini-3.1-family-pro  # For complex reasoning
GEMINI_FLASH_MODEL=gemini-3.1-family-flash-exp  # For cost efficiency
```
