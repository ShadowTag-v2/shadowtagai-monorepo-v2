# PNKLN Component Analysis Skill

**Purpose:** AI-powered analysis templates for PNKLN Core Stack™ components
**Enforcement:** `"suggest"`
**Priority:** `"high"`
**Version:** 1.0.0
...
This skill provides structured templates for analyzing PNKLN stack components using Gemini 2.0 Pro or similar LLMs. It enables deep architectural review, performance optimization, and quality validation across the entire stack—from ingestion layers to enforcement systems.
...
- Keywords: `analyze`, `review`, `audit`, `pnkln`, `component`, `architecture`
...
Every PNKLN component can be analyzed using this structured approach:
...
Use this structure for any PNKLN component:
...
- User-agent: `PNKLNBot/2.1 (+https://pnkln.ai/bot-info)`
...
- Alignment with PNKLN roadmap (see Strategy Diamond in MBA frameworks)
...
```markdown
Feature: Add Gemini Ingestion Layer to PNKLN stack
