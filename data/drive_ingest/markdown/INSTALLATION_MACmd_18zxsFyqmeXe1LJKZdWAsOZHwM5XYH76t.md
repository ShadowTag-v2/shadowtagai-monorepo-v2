...
git clone https://github.com/YOUR_USERNAME/ShadowTag-v2-fastapi-services.git
...
echo 'export PYTHONPATH="${PYTHONPATH}:/path/to/ShadowTag-v2-fastapi-services"' >> ~/.zshrc
