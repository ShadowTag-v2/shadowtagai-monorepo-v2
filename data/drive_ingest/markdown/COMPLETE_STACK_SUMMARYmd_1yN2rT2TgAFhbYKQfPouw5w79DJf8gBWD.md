...
### ✅ Layer 3b: ShadowTag-v2 Platform (Complete)
...
└────────────┬────────────────────────────────────────────┘
        ...
        │          │
┌───────▼──────┐  ┌▼─────────────────────────────────────┐
│  ShadowTag   │  │  ShadowTag-v2 Platform                      │
│  port 8002   │  │  port 8003                           │
│              │  │                                       │
...
# - ShadowTag-v2: http://localhost:8003
```
...
python -m uvicorn ShadowTag-v2.api:app --port 8003
...
| **ShadowTag-v2 Platform**           | Hosting only      | $50-100/month (compute)         |
...
| ShadowTag-v2 Subscriptions | $10/mo × 40M users | $4.8B                 |
| **Combined**        | -                  | **$6.2B**             |
...
- **Multi-namespace**: Validates across ingestion, shadowtag, ShadowTag-v2, ShadowTagjr
...
```
1. User uploads content to ShadowTag-v2 (/upload)
   ↓
2. ShadowTag-v2 creates IngestedItem
   ↓
...
```
1. User requests feed from ShadowTag-v2 (/feed)
   ↓
...
4. Build frontend UI for ShadowTag-v2 platform
...
### ShadowTag + ShadowTag-v2 = Two-Sided Monopoly

**From your original thesis**:

> "ShadowTag supplies the proof layer of the internet: verifiable authenticity for every pixel and sound. ShadowTag-v2 becomes the first social layer built entirely on that proof: an AI-judged showcase of authentic, high-trust video. Together, they create a two-sided monopoly: whoever owns the proof standard owns discovery itself."
...
- **Phase 3 (scale)**: Your $1.4B ShadowTag + $4.8B ShadowTag-v2 projections
...
3. **ShadowTag-v2 content platform** ✅
