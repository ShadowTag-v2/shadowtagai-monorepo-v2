...
caller = GeminiFunctionCaller(model="gemini-3.1-family-flash-exp", tools=tools)
...
- SHADOWTAGAI validation (JR Engine)
...
from src.shadowtagai import JudgeSix, CorOrchestrator, ShadowTag, SemanticMemory
...
caller = GeminiFunctionCaller(
    model_name="gemini-3.1-family-flash-exp",
...
# 4. Create SHADOWTAGAI orchestrator
shadowtag = ShadowTag()
ns = SemanticMemory()
