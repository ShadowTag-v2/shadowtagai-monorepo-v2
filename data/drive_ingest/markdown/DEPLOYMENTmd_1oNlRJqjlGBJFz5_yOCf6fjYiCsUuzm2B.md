...
export PROJECT_ID="ShadowTag-v2-pnkln-prod"
    ...
    spec:
      ...
      template:
        ...
        spec:
          ...
          containers:
          - name: ingestion
            image: gcr.io/ShadowTag-v2-pnkln-prod/pnkln-ingestion:latest
...
on:
  push:
    branches:
      - main
      - 'claude/ShadowTag-v2-verified-mesh-*'
    paths:
      - 'src/**'
      - 'config/**'
      - 'k8s/**'
...
env:
  PROJECT_ID: ShadowTag-v2-pnkln-prod
  REGION: us-central1
  CLUSTER_NAME: pnkln-cluster
  IMAGE: gcr.io/ShadowTag-v2-pnkln-prod/pnkln-ingestion
    ...
    spec:
      template:
        spec:
          containers:
          - name: analysis
            image: gcr.io/ShadowTag-v2-pnkln-prod/pinkln-reasoning:latest
            command:
            - python
            - -m
...
- [ShadowTag-v2 Global Edge Fabric](../ShadowTag-v2-global-edge-fabric/docs/)
