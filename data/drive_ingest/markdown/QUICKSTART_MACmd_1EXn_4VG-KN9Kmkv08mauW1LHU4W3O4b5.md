...
**Platform**: ShadowTag Governance Service + LLM Efficiency Optimizations
...
pwd
# Should show: .../ShadowTag-v2-fastapi-services
```
...
INFO:     Starting ShadowTag-governance-service v1.0.0
...
```json
{
  "service": "ShadowTag-governance-service",
  "version": "1.0.0",
  "description": "ShadowTag Governance Service - Full compliance & infrastructure management",
  "persona_iq": 160,
  "governance": {
    "eu_ai_act": true,
    "dsa_vlop": false,
...
_Platform: ShadowTag Governance Service + LLM Efficiency Optimizations_
