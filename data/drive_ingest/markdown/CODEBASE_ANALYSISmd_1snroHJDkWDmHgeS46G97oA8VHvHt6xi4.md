# ShadowTag-v2 FastAPI Services - Comprehensive Codebase Analysis
...
- `/home/user/ShadowTag-v2-fastapi-services/.claude/skills/testing/test-driven-development.md`
- `/home/user/ShadowTag-v2-fastapi-services/.claude/skills/debugging/systematic-debugging.md`
- `/home/user/ShadowTag-v2-fastapi-services/.claude/skills/collaboration/brainstorming.md`

### Framework Documentation

- `/home/user/ShadowTag-v2-fastapi-services/MASTER_AGENT_FRAMEWORK.md`
- `/home/user/ShadowTag-v2-fastapi-services/VERTEX_AI_IMPLEMENTATION_GUIDE.md`

### Services

- `/home/user/ShadowTag-v2-fastapi-services/services/gptram_service.py`
- `/home/user/ShadowTag-v2-fastapi-services/tools/gptram_mcp.py`

### Infrastructure

- `/home/user/ShadowTag-v2-fastapi-services/terraform/main.tf`
- `/home/user/ShadowTag-v2-fastapi-services/judge-deployment.yaml`
- `/home/user/ShadowTag-v2-fastapi-services/pnkln-gke-deploy.sh`

### Examples

- `/home/user/ShadowTag-v2-fastapi-services/examples/typescript/`
- `/home/user/ShadowTag-v2-fastapi-services/examples/python/`
...
The **ShadowTag-v2-fastapi-services** repository is a comprehensive, production-ready ecosystem for:
