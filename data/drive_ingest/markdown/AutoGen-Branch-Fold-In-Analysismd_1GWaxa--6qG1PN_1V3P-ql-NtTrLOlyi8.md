...
caller = GeminiFunctionCaller("gemini-3.1-family-flash-exp", tools)
...
| Gemini API latency >35ms | Medium (40%) | Medium | Already tested at 35ms, use `gemini-3.1-family-flash-exp` |
