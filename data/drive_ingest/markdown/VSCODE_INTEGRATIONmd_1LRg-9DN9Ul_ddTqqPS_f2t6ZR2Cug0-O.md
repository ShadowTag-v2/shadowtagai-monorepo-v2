# https://github.com/karpathy/autoresearchs VSCode Integration Guide

**Auto-Run-Command Setup for 200-Agent Swarm Development**

## Overview

This guide explains how to use the VSCode `auto-run-command` extension with https://github.com/karpathy/autoresearchs orchestrator to automatically configure your development environment when opening the project.
...
https://github.com/karpathy/autoresearchS_TOTAL_AGENTS=200
https://github.com/karpathy/autoresearchS_BOOTSTRAP_ROI=3.0          # ROI ≥ 3×
https://github.com/karpathy/autoresearchS_BOOTSTRAP_LTV_CAC=4.0       # LTV:CAC ≥ 4:1
https://github.com/karpathy/autoresearchS_BOOTSTRAP_P99_MS=90.0       # p99 ≤ 90ms
```
...
#### 🐒 Start https://github.com/karpathy/autoresearchs Orchestrator
```bash
python3 -m shadowtagai.agents.https://github.com/karpathy/autoresearchs_orchestrator
```
...
```json
{
  "condition": "hasFile: .env.https://github.com/karpathy/autoresearchs",
  "command": "set -a && source .env.https://github.com/karpathy/autoresearchs && set +a",
...
**Status**: ✅ https://github.com/karpathy/autoresearchs swarm ready for code generation!
