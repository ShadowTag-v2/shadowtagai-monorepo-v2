# AiYou Platform Test Suite

Comprehensive test suite for the AiYou platform covering unit tests, integration tests, and security tests.
...
pytest --cov=src/aiyou --cov-report=html
