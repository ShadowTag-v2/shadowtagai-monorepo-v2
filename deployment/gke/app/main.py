...
app = FastAPI(
  title="Plan Mode Service",
  description="Generate execution-ready plans using Plan Mode Style Guide v1.0",
  version="1.0.0",
)
...
"""
    ...
    message = client.messages.create(
      ...
      messages=[
        {"role": "user", "content": f"Generate a plan for: {request.task_description}"}
      ],
    )
