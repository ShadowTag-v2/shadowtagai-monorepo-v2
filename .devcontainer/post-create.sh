...
echo "🚀 shadowtag-omega-v4 Safety-Case SaaS Framework - Post-Create Setup"
...
git config --global --add safe.directory /workspaces/shadowtag-omega-v4-fastapi-services || true
