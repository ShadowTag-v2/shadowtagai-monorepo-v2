...
echo "Pushing..."
GIT_TRACE=1 GIT_CURL_VERBOSE=1 git push --force --no-verify "https://x-access-token:${CLEAN_TOKEN}@github.com/ShadowTag-v2/Monorepo-Uphillsnowball.git" HEAD:refs/heads/main > push_out_v2.txt 2>&1
echo "Exit code: $?" >> push_out_v2.txt
