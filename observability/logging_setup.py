...
def set_up_observability():
    ...
    try:
        ...
        logger.info(f"GCP Cloud Logging tracking initialized for project {settings.gcp_project_id} with PII redact filter.")
    except Exception as e:
        logger.warning(f"Could not initialize GCP Logging (are credentials loaded?). Fallback to stdout. Err: {e}")
