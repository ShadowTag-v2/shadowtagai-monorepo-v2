...
class MultiLLMReasoningSkill(BaseSkill):
  ...
  async def execute(self, skill_input: SkillInput) -> SkillOutput:
    ...
    methods = skill_input.parameters.get(
      "methods", [ReasoningMethod.CHAIN_OF_THOUGHT, ReasoningMethod.TREE_OF_THOUGHTS]
    )
  ...
  def _assess_confidence(
    self, paths: list[ReasoningPath], synthesis: dict[str, Any]
  ) -> float:
        ...
        alternatives.append(
          {
            ...
            "reason_rejected": "Lower scoring path",
          }
        )
