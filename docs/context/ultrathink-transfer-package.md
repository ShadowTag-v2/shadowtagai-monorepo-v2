...
• Frameworks = Tiny Team, Disciplined Entrepreneurship, AiYouJR (Strict Bourne-160 mode), First Principles Thinking
...
*This 3-part package gives you an instant reboot: paste the restart block in a new chat to restore the full working environment, product scope, and strategic mindset.*
