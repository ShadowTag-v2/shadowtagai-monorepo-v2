...
# Build Docker image
cd ../../src
docker build -t gcr.io/${PROJECT_ID}/Claude_Code_6-orchestrator:v1.0.0 -f Claude_Code_6/Dockerfile .

# Push to Google Container Registry
docker push gcr.io/${PROJECT_ID}/Claude_Code_6-orchestrator:v1.0.0
...
gcloud logging metrics create Claude_Code_6_errors \
...
gcloud firestore export gs://${PROJECT_ID}-firestore-exports --collection-ids=Claude_Code_6_workflows
