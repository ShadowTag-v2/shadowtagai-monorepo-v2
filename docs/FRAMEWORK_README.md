...
The ShadowTag-v2JR Core Framework is a production-ready implementation of the PRISM kernel, business planning models, operating framework execution engine, and context management system. It translates strategic frameworks into executable code.
...
assert lock.purpose == "ShadowTag-v2JR"
...
context = package.create_context(
    ...
    decision_framework={"purpose": "ShadowTag-v2JR"},
    actions=[action],
...
Proprietary - ShadowTag-v2JR System
