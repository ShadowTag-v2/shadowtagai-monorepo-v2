...
**Supersedes:** judge6_biz_plan, COR_22_JUDGE6_REVENUE, JUDGE_6_PREMIUM_RESTRUCTURE,
JUDGE6_FINANCIAL_PROTOCOL, JUDGE6_PREMIUM_STRATEGY, JUDGE_6_TECH_BRIEF,
cor_55_judge6_fused_architecture, judge_6_technical_specification (8 docs → 1)
...
*intent* — only syntax. Human reviewers can't keep up with agent commit velocity.
...
- Already operational as `scripts/judge6.sh` in Monorepo-Uphillsnowball
...
PR Push → GitHub Webhook → Judge 6 Cloud Run (GCP)
  ...
  → Report → artifacts/judge6-reports/
