...
gcloud firestore export gs://${PROJECT_ID}-firestore-exports --collection-ids=Claude_Code_6_workflows --async

# 4. Verify metrics
gcloud monitoring time-series list \
  --filter='metric.type="custom.googleapis.com/Claude_Code_6/workflow_duration_seconds"' \
