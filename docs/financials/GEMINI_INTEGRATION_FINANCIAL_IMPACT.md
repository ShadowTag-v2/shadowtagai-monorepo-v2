...
1. **Database Models** (`src/ShadowTag-v2/models/ingestion.py`):
...
2. **Gemini Client** (`src/ShadowTag-v2/services/gemini/client.py`):
...
3. **API Routes** (`src/ShadowTag-v2/routes/ingestion.py`):
...
1. **Data Moat**:
   ...
   - Fine-tuned models specific to ShadowTag-v2's content types
...
3. **Kernel-Chain Optimization**:
   ...
   - Adaptive thresholds tuned to ShadowTag-v2's specific policies
...
2. **Fine-Tune Custom Models**:
   - Train NSFW detector on ShadowTag-v2-specific content
   - Target: 99%+ precision
