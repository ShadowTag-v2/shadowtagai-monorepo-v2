...
# Start FlyingMonkeys Orchestrator (200 agents)
python3 shadowtagai/agents/flyingmonkeys_orchestrator.py
```
...
| Claude_Code_6 Binary | Gemini+MCP | p99≤90ms | $0.0003 |
...
USER REQUEST
 ↓
FlyingMonkeys Orchestrator (200 agents)
...
ANTIGRAVITY HANDOFF
 ...
 └─ Claude_Code_6 binary (<35ms governance)
 ↓
...
1. **🐒 Start FlyingMonkeys Orchestrator**
...
shadowtagai/agents/
├── flyingmonkeys_orchestrator.py  # 200-agent swarm
├── core/
...
|-----------|--------|-------------|
| Claude_Code_6 | p99≤90ms | Kill-switch after 1hr breach |
