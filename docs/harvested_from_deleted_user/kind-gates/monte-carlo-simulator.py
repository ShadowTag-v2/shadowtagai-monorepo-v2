#!/usr/bin/env python3
"""
ShadowTag-v2 Monte Carlo Valuation Simulator
...
def generate_report(results, projections):
    ...
    print("\n" + "="*60)
    print(f"ShadowTag-v2 Monte Carlo Simulation Results ({SIMULATIONS:,} runs)")
    print("="*60 + "\n")
...
def plot_distribution(results):
    ...
    plt.title(f'ShadowTag-v2 Exit Valuation Distribution ({SIMULATIONS:,} Monte Carlo Simulations)', fontsize=14, fontweight='bold')
