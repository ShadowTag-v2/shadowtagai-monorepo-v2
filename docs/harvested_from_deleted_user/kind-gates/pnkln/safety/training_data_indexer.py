...
- Claude_Code_6 content classification
...
class TrainingDataIndexer:
  ...
  def _calculate_severity(
    self, category: SafetyCategory, term: str, context: str
  ) -> float:
    """
  ...
  async def search_phrase(
    self, phrase: str, slop: int = 0, limit: int = 100
  ) -> List[Dict]:
    """
...
# =============================================================================
# INTEGRATION WITH Claude_Code_6
# =============================================================================


class SafetyGate:
  """
  Safety gate for Claude_Code_6 pipeline.
