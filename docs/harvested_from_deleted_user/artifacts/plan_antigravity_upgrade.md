...
## Objective
Upgrade the current workspace to fully implement the "Antigravity Workspace Template" standards, focusing on the "Flying Monkeys" agent swarm and "Claude_Code_6" governance engine.
...
## Phase 2: Claude_Code_6 LLM Integration
...
- [ ] Create `src/tools/governance_tools.py` wrapping Claude_Code_6.
