...
- [x] Wire the [transcript_to_contract.py](file:///Users/pikeymickey/ShadowTag-v2-stack/ShadowTag-v2/src/api/transcript_to_contract.py) core into the newly available `Judge 6` ecosystem.
