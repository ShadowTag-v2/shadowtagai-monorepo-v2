...
- [x] Execute [hunter_killer_docker_snippet.md](file:///Users/pikeymickey/ShadowTag-v2-stack/ShadowTag-v2/hunter_killer_docker_snippet.md) equivalents so we have Ripgrep, AST-grep, and Ugrep locally.

## Phase 2: Database Re-Alignment
- [x] Revert DB to `postgres` (from `alloydbomni`) as we lack GC credits.
- [x] Ensure [shadowtag_hippocampus.sql](file:///Users/pikeymickey/ShadowTag-v2-stack/ShadowTag-v2/src/database/shadowtag_hippocampus.sql) does not use AlloyDB native embeddings.
- [x] Execute [shadowtag_hippocampus.sql](file:///Users/pikeymickey/ShadowTag-v2-stack/ShadowTag-v2/src/database/shadowtag_hippocampus.sql) against the database.
- [x] Load [shadowtag-laws.md](file:///Users/pikeymickey/ShadowTag-v2-stack/ShadowTag-v2/.agent/rules/shadowtag-laws.md) into the `shadowtag_hippocampus` index.
...
- [x] Map these instructions into [src/brain/orchestrator.py](file:///Users/pikeymickey/ShadowTag-v2-stack/ShadowTag-v2/src/brain/orchestrator.py) system prompts.
- [x] Inject OTLP Telemetry to [src/brain/orchestrator.py](file:///Users/pikeymickey/ShadowTag-v2-stack/ShadowTag-v2/src/brain/orchestrator.py).
- [x] Implement Visual Quant Engine in [src/citadels/omniscience_quant.py](file:///Users/pikeymickey/ShadowTag-v2-stack/ShadowTag-v2/src/citadels/omniscience_quant.py).
- [x] Execute Visual Quant: write local test script returning PNG to disk.
- [x] Implement Pomelli Aegis UI in [src/frontend/app/components/AegisLock.tsx](file:///Users/pikeymickey/ShadowTag-v2-stack/ShadowTag-v2/src/frontend/app/components/AegisLock.tsx).
- [x] The Firestore Pipeline Migration: Python script using Firestore aggregation pipelines to count queued tasks.
- [x] The Antigravity SDK Skill: Write [.agent/skills/genai_v1_expert.md](file:///Users/pikeymickey/ShadowTag-v2-stack/ShadowTag-v2/.agent/skills/genai_v1_expert.md) teaching the new `google-genai` SDK and `code_execution` tool.
