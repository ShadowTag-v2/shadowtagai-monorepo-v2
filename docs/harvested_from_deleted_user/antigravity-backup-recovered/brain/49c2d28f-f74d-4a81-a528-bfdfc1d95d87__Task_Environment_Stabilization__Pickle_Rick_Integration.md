...
- [x] Deploy to Cloud Run (Web)
    - [x] Create [frontend/Dockerfile](file:///Users/pikeymickey/ShadowTag-v2-stack/ShadowTag-v2/frontend/Dockerfile)
    - [x] Update [deploy_web_frontend.sh](file:///Users/pikeymickey/ShadowTag-v2-stack/ShadowTag-v2/deploy_web_frontend.sh)
    - [x] Execute deployment
    - [x] Verify live URL
    - [x] Secure deployment (remove public access)
- [x] Update [.vscode/settings.json](file:///Users/pikeymickey/ShadowTag-v2-stack/ShadowTag-v2/.vscode/settings.json) exclusions:
...
- [x] Clone `galz10/pickle-rick-extension`
- [x] Read [STEP_BY_STEP_GUIDE.md](file:///Users/pikeymickey/ShadowTag-v2-stack/ShadowTag-v2/knowledge/pickle-rick-extension/STEP_BY_STEP_GUIDE.md)
...
- [x] Resume Pitch Deck finalization under new protocol
    - [x] Create [frontend/src/app/pitch/page.tsx](file:///Users/pikeymickey/ShadowTag-v2-stack/ShadowTag-v2/frontend/src/app/pitch/page.tsx)
    - [x] Update [frontend/src/components/ReactorCore.tsx](file:///Users/pikeymickey/ShadowTag-v2-stack/ShadowTag-v2/frontend/src/components/ReactorCore.tsx) to link to `/pitch`
