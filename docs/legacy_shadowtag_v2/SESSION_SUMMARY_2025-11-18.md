...
- pnkln-stack Governance Service (app/)
...
2. **`docs/research/implementation-checklist.md`** (581 lines)
   ...
   - Week-by-week checklist for ShadowTag + pnkln-stack
...
3. **`docs/research/strategic-business-integration.md`** (1,142 lines)
   ...
   - pnkln-stack governance integration
...
2. pnkln-stack Governance + MCP Batch API setup
...
**Platform total** (with existing pnkln-stack):
...
- FastAPI (pnkln-stack service)

- SQLite (Nightly Intel, LLM Memory)

- PostgreSQL + Redis (pnkln-stack optional)
...
| ----------------------- | ----------- | -------------- | ---------------- |
| **pnkln-stack FastAPI** | ✅ Ready    | 📋 Pending     | Code complete    |
...
- pnkln-stack: Deploy with Cloud Run or GKE
...
3. Setup PostgreSQL + Redis for pnkln-stack
