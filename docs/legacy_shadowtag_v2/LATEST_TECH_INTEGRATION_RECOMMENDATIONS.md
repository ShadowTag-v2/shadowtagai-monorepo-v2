...
- `app/services/vertex_ai_client.py` uses `gemini-3.1-family`

- `kosmos/core/vertex_client.py` already uses `gemini-3.1-flash-exp`

**Recommendation**: Upgrade pnkln-stack Governance Service to Gemini 2.0 Flash
...
model: str = "gemini-3.1-flash-exp"
...
GEMINI_PRO_MODEL=gemini-3.1-family  # For complex reasoning
GEMINI_FLASH_MODEL=gemini-3.1-flash-exp  # For cost efficiency
