...
### 1. **pnkln-stack-fastapi-services** (Main Platform)

**URL**: https://github.com/ShadowTag-v2/pnkln-stack-fastapi-services
**Purpose**: AiU + pnkln-stack unified platform - Pre-execution AI governance + verified content economy
...
**Status**: Components integrated into pnkln-stack-fastapi-services
...
See [MEGA_INTEGRATION_SUMMARY.md](https://github.com/ShadowTag-v2/pnkln-stack-fastapi-services/blob/main/MEGA_INTEGRATION_SUMMARY.md) for complete history of 163 prior branch integrations.
...
**Primary Repo**: [pnkln-stack-fastapi-services](https://github.com/ShadowTag-v2/pnkln-stack-fastapi-services)
