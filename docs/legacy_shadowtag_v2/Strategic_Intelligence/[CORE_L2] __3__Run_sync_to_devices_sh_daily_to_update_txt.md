...
| src/Cor.Claude_Code_6/state.py       | Added SwarmVoteState, SwarmVoteMethod, default VotingMode.SWARM |
| src/Cor.Claude_Code_6/nodes.py       | Added \_async_swarm_vote, \_async_debate dispatcher             |
