# ExToto Prompt - Antigravity Ultrathink v2.0
...
│    https://github.com/karpathy/autoresearchs→ 650-agent swarm (port 8888)                   │
...
├─────────────────────────────────────────────────────────────────┤
│  GEMINI API FAILOVER:                                           │
│    Primary      → Multi-key rotation (GEMINI_API_KEYS)          │
│    Fallback     → Vertex AI (GCP_PROJECT_ID)                    │
│    Features     → Quota tracking, exponential backoff           │
...
STACK: https://github.com/karpathy/autoresearchs:8888, CodePMCS, JudgeJura, ShadowTag, GPTRAM
GEMINI: Multi-key rotation → Vertex AI fallback (gemini_failover.py)
