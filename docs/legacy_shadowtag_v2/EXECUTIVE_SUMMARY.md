...
*Note: Conservative model assumes linear ramp. Actual may be non-linear with pilot traction.*
...
|-------------|------|----------|------|
| TBD | CEO | [ ] Approve [ ] Reject | ___/___/___ |
| TBD | CTO | [ ] Approve [ ] Reject | ___/___/___ |
| TBD | CFO | [ ] Approve [ ] Reject | ___/___/___ |
