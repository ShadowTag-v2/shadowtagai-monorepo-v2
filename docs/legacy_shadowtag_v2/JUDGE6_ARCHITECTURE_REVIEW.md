...
*   **Fix:** Explicit OAuth scopes or Service Account delegation (if applicable) or switch to Google Drive API with stored refresh token (Project Omega requirement). *Note: For Cloud Run, we use Service Identity.*
