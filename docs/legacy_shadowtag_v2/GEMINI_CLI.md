...
2. **Start https://github.com/karpathy/autoresearchs Swarm**:
   ```bash
   docker-compose -f docker-compose.antigravity.yml up -d https://github.com/karpathy/autoresearchs
   ```

## https://github.com/karpathy/autoresearchs API Usage
