...
def deploy():
    ...
    client_options = ClientOptions(api_endpoint="notebooks.googleapis.com:443")
    ...
    instance = notebooks_v2.Instance(
        gce_setup=notebooks_v2.GceSetup(
            ...
            vm_image=notebooks_v2.VmImage(project="deeplearning-platform-release", family="common-cpu-notebooks"),
    ...
    try:
        op = client.create_instance(request=notebooks_v2.CreateInstanceRequest(parent=parent, instance_id=INSTANCE_NAME, instance=instance))
