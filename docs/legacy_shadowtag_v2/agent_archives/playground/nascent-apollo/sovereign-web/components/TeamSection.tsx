      ...
      <div className="max-w-6xl mx-auto px-6">
            ...
            <div key={i} className="group relative p-6 bg-surface border border-tension rounded-xl hover:border-accent transition-colors duration-300">
               <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <div className="text-accent font-mono text-xs uppercase tracking-wider mb-2">{f.role}</div>
                    <p className="text-ghost text-sm mb-4 leading-relaxed">{f.bio}</p>
                    <a href={f.linkedin} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-ghost hover:text-white text-xs font-mono uppercase transition-colors">
        ...
        <div className="mt-12 p-4 border border-burn/20 bg-burn/5 rounded text-center">
            <p className="text-burn font-mono text-xs">
                ⚠️ COMPLIANCE NOTICE: This section must be updated with real Founder identities to meet Google Start Tier requirements.
            </p>
        </div>
      </div>
    </section>
