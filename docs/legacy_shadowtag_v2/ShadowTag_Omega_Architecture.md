...
_The "Wild" Agent. Lives on the metal, owns the browser, runs as the User._
...
- **Cognitive Boundaries:**
  - `task_boundary_tool.tmpl`: Defines what the sub-agent _cannot_ do.
...
_The "Civilized" Agent. Lives in the Cloud, governed by IAM, speaks universal protocols._
...
_The Governance Layer. How the Cloud Agent touches internal corporate data safely._
...
3. **Govern:**
   ...
   - **OAuth Scopes:** Passes the _human user's_ token to the internal service, ensuring the AI can only see what the human is allowed to see.
...
_Current state of the repository as of Jan 18, 2026._

### 1. RLM Implementation (Kosmos)

**File:** `src/agents/https://github.com/karpathy/autoresearchs7.py`
...
_Meta-Cognitive Re-Punch (Jan 18, 2026)_
