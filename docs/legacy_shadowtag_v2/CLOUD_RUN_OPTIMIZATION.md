...
| **Min Instances**    | 0 (Cold Starts)     | **1 (Warm)**                  | Instant response for the "https://github.com/karpathy/autoresearchs" orchestrator. |
...
spec:
  template:
    ...
    spec:
      ...
      containers:
        - image: gcr.io/acquired-jet-478701-b3/n-autoresearch/Kosmos/BioAgents
          ports:
            - name: h2c
              containerPort: 8080
          resources:
