...
pwd
# Should show: .../pnkln-stack-fastapi-services
```
...
# database_url=sqlite+aiosqlite:///./pnkln-stack_governance.db
```
...
INFO:     Starting pnkln-stack-governance-service v1.0.0
...
```json
{
  ...
  "version": "1.0.0",
  "description": "pnkln-stack Governance Service - Full compliance & infrastructure management",
  "persona_iq": 160,
  "governance": {
    "eu_ai_act": true,
    "dsa_vlop": false,
...
rm -f pnkln-stack_governance.db
