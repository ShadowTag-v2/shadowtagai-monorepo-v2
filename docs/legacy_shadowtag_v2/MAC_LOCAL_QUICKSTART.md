...
# Expected: /Users/yourname/pnkln-stack-fastapi-services/venv/bin/python
...
GEMINI_PRO_MODEL=gemini-3.1-family
...
DATABASE_URL=postgresql+asyncpg://pnkln-stack:pnkln-stack_password@localhost:5432/pnkln-stack_governance
...
DEBUG=true
SERVICE_NAME=pnkln-stack-governance-service
API_HOST=0.0.0.0
API_PORT=8000
...
psql postgres << EOF
CREATE DATABASE pnkln-stack_governance;
CREATE USER pnkln-stack WITH PASSWORD 'pnkln-stack_password';
GRANT ALL PRIVILEGES ON DATABASE pnkln-stack_governance TO pnkln-stack;
\q
EOF

# Verify database created

psql -U pnkln-stack -d pnkln-stack_governance -c "SELECT version();"
...
### Test 1: Start pnkln-stack Governance Service
...
cd /Users/yourname/pnkln-stack-fastapi-services
source venv/bin/activate
...
├── app/                          # FastAPI pnkln-stack Governance Service
