...
│   └── pnkln-stack_neural_rank.py    # pnkln-stack AI-cognition ranking
│
...
```bash
python examples/demo_shadowtag_pnkln-stack.py
```
...
agent = pnkln-stackNeuralRankAgent(gemini_api_key="...")
...
### pnkln-stack Content Workflow

```python
from src.protocols.agent_protocol import create_pnkln-stack_content_workflow

workflow = create_pnkln-stack_content_workflow(content)
