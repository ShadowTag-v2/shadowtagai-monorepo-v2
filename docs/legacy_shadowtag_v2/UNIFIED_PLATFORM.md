...
- **Customer Lifetime Value (LTV)**: $299/mo _ 18 months _ 0.7 retention = $3,767
    ...
    spec:
      template:
        spec:
          containers:
            - name: collector
              image: gcr.io/ShadowTag-v2-intelligence/collector:latest
              env:
...
app = FastAPI(title="ShadowTag-v2 Intelligence Platform")
