...
## Part 1: pnkln-stack Governance Service + MCP Batch API
...
# PostgreSQL (optional for pnkln-stack)

POSTGRES_HOST=localhost
POSTGRES_PORT=5432
POSTGRES_DB=pnkln-stack_governance
POSTGRES_USER=postgres
POSTGRES_PASSWORD=your_password

# Redis (optional for pnkln-stack)
...
0 2 * * * cd ~/Projects/pnkln-stack-fastapi-services/nightly_intel_pipeline && /usr/bin/python3 main.py >> logs/cron.log 2>&1
...
```bash
cd ~/Projects/pnkln-stack-fastapi-services/erik-hancock-llm-memory
...
### 4.1 PostgreSQL (for pnkln-stack Governance)
...
createdb pnkln-stack_governance
...
### 4.2 Redis (for pnkln-stack Caching)
...
# Deploy pnkln-stack FastAPI

gcloud run deploy pnkln-stack-governance \
  --source=. \
  --region=us-central1 \
...
**Issues**: https://github.com/ShadowTag-v2/pnkln-stack-fastapi-services/issues
