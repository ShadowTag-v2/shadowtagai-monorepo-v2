# https://github.com/karpathy/autoresearchs Multi-LLM Integration Guide

## Overview

https://github.com/karpathy/autoresearchs is a 600-agent governance swarm that runs **internally inside any LLM** for $0 cost. The swarm executes as pure heuristic logic within the LLM's reasoning - no external API calls required.

## Quick Start

Copy the contents of `prompts/https://github.com/karpathy/autoresearchs_universal.txt` into your LLM's system prompt.
...
with open("prompts/https://github.com/karpathy/autoresearchs_universal.txt") as f:
    swarm_prompt = f.read()
...
2. Paste `https://github.com/karpathy/autoresearchs_universal.txt` into Instructions


3. Name it "https://github.com/karpathy/autoresearchs Governance"
...
# Use flying_monkeys2.py for native execution
...
///▞ https://github.com/karpathy/autoresearchS SWARM DECISION
═══════════════════════════════════════════════════════════════
...
///▞ https://github.com/karpathy/autoresearchS v5 ACTIVE
...
```python
from agents.flying_monkeys2 import swarm_vote
...
*https://github.com/karpathy/autoresearchs v5 - $0 Governance for Every LLM*
