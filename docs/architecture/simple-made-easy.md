# Sovereign Philosophy: Simple Made Easy

From Rich Hickey's doctrine, "Simple Made Easy".

## Simple vs. Easy
- **Easy** means "at hand," familiar, quick to type, or within the immediate mental toolkit (e.g., pulling a massive NPM framework to solve a minimal UI issue).
- **Simple** means *unentangled*. One fold. Orthogonal concerns remain separate.
