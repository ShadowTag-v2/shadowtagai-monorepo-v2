...
- "Here's our live API" → Show https://api.ShadowTag.com/docs
...
# LIVE IN PRODUCTION
curl https://api.ShadowTag.com/health  # ✅ Production healthy
```
...
curl https://api.ShadowTag.com/health  # ✅
curl https://api.ShadowTag.com/docs    # ✅ Swagger UI
