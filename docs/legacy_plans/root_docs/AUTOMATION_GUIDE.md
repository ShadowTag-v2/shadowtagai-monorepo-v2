...
1. Upload `deployment/vertex-ai/plan_mode_notebook.ipynb`
...
gcloud iam service-accounts add-iam-policy-binding \
  ...
  --member="principalSet://iam.googleapis.com/projects/PROJECT_NUMBER/locations/global/workloadIdentityPools/github-pool/attribute.repository/ehanc69/ShadowTag-v2-fastapi-services"
```
