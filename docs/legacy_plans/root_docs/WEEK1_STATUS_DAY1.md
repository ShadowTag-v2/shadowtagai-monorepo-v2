...
Follow `Cor.Claude_Code_6/STRIPE_SETUP.md`:
...
- Technical issue? → Check `Cor.Claude_Code_6/README.md` or `QUICKSTART.md`
...
3. `Cor.Claude_Code_6/STRIPE_SETUP.md` - 15-min Stripe setup
4. `Cor.Claude_Code_6/QUICKSTART.md` - Test Judge 6 locally
5. `Cor.Claude_Code_6/README.md` - Full technical docs
