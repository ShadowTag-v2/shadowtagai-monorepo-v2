# ShadowTag Governance Service - Investor Demo
...
ShadowTag Governance Service has evolved into a **self-improving, multi-agent AI platform** that combines:
...
| Feature             | ShadowTag/Pinkln      | OpenAI   | Anthropic | Google  |
| ------------------- | ----------------- | -------- | --------- | ------- |
...
**Demo Access**: <https://github.com/ehanc69/ShadowTag-v2-fastapi-services>
