...
```python
from src.ingestion.judge_integration import Claude_Code_6Integrator

integrator = Claude_Code_6Integrator()
...
# Judge 6 integration
judge_integrator = Claude_Code_6Integrator()
```
