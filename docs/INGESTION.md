...
**Transparency**:
- Clear user agent: `AIYou-Ingestion/1.0 (Educational; +https://github.com/ehanc69)`
...
kubectl get cronjob gemini-ingestion-pipeline -n aiyou-llm-serving

# View latest job
kubectl get jobs -n aiyou-llm-serving | grep gemini-ingestion

# View logs
kubectl logs -f job/gemini-ingestion-pipeline-<timestamp> -n aiyou-llm-serving

# Manual trigger (for testing)
kubectl create job --from=cronjob/gemini-ingestion-pipeline manual-run-1 -n aiyou-llm-serving
```
...
kubectl exec -it <pod-name> -n aiyou-llm-serving -- cat /output/daily_briefing.md

# Via HTTP (if briefing-server deployed)
kubectl port-forward svc/ingestion-briefing-service 8080:80 -n aiyou-llm-serving
...
- PNKLN Core Stack™: Integrated intelligence pipeline

### Support

For issues or questions:
- GitHub Issues: [Create an issue](https://github.com/ehanc69/aiyou-fastapi-services/issues)
- Documentation: `docs/INGESTION.md`
- Configuration: `src/ingestion/`

---

**Built for efficient, ethical intelligence gathering in the PNKLN Core Stack™**
