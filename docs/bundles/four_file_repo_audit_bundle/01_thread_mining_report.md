...
- root `/Users/pikeymickey/pnkln-stack-stack/ShadowTag-v2/ShadowTag-Omega`
...
4. **True naming rationalization**
   The repo still mixes `ShadowTag`, `ShadowTag-Omega`, `pnkln-stack`, `UphillSnowball`, `pnkln`, and product/lab/control-plane language in ways that increase ambiguity.
