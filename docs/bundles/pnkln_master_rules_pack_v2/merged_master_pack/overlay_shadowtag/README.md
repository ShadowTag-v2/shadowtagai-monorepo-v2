# ShadowTag Constitution Pack

This pack is the ShadowTag-specific companion to the portable brand-agnostic pack.
...
- suggested prompts / next-step scaffolding
...
- unverifiable claims about identity or status that do not improve execution
