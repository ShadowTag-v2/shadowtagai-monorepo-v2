...
**Automated analysis of the SHADOWTAGAI Intelligence Pipeline using Gemini 2.0 Pro**
...
chmod +x shadowtagai_intelligence/scripts/*.sh
chmod +x shadowtagai_intelligence/scripts/*.py
...
./shadowtagai_intelligence/scripts/prepare_analysis_input.sh > analysis_input.txt
...
python shadowtagai_intelligence/scripts/aggregate_confidence.py \
...
**Solution**: `chmod +x shadowtagai_intelligence/scripts/*.sh`
...
**Maintained by**: SHADOWTAGAI Intelligence Team
