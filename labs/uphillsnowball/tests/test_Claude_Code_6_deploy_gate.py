...
"""Tests for Claude_Code_6DeployGate — Wet Fleece / Dry Ground / Battle."""
...
class TestWetFleece:
    ...
    def test_clean_artifact_passes(self):
        ...
        result = Claude_Code_6DeployGate.wet_fleece(artifact)
...
class TestDryGround:
    ...
    def test_all_tests_pass(self):
        ...
        result = Claude_Code_6DeployGate.dry_ground(artifact, test_results)
        assert result.passed is True
...
class TestBattle:
    ...
    def test_all_clear_deploys(self):
        ...
        result = Claude_Code_6DeployGate.battle(artifact, integration)
        assert result.passed is True
...
class TestRunGate:
    ...
    def test_fail_fast_on_wet_fleece(self):
        ...
        results = Claude_Code_6DeployGate.run_gate(artifact)
    ...
    def test_full_pipeline_pass(self):
        ...
        results = Claude_Code_6DeployGate.run_gate(artifact, test_results, integration)
