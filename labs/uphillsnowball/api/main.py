...
AGENTS: list[dict[str, Any]] = [
    ...
    {"agent_id": "Claude_Code_6-004", "role": "Judge 6 (Governance)", "model": "gemini-3.1-flash-lite-preview", "temperature": 0.2, "status": "active"},
...
async def stream_task(task_id: str) -> StreamingResponse:
    ...
    async def event_stream() -> AsyncGenerator[str]:
        ...
        task["result"] = f"Task {task_id} completed by {task.get('assigned_agent', 'swarm')}"
