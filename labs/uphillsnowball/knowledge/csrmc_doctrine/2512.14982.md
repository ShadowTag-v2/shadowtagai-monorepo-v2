...
Yaniv Leviathan∗
Google Research
leviathan@google.comMatan Kalman∗
Google Research
matank@google.comYossi Matias
Google Research
yossi@google.com
Abstract
...
1 Prompt Repetition
LLMs are often trained ascausallanguage models, i.e. past tokens cannot attend to future tokens.
...
“<QUESTION> <CONTEXT> ” (seeoptions-firstvs.question-firstin Figure 1). We propose torepeat
...
∗Equal contribution.
Preprint.arXiv:2512.14982v1  [cs.LG]  17 Dec 2025

## Page 2

As further motivation, we observe that reasoning models trained with RL often learn to repeat (parts
of) the user’s request. Prompt repetition isefficient, moving the repetition to the parallelizable prefill
stage. The number of generated tokens does not increase1. Moreover, prompt repetition does not
...
2 Experiments
We testprompt repetitionon a range of 7 popular models from leading LLM providers of varying
...
tion (Verbose)andPrompt Repetition ×3(Appendix A.4). We observe that they perform similarly
for most tasks and models (Figures 2 and 3), and sometimes outperform vanilla prompt repetition.
Notably,Prompt Repetition ×3often substantially outperforms vanilla prompt repetition (which
...
prompt and not to simply increasing the length of the input, we also evaluate thePaddingmethod
...
all casesprompt repetition and its variants do not increase the lengths of the generated outputs
...
repeat×3variant) where the latencies increase (likely due to the prefill stage taking longer).
...
2018. URLhttps://arxiv.org/abs/1803.05457.
...
transformer, 2023. URLhttps://arxiv.org/abs/1910.10683.
...
understanding benchmark, 2024. URLhttps://arxiv.org/abs/2406.01574.
...
NameIndexHere the model gets a list of Nnames and is asked to output the ith name on the list.
We useN= 50, i= 25. Example:
...
MiddleMatchHere the model gets a list of Nnames or numbers (out of a total possible set of K,
i.e.,K < N means there will be repeating elements), and is asked to output the name/number located
directly between two given ones. We useN= 40, K= 10. Example:
...
Baseline <QUERY>Which of the following combinations is a mixture rather
than a compound?
...
question: .......
...<LEN(QUERY)>...Which of the following combinations is a mixture rather
than a compound?
A. oxygen and nitrogen in air
B. sodium and chlorine in salt
C. hydrogen and oxygen in water
