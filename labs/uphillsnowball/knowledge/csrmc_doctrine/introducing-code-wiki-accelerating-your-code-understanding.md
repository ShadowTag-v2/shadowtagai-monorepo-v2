# Source: https://developers.googleblog.com/introducing-code-wiki-accelerating-your-code-understanding/
...
[Fergus Hurley](/search/?author=Fergus+Hurley)
Director, Product Management
Google Cloud, Developer & Experiences

[Pedro Rodriguez](/search/?author=Pedro+Rodriguez)
Senior Engineering Manager
Google Cloud, Developer & Experiences

[Rafael Marques](/search/?author=Rafael+Marques)
Product Manager
Google Cloud, Developer & Experiences

[Omar Shams](/search/?author=Omar+Shams)
Research Engineer
Google Research
...
![Code Wiki Header](https://storage.googleapis.com/gweb-developer-goog-blog-assets/images/Code_Wiki_Header.original.png)

Reading existing code is the one of the biggest, most expensive bottlenecks in software development.

To address this issue and improve your productivity, we're introducing [Code Wiki](http://codewiki.google/?utm_source=blog&utm_medium=gfd&utm_campaign=launch_post), a platform that maintains a continuously updated, structured wiki for code repositories.
...
We’re building a [Gemini CLI extension](http://geminicli.com/extensions) for Code Wiki so teams can run the same system locally and securely on internal repositories. [Join the waitlist for the Gemini CLI extension](https://developers.google.com/profile/badges/community/sdlcagents/gca-agents).
...
Start now at [**codewiki.google**](http://codewiki.google/?utm_source=blog&utm_medium=gfd&utm_campaign=launch_post).

posted in:

* [AI](/search/?technology_categories=AI)
* [Cloud](/search/?technology_categories=Cloud)
