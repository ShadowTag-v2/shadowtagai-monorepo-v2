  ...
  if (shape === 'hex') {
    return (
      <svg
        ...
        opacity={0.7}
        role="img"
        aria-label="Hexagonal data node"
      >
  ...
  return (
    ...
    >
      ...
      <svg
        ...
        role="img"
        aria-label="Diagonal vector line representing uphill momentum"
      >
        <defs>
