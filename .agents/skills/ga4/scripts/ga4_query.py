...
def main():
    ...
    parser.add_argument("--metrics", "-m", default="screenPageViews", help="Comma-separated metrics (default: screenPageViews)")
    parser.add_argument("--metric", help="Single metric (alias for --metrics)")
    parser.add_argument("--dimensions", "-d", default="pagePath", help="Comma-separated dimensions (default: pagePath)")
