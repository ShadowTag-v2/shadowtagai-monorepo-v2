# FlyingMonkeys Server API Reference

**Version**: 1.0
**Last Updated**: 2025-11-26
**Scope**: External API interaction with the FlyingMonkeys Swarm Server

## Overview

The FlyingMonkeys Server exposes a REST API for submitting tasks to the agent swarm. It implements the **JURA Protocol** for cost-aware routing (Free/Flash/Pro tiers).
...
```json
{
  ...
  "agents": 600,
  "tiers": {
    "bulk": { "model": "gemini-3.1-flash", "agents": 570 },
    "governance": { "model": "gemini-3.1-pro", "agents": 30 }
  },
...
- **Connection Refused**: Server not running. Run `python3 bin/flyingmonkeys-server`.
