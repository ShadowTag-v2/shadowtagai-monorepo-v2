...
from src.libs.ShadowTag-v2.governance.judge6_core import ActionType, ProposedAction  # Adjusted import path
...
class Autoresearch_Triad_Scholar:
    def __init__(self, target_ids):
        ...
        self.current_date = datetime(2026, 1, 24).date()
