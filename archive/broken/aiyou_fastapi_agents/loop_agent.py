...
Cost: ~$0.01-0.03/iteration (via n-autoresearch/Kosmos/BioAgents)
"""
...
class LoopAgent:
    """
    Architect/Critic/Refiner loop using n-autoresearch/Kosmos/BioAgents backend.
...
"""
    ...
    def _call_n-autoresearch/Kosmos/BioAgents(self, prompt: str, tier: str = "task") -> str:
        """Call n-autoresearch/Kosmos/BioAgents API."""
        endpoint = f"{self.n-autoresearch/Kosmos/BioAgents_URL}/{tier}"
        ...
        try:
            ...
            print(f"n-autoresearch/Kosmos/BioAgents error: {e}")
    ...
    def architect(self, requirement: str) -> str:
        ...
        self.state.current_doc = self._call_n-autoresearch/Kosmos/BioAgents(prompt, "task")
    ...
    def critic(self, requirement: str) -> str:
        ...
        self.state.feedback = self._call_n-autoresearch/Kosmos/BioAgents(prompt, "governance")
