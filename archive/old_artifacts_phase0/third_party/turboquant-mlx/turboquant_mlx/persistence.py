...
class TurboQuantCache:
        ...
        for layer_idx, layer_state in enumerate(kv_states):
            ...
            for tensor_idx, tensor in enumerate(tensors):
                ...
                if self.compress:
                    ...
                    compressed_bytes += comp["data"].nbytes + comp["scales"].nbytes + comp["zeros"].nbytes
    ...
    def _maybe_evict(self):
        ...
        sorted_contexts = sorted(contexts, key=lambda x: self._access_times.get(x.get("name", ""), 0))
