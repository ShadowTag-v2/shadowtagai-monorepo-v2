...
<img
  src="/images/integrations/jira-step-connect-btn-dark.png"
...
<img
  src="/images/integrations/jira-step-connect-btn-light.png"
  alt="Screenshot of organization settings page with PM integrations section"
  title="Screenshot of organization settings page with PM integrations section"
...
<img
  src="/images/integrations/jira-step-create-token-dark.png"
...
<img
  src="/images/integrations/jira-step-create-token-light.png"
  alt="Screenshot of Atlassian API token creation page"
  title="Screenshot of Atlassian API token creation page"
  className="block dark:hidden mx-auto"
  style={{ width:"58%" }}
...
<img
  src="/images/integrations/jira-step-configure-dark.png"
...
<img
  src="/images/integrations/jira-step-configure-light.png"
  alt="Screenshot of Jira integration configuration form"
  title="Screenshot of Jira integration configuration form"
  className="block dark:hidden mx-auto"
  style={{ width:"58%" }}
...
<img
  src="/images/integrations/jira-step-pm-table-dark.png"
...
<img
  src="/images/integrations/jira-step-pm-table-light.png"
  alt="Screenshot showing webhook configuration button in settings"
  title="Screenshot showing webhook configuration button in settings"
  className="block dark:hidden mx-auto"
  style={{ width:"58%" }}
...
<Step title="Click 'Link to Jira Epic'">
  ...
  <img
    src="/images/integrations/jira-campaign-setting-dark.png"
  ...
  <img
    src="/images/integrations/jira-campaign-setting-light.png"
    alt="Screenshot showing the link button in project header"
    title="Screenshot showing the link button in project header"
    className="block dark:hidden mx-auto"
    style={{ width:"58%" }}
...
<Step title="Search and select epic">
  ...
  <img
    src="/images/integrations/jira-campaign-modal-dark.png"
  ...
  <img
    src="/images/integrations/jira-campaign-modal-light.png"
    alt="Screenshot of project linking modal with Jira project selection"
    title="Screenshot of project linking modal with Jira project selection"
    className="block dark:hidden mx-auto"
    style={{ width:"58%" }}
...
<ManagingIntegration
  provider="Jira"
  settingsPath="Organization Settings → Project Management Integrations"
  actionText='"Disconnect" or the configure buttons'
/>
