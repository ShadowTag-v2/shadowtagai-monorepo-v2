...
class TestParallelScrapingConfiguration(unittest.TestCase):
    ...
    def test_single_worker_default(self):
        ...
        config = {"name": "test", "base_url": "https://example.com/", "selectors": {"main_content": "article"}, "max_pages": 10}
    ...
    def test_multiple_workers_creates_lock(self):
        ...
        config = {"name": "test", "base_url": "https://example.com/", "selectors": {"main_content": "article"}, "max_pages": 10, "workers": 4}
    ...
    def test_workers_from_config(self):
        ...
        config = {"name": "test", "base_url": "https://example.com/", "selectors": {"main_content": "article"}, "workers": 8}
...
class TestUnlimitedMode(unittest.TestCase):
    ...
    def test_unlimited_with_none(self):
        ...
        config = {"name": "test", "base_url": "https://example.com/", "selectors": {"main_content": "article"}, "max_pages": None}
    ...
    def test_unlimited_with_minus_one(self):
        ...
        config = {"name": "test", "base_url": "https://example.com/", "selectors": {"main_content": "article"}, "max_pages": -1}
...
class TestRateLimiting(unittest.TestCase):
    ...
    def test_rate_limit_from_config(self):
        ...
        config = {"name": "test", "base_url": "https://example.com/", "selectors": {"main_content": "article"}, "rate_limit": 0.1}
    ...
    def test_zero_rate_limit_disables(self):
        ...
        config = {"name": "test", "base_url": "https://example.com/", "selectors": {"main_content": "article"}, "rate_limit": 0}
...
class TestThreadSafety(unittest.TestCase):
    ...
    def test_lock_protects_visited_urls(self):
        ...
        config = {"name": "test", "base_url": "https://example.com/", "selectors": {"main_content": "article"}, "workers": 4}
    ...
    def test_single_worker_no_lock(self):
        ...
        config = {"name": "test", "base_url": "https://example.com/", "selectors": {"main_content": "article"}, "workers": 1}
...
class TestScrapingModes(unittest.TestCase):
    ...
    def test_single_threaded_limited(self):
        ...
        config = {"name": "test", "base_url": "https://example.com/", "selectors": {"main_content": "article"}, "max_pages": 10, "workers": 1}
    ...
    def test_parallel_limited(self):
        ...
        config = {"name": "test", "base_url": "https://example.com/", "selectors": {"main_content": "article"}, "max_pages": 100, "workers": 4}
    ...
    def test_parallel_unlimited(self):
        ...
        config = {"name": "test", "base_url": "https://example.com/", "selectors": {"main_content": "article"}, "max_pages": None, "workers": 8}
