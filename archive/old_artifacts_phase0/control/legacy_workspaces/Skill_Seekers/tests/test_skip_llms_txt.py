...
class TestSkipLlmsTxtConfig(unittest.TestCase):
    ...
    def test_skip_llms_txt_can_be_set_false(self):
        ...
        config = {"name": "test", "base_url": "https://example.com/", "selectors": {"main_content": "article"}, "skip_llms_txt": False}
    ...
    def test_llms_txt_tried_when_not_skipped(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            try:
                ...
                with patch.object(converter, "_try_llms_txt", return_value=False) as mock_try, patch.object(converter, "scrape_page"):
    ...
    def test_llms_txt_skipped_when_skip_true(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            try:
                ...
                with patch.object(converter, "_try_llms_txt") as mock_try, patch.object(converter, "scrape_page"):
                    with patch.object(converter, "save_summary"):
                        converter.scrape_all()
...
class TestSkipLlmsTxtWithRealConfig(unittest.TestCase):
    ...
    def test_telegram_bots_config_pattern(self):
        ...
        config = {
            ...
            "selectors": {"main_content": "#dev_page_content, main, article", "title": "h1, title", "code_blocks": "pre code, pre"},
        }
