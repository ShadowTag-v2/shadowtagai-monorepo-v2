...
class TestCategorization(unittest.TestCase):
    ...
    def test_categorize_by_title(self):
        ...
        pages = [{"url": "https://example.com/docs/page", "title": "API Reference Documentation", "content": "Some content"}]
        categories = self.converter.smart_categorize(pages)
    ...
    def test_categorize_by_content(self):
        ...
        pages = [
            {"url": "https://example.com/docs/page", "title": "Some Page", "content": "This is a tutorial for beginners. An intro to the system."}
        ]
        categories = self.converter.smart_categorize(pages)
    ...
    def test_categorize_to_other(self):
        ...
        pages = [{"url": "https://example.com/random/page", "title": "Random Page", "content": "Random content with no keywords"}]
        categories = self.converter.smart_categorize(pages)
