...
class Mru:
    def __init__(self):
        self._cache_dir = os.path.join(lfEval("g:Lf_CacheDirectory"), "LeaderF", "python" + lfEval("g:Lf_PythonVersion"), "mru")
    ...
    def saveToCache(self, data_list):
        ...
        for item in data_list:
            ...
            if True in (fnmatch.fnmatch(name, i) for i in lfEval("g:Lf_MruFileExclude")):
                continue
            ...
            for item in frecency_list:
                ...
                for i, line in enumerate(lines):
                    ...
                    if (compare == text) or (nocase and compare == text.lower()):
                        ...
                        lines[i] = f"{time1} {int(rank1) + int(rank2)} {filename}\n"
                        break
                else:
                    lines.append(item + "\n")
