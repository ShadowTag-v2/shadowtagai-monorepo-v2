...
We eliminated the legacy `n-autoresearch/Kosmos/BioAgents` and `CavMTOE` architectures. Everything routes through **Kosmos** and is vetted by **Judge 6** (The Sentinel) using an **Agent-to-Agent (A2A)** JSON RPC 2.0 orchestration layer.
