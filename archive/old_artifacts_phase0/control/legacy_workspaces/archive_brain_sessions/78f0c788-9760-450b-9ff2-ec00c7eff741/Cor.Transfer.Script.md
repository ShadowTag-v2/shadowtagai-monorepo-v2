...
We didn't just check the boxes. We engineered an autonomous python pipeline (`execute_fold_in.py`) to traverse the absolute outer bounds of the `/ShadowTag-v2-stack/` root.
