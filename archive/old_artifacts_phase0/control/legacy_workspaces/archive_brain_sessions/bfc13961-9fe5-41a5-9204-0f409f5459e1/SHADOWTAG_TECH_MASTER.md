...
**Sidecar A (The Brain)**: `bin/n-autoresearch/Kosmos/BioAgentss-server` (Gemini Ultra/Pro context).
...
*   [ ] Activate `bin/n-autoresearch/Kosmos/BioAgentss-server` with `libs` path.
