...
class SwarmVoter:
    ...
    async def aggregate_votes(self, context: VoteContext, votes: list[Vote]) -> Decision:
        """
        ...
        print(
            f"///▞ SWARM_VOTER :: Unclear consensus ({consensus_ratio:.2%}), invoking LLM tiebreaker"
        )
    ...
    async def vote(
        ...
        print(
            f"///▞ SWARM_VOTER :: Decision: {decision.decision.value} "
...
_voter_instance: SwarmVoter | None = None
