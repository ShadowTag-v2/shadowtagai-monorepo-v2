from ast_grep_py import Config, Pattern, Relation, Rule, SgRoot
...
def test_pattern():
    node = root.find(pattern={"context": "let a = 123", "selector": "variable_declarator"})
    assert node
