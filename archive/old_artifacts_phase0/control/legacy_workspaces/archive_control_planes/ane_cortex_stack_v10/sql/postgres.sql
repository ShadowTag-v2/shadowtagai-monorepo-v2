...
CREATE TABLE IF NOT EXISTS repo_root_conflicts (
  conflict_id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  repo_id TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS authority_promotions (
  ...
  repo_id TEXT NOT NULL,
  promotion_kind TEXT NOT NULL, -- atom,snapshot,procedure,setting,standard
  subject TEXT NOT NULL,
  payload JSONB NOT NULL,
  approval_status TEXT NOT NULL DEFAULT 'proposed', -- proposed,approved,rejected,applied
  proposed_by TEXT,
