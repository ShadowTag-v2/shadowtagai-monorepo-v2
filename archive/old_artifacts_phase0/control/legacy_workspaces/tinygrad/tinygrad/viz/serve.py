...
from tinygrad.device import Device, ProfileDeviceEvent, ProfileGraphEntry, ProfileGraphEvent
...
def get_render(i: int, j: int, fmt: str) -> dict:
  ...
  if fmt == "asm":
    ...
    from tinygrad.runtime.support.compiler_cpu import LLVMCompiler, llvm
