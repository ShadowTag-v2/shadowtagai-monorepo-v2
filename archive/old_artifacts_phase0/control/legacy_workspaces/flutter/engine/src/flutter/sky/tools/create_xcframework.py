...
def main():
    parser = argparse.ArgumentParser(description="Creates an XCFramework consisting of the specified universal frameworks")

    parser.add_argument("--frameworks", nargs="+", help="The framework paths used to create the XCFramework.", required=True)
