...
def main():
    parser = argparse.ArgumentParser(description="Removes existing files and installs the specified headers" + "at the given location.")

    parser.add_argument("--headers", nargs="+", help="The headers to install at the location.", required=True)
