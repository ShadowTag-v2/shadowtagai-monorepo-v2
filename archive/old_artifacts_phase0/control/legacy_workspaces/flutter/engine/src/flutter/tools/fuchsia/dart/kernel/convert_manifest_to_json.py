...
def main():
    ...
    parser.add_argument("--path_prefix", help="Directory path containing the manifest entry sources", required=True)
    ...
    with open(args.output, "w") as output_file:
        json.dump([e._asdict() for e in entries], output_file, indent=2, sort_keys=True, separators=(",", ": "))
