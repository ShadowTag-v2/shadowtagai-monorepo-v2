...
sys.path.insert(0, os.path.join(os.path.dirname(__file__), "../../tools/fuchsia/test_scripts/test/"))

# pylint: disable=import-error, wrong-import-position
from bundled_test_runner import TestCase, run_tests
...
def main() -> int:
    ...
    with open(os.path.join(os.path.dirname(__file__), "test_suites.yaml")) as file:
