...
def main():
    ...
    parser.add_argument("--output", type=str, required=True, help="The location to generate the Metal library to.")
    parser.add_argument("--depfile", type=str, required=True, help="The location of the depfile.")
    parser.add_argument("--source", type=str, action="append", required=True, help="The source file to compile. Can be specified multiple times.")
    parser.add_argument("--platform", required=True, choices=["mac", "ios", "ios-simulator"], help="Select the platform.")
    parser.add_argument("--metal-version", required=True, help="The language standard version to compile for.")
