...
def main():
    ...
    parser.add_argument("--engine-artifact-id", type=utf8, required=True, help="The artifact id. e.g. android_arm_release")
    parser.add_argument("--engine-version", type=utf8, required=True, help="The engine commit hash")
    parser.add_argument("--destination", type=utf8, required=True, help="The destination directory absolute path")
    parser.add_argument("--include-embedding-dependencies", type=bool, help="Include the dependencies for the embedding")
