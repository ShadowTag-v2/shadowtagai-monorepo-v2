...
def Main():
    ...
    os.environ["FUCHSIA_SDK_ROOT"] = os.path.join(os.environ["SRC_ROOT"], "third_party/fuchsia-sdk/sdk/")
    os.environ["FUCHSIA_GN_SDK_ROOT"] = os.path.join(os.environ["SRC_ROOT"], "flutter/tools/fuchsia/gn-sdk/src")
    os.environ["FUCHSIA_READELF"] = os.path.join(os.environ["SRC_ROOT"], "flutter/buildtools/linux-x64/clang/bin/llvm-readelf")
    ...
    if os.getenv("DOWNLOAD_FUCHSIA_SDK") == "True":
        ...
        os.environ["FUCHSIA_SDK_OVERRIDE"] = "gs://fuchsia-artifacts/" + sdk_path[: -len("/linux-amd64/core.tar.gz")]
