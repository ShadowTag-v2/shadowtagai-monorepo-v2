...
def Main():
    ...
    parser.add_argument("--force-upload", action="store_true", default=False, help="Force artifact upload, overwriting existing artifacts.")
    ...
    parser.add_argument("--dry-run", action="store_true", help="Print what would be done, but do nothing.")
    ...
    for builder in builders:
        if args.force_upload:
            params = '{"Commit": "%s", "Builder": "%s", "Repo": "engine", "Properties": {"force_upload":true}}' % (args.commit, builder)
        else:
