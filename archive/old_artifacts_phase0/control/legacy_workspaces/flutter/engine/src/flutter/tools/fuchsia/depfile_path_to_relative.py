...
def main():
    parser = argparse.ArgumentParser(description="Executes a command, then rewrites the depfile, converts all absolute paths to relative")
