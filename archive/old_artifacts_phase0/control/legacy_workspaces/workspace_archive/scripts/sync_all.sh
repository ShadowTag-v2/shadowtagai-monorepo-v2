...
ARCHIVE_DIR="/Users/pikeymickey/ShadowTag-v2-stack/workspace_archive"
...
if [ -d "/Users/pikeymickey/ShadowTag-v2-stack/ShadowTag-v2/docs/icloud_notes_imported" ]; then
    rsync -av --delete "/Users/pikeymickey/ShadowTag-v2-stack/ShadowTag-v2/docs/icloud_notes_imported/" "$ARCHIVE_DIR/icloud_notes/"
...
if [ -d "/Users/pikeymickey/ShadowTag-v2-stack/ShadowTag-v2/extracted/antigravity_brain" ]; then
    rsync -av "/Users/pikeymickey/ShadowTag-v2-stack/ShadowTag-v2/extracted/antigravity_brain/" "$ARCHIVE_DIR/google_drive/antigravity_brain/"
    log "  - Antigravity brain: synced"
fi

# 5. Sync local code summaries
log "Creating local code index..."
find /Users/pikeymickey/ShadowTag-v2-stack -maxdepth 2 -type d -name ".git" 2>/dev/null | \
    sed 's/\/.git$//' | \
    while read repo; do
