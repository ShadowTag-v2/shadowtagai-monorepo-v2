...
def upgrade() -> None:
    ...
    # Composite indexes for common query patterns
    op.create_index("idx_experiments_domain_status", "experiments", ["domain", "status"], unique=False)

    op.create_index("idx_experiments_status_created", "experiments", ["status", "created_at"], unique=False)
    ...
    op.create_index("idx_hypotheses_testability_score", "hypotheses", ["testability_score"], unique=False)

    op.create_index("idx_hypotheses_created_at", "hypotheses", ["created_at"], unique=False)

    # Composite indexes for common query patterns
    op.create_index("idx_hypotheses_domain_status", "hypotheses", ["domain", "status"], unique=False)

    op.create_index("idx_hypotheses_domain_novelty", "hypotheses", ["domain", "novelty_score"], unique=False)
    ...
    # Composite indexes for common query patterns
    op.create_index("idx_papers_domain_relevance", "papers", ["domain", "relevance_score"], unique=False)

    op.create_index("idx_papers_domain_pubdate", "papers", ["domain", "publication_date"], unique=False)
    ...
    op.create_index("idx_results_supports_hypothesis", "results", ["supports_hypothesis"], unique=False)
    ...
    op.create_index("idx_research_sessions_created_at", "research_sessions", ["created_at"], unique=False)

    # Composite indexes for common query patterns
    op.create_index("idx_research_sessions_domain_status", "research_sessions", ["domain", "status"], unique=False)
