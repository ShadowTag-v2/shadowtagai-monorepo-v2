...
def generate_qc_plots(adata, output_prefix="qc"):
    ...
    sc.pl.violin(adata, ["n_genes_by_counts", "total_counts", "pct_counts_mt"], jitter=0.4, multi_panel=True, save=f"_{output_prefix}_violin.pdf")
...
def main():
    ...
    # Calculate QC metrics
    adata = calculate_qc_metrics(adata, mt_threshold=args.mt_threshold, min_genes=args.min_genes, min_cells=args.min_cells)
