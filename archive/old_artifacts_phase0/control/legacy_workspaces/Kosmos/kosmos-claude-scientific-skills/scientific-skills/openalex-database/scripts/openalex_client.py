...
class OpenAlexClient:
    ...
    def _make_request(self, endpoint: str, params: dict | None = None, max_retries: int = 5) -> dict[str, Any]:
        """
    ...
    def batch_lookup(self, entity_type: str, ids: list[str], id_field: str = "openalex_id") -> list[dict[str, Any]]:
        """
    ...
    def paginate_all(self, endpoint: str, params: dict | None = None, max_results: int | None = None) -> list[dict[str, Any]]:
        """
    ...
    def sample_works(self, sample_size: int, seed: int | None = None, filter_params: dict | None = None) -> list[dict[str, Any]]:
        """
    ...
    def group_by(self, entity_type: str, group_field: str, filter_params: dict | None = None) -> list[dict[str, Any]]:
        """
...
if __name__ == "__main__":
    ...
    results = client.search_works(search="machine learning", filter_params={"publication_year": "2023"}, per_page=10)
