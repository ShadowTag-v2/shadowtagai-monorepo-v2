...
def complete_clustering_analysis(X, true_labels=None, scale=True, find_k=True, k_range=range(2, 11), n_clusters=3):
    """
...
if __name__ == "__main__":
    ...
    results_iris = complete_clustering_analysis(X_iris, true_labels=y_iris, scale=True, find_k=True, k_range=range(2, 8), n_clusters=3)
    ...
    results_synth = complete_clustering_analysis(X_synth, true_labels=y_synth_with_noise, scale=True, find_k=True, k_range=range(2, 8), n_clusters=4)
