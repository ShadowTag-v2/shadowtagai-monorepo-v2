...
from reportlab.platypus import BaseDocTemplate, Frame, PageBreak, PageTemplate, Paragraph, Spacer, Table, TableOfContents, TableStyle
...
def create_report(filename, report_data):
    ...
    doc = BaseDocTemplate(filename, pagesize=letter, rightMargin=72, leftMargin=72, topMargin=inch, bottomMargin=inch)
        ...
        "sections": [
            {
                ...
                """,
                "subsections": [{"title": "Key Achievements", "content": "Successfully launched Product X with 10,000 units sold in first month."}],
            },
            {
                ...
                "chart_data": {"type": "bar", "data": [[2.5, 3.1], [0.5, 0.68], [2.0, 2.4]], "categories": ["Q3", "Q4"]},
            },
            {
                ...
                """,
                "chart_data": {"type": "line", "data": [[100, 120, 115, 140, 135, 150]], "categories": ["Oct", "Nov", "Dec", "Oct", "Nov", "Dec"]},
            },
        ],
    }
