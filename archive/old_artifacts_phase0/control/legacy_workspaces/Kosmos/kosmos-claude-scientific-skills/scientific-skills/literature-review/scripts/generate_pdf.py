...
def generate_pdf(
    markdown_file: str, output_pdf: str = None, citation_style: str = "apa", template: str = None, toc: bool = True, number_sections: bool = True
) -> bool:
    """
...
def main():
    ...
    # Generate PDF
    success = generate_pdf(markdown_file, output_pdf, citation_style=citation_style, toc=toc, number_sections=number_sections)
