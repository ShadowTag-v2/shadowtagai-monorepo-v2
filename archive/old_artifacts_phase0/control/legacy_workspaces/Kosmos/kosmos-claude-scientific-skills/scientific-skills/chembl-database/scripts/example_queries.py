...
def get_bioactivity_data(target_chembl_id, activity_type="IC50", max_value=100):
    ...
    results = activity.filter(target_chembl_id=target_chembl_id, standard_type=activity_type, standard_value__lte=max_value, standard_units="nM")
    return list(results)
...
def find_kinase_inhibitors(max_ic50=100):
    ...
    # Find activities
    results = activity.filter(target_chembl_id__in=target_ids, standard_type="IC50", standard_value__lte=max_ic50, standard_units="nM")
