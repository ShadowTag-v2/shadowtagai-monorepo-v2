...
def available_oracles_info():
    ...
    oracle_info = {
        "Biochemical Targets": ["DRD2", "GSK3B", "JNK3", "5HT2A", "ACE", "MAPK", "CDK", "P38", "PARP1", "PIK3CA"],
        "Physicochemical Properties": ["QED", "SA", "LogP", "MW", "Lipinski"],
        "Composite Metrics": ["Isomer_Meta", "Median1", "Median2", "Rediscovery", "Similarity", "Uniqueness", "Novelty"],
...
def constraint_satisfaction_example():
    ...
    # Test molecules
    test_molecules = ["CC(C)Cc1ccc(cc1)C(C)C(O)=O", "CC(=O)Oc1ccccc1C(=O)O", "Cn1c(=O)c2c(ncn2C)n(C)c1=O"]
