...
def save_pathway_summary(results, output_file):
    ...
    with open(output_file, "w", newline="") as f:
        ...
        # Header
        writer.writerow(
            ["Pathway_ID", "Pathway_Name", "Num_Genes", "Num_Interactions", "Activation", "Inhibition", "Phosphorylation", "Binding", "Other"]
        )
        ...
        for result in results:
            ...
            writer.writerow(
                [
                    ...
                    sum(v for k, v in rel_types.items() if k not in ["activation", "inhibition", "phosphorylation", "binding/association"]),
                ]
            )
...
def save_detailed_pathway_info(results, output_dir):
    ...
    for result in results:
        ...
        with open(filename, "w", newline="") as f:
            ...
            for rel in result["relations"]:
                writer.writerow([rel.get("entry1", ""), rel.get("entry2", ""), rel.get("name", "unknown"), rel.get("link", "unknown")])
...
Organism codes:
  ...
  eco = Escherichia coli
    ...
    parser.add_argument("--limit", type=int, default=None, help="Limit analysis to first N pathways")
