...
def calculate_properties(mol):
    ...
    properties["Lipinski_Pass"] = properties["MW"] <= 500 and properties["LogP"] <= 5 and properties["HBD"] <= 5 and properties["HBA"] <= 10

    # Lead-likeness
    properties["Lead-like"] = 250 <= properties["MW"] <= 350 and properties["LogP"] <= 3.5 and properties["Rotatable_Bonds"] <= 7
