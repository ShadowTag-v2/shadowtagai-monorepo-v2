...
def extract_metadata_text(ds, show_sequences=False):
    ...
    # Patient Information
    lines.append("\n[Patient Information]")
    patient_tags = ["PatientName", "PatientID", "PatientBirthDate", "PatientSex", "PatientAge", "PatientWeight"]
    ...
    # Study Information
    lines.append("\n[Study Information]")
    study_tags = ["StudyInstanceUID", "StudyDate", "StudyTime", "StudyDescription", "AccessionNumber", "StudyID"]
    ...
    # Series Information
    lines.append("\n[Series Information]")
    series_tags = ["SeriesInstanceUID", "SeriesNumber", "SeriesDescription", "Modality", "SeriesDate", "SeriesTime"]
...
Examples:
  ...
  python extract_metadata.py file.dcm --show-sequences
    ...
    parser.add_argument("--format", type=str, choices=["text", "json"], default="text", help="Output format (default: text)")
    parser.add_argument("--show-sequences", action="store_true", help="Include all data elements including sequences")
