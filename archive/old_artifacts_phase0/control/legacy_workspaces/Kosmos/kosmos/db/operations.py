...
from kosmos.db.models import AgentRecord, Experiment, ExperimentStatus, Hypothesis, HypothesisStatus, Paper, ResearchSession, Result
...
def get_hypothesis(session: Session, hypothesis_id: str, with_experiments: bool = False) -> Hypothesis | None:
    """
