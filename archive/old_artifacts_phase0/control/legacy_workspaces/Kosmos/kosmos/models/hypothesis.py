...
class Hypothesis(BaseModel):
    ...
    parent_hypothesis_id: str | None = Field(None, description="ID of parent hypothesis (if refined/spawned)")
...
class HypothesisGenerationRequest(BaseModel):
    ...
    # Optional context
    context: dict[str, Any] | None = Field(None, description="Additional context (literature, data, etc.)")
