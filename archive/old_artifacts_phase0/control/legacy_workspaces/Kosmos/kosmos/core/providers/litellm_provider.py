...
class LiteLLMProvider(LLMProvider):
    ...
    def __init__(self, config: dict[str, Any]):
        ...
        try:
            ...
            raise ImportError("LiteLLM is required for LiteLLMProvider. Install it with: pip install litellm")
        ...
        logger.info(f"LiteLLM provider initialized: model={self.model}, provider_type={self.provider_type}, api_base={self.api_base}")
    ...
    def generate_with_messages(self, messages: list[Message], max_tokens: int = None, temperature: float = None, **kwargs) -> LLMResponse:
        """
    ...
    def generate_structured(
        self, prompt: str, schema: dict[str, Any], system: str | None = None, max_tokens: int = None, temperature: float = None, **kwargs
    ) -> dict[str, Any]:
        """
...
The response must match this schema: """
        ...
        try:
            ...
            raise ProviderAPIError("litellm", f"Invalid JSON response: {e}", raw_error=e, recoverable=False)

    def generate_stream(self, prompt: str, system: str | None = None, max_tokens: int = None, temperature: float = None, **kwargs) -> Iterator[str]:
        """
    ...
    async def generate_stream_async(
        self, prompt: str, system: str | None = None, max_tokens: int = None, temperature: float = None, **kwargs
    ) -> AsyncIterator[str]:
        """
