...
from kosmos.orchestration import DelegationManager, NoveltyDetector, PlanCreatorAgent, PlanReviewerAgent
...
class ResearchWorkflow:
    ...
    async def _emit_workflow_event(
        ...
        try:
            from kosmos.core.events import EventType, WorkflowEvent
