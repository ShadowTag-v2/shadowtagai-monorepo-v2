...
def main(
    ...
    debug_modules: str | None = typer.Option(None, "--debug-modules", help="Comma-separated modules to debug"),
...
def register_commands():
    ...
    try:
        from kosmos.cli.commands import cache, graph, history, profile, run, status
        from kosmos.cli.commands import config as config_cmd
