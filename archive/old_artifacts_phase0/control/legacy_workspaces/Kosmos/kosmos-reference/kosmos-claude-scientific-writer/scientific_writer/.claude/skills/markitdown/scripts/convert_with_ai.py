...
Popular Models (use with --model):
  ...
  google/gemini-pro-vision   - Gemini Pro Vision
    ...
    parser.add_argument(
        "--model", "-m", default="anthropic/claude-sonnet-4.5", help="Model to use via OpenRouter (default: anthropic/claude-sonnet-4.5)"
    )
    parser.add_argument("--prompt-type", "-t", choices=list(PROMPTS.keys()), default="general", help="Type of prompt to use (default: general)")
