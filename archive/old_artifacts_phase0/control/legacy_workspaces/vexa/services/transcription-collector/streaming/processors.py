...
async def process_session_start_event(message_id: str, stream_data: dict[str, Any], db: AsyncSession, user: User | None, meeting: Meeting, redis_c: aioredis.Redis) -> bool:
