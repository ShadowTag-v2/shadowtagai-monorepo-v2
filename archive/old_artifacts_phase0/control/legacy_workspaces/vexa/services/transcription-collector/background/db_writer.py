...
def create_transcription_object(meeting_id: int, start: float, end: float, text: str, language: str | None, session_uid: str | None, mapped_speaker_name: str | None) -> Transcription:
