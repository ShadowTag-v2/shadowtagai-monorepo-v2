...
# ---------------------------
async def get_api_key(authorization: str | None = Header(None)) -> str:
    """
...
class RequestMeetingBot(BaseModel):
    ...
    language: str | None = Field(None, description="Optional language code for transcription (e.g., 'en', 'es'). If not specified, auto-detected")
    bot_name: str | None = Field(None, description="Optional custom name for the bot in the meeting")
...
class UpdateMeetingData(BaseModel):
    name: str | None = Field(None, description="Optional meeting name/title")
    participants: list[str] | None = Field(None, description="Optional list of participant names")
    languages: list[str] | None = Field(None, description="Optional list of language codes detected/used in the meeting")
    notes: str | None = Field(None, description="Optional meeting notes or description")
