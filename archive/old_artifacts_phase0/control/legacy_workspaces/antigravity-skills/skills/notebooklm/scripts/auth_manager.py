...
class AuthManager:
    ...
    def get_auth_info(self) -> dict[str, Any]:
        ...
        info = {"authenticated": self.is_authenticated(), "state_file": str(self.state_file), "state_exists": self.state_file.exists()}
    ...
    def _save_auth_info(self):
        ...
        try:
            info = {"authenticated_at": time.time(), "authenticated_at_iso": time.strftime("%Y-%m-%d %H:%M:%S")}
