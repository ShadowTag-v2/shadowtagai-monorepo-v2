...
class NotebookLibrary:
    ...
    def _save_library(self):
        ...
        try:
            data = {"notebooks": self.notebooks, "active_notebook_id": self.active_notebook_id, "updated_at": datetime.now().isoformat()}
...
def main():
    ...
    if args.command == "add":
        ...
        notebook = library.add_notebook(url=args.url, name=args.name, description=args.description, topics=topics, use_cases=use_cases, tags=tags)
