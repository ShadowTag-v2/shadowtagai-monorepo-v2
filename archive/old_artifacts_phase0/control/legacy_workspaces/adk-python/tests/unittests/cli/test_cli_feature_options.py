...
from google.adk.cli.cli_tools_click import _apply_feature_overrides, feature_options
from google.adk.features._feature_registry import _FEATURE_OVERRIDES, _WARNED_FEATURES, FeatureName, is_feature_enabled
...
class TestApplyFeatureOverrides:
    ...
    def test_comma_separated_features(self):
        ...
        _apply_feature_overrides(enable_features=("JSON_SCHEMA_FOR_FUNC_DECL,PROGRESSIVE_SSE_STREAMING",))
        assert is_feature_enabled(FeatureName.JSON_SCHEMA_FOR_FUNC_DECL)
    ...
    def test_whitespace_handling(self):
        ...
        _apply_feature_overrides(enable_features=(" JSON_SCHEMA_FOR_FUNC_DECL , COMPUTER_USE ",))
        assert is_feature_enabled(FeatureName.JSON_SCHEMA_FOR_FUNC_DECL)
    ...
    def test_comma_separated_disable_features(self):
        ...
        # Then disable them
        _apply_feature_overrides(disable_features=("JSON_SCHEMA_FOR_FUNC_DECL,PROGRESSIVE_SSE_STREAMING",))
        assert not is_feature_enabled(FeatureName.JSON_SCHEMA_FOR_FUNC_DECL)
...
class TestFeatureOptionsDecorator:
    ...
    def test_enable_features_applied_before_command(self):
        ...
        @feature_options()
        def test_cmd():
            feature_was_enabled.append(is_feature_enabled(FeatureName.JSON_SCHEMA_FOR_FUNC_DECL))
    ...
    def test_multiple_enable_features_flags(self):
        ...
        @feature_options()
        def test_cmd():
            enabled_features.append(is_feature_enabled(FeatureName.JSON_SCHEMA_FOR_FUNC_DECL))
            enabled_features.append(is_feature_enabled(FeatureName.PROGRESSIVE_SSE_STREAMING))
    ...
    def test_preserves_function_metadata(self):
        ...
        assert "my_test_command" in my_test_command.name or my_test_command.callback.__name__ == "my_test_command"
    ...
    def test_disable_features_applied_before_command(self):
        ...
        @feature_options()
        def test_cmd():
            feature_was_disabled.append(not is_feature_enabled(FeatureName.JSON_SCHEMA_FOR_FUNC_DECL))
    ...
    def test_enable_and_disable_together(self):
        ...
        @feature_options()
        def test_cmd():
            feature_states.append(is_feature_enabled(FeatureName.JSON_SCHEMA_FOR_FUNC_DECL))
            feature_states.append(is_feature_enabled(FeatureName.PROGRESSIVE_SSE_STREAMING))
