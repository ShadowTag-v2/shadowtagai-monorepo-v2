...
class TestAgentLoader:
    ...
    def create_agent_structure(self, temp_dir: Path, agent_name: str, structure_type: str):
    ...
    def test_load_agent_as_package_with_root_agent(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.create_agent_structure(temp_path, "package_agent", "package_with_root")
    ...
    def test_load_agent_as_package_with_agent_module(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.create_agent_structure(temp_path, "modular_agent", "package_with_agent_module")
    ...
    def test_loading_order_preference(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            agent_submodule_file.write_text(
                dedent(f"""
                from google.adk.agents.base_agent import BaseAgent
    ...
    def test_load_multiple_different_agents(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.create_agent_structure(temp_path, "agent_three", "package_with_agent_module")
    ...
    def test_agent_not_found_error(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            expected_msg_part_2 = (
                "Searched in 'nonexistent_agent.agent.root_agent', 'nonexistent_agent.root_agent' and 'nonexistent_agent/root_agent.yaml'."
            )
            expected_msg_part_3 = f"Ensure '{agents_dir}/nonexistent_agent' is structured correctly"
    ...
    def test_agent_internal_syntax_error(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with pytest.raises(SyntaxError) as exc_info:  # Or potentially ImportError depending on Python version specifics with importlib
                loader.load_agent(agent_name)
    ...
    def test_agent_internal_name_error(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # SyntaxError is a subclass of Exception, and importlib might wrap it
            # The loader is expected to prepend its message and re-raise.
            with pytest.raises(NameError) as exc_info:  # Or potentially ImportError depending on Python version specifics with importlib
                loader.load_agent(agent_name)
    ...
    def create_yaml_agent_structure(self, temp_dir: Path, agent_name: str, yaml_content: str):
    ...
    def test_yaml_agent_not_found_error(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            expected_msg_part_3 = f"Ensure '{agents_dir}/nonexistent_yaml_agent' is structured correctly"
    ...
    def test_yaml_agent_invalid_yaml_error(self):
      ...
      """)
            ...
            self.create_yaml_agent_structure(temp_path, agent_name, invalid_yaml_content)
    ...
    def create_special_agent_structure(self, special_agents_dir: Path, agent_name: str, structure_type: str):
    ...
    def test_load_special_agent_with_double_underscore(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.create_special_agent_structure(special_agents_dir, "helper", "package_with_agent_module")
    ...
    def test_special_agent_caching_returns_same_instance(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # Create a special agent
            self.create_special_agent_structure(special_agents_dir, "cached_helper", "module")
    ...
    def test_special_agent_not_found_error(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                expected_msg_part_2 = (
                    "Searched in 'nonexistent_special.agent.root_agent', 'nonexistent_special.root_agent' and 'nonexistent_special/root_agent.yaml'."
                )
                expected_msg_part_3 = f"Ensure '{special_agents_dir}/nonexistent_special' is structured correctly"
    ...
    def create_special_yaml_agent_structure(self, special_agents_dir: Path, agent_name: str, yaml_content: str):
    ...
    def test_load_special_agent_from_yaml_config(self):
      ...
      """)
            ...
            self.create_special_yaml_agent_structure(special_agents_dir, agent_name, yaml_content)
    ...
    def test_yaml_config_agents_dir_parameter(self):
      ...
      """)
            self.create_yaml_agent_structure(regular_agents_dir, agent_name, regular_yaml_content)
      ...
      """)
            self.create_yaml_agent_structure(custom_agents_dir, agent_name, custom_yaml_content)

            # Create loader pointing to regular directory
            loader = AgentLoader(str(regular_agents_dir))

            # Test 1: Call with regular agents_dir (should use self.agents_dir)
            default_agent = loader._load_from_yaml_config(agent_name, str(regular_agents_dir))
            ...
            custom_agent = loader._load_from_yaml_config(agent_name, str(custom_agents_dir))
            ...
            explicit_agent = loader._load_from_yaml_config(agent_name, loader.agents_dir)
