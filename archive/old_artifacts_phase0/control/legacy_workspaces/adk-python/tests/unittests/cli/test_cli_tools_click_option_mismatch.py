...
import click
from google.adk.cli.cli_tools_click import (
    cli_api_server,
    cli_create_cmd,
...
def _get_command_by_name(commands: MutableMapping[str, click.Command], name) -> click.Command | None:
...
def test_adk_create():
    ...
    _check_options_in_parameters(create_command, cli_create_cmd.callback, "create")
...
def test_adk_web():
    ...
    _check_options_in_parameters(web_command, cli_web.callback, "web", ignore_params={"verbose"})
...
def test_adk_deploy_agent_engine():
    ...
    assert agent_engine_command is not None, "Agent Engine deploy command not found"
    _check_options_in_parameters(
...
def test_adk_deploy_gke():
    ...
    _check_options_in_parameters(gke_command, cli_deploy_gke.callback, "deploy gke")
