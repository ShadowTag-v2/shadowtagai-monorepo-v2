...
try:
    ...
    from google.adk.a2a.utils.agent_card_builder import (
        ...
        _convert_example_tool_examples,
...
class TestAgentCardBuilder:
    ...
    async def test_build_success(self, mock_build_sub_skills, mock_build_primary_skills):
    ...
    @patch("google.adk.a2a.utils.agent_card_builder._build_primary_skills")
    @patch("google.adk.a2a.utils.agent_card_builder._build_sub_agent_skills")
    async def test_build_with_custom_parameters(self, mock_build_sub_skills, mock_build_primary_skills):
        ...
        assert result.documentation_url is None
        assert result.url == "https://example.com/a2a"  # Should strip trailing slash
    ...
    @patch("google.adk.a2a.utils.agent_card_builder._build_primary_skills")
    @patch("google.adk.a2a.utils.agent_card_builder._build_sub_agent_skills")
    async def test_build_raises_runtime_error_on_failure(self, mock_build_sub_skills, mock_build_primary_skills):
...
class TestDescriptionBuildingFunctions:
    ...
    def test_get_workflow_description_sequential_agent(self):
        ...
        assert result == "First, this agent will First agent Finally, this agent will Second agent."
    ...
    def test_get_workflow_description_parallel_agent(self):
        ...
        # Assert
        assert result is not None
        assert result == "This agent will First agent and Second agent simultaneously."
    ...
    def test_get_workflow_description_loop_agent(self):
        ...
        # Assert
        assert result == "This agent will First agent and Second agent in a loop (max 5 iterations)."
    ...
    def test_get_workflow_description_loop_agent_unlimited(self):
        ...
        # Assert
        assert result == "This agent will First agent in a loop (max unlimited iterations)."
    ...
    def test_build_sequential_description_multiple_agents(self):
        ...
        # Assert
        assert result == "First, this agent will First agent Then, this agent will Second agent Finally, this agent will Third agent."
    ...
    def test_build_sequential_description_without_descriptions(self):
        ...
        # Assert
        assert result == "First, this agent will execute the agent1 agent Finally, this agent will execute the agent2 agent."
    ...
    def test_build_parallel_description_multiple_agents(self):
        ...
        # Assert
        assert result == "This agent will First agent , Second agent and Third agent simultaneously."
    ...
    def test_build_loop_description_multiple_agents(self):
        ...
        # Assert
        assert result == "This agent will First agent and Second agent in a loop (max 10 iterations)."
    ...
    def test_build_orchestration_skill_with_sub_agents(self):
        ...
        assert result.description == "Orchestrates: agent1: First agent description; agent2: Second agent description"
    ...
    def test_build_orchestration_skill_without_descriptions(self):
        ...
        # Assert
        assert result is not None
        assert result.description == "Orchestrates: agent1: No description; agent2: No description"
...
class TestExampleExtractionFunctions:
    ...
    def test_extract_examples_from_instruction_with_examples(self):
        ...
        # Arrange
        instruction = 'Example Query: "What is the weather?" Example Response: "The weather is sunny."'
    ...
    def test_extract_examples_from_instruction_with_different_patterns(self):
        ...
        # Arrange
        instruction = 'Example: "What is the weather?" Example Response: "The weather is sunny."'
    ...
    def test_extract_examples_from_instruction_odd_number_of_matches(self):
        ...
        # Arrange
        instruction = 'Example Query: "What is the weather?" Example Response: "The weather is sunny." Example Query: "What time is it?"'
