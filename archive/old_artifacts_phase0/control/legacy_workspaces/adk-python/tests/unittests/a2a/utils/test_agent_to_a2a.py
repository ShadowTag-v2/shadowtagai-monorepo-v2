...
class TestToA2A:
    ...
    def test_to_a2a_default_parameters(
        ...
        mock_request_handler_class.assert_called_once_with(agent_executor=mock_agent_executor, task_store=mock_task_store)
        mock_card_builder_class.assert_called_once_with(agent=self.mock_agent, rpc_url="http://localhost:8000/")
        mock_app.add_event_handler.assert_called_once_with("startup", mock_app.add_event_handler.call_args[0][1])
    ...
    def test_to_a2a_custom_host_port(
        ...
        # Assert
        assert result == mock_app
        mock_card_builder_class.assert_called_once_with(agent=self.mock_agent, rpc_url="http://example.com:9000/")
    ...
    def test_to_a2a_with_custom_port_zero(
        ...
        # Assert
        assert result == mock_app
        mock_card_builder_class.assert_called_once_with(agent=self.mock_agent, rpc_url="http://localhost:0/")
    ...
    def test_to_a2a_with_empty_string_host(
        ...
        # Assert
        assert result == mock_app
        mock_card_builder_class.assert_called_once_with(agent=self.mock_agent, rpc_url="http://:8000/")
    ...
    def test_to_a2a_with_negative_port(
        ...
        # Assert
        assert result == mock_app
        mock_card_builder_class.assert_called_once_with(agent=self.mock_agent, rpc_url="http://localhost:-1/")
    ...
    def test_to_a2a_with_very_large_port(
        ...
        # Assert
        assert result == mock_app
        mock_card_builder_class.assert_called_once_with(agent=self.mock_agent, rpc_url="http://localhost:65535/")
    ...
    def test_to_a2a_with_special_characters_in_host(
        ...
        # Assert
        assert result == mock_app
        mock_card_builder_class.assert_called_once_with(agent=self.mock_agent, rpc_url="http://test-host.example.com:8000/")
    ...
    def test_to_a2a_with_ip_address_host(
        ...
        # Assert
        assert result == mock_app
        mock_card_builder_class.assert_called_once_with(agent=self.mock_agent, rpc_url="http://192.168.1.1:8000/")
