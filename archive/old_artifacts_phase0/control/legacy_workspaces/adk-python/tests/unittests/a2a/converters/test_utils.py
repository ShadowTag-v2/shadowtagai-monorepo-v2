...
class TestUtilsFunctions:
    ...
    def test_get_adk_metadata_key_empty_string(self):
        ...
        with pytest.raises(ValueError, match="Metadata key cannot be empty or None"):
            _get_adk_metadata_key("")
    ...
    def test_to_a2a_context_id_empty_app_name(self):
        ...
        with pytest.raises(
            ValueError,
            match=("All parameters \\(app_name, user_id, session_id\\) must be non-empty"),
        ):
    ...
    def test_from_a2a_context_id_too_many_parts(self):
        ...
        context_id = f"{ADK_CONTEXT_ID_PREFIX}/test-app/test-user/test-session/extra"
