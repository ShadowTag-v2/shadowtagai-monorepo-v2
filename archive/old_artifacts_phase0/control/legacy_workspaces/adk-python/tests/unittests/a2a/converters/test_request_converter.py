...
try:
    ...
    from google.adk.a2a.converters.request_converter import _get_user_id, convert_a2a_request_to_agent_run_request
...
class TestConvertA2aRequestToAgentRunRequest:
    ...
    def test_convert_a2a_request_basic(self):
        ...
        # Act
        result = convert_a2a_request_to_agent_run_request(request, mock_convert_part)
        ...
        assert result.run_config.custom_metadata == {"a2a_metadata": {"test_key": "test_value"}}
...
class TestIntegration:
    ...
    def test_end_to_end_conversion_with_fallback_user(self):
        ...
        # Assert
        assert result is not None
        assert result.user_id == "A2A_USER_test_session_456"  # Should fall back to context ID
