...
class TestConvertA2aPartToGenaiPart:
    ...
    def test_convert_file_part_with_uri(self):
        ...
        # Arrange
        a2a_part = a2a_types.Part(root=a2a_types.FilePart(file=a2a_types.FileWithUri(uri="gs://bucket/file.txt", mime_type="text/plain")))
    ...
    def test_convert_file_part_with_bytes(self):
        ...
        a2a_part = a2a_types.Part(root=a2a_types.FilePart(file=a2a_types.FileWithBytes(bytes=base64_encoded, mime_type="text/plain")))
    ...
    def test_convert_data_part_without_special_metadata(self):
        ...
        a2a_part = a2a_types.Part(root=a2a_types.DataPart(data=data, metadata={"other": "metadata"}))
...
class TestConvertGenaiPartToA2aPart:
    ...
    def test_convert_file_data_part(self):
        ...
        # Arrange
        genai_part = genai_types.Part(file_data=genai_types.FileData(file_uri="gs://bucket/file.txt", mime_type="text/plain"))
    ...
    def test_convert_inline_data_part(self):
        ...
        # Arrange
        test_bytes = b"test file content"
        genai_part = genai_types.Part(inline_data=genai_types.Blob(data=test_bytes, mime_type="text/plain"))
    ...
    def test_convert_function_call_part(self):
        ...
        # Arrange
        function_call = genai_types.FunctionCall(name="test_function", args={"param1": "value1", "param2": 42})
        ...
        assert result.root.metadata[_get_adk_metadata_key(A2A_DATA_PART_METADATA_TYPE_KEY)] == A2A_DATA_PART_METADATA_TYPE_FUNCTION_CALL

    def test_convert_function_response_part(self):
        """Test conversion of GenAI function_response Part to A2A Part."""
        # Arrange
        function_response = genai_types.FunctionResponse(name="test_function", response={"result": "success", "data": [1, 2, 3]})
        ...
        assert isinstance(result, a2a_types.Part)
        assert isinstance(result.root, a2a_types.DataPart)
        expected_data = function_response.model_dump(by_alias=True, exclude_none=True)
        assert result.root.data == expected_data
        assert result.root.metadata[_get_adk_metadata_key(A2A_DATA_PART_METADATA_TYPE_KEY)] == A2A_DATA_PART_METADATA_TYPE_FUNCTION_RESPONSE

    def test_convert_code_execution_result_part(self):
        """Test conversion of GenAI code_execution_result Part to A2A Part."""
        # Arrange
        code_execution_result = genai_types.CodeExecutionResult(outcome=genai_types.Outcome.OUTCOME_OK, output="Hello, World!")
        ...
        assert isinstance(result, a2a_types.Part)
        assert isinstance(result.root, a2a_types.DataPart)
        expected_data = code_execution_result.model_dump(by_alias=True, exclude_none=True)
        assert result.root.data == expected_data
        assert result.root.metadata[_get_adk_metadata_key(A2A_DATA_PART_METADATA_TYPE_KEY)] == A2A_DATA_PART_METADATA_TYPE_CODE_EXECUTION_RESULT

    def test_convert_executable_code_part(self):
        """Test conversion of GenAI executable_code Part to A2A Part."""
        # Arrange
        executable_code = genai_types.ExecutableCode(language=genai_types.Language.PYTHON, code="print('Hello, World!')")
        ...
        assert result.root.data == expected_data
        assert result.root.metadata[_get_adk_metadata_key(A2A_DATA_PART_METADATA_TYPE_KEY)] == A2A_DATA_PART_METADATA_TYPE_EXECUTABLE_CODE
...
class TestRoundTripConversions:
    ...
    def test_file_uri_round_trip(self):
        ...
        a2a_part = a2a_types.Part(root=a2a_types.FilePart(file=a2a_types.FileWithUri(uri=original_uri, mime_type=original_mime_type)))
    ...
    def test_file_bytes_round_trip(self):
        ...
        genai_part = genai_types.Part(inline_data=genai_types.Blob(data=original_bytes, mime_type=original_mime_type))
    ...
    def test_function_response_round_trip(self):
        ...
        assert result_genai_part.function_response.response == function_response.response
    ...
    def test_code_execution_result_round_trip(self):
        ...
        assert result_genai_part.code_execution_result.outcome == code_execution_result.outcome
        assert result_genai_part.code_execution_result.output == code_execution_result.output
    ...
    def test_executable_code_round_trip(self):
        ...
        assert result_genai_part.executable_code.language == executable_code.language
