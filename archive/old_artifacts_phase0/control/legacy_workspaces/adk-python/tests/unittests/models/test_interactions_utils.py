...
class TestConvertPartToInteractionContent:
    ...
    def test_function_call_part_with_thought_signature(self):
        ...
        assert base64.b64decode(result["thought_signature"]) == b"test_signature_bytes"
    ...
    def test_multiple_parts(self):
        ...
        content = types.Content(
            ...
            parts=[
                ...
                types.Part(inline_data=types.Blob(data=b"img", mime_type="image/png")),
            ],
        )
        result = interactions_utils.convert_content_to_turn(content)
...
class TestConvertToolsConfig:
    ...
    def test_function_declaration(self):
        ...
        result = interactions_utils.convert_tools_config_to_interactions_format(config)
        assert len(result) == 1
...
class TestConvertInteractionOutputToPart:
    ...
    def test_function_call_output_with_thought_signature(self):
        ...
        output = MagicMock(spec=["type", "id", "name", "arguments", "thought_signature"])
        output.type = "function_call"
        ...
        output.thought_signature = base64.b64encode(b"gemini3_signature").decode("utf-8")
        result = interactions_utils.convert_interaction_output_to_part(output)
...
class TestConvertInteractionEventToLlmResponse:
    ...
    def test_text_delta_event(self):
        ...
        aggregated_parts = []
        result = interactions_utils.convert_interaction_event_to_llm_response(event, aggregated_parts, interaction_id="int_123")
    ...
    def test_function_call_delta_with_thought_signature(self):
        ...
        event = MagicMock()
        event.event_type = "content.delta"
        event.delta = MagicMock(spec=["type", "id", "name", "arguments", "thought_signature"])
        ...
        event.delta.thought_signature = base64.b64encode(b"delta_signature").decode("utf-8")

        aggregated_parts = []
        result = interactions_utils.convert_interaction_event_to_llm_response(event, aggregated_parts, interaction_id="int_456")
    ...
    def test_function_call_delta_without_thought_signature(self):
        ...
        aggregated_parts = []
        result = interactions_utils.convert_interaction_event_to_llm_response(event, aggregated_parts, interaction_id="int_789")
    ...
    def test_function_call_delta_without_name_skipped(self):
        ...
        aggregated_parts = []
        result = interactions_utils.convert_interaction_event_to_llm_response(event, aggregated_parts, interaction_id="int_000")
    ...
    def test_image_delta_with_data(self):
        ...
        aggregated_parts = []
        result = interactions_utils.convert_interaction_event_to_llm_response(event, aggregated_parts, interaction_id="int_img")
    ...
    def test_unknown_event_type_returns_none(self):
        ...
        aggregated_parts = []
        result = interactions_utils.convert_interaction_event_to_llm_response(event, aggregated_parts, interaction_id="int_other")
