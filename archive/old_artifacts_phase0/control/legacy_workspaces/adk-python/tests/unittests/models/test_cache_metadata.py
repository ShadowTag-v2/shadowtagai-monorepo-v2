...
class TestCacheMetadata:
    ...
    def test_required_fields(self):
        ...
        assert metadata.cache_name == "projects/123/locations/us-central1/cachedContents/456"
    ...
    def test_model_config(self):
        ...
        assert metadata.model_config["frozen"]
    ...
    def test_field_descriptions(self):
        ...
        assert "Number of invocations" in schema["properties"]["invocations_used"]["description"]

        assert "contents_count" in schema["properties"]
        assert "Number of contents" in schema["properties"]["contents_count"]["description"]
