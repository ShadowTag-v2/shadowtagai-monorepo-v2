...
from google.adk.flows.llm_flows.functions import _call_tool_in_thread_pool, _get_tool_thread_pool, _is_sync_tool
...
class TestCallToolInThreadPool:
    ...
    async def test_sync_tool_with_args(self):
        ...
        result = await _call_tool_in_thread_pool(tool, {"x": 42, "y": "hello"}, tool_context)
    ...
    async def test_blocking_io_does_not_block_event_loop(self):
        ...
        assert event_loop_ticks >= 5, f"Event loop should have ticked at least 5 times, got {event_loop_ticks}"
    ...
    async def test_custom_max_workers_used(self):
        ...
        result = await _call_tool_in_thread_pool(tool, {}, tool_context, max_workers=12)
...
class TestToolThreadPoolConfig:
    ...
    def test_can_set_custom_max_workers(self):
        ...
        config = RunConfig(tool_thread_pool_config=ToolThreadPoolConfig(max_workers=8))
