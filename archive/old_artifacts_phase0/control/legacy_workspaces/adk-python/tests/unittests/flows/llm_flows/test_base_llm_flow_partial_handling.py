...
async def test_run_async_breaks_on_partial_event():
    ...
    partial_response = LlmResponse(
        content=types.Content(role="model", parts=[types.Part.from_text(text="Partial response")]),
        partial=True,
    )
...
async def test_run_async_breaks_on_final_response():
    ...
    final_response = LlmResponse(
        content=types.Content(role="model", parts=[types.Part.from_text(text="Final response")]),
        partial=False,
...
async def test_run_async_breaks_on_first_partial_response():
    ...
    mock_model = testing_utils.MockModel.create(responses=[partial_response, non_partial_response, final_partial_response])
