...
def test_async_function():
    ...
    increase_by_one_call = Part.from_function_call(name="increase_by_one", args={"x": 1})
    pending_response = Part.from_function_response(name="increase_by_one", response={"status": "pending"})
    ...
    assert testing_utils.simplify_events(events) == [
        ...
        (
            "root_agent",
            Part.from_function_response(name="increase_by_one", response={"status": "pending"}),
        ),
    ...
    still_waiting_response = Part.from_function_response(name="increase_by_one", response={"status": "still waiting"})
    ...
    result_response = Part.from_function_response(name="increase_by_one", response={"result": 2})
    ...
    another_result_response = Part.from_function_response(name="increase_by_one", response={"result": 3})
...
def test_async_function_with_none_response():
    ...
    assert testing_utils.simplify_contents(mockModel.requests[1].contents) == [
        ...
        (
            "user",
            Part.from_function_response(name="increase_by_one", response={"result": "pending"}),
        ),
    ]
