...
class TestBasicTypes(parameterized.TestCase):
    ...
    def test_basic_parameter_types(self, func, expected_param_props, expected_response_schema):
...
class TestCollectionTypes(parameterized.TestCase):
    ...
    def test_dict_with_typed_values(self):
        ...
        self.assertEqual(
            schema["properties"]["scores"].get("additionalProperties", {}).get("type"),
            "integer",
        )
        self.assertEqual(
            decl.response_json_schema,
...
class TestNestedObjects(parameterized.TestCase):
    ...
    def test_pydantic_model_parameter(self):
        ...
        self.assertEqual(address_def["properties"]["zip_code"]["pattern"], r"^\d{5}$")
        self.assertEqual(
            decl.response_json_schema,
            {
                "type": "string",
...
class TestSpecialCases(parameterized.TestCase):
    ...
    def test_tool_context_ignored_via_ignore_params(self):
        ...
        decl = build_function_declaration_with_json_schema(my_tool, ignore_params=["tool_context"])
        schema = decl.parameters_json_schema
    ...
    def test_ignore_params(self):
        ...
        decl = build_function_declaration_with_json_schema(complex_func, ignore_params=["internal"])
        schema = decl.parameters_json_schema
...
class TestStreamingReturnTypes(parameterized.TestCase):
    ...
    def test_async_generator_string_yield(self):
        ...
        async def streaming_tool(param: str) -> AsyncGenerator[str]:
        ...
        self.assertIsNotNone(decl.parameters_json_schema)
        self.assertEqual(decl.parameters_json_schema["properties"]["param"]["type"], "string")
    ...
    def test_async_generator_int_yield(self):
        ...
        async def counter(start: int) -> AsyncGenerator[int]:
            """A streaming counter."""
            yield start
    ...
    def test_generator_string_yield(self):
        ...
        def sync_streaming_tool(param: str) -> Generator[str]:
    ...
    def test_generator_int_yield(self):
        ...
        def sync_counter(start: int) -> Generator[int]:
