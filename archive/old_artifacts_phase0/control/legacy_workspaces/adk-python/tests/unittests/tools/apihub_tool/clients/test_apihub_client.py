...
MOCK_API_DETAIL = {
    "name": "projects/test-project/locations/us-central1/apis/api1",
    "versions": ["projects/test-project/locations/us-central1/apis/api1/versions/v1"],
}
MOCK_API_VERSION = {
    "name": "projects/test-project/locations/us-central1/apis/api1/versions/v1",
    "specs": ["projects/test-project/locations/us-central1/apis/api1/versions/v1/specs/spec1"],
}
...
class TestAPIHubClient:
    ...
    def test_get_api(self, mock_get, client):
        ...
        mock_get.return_value.status_code = 200
        api = client.get_api("projects/test-project/locations/us-central1/apis/api1")
    ...
    def test_get_api_version(self, mock_get, client):
        ...
        mock_get.return_value.status_code = 200
        api_version = client.get_api_version("projects/test-project/locations/us-central1/apis/api1/versions/v1")
    ...
    def test_get_api_version_error(self, mock_get, client):
        mock_get.return_value.raise_for_status.side_effect = HTTPError
        with pytest.raises(HTTPError):
            client.get_api_version("projects/test-project/locations/us-central1/apis/api1/versions/v1")

    @patch("requests.get")
    def test_get_spec_content(self, mock_get, client):
        mock_get.return_value.json.return_value = MOCK_SPEC_CONTENT
        mock_get.return_value.status_code = 200
        spec_content = client.get_spec_content("projects/test-project/locations/us-central1/apis/api1/versions/v1/specs/spec1")
    ...
    def test_get_spec_content_error(self, mock_get, client):
        mock_get.return_value.raise_for_status.side_effect = HTTPError
        with pytest.raises(HTTPError):
            client.get_spec_content("projects/test-project/locations/us-central1/apis/api1/versions/v1/specs/spec1")
    ...
    def test_extract_resource_name_invalid(self, client, url_or_path, expected_error_message):
        with pytest.raises(ValueError, match=expected_error_message):
            client._extract_resource_name(url_or_path)

    @patch("google.adk.tools.apihub_tool.clients.apihub_client.default_service_credential")
    @patch("google.adk.tools.apihub_tool.clients.apihub_client.service_account.Credentials.from_service_account_info")
    ...
    @patch("google.adk.tools.apihub_tool.clients.apihub_client.default_service_credential")
    def test_get_access_token_not_expired_use_cached_token(self, mock_default_credential):
    ...
    @patch("google.adk.tools.apihub_tool.clients.apihub_client.default_service_credential")
    def test_get_access_token_no_credentials(self, mock_default_service_credential):
        mock_default_service_credential.return_value = (None, None)
        with pytest.raises(
            ValueError,
            match=("Please provide a service account or an access token to API Hub client."),
        ):
    ...
    def test_get_spec_content_api_level(self, mock_get, client):
        mock_get.side_effect = [
            ...
            MagicMock(status_code=200, json=lambda: MOCK_API_VERSION),  # For get_api_version
            MagicMock(status_code=200, json=lambda: MOCK_SPEC_CONTENT),  # For get_spec_content
        ]

        content = client.get_spec_content("projects/test-project/locations/us-central1/apis/api1")
    ...
    def test_get_spec_content_version_level(self, mock_get, client):
        ...
        content = client.get_spec_content("projects/test-project/locations/us-central1/apis/api1/versions/v1")
        assert content == "spec content"
    ...
    def test_get_spec_content_spec_level(self, mock_get, client):
        ...
        content = client.get_spec_content("projects/test-project/locations/us-central1/apis/api1/versions/v1/specs/spec1")
        assert content == "spec content"
    ...
    def test_get_spec_content_no_versions(self, mock_get, client):
        ...
        with pytest.raises(
            ValueError,
            match=("No versions found in API Hub resource: projects/test-project/locations/us-central1/apis/api1"),
        ):
            client.get_spec_content("projects/test-project/locations/us-central1/apis/api1")
    ...
    def test_get_spec_content_no_specs(self, mock_get, client):
        ...
        with pytest.raises(
            ValueError,
            match=("No specs found in API Hub version: projects/test-project/locations/us-central1/apis/api1/versions/v1"),
        ):
            client.get_spec_content("projects/test-project/locations/us-central1/apis/api1/versions/v1")

    @patch("requests.get")
    def test_get_spec_content_invalid_path(self, mock_get, client):
        with pytest.raises(
            ValueError,
            match=("Project ID not found in URL or path in APIHubClient. Input path is 'invalid-path'."),
        ):
