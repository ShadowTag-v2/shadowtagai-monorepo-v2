...
class TestMCPSessionManager:
    ...
    async def test_create_session_stdio_new(self):
        ...
        with (
            patch("google.adk.tools.mcp_tool.mcp_session_manager.stdio_client") as mock_stdio,
            patch("google.adk.tools.mcp_tool.mcp_session_manager.AsyncExitStack") as mock_exit_stack_class,
            patch("google.adk.tools.mcp_tool.mcp_session_manager.ClientSession") as mock_session_class,
        ):
            # Setup mocks
