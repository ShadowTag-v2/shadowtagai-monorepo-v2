...
import pytest
from google.adk.tools.bigtable.bigtable_credentials import BIGTABLE_DEFAULT_SCOPE, BigtableCredentialsConfig
...
class TestBigtableCredentials:
    ...
    def test_bigtable_credentials_config_validation_errors(self):
        ...
        mock_creds = mock.create_autospec(Credentials, instance=True)
        with pytest.raises(ValueError):
            BigtableCredentialsConfig(credentials=mock_creds, client_id="abc", client_secret="def")
