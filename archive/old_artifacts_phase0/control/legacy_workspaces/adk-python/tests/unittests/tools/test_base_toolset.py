...
class _TestingToolset(BaseToolset):
    ...
    def __init__(self, *args, tools: list[BaseTool] | None = None, **kwargs):
...
async def test_process_llm_request_default_implementation():
    ...
    await toolset.process_llm_request(tool_context=tool_context, llm_request=llm_request)
...
async def test_prefix_creates_tool_copies():
    ...
    original_tool = _TestingTool(name="original", description="Original description")
...
async def test_prefixed_tools_in_llm_request():
    ...
    await prefixed_tool.process_llm_request(tool_context=tool_context, llm_request=llm_request)
