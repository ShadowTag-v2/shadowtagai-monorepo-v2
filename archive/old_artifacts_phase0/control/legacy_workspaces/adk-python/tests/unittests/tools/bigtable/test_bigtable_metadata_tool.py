...
def test_list_instances():
    ...
    with mock.patch("google.adk.tools.bigtable.client.get_bigtable_admin_client") as mock_get_client:
...
def test_list_instances_failed_locations():
    ...
    with (
        mock.patch("google.adk.tools.bigtable.client.get_bigtable_admin_client") as mock_get_client,
...
def test_get_instance_info():
    ...
    with mock.patch("google.adk.tools.bigtable.client.get_bigtable_admin_client") as mock_get_client:
        ...
        creds = mock.create_autospec(Credentials, instance=True)
        result = metadata_tool.get_instance_info("test-project", "test-instance", creds)
        expected_result = {
...
def test_get_table_info():
    ...
    with mock.patch("google.adk.tools.bigtable.client.get_bigtable_admin_client") as mock_get_client:
        ...
        creds = mock.create_autospec(Credentials, instance=True)
        result = metadata_tool.get_table_info("test-project", "test-instance", "test-table", creds)
        expected_result = {
            "project_id": "test-project",
            "instance_id": "test-instance",
            "table_id": "test-table",
