...
def test_similarity_search_knn_success(mock_get_spanner_client, mock_spanner_ids, mock_credentials):
...
@patch("google.adk.tools.spanner.client.get_spanner_client")
def test_similarity_search_ann_success(mock_get_spanner_client, mock_spanner_ids, mock_credentials):
    ...
    result = search_tool.similarity_search(
        ...
        settings=MagicMock(),
        tool_context=MagicMock(),
        search_options={"nearest_neighbors_algorithm": "APPROXIMATE_NEAREST_NEIGHBORS"},
    )
    assert result["status"] == "SUCCESS", result
...
@patch("google.adk.tools.spanner.client.get_spanner_client")
def test_similarity_search_error(mock_get_spanner_client, mock_spanner_ids, mock_credentials):
...
@patch("google.adk.tools.spanner.client.get_spanner_client")
def test_similarity_search_postgresql_knn_success(mock_get_spanner_client, mock_spanner_ids, mock_credentials):
...
@patch("google.adk.tools.spanner.client.get_spanner_client")
def test_similarity_search_postgresql_ann_unsupported(mock_get_spanner_client, mock_spanner_ids, mock_credentials):
    ...
    assert result["status"] == "ERROR"
    assert result["error_details"] == "APPROXIMATE_NEAREST_NEIGHBORS is not supported for PostgreSQL dialect."


@patch("google.adk.tools.spanner.client.get_spanner_client")
def test_similarity_search_missing_spanner_embedding_model_name_error(mock_get_spanner_client, mock_spanner_ids, mock_credentials):
    ...
    assert result["status"] == "ERROR"
    assert "embedding_options['spanner_embedding_model_name'] must be specified for GoogleSQL dialect." in result["error_details"]


@patch("google.adk.tools.spanner.client.get_spanner_client")
def test_similarity_search_missing_vertex_ai_embedding_model_endpoint_error(mock_get_spanner_client, mock_spanner_ids, mock_credentials):
    ...
    assert result["status"] == "ERROR"
    assert "embedding_options['vertex_ai_embedding_model_endpoint'] must be specified for PostgreSQL dialect." in result["error_details"]
