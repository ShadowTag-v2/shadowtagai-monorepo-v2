...
from google.adk.tools.openapi_tool.common.common import ApiParameter, PydocHelper, TypeHintHelper, rename_python_keywords
...
class TestApiParameter:
    ...
    def test_api_parameter_type_hint_helper(self, schema, expected_type_value, expected_type_hint):
        param = ApiParameter(original_name="test", param_location="query", param_schema=schema)
        assert param.type_value == expected_type_value
        assert param.type_hint == expected_type_hint
        assert TypeHintHelper.get_type_hint(param.param_schema) == expected_type_hint
        assert TypeHintHelper.get_type_value(param.param_schema) == expected_type_value
...
class TestTypeHintHelper:
    ...
    def test_get_type_value_and_hint(self, schema, expected_type_value, expected_type_hint):
...
class TestPydocHelper:
    ...
    def test_generate_param_doc_object(self):
        ...
        expected_doc = "test_param (Dict[str, Any]): Test object parameter Object properties:\n       prop1 (str): Prop1 desc\n       prop2 (int): \n"
        assert PydocHelper.generate_param_doc(param) == expected_doc
    ...
    def test_generate_return_doc_simple(self):
        ...
        assert PydocHelper.generate_return_doc(dict_to_responses(responses)) == expected_doc
