...
from fastapi.openapi.models import APIKeyIn, OAuth2, OAuthFlowAuthorizationCode, OAuthFlows
...
class TestMcpToolsetGetAuthConfig:
    ...
    def test_get_auth_config_returns_none_without_auth_scheme(self):
        ...
        toolset = McpToolset(connection_params=StdioServerParameters(command="echo", args=["test"]))
...
class TestMcpToolsetGetAuthHeaders:
    ...
    def test_get_auth_headers_returns_none_without_exchanged_credential(self, toolset_with_oauth2):
