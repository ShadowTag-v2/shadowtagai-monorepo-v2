...
def mock_rest_api_tool():
    ...
    mock_tool._get_declaration.return_value = FunctionDeclaration(name="test_function", description="Test function description")
...
class TestGoogleApiTool:
    ...
    async def test_run_async(self, mock_rest_api_tool, mock_tool_context):
        ...
        mock_rest_api_tool.run_async.assert_called_once_with(args=args, tool_context=mock_tool_context)
