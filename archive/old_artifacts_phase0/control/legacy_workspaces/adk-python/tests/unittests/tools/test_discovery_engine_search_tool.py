...
class TestDiscoveryEngineSearchTool:
    ...
    def test_init_with_data_store_id(self):
        ...
        assert tool._serving_config == "test_data_store/servingConfigs/default_config"
    ...
    def test_init_with_search_engine_id(self):
        ...
        assert tool._serving_config == "test_search_engine/servingConfigs/default_config"
    ...
    def test_init_with_data_store_specs_without_search_engine_id_raises_error(
        ...
        with pytest.raises(
            ...
            DiscoveryEngineSearchTool(data_store_id="test_data_store", data_store_specs=[{"id": "123"}])
    ...
    def test_discovery_engine_search_api_error(self, mock_search_client):
        ...
        mock_search_client.return_value.search.side_effect = exceptions.GoogleAPICallError("API error")
