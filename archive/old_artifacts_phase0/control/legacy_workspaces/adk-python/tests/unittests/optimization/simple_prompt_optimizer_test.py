...
from google.adk.optimization.simple_prompt_optimizer import SimplePromptOptimizer, SimplePromptOptimizerConfig
...
def mock_llm_class() -> mock.MagicMock:
    ...
    async def mock_generate_content_async(*args, **kwargs):
        yield LlmResponse(content=genai_types.Content(parts=[genai_types.Part(text="IMPROVED PROMPT")]))
...
@mock.patch("google.adk.optimization.simple_prompt_optimizer.LLMRegistry.resolve")
@pytest.mark.asyncio
