...
@pytest.fixture
def callback_context_with_artifact_service(mock_invocation_context, mock_artifact_service):
...
class TestCallbackContextListArtifacts:
    ...
    @pytest.mark.asyncio
    async def test_list_artifacts_returns_artifact_keys(self, callback_context_with_artifact_service, mock_artifact_service):
    ...
    @pytest.mark.asyncio
    async def test_list_artifacts_returns_empty_list(self, callback_context_with_artifact_service, mock_artifact_service):
    ...
    @pytest.mark.asyncio
    async def test_list_artifacts_raises_value_error_when_service_is_none(self, callback_context_without_artifact_service):
    ...
    @pytest.mark.asyncio
    async def test_list_artifacts_passes_through_service_exceptions(self, callback_context_with_artifact_service, mock_artifact_service):
        """Test that list_artifacts passes through exceptions from the artifact service."""
        mock_artifact_service.list_artifact_keys.side_effect = Exception("Service error")
...
class TestCallbackContext:
    ...
    @pytest.mark.asyncio
    async def test_tool_context_inherits_list_artifacts(self, mock_invocation_context, mock_artifact_service):
    ...
    @pytest.mark.asyncio
    async def test_tool_context_list_artifacts_raises_value_error_when_service_is_none(self, mock_invocation_context):
    ...
    def test_tool_context_has_list_artifacts_method(self):
        ...
        assert callable(ToolContext.list_artifacts)
    ...
    def test_callback_context_has_list_artifacts_method(self):
        ...
        assert callable(CallbackContext.list_artifacts)
    ...
    @pytest.mark.asyncio
    async def test_load_credential_returns_none(self, mock_invocation_context, mock_auth_config):
