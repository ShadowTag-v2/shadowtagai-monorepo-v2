...
class TestSessionStateCredentialService:
    ...
    @pytest.mark.asyncio
    async def test_save_credential_with_none_exchanged_credential(self, credential_service, auth_config, callback_context):
    ...
    @pytest.mark.asyncio
    async def test_load_credential_with_empty_credential_key(self, credential_service, auth_config, callback_context):
    ...
    @pytest.mark.asyncio
    async def test_state_persistence_across_operations(self, credential_service, auth_config, callback_context):
        ...
        assert callback_context.state[auth_config.credential_key] == auth_config.exchanged_auth_credential
    ...
    @pytest.mark.asyncio
    async def test_credential_key_uniqueness(self, credential_service, oauth2_auth_scheme, callback_context):
        ...
        assert callback_context.state["unique_key_1"] != callback_context.state["unique_key_2"]
    ...
    @pytest.mark.asyncio
    async def test_direct_state_access(self, credential_service, auth_config, callback_context):
