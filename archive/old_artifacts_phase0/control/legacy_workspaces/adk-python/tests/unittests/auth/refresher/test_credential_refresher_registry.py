...
class TestCredentialRefresherRegistry:
    ...
    def test_register_multiple_refreshers(self):
        ...
        registry.register(AuthCredentialTypes.OPEN_ID_CONNECT, mock_openid_refresher)
        registry.register(AuthCredentialTypes.SERVICE_ACCOUNT, mock_service_account_refresher)

        assert registry._refreshers[AuthCredentialTypes.OAUTH2] == mock_oauth2_refresher
        assert registry._refreshers[AuthCredentialTypes.OPEN_ID_CONNECT] == mock_openid_refresher
        assert registry._refreshers[AuthCredentialTypes.SERVICE_ACCOUNT] == mock_service_account_refresher
    ...
    def test_registry_independence(self):
        ...
        assert registry1.get_refresher(AuthCredentialTypes.OAUTH2) == mock_refresher1
        assert registry2.get_refresher(AuthCredentialTypes.OAUTH2) == mock_refresher2
        assert registry1.get_refresher(AuthCredentialTypes.OAUTH2) != registry2.get_refresher(AuthCredentialTypes.OAUTH2)
