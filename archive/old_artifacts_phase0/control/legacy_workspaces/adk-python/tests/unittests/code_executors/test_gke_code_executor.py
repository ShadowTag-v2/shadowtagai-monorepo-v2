...
def mock_k8s_clients():
    ...
    with patch("google.adk.code_executors.gke_code_executor.client") as mock_client_class:
...
class TestGkeCodeExecutor:
    ...
    def test_execute_code_job_failed(
        ...
        mock_watch.return_value.stream.return_value = [{"object": mock_job}]
        mock_k8s_clients["core_v1"].read_namespaced_pod_log.return_value = "Traceback...\nValueError: failure"
    ...
    def test_execute_code_api_exception(self, mock_k8s_clients, mock_invocation_context):
        """Tests handling of an ApiException from the K8s client."""
        mock_k8s_clients["core_v1"].create_namespaced_config_map.side_effect = ApiException(reason="Test API Error")
        executor = GkeCodeExecutor()
    ...
    def test_execute_code_timeout(
        ...
        mock_k8s_clients["core_v1"].read_namespaced_pod_log.return_value = "Still running..."
