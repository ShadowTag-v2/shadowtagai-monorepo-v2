...
class TestAgentEngineSandboxCodeExecutor:
    ...
    def test_init_with_sandbox_overrides(self):
        ...
        assert executor.sandbox_resource_name == ("projects/123/locations/us-central1/reasoningEngines/456/sandboxEnvironments/789")
    ...
    def test_init_with_agent_engine_overrides_throws_error(self):
        ...
        with pytest.raises(ValueError):
            AgentEngineSandboxCodeExecutor(
                agent_engine_resource_name=("projects/123/locations/us-central1/reason/456"),
            )
    ...
    def test_execute_code_success(
        ...
        mock_json_output.data = json.dumps({"stdout": "hello world", "stderr": ""}).encode("utf-8")
        ...
        mock_api_client.agent_engines.sandboxes.execute_code.return_value = mock_response
