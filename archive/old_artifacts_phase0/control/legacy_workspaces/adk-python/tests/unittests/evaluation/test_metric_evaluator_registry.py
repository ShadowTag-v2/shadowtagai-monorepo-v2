...
class TestMetricEvaluatorRegistry:
    ...
    def test_register_evaluator_updates_existing(self, registry):
        ...
        metric_info = TestMetricEvaluatorRegistry.AnotherDummyEvaluator.get_metric_info()
        registry.register_evaluator(metric_info, TestMetricEvaluatorRegistry.AnotherDummyEvaluator)
        assert registry._registry[_DUMMY_METRIC_NAME] == (
