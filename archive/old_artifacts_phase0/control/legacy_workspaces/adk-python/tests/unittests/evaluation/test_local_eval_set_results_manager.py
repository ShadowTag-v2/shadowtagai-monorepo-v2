...
from google.adk.evaluation.local_eval_set_results_manager import _ADK_EVAL_HISTORY_DIR, _EVAL_SET_RESULT_FILE_EXTENSION, LocalEvalSetResultsManager
...
class TestLocalEvalSetResultsManager:
    ...
    def setup(self):
        ...
        self.eval_set_result_id = self.app_name + "_" + self.eval_set_id + "_" + str(self.timestamp)
        self.eval_set_result_name = _sanitize_eval_set_result_name(self.eval_set_result_id)
    ...
    def test_save_eval_set_result(self, mocker):
        ...
        self.manager.save_eval_set_result(self.app_name, self.eval_set_id, self.eval_case_results)
        eval_history_dir = os.path.join(self.agents_dir, self.app_name, _ADK_EVAL_HISTORY_DIR)
    ...
    def test_get_eval_set_result(self, mocker):
        ...
        mock_time.return_value = self.timestamp
        self.manager.save_eval_set_result(self.app_name, self.eval_set_id, self.eval_case_results)
        retrieved_result = self.manager.get_eval_set_result(self.app_name, self.eval_set_result_name)
    ...
    def test_list_eval_set_results(self, mocker):
        ...
        eval_set_result_id2 = self.app_name + "_" + self.eval_set_id + "_" + str(timestamp2)
        ...
        self.manager.save_eval_set_result(self.app_name, self.eval_set_id, eval_case_results2)
        ...
        self.manager.save_eval_set_result(app_name2, self.eval_set_id, self.eval_case_results)
