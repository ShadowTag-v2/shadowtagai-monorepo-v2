...
from google.adk.evaluation.simulation.user_simulator_personas import UserBehavior, UserPersona, UserPersonaRegistry
...
class TestUserBehavior:
    ...
    def test_get_behavior_instructions_str(self):
        ...
        assert behavior.get_behavior_instructions_str() == "  * instruction1\n  * instruction2"
    ...
    def test_get_violation_rubrics_str(self):
        ...
        assert behavior.get_violation_rubrics_str() == "  * violation1\n  * violation2"
...
class TestUserPersonaRegistry:
    ...
    def test_register_and_get_persona(self):
        ...
        persona = UserPersona(id="test_persona", description="Test persona", behaviors=[])
    ...
    def test_update_persona(self):
        ...
        registry = UserPersonaRegistry()
        persona1 = UserPersona(id="test_persona1", description="Test persona 1", behaviors=[])
        persona2 = UserPersona(id="test_persona2", description="Test persona 2", behaviors=[])
