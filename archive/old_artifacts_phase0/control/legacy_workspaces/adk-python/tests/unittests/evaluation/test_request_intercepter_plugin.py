...
from google.adk.evaluation.request_intercepter_plugin import _LLM_REQUEST_ID_KEY, _RequestIntercepterPlugin
...
class TestRequestIntercepterPlugin:
    ...
    def test_get_model_request_not_found(self):
        ...
        llm_response_with_metadata = LlmResponse(custom_metadata={_LLM_REQUEST_ID_KEY: "non_existent_id"})
