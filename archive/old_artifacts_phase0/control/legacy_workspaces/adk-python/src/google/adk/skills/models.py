...
class Frontmatter(BaseModel):
    ...
    def _validate_name(cls, v: str) -> str:
        ...
        if not _NAME_PATTERN.match(v):
            raise ValueError("name must be lowercase kebab-case (a-z, 0-9, hyphens), with no leading, trailing, or consecutive hyphens")
        return v
...
class Resources(BaseModel):
    ...
    def get_reference(self, reference_id: str) -> str | None:
    ...
    def get_asset(self, asset_id: str) -> str | None:
