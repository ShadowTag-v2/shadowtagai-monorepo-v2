...
class Context(ReadonlyContext):
    ...
    def request_confirmation(
        ...
        *,
        ...
        if not self.function_call_id:
            raise ValueError("request_confirmation requires function_call_id. This method can only be used in a tool context.")
    ...
    async def add_session_to_memory(self) -> None:
        ...
        await self._invocation_context.memory_service.add_session_to_memory(self._invocation_context.session)
