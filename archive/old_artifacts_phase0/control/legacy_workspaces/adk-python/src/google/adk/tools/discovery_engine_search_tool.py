...
class DiscoveryEngineSearchTool(FunctionTool):
    ...
    def __init__(
        ...
        self._serving_config = f"{data_store_id or search_engine_id}/servingConfigs/default_config"
        ...
        self._discovery_engine_client = discoveryengine.SearchServiceClient(credentials=credentials)
