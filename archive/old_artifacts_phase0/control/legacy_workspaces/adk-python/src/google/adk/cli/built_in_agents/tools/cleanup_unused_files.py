...
from ..utils.resolve_root_directory import resolve_file_path, resolve_file_paths
...
async def cleanup_unused_files(
    ...
    try:
        ...
        resolved_used_files = {path.resolve() for path in resolve_file_paths(used_files or [], session_state)}
