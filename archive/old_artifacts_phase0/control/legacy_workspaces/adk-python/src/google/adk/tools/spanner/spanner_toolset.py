...
from google.adk.tools.spanner import metadata_tool, query_tool, search_tool
from typing import override

from ...tools.base_tool import BaseTool
from ...tools.base_toolset import BaseToolset, ToolPredicate
from ...tools.google_tool import GoogleTool
from ...utils.feature_decorator import experimental
from .settings import Capabilities, SpannerToolSettings
...
class SpannerToolset(BaseToolset):
    ...
    def __init__(
        ...
        *,
        ...
        self._tool_settings = spanner_tool_settings if spanner_tool_settings else SpannerToolSettings()
    ...
    async def get_tools(self, readonly_context: ReadonlyContext | None = None) -> list[BaseTool]:
        ...
        # Query tools
        if self._tool_settings and Capabilities.DATA_READ in self._tool_settings.capabilities:
            all_tools.append(
                GoogleTool(
