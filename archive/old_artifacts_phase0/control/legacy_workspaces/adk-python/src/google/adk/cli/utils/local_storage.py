...
from ...sessions.base_session_service import BaseSessionService, GetSessionConfig, ListSessionsResponse
from ...sessions.session import Session
from .dot_adk_folder import DotAdkFolder, dot_adk_folder_for_agent
...
def create_local_artifact_service(*, base_dir: Path | str) -> BaseArtifactService:
    ...
    async def _get_service(self, app_name: str) -> BaseSessionService:
        async with self._service_lock:
            ...
            if service is not None:
                return service
            folder = dot_adk_folder_for_agent(agents_root=self._agents_root, app_name=app_name)
