...
try:
    ...
    from a2a.types import Artifact, Message, Role, TaskArtifactUpdateEvent, TaskState, TaskStatus, TaskStatusUpdateEvent, TextPart
...
from ..converters.event_converter import AdkEventToA2AEventsConverter, convert_event_to_a2a_events
from ..converters.part_converter import (
    A2APartToGenAIPartConverter,
    GenAIPartToA2APartConverter,
    convert_a2a_part_to_genai_part,
    convert_genai_part_to_a2a_part,
)
from ..converters.request_converter import A2ARequestToAgentRunRequestConverter, AgentRunRequest, convert_a2a_request_to_agent_run_request
...
class A2aAgentExecutor(AgentExecutor):
    ...
    async def _resolve_runner(self) -> Runner:
        ...
        raise TypeError(f"Runner must be a Runner instance or a callable that returns a Runner, got {type(self._runner)}")
