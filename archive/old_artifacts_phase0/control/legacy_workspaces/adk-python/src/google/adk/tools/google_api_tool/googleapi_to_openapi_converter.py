...
class GoogleApiToOpenApiConverter:
    ...
    def _convert_servers(self) -> None:
        """Convert server information."""
        base_url = self._google_api_spec.get("rootUrl", "") + self._google_api_spec.get("servicePath", "")
    ...
    def _convert_schemas(self) -> None:
        ...
        for schema_name, schema_def in schemas.items():
            ...
            self._openapi_spec["components"]["schemas"][schema_name] = converted_schema

    def _convert_schema_object(self, schema_def: dict[str, Any]) -> dict[str, Any]:
            ...
            if gtype == "object":
                ...
                if "properties" in schema_def:
                    ...
                    for prop_name, prop_def in schema_def["properties"].items():
                        result["properties"][prop_name] = self._convert_schema_object(prop_def)
    ...
    def _convert_resources(self, resources: dict[str, Any], parent_path: str = "") -> None:
    ...
    def _convert_methods(self, methods: dict[str, Any], resource_path: str) -> None:
        ...
        for method_name, method_data in methods.items():
            ...
            self._openapi_spec["paths"][rest_path][http_method] = self._convert_operation(method_data, path_params)
    ...
    def _convert_operation(self, method_data: dict[str, Any], path_params: list[str]) -> dict[str, Any]:
        ...
        if "response" in method_data:
            ...
            if response_ref:
                ...
                operation["responses"]["200"]["content"] = {"application/json": {"schema": {"$ref": openapi_ref}}}
    ...
    def _convert_parameter_schema(self, param_data: dict[str, Any]) -> dict[str, Any]:
...
def main():
    ...
    parser = argparse.ArgumentParser(description=("Convert Google API Discovery documents to OpenAPI v3 specifications"))
    parser.add_argument("api_name", help="Name of the Google API (e.g., 'calendar')")
