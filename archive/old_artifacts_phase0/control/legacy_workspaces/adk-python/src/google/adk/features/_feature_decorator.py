...
from ._feature_registry import FeatureConfig, FeatureName, FeatureStage, _get_feature_config, _register_feature, is_feature_enabled
    ...
    *,
    ...
    def decorator(obj: T) -> T:
        ...
        if isinstance(obj, type):  # decorating a class
            ...
            raise TypeError("@experimental can only be applied to classes or callable objects")
