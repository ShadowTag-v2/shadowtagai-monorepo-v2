...
ConfigsUnion = Annotated[
    Annotated[LlmAgentConfig, Tag("LlmAgent")] | Annotated[LoopAgentConfig, Tag("LoopAgent")] | Annotated[ParallelAgentConfig, Tag("ParallelAgent")] | Annotated[SequentialAgentConfig, Tag("SequentialAgent")] | Annotated[BaseAgentConfig, Tag("BaseAgent")],
