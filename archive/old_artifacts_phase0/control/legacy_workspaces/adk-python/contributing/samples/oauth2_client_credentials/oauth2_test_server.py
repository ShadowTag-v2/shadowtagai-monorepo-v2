...
async def handle_authorization_code(client_id: str, code: str, redirect_uri: str, scope: str) -> TokenResponse:
...
@app.get("/api/weather")
async def get_weather(request: Request, city: str = "San Francisco", units: str = "metric"):
...
if __name__ == "__main__":
    ...
    print('🔧 Test with: curl -H "Authorization: Bearer TOKEN" "http://localhost:8080/api/weather?city=Tokyo"')
