...
def get_old_open_issue_numbers(owner: str, repo: str, days_old: float | None = None) -> list[int]:
    """
    ...
    logger.info(f"Searching for issues in '{owner}/{repo}' created before {cutoff_str}...")
