...
async def monitor_stock_price(stock_symbol: str) -> AsyncGenerator[str]:
...
async def monitor_video_stream(
    ...
    while True:
        ...
        if last_valid_req is not None:
            ...
            image_part = genai_types.Part.from_bytes(data=last_valid_req.blob.data, mime_type=last_valid_req.blob.mime_type)
