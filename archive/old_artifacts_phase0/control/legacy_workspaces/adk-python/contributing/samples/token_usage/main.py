...
async def main():
    ...
    async def run_prompt(session: Session, new_message: str):
        ...
        async for event in runner.run_async(
            ...
            if event.usage_metadata:
                ...
                total_candidate_tokens += event.usage_metadata.candidates_token_count or 0
        ...
        print(f"Session tokens: {total_tokens} (prompt={total_prompt_tokens}, candidates={total_candidate_tokens})")
    ...
    print(await artifact_service.list_artifact_keys(app_name=app_name, user_id=user_id_1, session_id=session_11.id))
    end_time = time.time()
    print("------------------------------------")
