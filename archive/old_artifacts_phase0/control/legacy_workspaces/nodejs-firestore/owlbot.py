...
from synthtool import _tracked_paths, shell
...
if staging.is_dir():
    try:
        ...
        s.replace("dev/test/gapic_firestore_v1.ts", r"import \* as firestoreModule from '\.\./src';", "import * as firestoreModule from '../src/v1';")
        s.replace("dev/test/gapic_firestore_v1.ts", r"firestoreModule\.v1", "firestoreModule")
        ...
        s.replace("dev/test/gapic_firestore_admin_v1.ts", r"firestoreadminModule\.v1", "firestoreadminModule")
        ...
        s.replace("dev/test/gapic_firestore_v1beta1.ts", r"firestoreModule\.v1beta1", "firestoreModule")
        s.replace("dev/src/v1/firestore_client.ts", r"\.\./\.\./protos/protos.json", "../../protos/v1.json")
        s.replace("dev/src/v1/firestore_admin_client.ts", r"\.\./\.\./protos/protos.json", "../../protos/admin_v1.json")
        s.replace("dev/src/v1beta1/firestore_client.ts", r"\.\./\.\./protos/protos.json", "../../protos/v1beta1.json")
        s.replace("dev/test/gapic_firestore_v1.ts", r"\.\./protos/protos.json", "../protos/v1.json")
        s.replace("dev/test/gapic_firestore_admin_v1.ts", r"\.\./protos/protos.json", "../protos/admin_v1.json")
        s.replace("dev/test/gapic_firestore_v1beta1.ts", r"\.\./protos/protos.json", "../protos/v1beta1.json")
        ...
        s.replace("types/protos/firestore_admin_v1_proto_api.d.ts", r'import Long = require\("long"\);', "")
        s.replace("types/protos/firestore_v1_proto_api.d.ts", r'import Long = require\("long"\);', "")
        s.replace("types/protos/firestore_v1beta1_proto_api.d.ts", r'import Long = require\("long"\);', "")
