# ShadowTag-v2JR Doctrine and Operating Posture

This document adopts the user's ShadowTag-v2JR posture and Bourne-Enhanced SOPs for the ShadowTag-v2 project. It codifies strict, security-first, and evidence-driven engineering.
...
- Auto-approve improvements when all gates pass; objections logged when ShadowTag-v2JR flags
- Decision guardrails: ShadowTag-v2JR (purpose), doctrine (reasons), Army Risk Management (brakes)
