...
export namespace google {
    ...
    namespace admin {
      ...
      namespace v1 {
        ...
        namespace Backup {
          ...
          /** State enum. */
          type State = 'STATE_UNSPECIFIED' | 'CREATING' | 'READY' | 'NOT_AVAILABLE';
        }
        ...
        namespace Database {
          /** DatabaseType enum. */
          type DatabaseType = 'DATABASE_TYPE_UNSPECIFIED' | 'FIRESTORE_NATIVE' | 'DATASTORE_MODE';
          ...
          namespace EncryptionConfig {
            ...
            type IGoogleDefaultEncryptionOptions = {};
          ...
          type DatabaseEdition = 'DATABASE_EDITION_UNSPECIFIED' | 'STANDARD' | 'ENTERPRISE';
        }
        ...
        namespace Field {
          ...
          namespace TtlConfig {
            /** State enum. */
            type State = 'STATE_UNSPECIFIED' | 'CREATING' | 'ACTIVE' | 'NEEDS_REPAIR';
          }
        }
        ...
        namespace Index {
          ...
          /** ApiScope enum. */
          type ApiScope = 'ANY_API' | 'DATASTORE_MODE_API' | 'MONGODB_COMPATIBLE_API';
          ...
          /** State enum. */
          type State = 'STATE_UNSPECIFIED' | 'CREATING' | 'READY' | 'NEEDS_REPAIR';

          /** Density enum. */
          type Density = 'DENSITY_UNSPECIFIED' | 'SPARSE_ALL' | 'SPARSE_ANY' | 'DENSE';
        }
        ...
        type IBulkDeleteDocumentsResponse = {};
  ...
  namespace api {
    ...
    namespace ResourceDescriptor {
      /** History enum. */
      type History = 'HISTORY_UNSPECIFIED' | 'ORIGINALLY_SINGLE_PATTERN' | 'FUTURE_MULTI_PATTERN';
  ...
  namespace protobuf {
    ...
    namespace FieldOptions {
      ...
      type OptionRetention = 'RETENTION_UNKNOWN' | 'RETENTION_RUNTIME' | 'RETENTION_SOURCE';
    ...
    namespace MethodOptions {
      ...
      type IdempotencyLevel = 'IDEMPOTENCY_UNKNOWN' | 'NO_SIDE_EFFECTS' | 'IDEMPOTENT';
    }
    ...
    namespace FeatureSet {
      /** FieldPresence enum. */
      type FieldPresence = 'FIELD_PRESENCE_UNKNOWN' | 'EXPLICIT' | 'IMPLICIT' | 'LEGACY_REQUIRED';

      /** EnumType enum. */
      type EnumType = 'ENUM_TYPE_UNKNOWN' | 'OPEN' | 'CLOSED';

      /** RepeatedFieldEncoding enum. */
      type RepeatedFieldEncoding = 'REPEATED_FIELD_ENCODING_UNKNOWN' | 'PACKED' | 'EXPANDED';

      /** Utf8Validation enum. */
      type Utf8Validation = 'UTF8_VALIDATION_UNKNOWN' | 'VERIFY' | 'NONE';

      /** MessageEncoding enum. */
      type MessageEncoding = 'MESSAGE_ENCODING_UNKNOWN' | 'LENGTH_PREFIXED' | 'DELIMITED';
