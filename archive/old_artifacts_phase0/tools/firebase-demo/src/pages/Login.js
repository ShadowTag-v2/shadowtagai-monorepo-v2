  ...
  return (
    <>
        ...
        <Card style={{ margin: 24 }}>
          <Card.Header>
            ...
            <p style={{ marginTop: 8, fontSize: 12, color: '#A1A1A1' }}>
              If you're an admin of SaltNPepper please login below. If you don't have an account
              please contact your administrator to get a login.
            </p>
          </Card.Header>
          <Card.Body>
      ...
      {user !== null && (
        <div style={{ margin: 24 }}>
          <p>
            You're loggedin successfully. Go to <a href="/dashboard">dashboard</a>
          </p>
          <p>
