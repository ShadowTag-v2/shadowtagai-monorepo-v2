import { BarChart2, Filter, GitBranch, HelpCircle, Keyboard, Search, X, Zap } from 'lucide-react';
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
        ...
        >
          ...
          <p style={{ fontSize: 12, color: '#9ca3af', margin: 0, lineHeight: 1.6 }}>
            · Scroll to zoom <br />· Click and drag to pan <br />· Double-click a node to focus its
            subgraph
          </p>
        </div>
      </div>
