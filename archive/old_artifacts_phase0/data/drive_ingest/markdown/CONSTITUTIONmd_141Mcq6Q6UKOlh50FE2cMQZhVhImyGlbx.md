...
**Mission:** Build and scale an AI-driven B2C SaaS platform (ShadowTag/ShadowTag) under the spirit of the Business Judgment Rule.
...
1.  **Target URI:** The Agent MUST NEVER deviate from `https://github.com/ShadowTag-v2/ShadowTag-v2-fastapi-services.git`.
