///▙▖▙▖▞▞▙▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂
  ...
  ╔══════════════════════════════════════════════════════════════════╗
  ║  n-autoresearch/Kosmos/BioAgentsS CAVALRY SQUADRON                                  ║
  ╠══════════════════════════════════════════════════════════════════╣
  ...
  │    n-autoresearch/Kosmos/BioAgentss→ 650-agent swarm (port 8600)                   │
  ...
  STACK: n-autoresearch/Kosmos/BioAgentss:8600, CodePMCS, JudgeJura, ShadowTag, GPTRAM
...
Finally, note at the beginning of your response, whether you are utilizing "n-autoresearch/Kosmos/BioAgentss" or not.  Must declare as, "Monkey's activated / not activated, standing by."  Monkey's are to always be activated.
