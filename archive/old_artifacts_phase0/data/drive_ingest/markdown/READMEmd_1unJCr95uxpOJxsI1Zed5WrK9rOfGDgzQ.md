# ShadowTag-v2 Platform Test Suite

Comprehensive test suite for the ShadowTag-v2 platform covering unit tests, integration tests, and security tests.
...
pytest --cov=src/ShadowTag-v2 --cov-report=html
