...
| -------------------------------- | --------------------- | ---------------------- |
| `ehanc69/ShadowTag-v2-fastapi-services` | ✅ **Fixed & Merged** | Test the workflow      |
| `ehanc69/mlops`                  | ⚠️ **Needs Fix**      | Apply fix using script |

---

## Part 1: Verify Fix in ShadowTag-v2-fastapi-services
...
1. Go to https://github.com/ehanc69/ShadowTag-v2-fastapi-services/actions
...
```bash
# Navigate to ShadowTag-v2-fastapi-services repository
cd /home/user/ShadowTag-v2-fastapi-services
...
```bash
# Copy from ShadowTag-v2-fastapi-services repository
cp /home/user/ShadowTag-v2-fastapi-services/.github/workflows/ingest.yml \
...
/home/user/ShadowTag-v2-fastapi-services/scripts/verify-workflow.sh .
```
...
- Applied fix from ShadowTag-v2-fastapi-services repository"
```
...
# Test URL manually
curl -fsSL "https://raw.githubusercontent.com/ehanc69/ShadowTag-v2-policy/main/policy/config/strict_policy.yml"
