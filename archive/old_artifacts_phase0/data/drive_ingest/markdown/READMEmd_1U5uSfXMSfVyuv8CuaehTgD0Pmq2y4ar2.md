...
gsutil -m cp -r ./training-data gs://ShadowTag-data/fine-tune-dataset/
```
...
gsutil ls gs://ShadowTag-models/llama-7b-finetuned/

# Download locally if needed
gsutil -m cp -r gs://ShadowTag-models/llama-7b-finetuned/ ./models/
```
