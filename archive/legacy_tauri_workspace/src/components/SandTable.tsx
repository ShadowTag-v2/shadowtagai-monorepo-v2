      ...
      {loading ? (
        ...
        <div className="flex flex-col gap-2">
          {telemetry.map((t, idx) => (
            <div
              key={idx}
              className="flex justify-between items-center text-xs text-red-400 bg-red-950/20 p-2 rounded border border-red-900/50 opacity-90 hover:opacity-100 transition-opacity"
            >
