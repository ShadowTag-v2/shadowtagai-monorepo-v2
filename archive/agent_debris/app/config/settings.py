...
class Settings(BaseSettings):
    ...
    GCP_PROJECT_ID: str = "shadowtag-omega-v4-project"
    GCP_REGION: str = "us-central1"
    GCP_LOCATION: str = "us-central1"
    VERTEX_AI_ENDPOINT: str = "https://us-central1-aiplatform.googleapis.com"

    # Google Cloud Storage
    GCS_BUCKET_NAME: str = "shadowtag-omega-v4-data-bucket"
    GCS_MODEL_BUCKET: str = "shadowtag-omega-v4-models-bucket"
    ...
    # Database
    DATABASE_URL: str = "postgresql+asyncpg://user:password@localhost:5432/shadowtag-omega-v4"
    MONGO_URI: str = "mongodb://localhost:27017/shadowtag-omega-v4"
