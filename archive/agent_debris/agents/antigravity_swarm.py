...
MISSION: Final[str] = "shadowtag-omega-v4JR Enforce Doctrine Optimize for Speed and Quality"
...
def main(cycles: int = 5) -> None:
    ...
    logger.info("///▞ Purpose=shadowtag-omega-v4JR • Reason=Doctrine • Brakes=Judge6")
    ...
    try:
        for i in range(1, cycles + 1):
            ...
            logger.info("  Active: %d | Approved: %d | Blocked: %d | Avg: %.1f%%",
