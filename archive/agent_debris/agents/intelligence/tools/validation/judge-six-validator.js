...
const DEFAULT_GATES = {
  items: {
    minDaily: 500,
    targetDaily: 1000,
    minQuality: 0.60  // Minimum average quality score
  },
  sources: {
    minSources: 5,
    maxSourcePercent: 0.40,  // No single source > 40%
...
export const judgeSixValidatorTool = tool({
  ...
  description: "Validate intelligence ingestion against quality gates (items, sources, costs, scores)",
  parameters: {
    type: "object",
    properties: {
      data: {
