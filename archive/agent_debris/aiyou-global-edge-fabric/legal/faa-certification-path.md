...
shadowtag-omega-v4 systems will target **DAL-C** (Major failure condition):
...
- License their certified platform, integrate shadowtag-omega-v4 algorithms as "data provider"
...
- Allows commercial operators to install shadowtag-omega-v4 units
