...
from kosmos.core.orchestrator import ReActStep, ReActResult
...
class AgentOpsTracker:
    ...
    def end_session(
        ...
        logger.info(f"Ended AgentOps session: {self.current_session.session_id} with result: {result}")
    ...
    def __repr__(self) -> str:
        return f"AgentOpsTracker(enabled={self.enabled}, current_session={self.current_session.session_id if self.current_session else None})"
