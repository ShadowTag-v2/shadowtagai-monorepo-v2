...
""",
    ...
    def generate_hypotheses(
        ...
        Returns:
            ReActResult with generated hypotheses
        """
        task = f"Generate {num_hypotheses} testable hypotheses based on current literature and data."
    ...
    def prioritize_hypotheses(self) -> ReActResult:
        ...
        hypotheses_text = "\n".join([f"{i + 1}. [{h.id}] {h.text} (confidence: {h.confidence})" for i, h in enumerate(untested)])
