...
class TestCreateSession:
  ...
  @pytest.mark.asyncio()
  async def test_creates_session_document(
    self,
  ...
  @pytest.mark.asyncio()
  async def test_trust_level_nonzero_rejected(
  ...
  async def test_overlay_files_written_as_subcollection(
    self,
    store: FirestoreSessionStore,
    reviewing_session: SandboxSession,
    mock_db: MagicMock,
  ) -> None:
  ...
  @pytest.mark.asyncio()
  async def test_session_data_fields(
    self,
    store: FirestoreSessionStore,
    sample_session: SandboxSession,
    mock_db: MagicMock,
...
class TestGetSession:
  ...
  @pytest.mark.asyncio()
  async def test_returns_none_for_missing_doc(
    self, store: FirestoreSessionStore, mock_db: MagicMock
  ) -> None:
...
class TestUpdateState:
  ...
  @pytest.mark.asyncio()
  async def test_updates_state_field(
    self, store: FirestoreSessionStore, mock_db: MagicMock
  ) -> None:
  ...
  @pytest.mark.asyncio()
  async def test_extra_fields_merged(
    self, store: FirestoreSessionStore, mock_db: MagicMock
  ) -> None:
...
class TestUpdateOverlay:
  ...
  @pytest.mark.asyncio()
  async def test_overlay_written_via_batch(
    self, store: FirestoreSessionStore, mock_db: MagicMock
  ) -> None:
...
class TestRecordDecision:
  ...
  @pytest.mark.asyncio()
  async def test_records_accept_decision(
    self, store: FirestoreSessionStore, mock_db: MagicMock
  ) -> None:
  ...
  @pytest.mark.asyncio()
  async def test_records_reject_with_reason(
    self, store: FirestoreSessionStore, mock_db: MagicMock
  ) -> None:
  ...
  @pytest.mark.asyncio()
  async def test_partial_accept_with_selected_files(
    self, store: FirestoreSessionStore, mock_db: MagicMock
  ) -> None:
    await store.record_decision(
      session_id="s-1",
  ...
  @pytest.mark.asyncio()
  async def test_immutable_flag_set(
    self, store: FirestoreSessionStore, mock_db: MagicMock
  ) -> None:
...
class TestGetDecisions:
  ...
  @pytest.mark.asyncio()
  async def test_returns_empty_for_no_decisions(
    self, store: FirestoreSessionStore
  ) -> None:
  ...
  @pytest.mark.asyncio()
  async def test_returns_ordered_decisions(
    self, store: FirestoreSessionStore, mock_db: MagicMock
  ) -> None:
...
class TestExpireSession:
  ...
  @pytest.mark.asyncio()
  async def test_soft_deletes_via_state_update(
    self, store: FirestoreSessionStore, mock_db: MagicMock
  ) -> None:
...
class TestListActiveSessions:
  ...
  @pytest.mark.asyncio()
  async def test_filters_by_attorney_uid(
    self, store: FirestoreSessionStore, mock_db: MagicMock
  ) -> None:
  ...
  @pytest.mark.asyncio()
  async def test_filters_by_matter_id(
    self, store: FirestoreSessionStore, mock_db: MagicMock
  ) -> None:
...
class TestOverlayRoundTrip:
  ...
  @pytest.mark.asyncio()
  async def test_write_uses_batch(
    self, store: FirestoreSessionStore, mock_db: MagicMock
  ) -> None:
  ...
  @pytest.mark.asyncio()
  async def test_read_returns_file_map(
    self, store: FirestoreSessionStore, mock_db: MagicMock
  ) -> None:
    doc1 = MagicMock()
  ...
  @pytest.mark.asyncio()
  async def test_empty_overlay_returns_empty_dict(
    self, store: FirestoreSessionStore
  ) -> None:
