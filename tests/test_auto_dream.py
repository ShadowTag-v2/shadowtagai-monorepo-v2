...
class TestCheckDreamGates:
  ...
  def test_time_gate_blocks_when_recent(
  ...
  def test_session_gate_blocks_with_few_sessions(
    self, memory_dir: str, transcript_dir: str
  ) -> None:
  ...
  def test_force_bypasses_time_and_session_gates(
    self, memory_dir: str, transcript_dir: str
  ) -> None:
    record_consolidation(memory_dir)
    # No sessions at all
  ...
  def test_agent_transcripts_excluded(
    self, memory_dir: str, transcript_dir: str
  ) -> None:
