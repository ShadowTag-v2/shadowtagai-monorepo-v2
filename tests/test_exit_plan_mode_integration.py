...
class TestPlanLifecycleHappyPath:
  ...
  def test_add_steps(self, orch: SpeculativeResearchOrchestrator) -> None:
    ...
    step2 = orch.add_plan_step(
      "s2", "Implement TTL logic", tool_calls=[{"tool": "write_to_file"}]
    )
...
class TestPlanCancellation:
  ...
  def test_cancel_when_idle_is_noop(
    self, orch: SpeculativeResearchOrchestrator
  ) -> None:
    """Cancelling when already IDLE should not raise."""
    orch.cancel_plan()
    assert orch.plan_state == PlanState.IDLE

  def test_cancel_from_abandoned_is_noop(
    self, orch: SpeculativeResearchOrchestrator
  ) -> None:
    orch.enter_plan_mode()
    orch.cancel_plan()
...
class TestRevisionLoop:
  ...
  def test_revision_loop_full_cycle(
    self, orch: SpeculativeResearchOrchestrator
  ) -> None:
...
class TestPhaseTransitionCoordination:
  ...
  def test_terminal_phase_cancels_active_plan(
    self, orch: SpeculativeResearchOrchestrator
  ) -> None:
  ...
  def test_failed_phase_cancels_active_plan(
    self, orch: SpeculativeResearchOrchestrator
  ) -> None:
    orch.enter_plan_mode()
    assert orch.plan_state == PlanState.PLANNING
  ...
  def test_idle_phase_cancels_active_plan(
    self, orch: SpeculativeResearchOrchestrator
  ) -> None:
    orch.enter_plan_mode()
  ...
  def test_research_phase_does_not_cancel_plan(
    self, orch: SpeculativeResearchOrchestrator
  ) -> None:
...
class TestOrchestratorReset:
  ...
  def test_reset_from_idle_is_clean(
    self, orch: SpeculativeResearchOrchestrator
  ) -> None:
    orch.reset()
    assert orch.plan_state == PlanState.IDLE
...
class TestSpeculationEngineCoordination:
  ...
  def test_begin_speculation_starts_engine(
    self, orch: SpeculativeResearchOrchestrator
  ) -> None:
  ...
  def test_begin_speculation_no_steps_raises(
    self, orch: SpeculativeResearchOrchestrator
  ) -> None:
  ...
  def test_engine_and_plan_independent_abort(
    self, orch: SpeculativeResearchOrchestrator
  ) -> None:
...
class TestTransitionGuards:
  ...
  def test_cannot_add_step_when_speculating(
    self, orch: SpeculativeResearchOrchestrator
  ) -> None:
    orch.enter_plan_mode()
    orch.add_plan_step("s1", "Step")
  ...
  def test_cannot_confirm_when_planning(
    self, orch: SpeculativeResearchOrchestrator
  ) -> None:
    orch.enter_plan_mode()
  ...
  def test_direct_planning_to_planning_raises(
    self, orch: SpeculativeResearchOrchestrator
  ) -> None:
...
class TestSessionIdPropagation:
  ...
  def test_fallback_session_id_when_empty(
    self, orch: SpeculativeResearchOrchestrator
  ) -> None:
  ...
  def test_plan_controller_property_access(
    self, orch: SpeculativeResearchOrchestrator
  ) -> None:
...
class TestSpeculationComplete:
  ...
  def test_speculation_complete_transitions_to_confirming(
    self, orch: SpeculativeResearchOrchestrator
  ) -> None:
  ...
  def test_speculation_complete_from_planning_raises(
    self, orch: SpeculativeResearchOrchestrator
  ) -> None:
  ...
  def test_speculation_complete_from_idle_raises(
    self, orch: SpeculativeResearchOrchestrator
  ) -> None:
  ...
  def test_speculation_complete_from_confirming_raises(
    self, orch: SpeculativeResearchOrchestrator
  ) -> None:
...
class TestNeedsRevisionFromSpeculation:
  ...
  def test_needs_revision_returns_to_planning(
    self, orch: SpeculativeResearchOrchestrator
  ) -> None:
  ...
  def test_needs_revision_allows_re_speculation(
    self, orch: SpeculativeResearchOrchestrator
  ) -> None:
  ...
  def test_needs_revision_from_planning_raises(
    self, orch: SpeculativeResearchOrchestrator
  ) -> None:
  ...
  def test_needs_revision_from_idle_raises(
    self, orch: SpeculativeResearchOrchestrator
  ) -> None:
...
class TestConfirmPlanStateGuard:
  ...
  def test_confirm_plan_rejects_planning_state(
    self, orch: SpeculativeResearchOrchestrator
  ) -> None:
  ...
  def test_confirm_plan_rejects_speculating_state(
    self, orch: SpeculativeResearchOrchestrator
  ) -> None:
  ...
  def test_confirm_plan_rejects_executing_state(
    self, orch: SpeculativeResearchOrchestrator
  ) -> None:
  ...
  def test_confirm_plan_rejects_idle_state(
    self, orch: SpeculativeResearchOrchestrator
  ) -> None:
