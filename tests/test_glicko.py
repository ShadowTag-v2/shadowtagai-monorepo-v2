...
import pytest
from pnkln.core.glicko import Glicko2Player, Match, compare_players, DEFAULT_RATING, DEFAULT_RD, DEFAULT_VOLATILITY
...
class TestGlicko2Scenarios:
    ...
    def test_consistency_vs_volatility(self):
        ...
        matches = [Match(opponent_rating=1400, opponent_rd=50, outcome=1.0), Match(opponent_rating=1600, opponent_rd=50, outcome=0.0)]
