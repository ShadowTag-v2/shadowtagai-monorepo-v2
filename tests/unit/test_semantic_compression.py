...
class TestCompressionRatio:
  ...
  def test_compression_target_10_to_1(self):
    ...
    compressed = compress_audit_trail(
      "wire_transfer", original, "BLOCK", "high", True, "CFO"
    )
...
class TestEdgeCases:
  ...
  def test_empty_context(self):
    ...
    trail = compress_audit_trail(
      "unknown_action", {}, "BLOCK", "high", True, "Escalate"
    )
  ...
  def test_very_long_action_name(self):
    ...
    trail = compress_audit_trail(
      "very_long_action_name_that_should_be_abbreviated",
      {"amount_usd": 1000},
      "ALLOW",
      "low",
      False,
