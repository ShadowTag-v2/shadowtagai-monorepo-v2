...
class TestSemanticClassifyProperties:
  ...
  def test_latency_under_100ms_cold(self, query: str) -> None:
    ...
    assert elapsed_ms < 100.0, (
      f"Classification took {elapsed_ms:.2f}ms (limit: 100ms cold)"
    )
  ...
  def test_latency_under_5ms_warmed(self) -> None:
    ...
    for query in queries:
      ...
      assert elapsed_ms < 5.0, (
        f"Warmed classification took {elapsed_ms:.2f}ms (limit: 5ms)"
      )
...
class TestSemanticClassifyEdgeCases:
  ...
  def test_research_keyword_triggers_research(
    self, orchestrator: SpeculativeResearchOrchestrator
  ) -> None:
  ...
  def test_pure_action_stays_pair_programming(
    self, orchestrator: SpeculativeResearchOrchestrator
  ) -> None:
  ...
  def test_comparison_query_routes_to_research(
    self, orchestrator: SpeculativeResearchOrchestrator
  ) -> None:
  ...
  def test_multi_hop_reasoning_query(
    self, orchestrator: SpeculativeResearchOrchestrator
  ) -> None:
...
class TestAutoRouteIntegration:
  ...
  def test_keyword_route_short_query(
    self, keyword_orchestrator: SpeculativeResearchOrchestrator
  ) -> None:
  ...
  def test_keyword_route_research_query(
    self, keyword_orchestrator: SpeculativeResearchOrchestrator
  ) -> None:
