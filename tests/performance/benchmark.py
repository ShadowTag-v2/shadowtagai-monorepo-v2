...
class PerformanceBenchmark:
    ...
    def benchmark_cold_vs_warm_start(self, num_iterations: int = 100):
        ...
        self.results["cold_vs_warm"] = {"cold_mean_ms": cold_mean, "warm_mean_ms": warm_mean, "speedup_factor": speedup}
    ...
    def benchmark_decision_complexity(self):
        ...
        test_cases = [
            ("Simple ALLOW", JudgeType.FIN, {"amount_usd": 1000, "vendor_status": "approved", "purchase_order": "PO-123"}),
            ("Simple BLOCK", JudgeType.FIN, {"amount_usd": 75000, "vendor_status": "new", "purchase_order": None, "destination_country": "Unknown"}),
            (
                "Complex fraud",
                JudgeType.FRAUD,
                {
