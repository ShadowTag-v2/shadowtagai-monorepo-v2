...
import pytest
from pnkln.tools.ethical_crawler import EthicalCrawler, CrawlRequest, RobotsTxtRules
...
class TestEthicalCrawler:
    ...
    async def test_robots_txt_compliance_allowed(self):
        ...
        allowed, reason = self.crawler.check_robots_txt_compliance("https://example.com/public/page")
    ...
    async def test_robots_txt_compliance_disallowed(self):
        ...
        allowed, reason = self.crawler.check_robots_txt_compliance("https://example.com/admin/users")
    ...
    async def test_custom_rate_limit_config(self):
        ...
        self.crawler.configure_rate_limit("custom_source", requests_per_minute=50, requests_per_hour=2000)
