...
_SERVICE_DIR = str(Path(__file__).resolve().parent.parent / "apps" / "aiyou_stack" / "aiyou-fastapi-services")
...
class TestAgentLoop:
    ...
    def test_tool_call_then_final_answer(self):
        ...
        tool_resp = self._mock_gemini_response([_make_fc_part("list_files_tool", {"path": "."})])
    ...
    def test_max_turns_reached(self):
        ...
        loop_resp = self._mock_gemini_response([_make_fc_part("list_files_tool", {"path": "."})])
    ...
    def test_api_error_returns_error_string(self):
        with patch.object(svc, "call_gemini_turn", side_effect=ConnectionError("network down")):
