...
class TestSubcollectionConsistency:
    ...
    EXPECTED_SUBCOLLECTIONS = {"sessions", "transcripts", "matters", "billing_records", "clients"}
...
class TestDeletionRateLimiting:
    ...
    def test_rate_limit_allows_after_window(self):
        ...
        _deletion_rate_limit["firm-expired"] = time.time() - (_DELETION_COOLDOWN_HOURS * 3600) - 1
