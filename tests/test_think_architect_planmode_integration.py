...
class TestEnterPlanMode:
    ...
    @pytest.mark.asyncio
    async def test_idempotent_when_already_in_plan(self, enter_plan_tool, root_context) -> None:
    ...
    @pytest.mark.asyncio
    async def test_permission_denied_for_subagent(self, enter_plan_tool, subagent_context) -> None:
...
class TestExitPlanMode:
    ...
    @pytest.mark.asyncio
    async def test_exit_when_not_in_plan_errors(self, exit_plan_tool, root_context) -> None:
        assert root_context.tool_permission_context.mode == PermissionMode.DEFAULT
        result = await exit_plan_tool.call({}, root_context)
        assert "error" in result.data
...
class TestSubagentIsolation:
    ...
    @pytest.mark.asyncio
    async def test_clone_does_not_inherit_plan_mode(self, enter_plan_tool, root_context) -> None:
