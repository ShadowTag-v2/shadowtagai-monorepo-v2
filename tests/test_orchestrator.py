...
async def test_intent_detection():
    ...
    orchestrator = create_orchestrator(skills_path="pnkln/skills/registry.yaml", agents_path="pnkln/agents/registry.yaml")

    test_cases = [
        {"input": "Research edge AI compute market", "expected_skills": ["research_explorer_v1"], "expected_agent": "pnkln_orchestrator_meta"},
        {"input": "Design a beautiful authentication API", "expected_skills": ["design_critic_v1"], "expected_agent": "ultrathink_designer"},
        {
...
async def test_audit_trail():
    ...
    queries = ["Research quantum computing market", "Design a minimalist dashboard UI", "Monetize my consulting expertise"]
