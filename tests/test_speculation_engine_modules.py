...
class TestAgentMailbox:
    ...
    def test_unanimous_rejection(self) -> None:
        ...
        envelope = mailbox.cast_vote("agent_a", "plan-003", approved=False, reason="security concern")
...
class TestAsyncConsumer:
    ...
    def _make_entry(self, text: str = "test suggestion", fresh: bool = True) -> SuggestionEntry:
