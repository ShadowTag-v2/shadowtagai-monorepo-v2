...
class TestGetContextWindowForModel:
    ...
    def test_unknown_model_returns_default(self):
        ...
        assert get_context_window_for_model("totally-unknown-model-xyz") == MODEL_CONTEXT_WINDOW_DEFAULT
...
class TestApproximateMessageTokens:
    ...
    def test_assistant_message_counted(self):
        ...
        messages = [
            {"type": "user", "message": {"content": "Hello there, I have a question about Python programming"}},
...
class TestAnalyzeContextUsage:
    ...
    def test_analysis_with_messages(self):
        ...
        msgs = [
            ...
            {"type": "assistant", "message": {"content": [{"type": "text", "text": "Quantum computing uses qubits..."}]}},
        ]
