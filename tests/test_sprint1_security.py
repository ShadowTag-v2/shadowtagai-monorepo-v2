...
class TestB20SubcommandCap:
    ...
    def test_b20_description_includes_deny_reason(self, engine: BlockAllowRuleEngine) -> None:
...
class TestContextWindowDecay:
    ...
    def test_plenty_remaining_no_warning(self) -> None:
        ...
        context_warnings = [w for w in result.warnings if w.vector == "context_remaining_low"]
