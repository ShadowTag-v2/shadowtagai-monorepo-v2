...
class TestNormalizeGitRemoteUrl:
  ...
  def test_ssh_no_git_suffix(self):
    assert (
      normalize_git_remote_url("git@github.com:owner/repo") == "github.com/owner/repo"
    )
  ...
  def test_https_no_suffix(self):
    assert (
      normalize_git_remote_url("https://github.com/owner/repo")
      == "github.com/owner/repo"
    )

  def test_ssh_url_format(self):
    assert (
      normalize_git_remote_url("ssh://git@github.com/owner/repo")
      == "github.com/owner/repo"
    )
