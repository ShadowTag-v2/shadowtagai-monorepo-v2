...
class TestCachedSessionStore:
    ...
    @pytest.fixture()
    def cached_store(self, firestore_store: AsyncMock, redis: MockRedis) -> CachedSessionStore:
    ...
    @pytest.mark.asyncio
    async def test_cache_miss_then_hit(self, cached_store: CachedSessionStore, firestore_store: AsyncMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_cache_invalidation_on_state_update(self, cached_store: CachedSessionStore, firestore_store: AsyncMock, redis: MockRedis) -> None:
    ...
    @pytest.mark.asyncio
    async def test_cache_warm_on_create(self, cached_store: CachedSessionStore, redis: MockRedis) -> None:
    ...
    @pytest.mark.asyncio
    async def test_cache_invalidation_on_expire(self, cached_store: CachedSessionStore, redis: MockRedis) -> None:
    ...
    @pytest.mark.asyncio
    async def test_session_exists_cache_acceleration(self, cached_store: CachedSessionStore, redis: MockRedis) -> None:
    ...
    @pytest.mark.asyncio
    async def test_cache_invalidation_on_decision(self, cached_store: CachedSessionStore, redis: MockRedis) -> None:
