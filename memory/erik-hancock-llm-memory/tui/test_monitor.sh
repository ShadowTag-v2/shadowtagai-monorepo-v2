...
REPO_ROOT="/Users/pikeymickey/Documents/Claude Code/Code/Claude Demo/aiyou-fastapi-services/erik-hancock-llm-memory"
cd "$REPO_ROOT"
...
python3 << 'PYEOF'
import sys
sys.path.insert(0, '/Users/pikeymickey/Documents/Claude Code/Code/Claude Demo/aiyou-fastapi-services/erik-hancock-llm-memory')
