...
- root `/Users/pikeymickey/shadowtag-omega-v4-stack/shadowtag-omega-v4/ShadowTagAI-Omega`
...
4. **True naming rationalization**
   The repo still mixes `ShadowTagAI`, `ShadowTagAI-Omega`, `shadowtag-omega-v4`, `UphillSnowball`, `pnkln`, and product/lab/control-plane language in ways that increase ambiguity.
