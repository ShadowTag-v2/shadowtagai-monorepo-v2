...
- A list of 56 (not 57) repos, mostly prefixed with `shadowtag-omega-v4-` plus `pnkln`, `erik-hancock-llm-memory`, and several public demos (e.g. `antigravity-go`, `Cor.Claude_Code_6`).
...
```json
{
  ...
  "settings": {
    ...
    "monorepo_primary_workspace": "shadowtag-omega-v4/Monorepo-Uphillsnowball",
...
4. **Classify and Fold Repos**:
   ...
   - Prioritise `shadowtag-omega-v4-*` repos, `pnkln`, `erik-hancock-llm-memory`, `cosmic-crab-payload`, `Pipeline`, and `nascent-apollo` for early canonicalization.
