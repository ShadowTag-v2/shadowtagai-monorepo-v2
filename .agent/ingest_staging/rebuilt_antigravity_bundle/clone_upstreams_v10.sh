...
clone_or_skip git@github.com:ehanc69/ShadowTag-v2-fastapi-services.git "$ROOT/authority/ShadowTag-v2-fastapi-services"
...
Authority repos:
  ...
  - shadowtag-omega-v4-fastapi-services
  - cosmic-crab-payload
  - Pipeline
  - nascent-apollo
