...
<#
  Bourne/Strict posture • pnkln-stackJR Purpose • Doctrine Reasons • Army RM Brakes
...
Say "Bourne posture engaged: Strict=On, pnkln-stackJR Purpose, Doctrine Reasons, Army RM Brakes" "OK"
