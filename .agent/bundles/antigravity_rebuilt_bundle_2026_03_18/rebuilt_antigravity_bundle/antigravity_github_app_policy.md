...
- `apps/pnkln_stack/pnkln-fastapi-services`
- `apps/pnkln_stack/cosmic-crab-payload`
- `apps/pnkln_stack/Pipeline`
- `apps/pnkln_stack/nascent-apollo`
...
- `shadowtag-omega-v4/Monorepo-Uphillsnowball` is the future sole workspace
