...
- do not leave `gemini-2.5-*`, `gemini-3.1-flash-lite-preview-*`, or `gemini-3-pro-interactions-exp` in live code/docs unless explicitly archived or intentionally experimental
...
This file also points to the older `ShadowTagAI-Omega` root and older repo identity.
