...
- Coordinate with `tdd-workflow` skill for red-green-refactor cycle
...
**Python projects:**
- Check for pytest (`pytest.ini`, `conftest.py`, `pyproject.toml [tool.pytest]`)
...
**Verification is mandatory** — no test suite is "done" without actually running it (Rule 01).
