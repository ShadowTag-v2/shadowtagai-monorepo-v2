...
Use ``build_engine()`` from ``judge6_factory`` rather than instantiating
this class directly.
"""
...
from .judge6_core import EnforcementLevel, GovernanceDecision
from .rkill import RkillConfig, RkillProtocol

logger = logging.getLogger("judge6_rkill_bridge")
...
class RkillNotifier:
    ...
    def __call__(self, decision: GovernanceDecision) -> None:
        ...
        triggered_by = f"judge6-auto:{decision.event.violation_type.value}"
