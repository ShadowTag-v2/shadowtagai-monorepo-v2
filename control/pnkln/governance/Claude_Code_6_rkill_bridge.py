...
"""RKILL ↔ Claude_Code_6Engine bridge.
...
Use ``build_engine()`` from ``Claude_Code_6_factory`` rather than instantiating
this class directly.
"""
...
from .Claude_Code_6_core import EnforcementLevel, GovernanceDecision
from .rkill import RkillConfig, RkillProtocol

logger = logging.getLogger("Claude_Code_6_rkill_bridge")
...
class RkillNotifier:
    ...
    def __call__(self, decision: GovernanceDecision) -> None:
        ...
        triggered_by = f"Claude_Code_6-auto:{decision.event.violation_type.value}"
