...
"""Claude_Code_6Engine factory — wires RKILL notifier from environment.
...
Usage::
    ...
    from control.pnkln.governance.Claude_Code_6_factory import build_engine
    ...
    app.state.Claude_Code_6 = build_engine()
"""
...
from .Claude_Code_6_core import GovernanceDecision, Claude_Code_6Engine
from .Claude_Code_6_rkill_bridge import RkillNotifier
from .rkill import RkillConfig

logger = logging.getLogger("Claude_Code_6_factory")
...
def build_engine(
    ...
    """Build a Claude_Code_6Engine with RKILL auto-lockout wired to ceo_notifier.
    ...
    Returns:
        Configured Claude_Code_6Engine ready for production use.
    """
    ...
    cfg = RkillConfig(
        ...
        trigger_reason="Claude_Code_6 L5_LOCKOUT auto-triggered",
    ...
    logger.info(
        "[Claude_Code_6_factory] engine built: rkill_dry_run=%s project=%s armor_policy=%s",
        effective_dry_run,
        project or "(unset)",
        armor_policy or "(unset)",
    )

    return Claude_Code_6Engine(
