...
Claude_Code_6Engine.evaluate() and returned as GovernanceDecision objects.
"""
...
from .Claude_Code_6_core import GovernanceDecision, Claude_Code_6Engine, RiskEvent, ViolationType
...
class SilentDetector:
    ...
    def __init__(self, engine: Claude_Code_6Engine, agent_id: str = "silent-detector") -> None:
        self.engine = engine
