"""Judge6Engine factory — wires RKILL notifier from environment.
...
Usage::
    ...
    from control.pnkln.governance.judge6_factory import build_engine
...
from .judge6_core import GovernanceDecision, Judge6Engine
from .judge6_rkill_bridge import RkillNotifier
from .rkill import RkillConfig

logger = logging.getLogger("judge6_factory")
