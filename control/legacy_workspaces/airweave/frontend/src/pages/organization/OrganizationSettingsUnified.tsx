    ...
    return (
      <div className="max-w-2xl mx-auto pt-16">
        <div className="text-center">
          ...
          <Button onClick={() => navigate("/onboarding")} size="sm" className="h-8 px-3 text-sm">
      ...
      <TooltipProvider delayDuration={200}>
        <div className="max-w-4xl mx-auto py-8">
          ...
          <div>
            ...
            {/* Members Tab */}
            {activeTab === "members" && (
              <MembersSettings currentOrganization={currentOrganization} />
            )}
            ...
            {/* Billing Tab */}
            {activeTab === "billing" && <BillingSettings organizationId={currentOrganization.id} />}
