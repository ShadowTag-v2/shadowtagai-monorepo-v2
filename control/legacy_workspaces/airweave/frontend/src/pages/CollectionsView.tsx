...
const CollectionsView = () => {
  ...
  const { totalCount, fetchCollectionsPaginated, fetchCollectionsCount } = useCollectionsStore();
    ...
    <div className="mx-auto w-full max-w-[1800px] px-6 py-6 pb-8">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">View and manage all your collections</p>
        </div>
