        ...
        <AlertDialogHeader className="space-y-4">
          ...
          <AlertDialogDescription className="space-y-4">
            <div className="bg-destructive/5 border border-destructive/20 rounded-lg p-4">
              <p className="font-medium text-foreground mb-3">This will permanently delete:</p>
                ...
                <div className="flex items-center gap-2 text-sm">
                  {isConfirmValid ? (
                    ...
                    <>
                      ...
                      <span className="text-destructive">Confirmation does not match</span>
                    </>
                  )}
                </div>
              )}
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (detailedConnections.length > 0) {
          ...
          const newConnection = newSourceId
            ? detailedConnections.find((c) => c.id === newSourceId)
            : null;
          if (newConnection) {
  ...
  if (error) {
    return (
      <div className="container mx-auto py-6">
        ...
        <div className="mt-4">
          <Button onClick={() => navigate(protectedPaths.dashboard)}>Return to Dashboard</Button>
        </div>
      </div>
    );
  }
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col justify-center">
                {isEditingName ? (
                  ...
                  <div className="flex items-center gap-2">
                    <h1 className="text-2xl font-bold tracking-tight text-foreground py-1 pl-0">
                      {collection?.name}
                    </h1>
                    <Button
                      variant="ghost"
                      ...
                      <TooltipContent className="max-w-xs">
                        <p className={DESIGN_SYSTEM.typography.sizes.body}>
                          ...
                          {entitiesAllowed &&
                            ...
                            sourceConnectionCheckDetails?.reason === "usage_limit_exceeded" && (
                              <>
                          ...
                          {entitiesAllowed &&
                            !sourceConnectionsAllowed &&
                            sourceConnectionCheckDetails?.reason === "payment_required" && (
                              <>
                                Billing issue detected.{" "}
                                <a
                                  href="/organization/settings?tab=billing"
            ...
            {sourceConnections.length === 0 && (
              <div
                className={cn(
                  ...
                  isDark ? "border-gray-700 bg-gray-900/30" : "border-gray-200 bg-gray-50/50",
                )}
              >
                <div
                  className={cn(
                ...
                >
                  <Plug
                    className={cn("h-6 w-6", isDark ? "text-gray-400" : "text-gray-500")}
                    strokeWidth={1.5}
                  />
                </div>
