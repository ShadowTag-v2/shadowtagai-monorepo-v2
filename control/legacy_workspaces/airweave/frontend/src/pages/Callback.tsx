...
const Callback = () => {
  const { isLoading: auth0Loading, isAuthenticated, error, user, logout } = useAuth0();
        ...
        <div className="max-w-md w-full mx-4 p-6 bg-card border border-border rounded-lg shadow-lg">
          ...
          <div className="space-y-4">
            <p className="text-muted-foreground">
              This email is already associated with a different Auth0 account. Please try a
              different sign-in method or contact support.
            </p>
            ...
            <div className="bg-muted p-4 rounded-md">
              ...
              <p className="text-sm text-muted-foreground">
                You previously signed up using a different authentication method (Google, GitHub, or
                email/password).
              </p>
            </div>
            ...
            <div className="flex space-x-3">
              ...
              <button
                onClick={() =>
                  window.open("mailto:support@airweave.ai?subject=Auth0 Account Conflict", "_blank")
                }
