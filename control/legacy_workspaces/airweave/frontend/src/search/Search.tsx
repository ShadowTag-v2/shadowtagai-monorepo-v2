...
export const Search = ({ collectionReadableId }: SearchProps) => {
  ...
  const handleSearchResult = useCallback(
    (response: any, responseType: "raw" | "completion", responseTimeMs: number) => {
      ...
      <div>
        <SearchBox
          ...
          onStreamUpdate={(partial: any) => {
            if (partial && Object.hasOwn(partial, "requestId")) {
        ...
        <div>
          <SearchResponse
            searchResponse={(() => {
              ...
              const response = isSearching ? { results: liveResults } : searchResponse;
              return response;
            })()}
