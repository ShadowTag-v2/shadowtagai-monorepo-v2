...
import type { PartialStreamUpdate, SearchEvent, StreamPhase } from "@/search/types";
...
export const SearchBox: React.FC<SearchBoxProps> = ({
  ...
  const [queriesCheckDetails, setQueriesCheckDetails] = useState<SingleActionCheckResponse | null>(
    null,
  );
                      ...
                      <textarea
                        ...
                        onKeyDown={(e) => {
                          if (e.key === "Enter" && !e.shiftKey) {
                            if (!hasQuery || isSearching || !queriesAllowed || isCheckingUsage)
                              return;
                            e.preventDefault();
                            handleSendQuery();
                          }
                ...
                <Tooltip open={openTooltip === "queryExpansion"}>
                  ...
                  >
                    <div className="space-y-2">
                      ...
                      <p className={DESIGN_SYSTEM.tooltip.description}>
                        Generates similar versions of your query to improve recall.
                      </p>
                      <div className={DESIGN_SYSTEM.tooltip.divider}>
                        <a
                  ...
                  >
                    <div className="space-y-3">
                      <div>
                        ...
                        <p className={cn(DESIGN_SYSTEM.tooltip.description, "mt-1")}>
                ...
                <Tooltip open={openTooltip === "queryInterpretation"}>
                  ...
                  >
                    <div className="space-y-2">
                      ...
                      <p className={DESIGN_SYSTEM.tooltip.description}>
                        Auto-extracts filters from natural language. May be over‑restrictive.
                      </p>
                      <div className={DESIGN_SYSTEM.tooltip.divider}>
                        <a
                ...
                <Tooltip open={openTooltip === "recencyBias"}>
                  ...
                  >
                    <div className="space-y-2">
                      ...
                      <p className={DESIGN_SYSTEM.tooltip.description}>
                        Prioritize recent documents. Higher values give more weight to newer
                        content.
                      </p>
                ...
                <Tooltip open={openTooltip === "answer"}>
                  ...
                  >
                    <div className="space-y-2">
                      ...
                      <p className={DESIGN_SYSTEM.tooltip.description}>
                        Returns an AI-written answer instead of raw results when enabled.
                      </p>
                      <div className={DESIGN_SYSTEM.tooltip.divider}>
                        <a
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <button
                      ...
                      disabled={
                        isSearching ? false : !hasQuery || !queriesAllowed || isCheckingUsage
                      }
                      className={cn(
                    ...
                    >
                      {isSearching ? (
                        ...
                        <RefreshCw
                          className={cn(DESIGN_SYSTEM.icons.button, "text-muted-foreground")}
                        />
                      ) : (
