...
`
    ...
    const pythonSnippet = `${pythonInterpretNote}from airweave import AirweaveSDK
...
${pythonParams.join(",\n")}
    ...
    const nodeExpansionStrategy =
      searchConfig?.expansion_strategy === "no_expansion"
        ? "noExpansion"
              ...
              <Button
                ...
                className={cn(
                  ...
                  isDark
                    ? "text-gray-200 hover:bg-gray-800/80"
                    : "text-gray-700 hover:bg-gray-200/80",
                  apiTab === "mcp" ? (isDark ? "bg-gray-800" : "bg-gray-200") : "",
                )}
              >
