  ...
  return (
    <div className={cn("space-y-1.5", className)}>
      <div className="flex items-center justify-between">
        ...
        <div className="text-xs font-semibold text-white">{localValue.toFixed(1)}</div>
      ...
      >
        ...
        <div
          className={cn(
            ...
            localValue > 0 ? "bg-primary" : isDark ? "bg-gray-600" : "bg-gray-400",
          )}
          style={{
            width: `${position}%`,
        ...
        <div
          ...
          className={cn(
            ...
            localValue > 0 ? "bg-primary border border-white" : "bg-white border border-gray-400",
          )}
          style={{
            left: `${position}%`,
