  ...
  const fetchEntityDefinitions = async () => {
    ...
    try {
      const response = await apiClient.get(
        `/entities/definitions/by-source/?source_short_name=${encodeURIComponent(shortName)}`,
      );
              ...
              <DialogHeader className="px-6 py-4 border-b border-border/70">
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <DialogDescription>
                      {selectedTab === "information" &&
                        "Overview and details about this data source"}
                      {selectedTab === "connections" &&
                        "Configure and manage connections to this source"}
                        ...
                        <div className="flex flex-col items-center justify-center py-12 text-center border border-dashed rounded-lg bg-muted/20">
                          ...
                          <p className="text-sm text-muted-foreground max-w-md">
                            {search
                              ...
                              : "You haven't created any connections to this source yet."}
                          </p>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="space-y-6">
                      ...
                      {isLoadingEntities ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-12 text-center border border-dashed rounded-lg bg-muted/20">
                          ...
                          <p className="text-sm text-muted-foreground max-w-md">{entitiesError}</p>
                          <Button
                            variant="outline"
                            size="sm"
                            className="mt-4"
                        ...
                        <div className="rounded-lg border border-border/70 overflow-hidden">
                          ...
                          <div className="divide-y divide-border/70">
                            {entities.map((entity) => (
                              <div
                                key={entity.id}
                                className="p-3 grid grid-cols-4 gap-4 text-sm items-center"
                              >
                                <div
                        ...
                        <div className="flex flex-col items-center justify-center py-12 text-center border border-dashed rounded-lg bg-muted/20">
                          ...
                          <p className="text-sm text-muted-foreground max-w-md">
                            Connect to this source and run a sync to view entities extracted from
                            this data source.
                          </p>
                        </div>
                      )}
          ...
          <Dialog open={!!selectedSchema} onOpenChange={(open) => !open && setSelectedSchema(null)}>
            <DialogContent className="sm:max-w-[800px] max-h-[90vh]">
              <DialogHeader>
                ...
                <DialogDescription>Entity schema definition and structure</DialogDescription>
              </DialogHeader>
              ...
              <div className="flex justify-end mt-4">
                <Button variant="outline" onClick={() => setSelectedSchema(null)}>
                  Close
                </Button>
              </div>
            </DialogContent>
            ...
            <DialogContent className="sm:max-w-[425px]">
              <DialogHeader>
                ...
                <DialogDescription className="pt-2">
                  ...
                  <span className="font-medium">{connectionToDisconnect?.name}</span>? This will
                  stop syncing data from this connection.
                </DialogDescription>
              </DialogHeader>
