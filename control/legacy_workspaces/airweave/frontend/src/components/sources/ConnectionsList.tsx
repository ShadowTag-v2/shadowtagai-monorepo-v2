import { AlertCircle, Ban, CheckCircle2, Database, Plus, Search, Unplug } from "lucide-react";
            ...
            >
              <div className="flex items-start justify-between mb-3">
                <div className="space-y-1">
                  ...
                  <code className="text-xs px-2 py-0.5 rounded-md bg-muted">{connection.id}</code>
                </div>
                <Button
                  variant="ghost"
                  size="icon"
              ...
              <div className="flex items-center gap-2 mt-3 pt-3 border-t">
                <Badge
                  variant={
                    connection.status.toUpperCase() === "ACTIVE"
                      ? "default"
                      : connection.status.toUpperCase() === "ERROR"
                        ? "destructive"
                        : "secondary"
                  }
                >
        ...
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription className="pt-2">
              ...
              <span className="font-medium">{connectionToDelete?.name}</span>?
            </DialogDescription>
          </DialogHeader>
