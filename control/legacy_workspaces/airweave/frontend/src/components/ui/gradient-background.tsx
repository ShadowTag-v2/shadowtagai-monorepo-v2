...
export function GradientBackground({
  ...
  return (
    <div className={cn(gradientClass, className)} style={noiseStyle} {...props}>
...
export function GradientCard({
  ...
  const bgClass = resolvedTheme === "dark" ? "bg-background-alpha-40" : "white";

  return (
    <div className={cn(`${bgClass} backdrop-blur-md`, className)} {...props}>
      {children}
    </div>
  );
}
