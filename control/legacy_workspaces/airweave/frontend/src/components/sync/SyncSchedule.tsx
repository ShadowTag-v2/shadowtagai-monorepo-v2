      ...
      <CardContent className="pt-6 space-y-6">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          >
            ...
            <p className="text-center text-sm text-muted-foreground">Automatic recurring sync</p>
          </div>

          {/* New "Instant Update" card that's disabled */}
          <div className="group relative rounded-lg border p-5 bg-muted/10 border-dashed">
            {/* PRO badge */}
                ...
                <div className="space-y-4 pb-2">
                  ...
                  {value.frequency === "weekly" && (
                    <div className="flex items-center gap-2 justify-center mt-3">
                      <Label htmlFor="dayOfWeek" className="min-w-24 text-right">
                        Day of week:
                      </Label>
                      <Select
                  ...
                  {value.frequency === "monthly" && (
                    <div className="flex items-center gap-2 justify-center mt-3">
                      <Label htmlFor="dayOfMonth" className="min-w-24 text-right">
                        Day of month:
                      </Label>
                      <Select
                  ...
                  {value.frequency !== "custom" && (
                    <div className="rounded-md bg-muted p-3 max-w-md mx-auto mt-6 text-center">
                      <p className="text-xs text-muted-foreground">
                        Cron expression:{" "}
                        <code className="font-mono">{buildCronExpression(value)}</code>
                      </p>
                    </div>
                  )}
                </div>
