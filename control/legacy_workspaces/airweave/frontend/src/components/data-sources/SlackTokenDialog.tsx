...
export function SlackTokenDialog({ open, onOpenChange, onSuccess }: SlackTokenDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            For local development, enter your Slack API token directly. You can generate a token
            from the{" "}
            <a
