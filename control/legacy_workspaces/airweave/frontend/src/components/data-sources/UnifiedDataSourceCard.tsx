import { Box, Check, ChevronsUpDown, Info, Plug } from "lucide-react";
        ...
        <CardFooter className="p-4 pt-2 flex flex-col gap-3 mt-auto h-[110px]">
          <div className="flex w-full justify-between items-center">
            ...
            <div className="flex flex-wrap gap-x-4 gap-y-2 text-sm text-muted-foreground pb-2">
              <div className="flex items-center gap-1.5">
                ...
                <span>
                  {entityCount === 0 ? "Entities calculated at sync" : `${entityCount} entities`}
                </span>
              </div>
          ...
          <div className="flex justify-center w-full">
            {mode === "manage" ? (
              ...
              >
                <span className="text-sm truncate max-w-[240px]">Manage Source</span>
              </Button>
            ) : status === "connected" ? (
              <div className="flex w-full justify-center">
                ...
                <DropdownMenu open={open} onOpenChange={setOpen}>
                  ...
                  >
                    <DropdownMenuItem className="cursor-pointer" onClick={handleAddNewConnection}>
