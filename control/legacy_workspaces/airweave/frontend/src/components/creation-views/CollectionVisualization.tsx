  ...
  const getSourceIcon = () => {
    if (!selectedSource) {
      ...
      return (
        ...
        >
          <Plus className={cn("w-8 h-8", isDark ? "text-gray-600" : "text-gray-400")} />
        </div>
      );
    }
    ...
    return (
      <img src={iconUrl} alt={sourceName || selectedSource} className="w-20 h-20 opacity-90" />
    );
  };
      ...
      <div className="flex-1 flex flex-col justify-center">
        <div className="w-full max-w-lg mx-auto">
          ...
          <div className="relative">
            ...
            <div
              className={cn(
                ...
                isDark ? "bg-gray-900/35 border-gray-700" : "bg-gray-50 border-gray-300",
              )}
            >
              ...
              <div className="flex gap-4">
                ...
                <div
                  className={cn(
                    ...
                    isDark ? "text-gray-400 border-gray-600" : "text-gray-500 border-gray-400",
                  )}
                >
                  Source Connections
                </div>
            ...
            >
              ...
              >
                ...
                <div className={cn("aspect-square p-4", isDark ? "bg-gray-900/50" : "bg-white/70")}>
          ...
          <div className="text-center mt-8">
            ...
            <p
              className={cn("text-xs opacity-55 mt-1", isDark ? "text-gray-600" : "text-gray-400")}
            >
