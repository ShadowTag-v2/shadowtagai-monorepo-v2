              ...
              <div className="relative">
                ...
                >
                  <div className="space-y-3">
                    <p
                      className={cn("text-sm font-medium", isDark ? "text-white" : "text-gray-900")}
                    >
                    ...
                    >
                      A collection is like a folder that groups related data sources. It can include
                      multiple sources from a user, organization, or project. When your agent
                      searches, it queries all sources in the collection at once.
                    </p>
                    <div
                      className={cn(
                    ...
                    >
                      <p className={cn(isDark ? "text-gray-500" : "text-gray-500")}>
                        <span className="font-medium">Example:</span> Group all HR tools (Jira,
                        Notion, Google Drive) at Acme Corp into one searchable collection
                      </p>
                    </div>
                  </div>
                </div>
