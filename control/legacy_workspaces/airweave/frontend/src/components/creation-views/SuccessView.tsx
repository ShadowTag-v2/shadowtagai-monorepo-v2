...
export const SuccessView: React.FC<SuccessViewProps> = ({
  ...
  const { collectionId, collectionName, sourceName } = useCollectionCreationStore();
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="text-center space-y-6 max-w-sm">
          ...
          <div>
            ...
            <p className="mt-2 text-gray-600 dark:text-gray-400">Your data is now syncing</p>
          </div>
            ...
            <div className="space-y-2 text-left">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="flex items-center gap-1.5">
                  ...
                  <span className="font-medium text-green-600 dark:text-green-400">Syncing</span>
                </span>
              </div>
            </div>
          </div>
