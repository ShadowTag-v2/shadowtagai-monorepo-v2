    ...
    <div className="space-y-8">
      ...
      <div className="space-y-6 max-w-lg">
        <div>
          ...
          />
          {!canEdit && (
            <p className="text-xs text-muted-foreground mt-1">Only owners and admins can edit</p>
          )}
        </div>
          ...
          <Tooltip>
            ...
            {currentOrganization.is_primary && (
              <TooltipContent side="left" className="max-w-xs">
                <p className="text-xs">
                  Cannot unset primary organization directly. Set another organization as primary to
                  change this.
                </p>
              </TooltipContent>
            )}
