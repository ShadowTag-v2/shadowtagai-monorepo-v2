import { AlertCircle, CheckCircle2, CloudUpload, Loader2, Trash2 } from "lucide-react";
          ...
          {!status?.configured ? (
            <>
              <Alert>
                ...
                <AlertDescription>
                  S3 destination is not configured. Set up your S3 bucket to enable event streaming
                  for all collections.
                </AlertDescription>
              </Alert>
