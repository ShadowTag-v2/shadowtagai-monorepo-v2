...
export const AuthProviderDetailView: React.FC<AuthProviderDetailViewProps> = ({
  ...
  useEffect(() => {
    ...
    const fetchConnectionDetails = async () => {
      console.log(
        "📡 [AuthProviderDetailView] Fetching connection details for:",
        authProviderConnectionId,
      );
      setLoading(true);
      try {
        const response = await apiClient.get(
          `/auth-providers/connections/${authProviderConnectionId}`,
        );
                  ...
                  <div className="relative w-full h-0.5 overflow-hidden">
                    ...
                    <div
                      className={cn(
                        ...
                        "opacity-0",
                        isDark ? "bg-green-300/30" : "bg-green-400/30",
                      )}
                      style={{
                        left: "20%",
                    ...
                    <div className="absolute -bottom-1 -right-1">
                      <div className="relative">
                        ...
                        <div
                          ...
                          style={{
                            animation:
                              "unlockGlow 2s ease-in-out infinite, iconPing 3s ease-in-out infinite",
                          }}
                        >
                          <Link
                            className={cn(
