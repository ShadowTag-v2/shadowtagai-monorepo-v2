...
export const QueryToolAndLiveDoc = ({ collectionReadableId }: QueryToolAndLiveDocProps) => {
  ...
  const [apiTab, setApiTab] = useState<
    "rest" | "python" | "node" | "claude" | "cursor" | "windsurf" | "server"
  >("rest");
  ...
  -H 'Content-Type: application/json'`;
    ...
    const pythonSnippet = `from airweave import AirweaveSDK
...
client.collections.search_collection(
    ...
    const nodeSnippet = `import { AirweaveSDKClient } from "@airweave/sdk";
...
await client.collections.searchCollection("${collectionReadableId}", {
  ...
  "mcpServers": {
    ...
    const installSnippet = `# Install the MCP server globally
npm install -g airweave-mcp-search@1.0.7

# Or run directly with npx
npx airweave-mcp-search`;

    const cliSnippet = `# Set environment variables
  ...
  return (
    <div className="w-full mb-6">
          ...
          <div className="flex h-8 items-stretch rounded-md border overflow-hidden shadow-xs">
            ...
            <div
              className={cn(
                ...
                isDark ? "bg-gray-900 text-gray-300" : "bg-gray-50/80 text-gray-700",
              )}
            >
                ...
                <form onSubmit={handleSubmit} className="flex items-stretch">
                  ...
                  >
                    ...
                    <input
                      type="text"
                      placeholder={
                        queriesAllowed ? "Ask a question about your data" : "Query limit reached"
                      }
                      value={query}
                      ...
                      className={cn(
                        ...
                        isDark ? "bg-gray-900 text-gray-200" : "bg-white/90",
                  ...
                  >
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="raw" className="text-xs font-mono">
                          raw
                        </SelectItem>
                        <SelectItem value="completion" className="text-xs font-mono">
                          completion
                        </SelectItem>
                      </SelectContent>
                    </Select>
            ...
            <div className="flex items-center gap-3">
              ...
              {searchStatus && (
                <div className="flex items-center">
                  ...
                  ></div>
                  <span className="text-xs opacity-80">{searchStatus.replace(/_/g, " ")}</span>
                </div>
              )}
            </div>
                  ...
                  {isLoading ? (
                    ...
                    <ReactMarkdown
                      ...
                      components={{
                        ...
                        h3: ({ node, ...props }) => (
                          <h3
                            style={{ fontSize: "1.17em", fontWeight: "bold", margin: "1em 0" }}
                            {...props}
                          />
                        ),
                        ul: ({ node, ...props }) => (
                          <ul
                            style={{ listStyle: "disc", paddingLeft: "2em", margin: "1em 0" }}
                            {...props}
                          />
                        ),
                        li: ({ node, ...props }) => (
                          <li style={{ display: "list-item", margin: "0.5em 0" }} {...props} />
                        ),
                        code(props) {
                          ...
                          return match ? (
                            ...
                            <code
                              ...
                              className={cn(
                                className,
                                "bg-opacity-75 px-1.5 py-0.5 rounded text-sm",
                              )}
                            >
                              {children}
                            </code>
      ...
      <div className="mb-8 mt-12">
        ...
        <div className="flex justify-between items-center mb-4">
          <div className="flex items-center gap-3">
            <h2 className="text-xl font-medium text-foreground opacity-90">
          ...
          <div className="w-full md:w-1/4 flex flex-row md:flex-col gap-3">
            <Button
              ...
              className={cn(
                ...
                viewMode === "restapi" &&
                  "border-primary bg-primary/5 dark:bg-primary/10 text-primary dark:text-primary-foreground font-medium",
              )}
            >
              <Code
                className={cn(
                  ...
                  <>
                    <Button
                      ...
                      className={cn(
                        ...
                        apiTab === "rest" ? (isDark ? "bg-gray-800" : "bg-gray-200") : "",
                      )}
                    >
                    ...
                    <Button
                      ...
                      className={cn(
                        ...
                        isDark
                          ? "text-gray-200 hover:bg-gray-800/80"
                          : "text-gray-700 hover:bg-gray-200/80",
                        apiTab === "python" ? (isDark ? "bg-gray-800" : "bg-gray-200") : "",
                      )}
                    >
                    ...
                    <Button
                      ...
                      className={cn(
                        ...
                        isDark
                          ? "text-gray-200 hover:bg-gray-800/80"
                          : "text-gray-700 hover:bg-gray-200/80",
                        apiTab === "node" ? (isDark ? "bg-gray-800" : "bg-gray-200") : "",
                      )}
                    >
                    ...
                    <Button
                      ...
                      className={cn(
                        ...
                        isDark
                          ? "text-gray-200 hover:bg-gray-800/80"
                          : "text-gray-700 hover:bg-gray-200/80",
                        apiTab === "claude" ? (isDark ? "bg-gray-800" : "bg-gray-200") : "",
                      )}
                    >
                    ...
                    <Button
                      ...
                      className={cn(
                        ...
                        isDark
                          ? "text-gray-200 hover:bg-gray-800/80"
                          : "text-gray-700 hover:bg-gray-200/80",
                        apiTab === "cursor" ? (isDark ? "bg-gray-800" : "bg-gray-200") : "",
                      )}
                    >
                    ...
                    <Button
                      ...
                      className={cn(
                        ...
                        isDark
                          ? "text-gray-200 hover:bg-gray-800/80"
                          : "text-gray-700 hover:bg-gray-200/80",
                        apiTab === "windsurf" ? (isDark ? "bg-gray-800" : "bg-gray-200") : "",
                      )}
                    >
                    ...
                    <Button
                      ...
                      className={cn(
                        ...
                        isDark
                          ? "text-gray-200 hover:bg-gray-800/80"
                          : "text-gray-700 hover:bg-gray-200/80",
                        apiTab === "server" ? (isDark ? "bg-gray-800" : "bg-gray-200") : "",
                      )}
                    >
