  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        <AlertCircle
          className={cn("h-5 w-5 mt-0.5 flex-shrink-0", isDark ? "text-red-400" : "text-red-600")}
        />

        <div className="flex-1 space-y-2">
          <div className="flex items-center justify-between">
            <h4 className={cn("font-medium", isDark ? "text-red-300" : "text-red-900")}>
          ...
          <p className={cn("text-sm", isDark ? "text-red-200/80" : "text-red-800")}>{error}</p>
