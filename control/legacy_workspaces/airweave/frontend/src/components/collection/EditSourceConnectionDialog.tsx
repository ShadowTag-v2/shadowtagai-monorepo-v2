  ...
  useEffect(() => {
    if (open && sourceDetails && sourceConnection) {
      console.log("📋 Source Details for Edit Dialog:", {
        ...
        showAuthFields,
        hasOAuthTokens: sourceDetails.auth_fields?.fields?.some((field: any) =>
                    ...
                    <div className="bg-muted/20 rounded-lg p-3 space-y-2 text-xs">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="truncate max-w-[200px]">
                          {sourceConnection.created_by_email}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">Modified by:</span>
                        <span className="truncate max-w-[200px]">
                          {sourceConnection.modified_by_email}
                        </span>
                      </div>
                    </div>
                  </div>
                        ...
                        {showAuthFields ? (
                            ...
                            {sourceDetails.auth_fields.fields.map((field: any) => (
                              <div key={field.name} className="space-y-1">
                                ...
                                <div className="relative">
                                  <Input
                                    type={
                                      field.secret && !showPasswordFields[field.name]
                                        ? "password"
                                        : "text"
                                    }
                                    className={cn(
                                  ...
                                  {field.secret && (
                                    <button
                                      ...
                                      onClick={() =>
                                        setShowPasswordFields((prev: any) => ({
                                          ...prev,
                          ...
                          <Alert className="mt-2 text-xs">
                            ...
                            <AlertDescription className="text-xs">
                              This source uses OAuth authentication. Authentication tokens cannot be
                              edited directly.
                            </AlertDescription>
                          </Alert>
                        )}
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-1">
                        ...
                        <Input
                          ...
                          placeholder={
                            sourceConnection.auth_provider || "Enter auth provider connection ID"
                          }
                        />
                      </div>
                      ...
                      {authProviderDetails?.config_fields?.fields &&
                        authProviderDetails.config_fields.fields.length > 0 && (
                          <>
