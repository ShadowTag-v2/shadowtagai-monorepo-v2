declare module "stream" {
  ...
  class ReadableStreamInner extends EventEmitter implements QuickJS.ReadableStream {
    /**
  ...
  class WritableStreamInner extends EventEmitter implements QuickJS.WritableStream {
    /**
     ...
     */
    write(
      chunk: string | Buffer | QuickJS.ArrayBufferView | ArrayBuffer | SharedArrayBuffer,
  ...
  class DefaultDuplexStream extends DefaultReadableStream implements DefaultWritableStream {
    /**
     * The `writable.write()` method writes some data to the stream, and calls the
     * supplied `callback` once the data has been fully handled. If an error
     * occurs, the `callback` will be called with the error as its
