declare module "child_process" {
  ...
  import { DefaultReadableStream as Readable, DefaultWritableStream as Writable } from "stream";
  ...
  class ChildProcess extends EventEmitter {
    ...
    emit(event: "close", code: number | null, signal: QuickJS.Signals | null): boolean;
    emit(event: "error", err: Error): boolean;
    emit(event: "exit", code: number | null, signal: QuickJS.Signals | null): boolean;
