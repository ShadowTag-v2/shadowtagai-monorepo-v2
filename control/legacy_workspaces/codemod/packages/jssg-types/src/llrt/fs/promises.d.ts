...
declare module "fs/promises" {
  ...
  export type FileSystemFlags = "a" | "ax" | "a+" | "r" | "r+" | "w" | "wx" | "w+" | "wx+";
   ...
   */
  function open(path: PathLike, flags?: FileSystemFlags, mode?: Mode): Promise<FileHandle>;
   ...
   */
  function mkdir(path: PathLike, options?: MakeDirectoryOptions): Promise<string>;
  ...
  function writeFile(
    file: PathLike,
    data: string | Buffer | QuickJS.ArrayBufferView | ArrayBuffer | SharedArrayBuffer,
    options?:
      | {
          mode?: Mode | undefined;
        }
