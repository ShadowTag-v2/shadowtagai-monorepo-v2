...
!((e, t) => {
    ...
    #t(e, t, n) {
      switch (t) {
        ...
        case "del":
          return function (n) {
            return n.type && n.type === t
              ? e(this.parser.parseInline(n.tokens))
              : e.apply(this, arguments);
          };
        case "escape":
        case "codespan":
        ...
        case "link":
          return function (n) {
            return n.type && n.type === t
              ? e(n.href, n.title, this.parser.parseInline(n.tokens))
              : e.apply(this, arguments);
          };
        case "image":
          return function (n) {
  ...
  (ae.options = ae.setOptions =
    (e) => (oe.setOptions(e), (ae.defaults = oe.defaults), n(ae.defaults), ae)),
    (ae.getDefaults = t),
    (ae.defaults = e.defaults),
    (ae.use = (...e) => (oe.use(...e), (ae.defaults = oe.defaults), n(ae.defaults), ae)),
    (ae.walkTokens = (e, t) => oe.walkTokens(e, t)),
