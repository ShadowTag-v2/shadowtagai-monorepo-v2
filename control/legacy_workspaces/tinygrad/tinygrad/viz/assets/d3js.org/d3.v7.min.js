...
!((t, n) => {
  ...
  function r(t) {
    ...
    return (
      ...
      {
        left: u,
        center: (t, n, e = 0, r = t.length) => {
          const i = u(t, n, e, r - 1);
          return i > e && a(t[i - 1], n) > -a(t[i], n) ? i - 1 : i;
        },
        right: (t, n, e = 0, i = t.length) => {
          if (e < i) {
            if (0 !== r(n, n)) return i;
            do {
              const r = (e + i) >>> 1;
  ...
  function Pt(t, n) {
    ...
    function h(h) {
      ...
      (x = x.merge(
        ...
        w.attr("opacity", 1).attr("transform", (t) => l(b(t) + c)),
        A.attr(s + "2", f * o),
        S.attr(s, f * g).text(p),
        m
          .filter(Ct)
  ...
  function It(t) {
    ...
    return (
      ...
      Object.hasOwn(Ut, n) ? { space: Ut[n], local: t } : t
    );
  }
  function Ot(t) {
    return function () {
  ...
  pe(ye, ze, {
    ...
    pe(
      ...
      ge(ye, {
        brighter(t) {
          return (
            (t = null == t ? _e : _e ** t), new qe(this.r * t, this.g * t, this.b * t, this.opacity)
          );
        },
        darker(t) {
          return (
            (t = null == t ? ve : ve ** t), new qe(this.r * t, this.g * t, this.b * t, this.opacity)
          );
        },
        rgb() {
          return this;
    ...
    pe(
      ...
      ge(ye, {
        brighter(t) {
          return (t = null == t ? _e : _e ** t), new Xe(this.h, this.s, this.l * t, this.opacity);
        },
        darker(t) {
          return (t = null == t ? ve : ve ** t), new Xe(this.h, this.s, this.l * t, this.opacity);
        },
        rgb() {
  ...
  pe(
    ...
    ge(ye, {
      brighter(t) {
        return (t = null == t ? _e : _e ** t), new Ar(this.h, this.s, this.l * t, this.opacity);
      },
      darker(t) {
        return (t = null == t ? ve : ve ** t), new Ar(this.h, this.s, this.l * t, this.opacity);
      },
      rgb() {
  ...
  function Br(t, n) {
    var e = new Date();
    return (t = +t), (n = +n), (r) => (e.setTime(t * (1 - r) + n * r), e);
  }
  function Yr(t, n) {
  ...
  function Vr(t, n) {
    return (t = +t), (n = +n), (e) => Math.round(t * (1 - e) + n * e);
  }
  var Wr,
    Zr = 180 / Math.PI,
  ...
  var ri = (function t(n, e, r) {
    function i(t, i) {
      var o,
        ...
        g = d * d + p * p;
      if (g < 1e-12)
        (a = Math.log(h / f) / n), (o = (t) => [u + t * d, c + t * p, f * Math.exp(n * t * a)]);
      else {
        var y = Math.sqrt(g),
        ...
        (a = (m - b) / n),
          (o = (t) => {
            var r = t * a,
              ...
              o =
                (f / (e * y)) *
                (i * ((t) => ((t = Math.exp(2 * t)) - 1) / (t + 1))(n * r + b) -
                  ((t) => ((t = Math.exp(t)) - 1 / t) / 2)(b));
  ...
  function ii(t) {
    return (n, e) => {
      ...
      return (t) => ((n.h = r(t)), (n.s = i(t)), (n.l = o(t)), (n.opacity = a(t)), n + "");
    };
  }
  var oi = ii(Pr),
    ai = ii($r);
  function ui(t) {
    return (n, e) => {
      var r = t((n = dr(n)).h, (e = dr(e)).h),
        ...
        o = $r(n.l, e.l),
        a = $r(n.opacity, e.opacity);
      return (t) => ((n.h = r(t)), (n.c = i(t)), (n.l = o(t)), (n.opacity = a(t)), n + "");
    };
  }
  var ci = ui(Pr),
    fi = ui($r);
  function si(t) {
    return (function n(e) {
      function r(n, r) {
        ...
        return (t) => ((n.h = i(t)), (n.s = o(t)), (n.l = a(t ** e)), (n.opacity = u(t)), n + "");
      }
  ...
  function So(t) {
    return 1.0009775171065494 * (2 ** (-10 * t) - 0.0009765625);
  }
  function Eo(t) {
  ...
  var Oo = 1.70158,
    ...
    Ho = (function t(n, e) {
      ...
      return (i.amplitude = (n) => t(n, e * jo)), (i.period = (e) => t(n, e)), i;
    })(1, 0.3),
    Xo = (function t(n, e) {
      var r = Math.asin(1 / (n = Math.max(1, n))) * (e /= jo);
      function i(t) {
  ...
  function wa(t) {
    ...
    function c(n) {
      ...
      var r = n.selectAll(".handle").data(t.handles, (t) => t.type);
      r.exit().remove(),
        r
          .enter()
          .append("rect")
          .attr("class", (t) => "handle handle--" + t.type)
          .attr("cursor", (t) => ha[t.type]),
        n
          .each(f)
          .attr("fill", "none")
          .attr("pointer-events", "all")
      ...
      n
        ? (t
          ...
          t
            ...
            .style("display", null)
            .attr("x", (t) =>
              "e" === t.type[t.type.length - 1] ? n[1][0] - u / 2 : n[0][0] - u / 2,
            )
            .attr("y", (t) => ("s" === t.type[0] ? n[1][1] - u / 2 : n[0][1] - u / 2))
            .attr("width", (t) => ("n" === t.type || "s" === t.type ? n[1][0] - n[0][0] + u : u))
            .attr("height", (t) => ("e" === t.type || "w" === t.type ? n[1][1] - n[0][1] + u : u)))
        : t
    ...
    function h(e) {
      ...
      function O(t) {
        ...
        R.attr("pointer-events", "all"),
          ...
          M.selection && (A = M.selection),
          ((t) => t[0][0] === t[1][0] || t[0][1] === t[1][1])(A) &&
            ((M.selection = null), f.call(_)),
          D.end(t, m.name);
      }
    }
    function d(t) {
      ...
      (c.move = (n, e, r) => {
        n.tween
          ...
          : n.each(function () {
              var i = arguments,
                o = this.__brush,
                a = t.input("function" == typeof e ? e.apply(this, i) : e, o.extent),
                u = s(this, i).beforestart();
              Gi(this),
      ...
      (a.sortChords = function (t) {
        return arguments.length
          ? (null == t
              ...
              : (((n = t),
                (o = (t, e) =>
                  n(t.source.value + t.target.value, e.source.value + e.target.value)))._ = t),
            a)
          : o && o._;
        var n;
      }),
  ...
  function nu(t, n, e) {
    var r, i, o, a;
    return (
      ((t, n, e) => (n[0] - t[0]) * (e[1] - t[1]) == (e[0] - t[0]) * (n[1] - t[1]))(t, n, e) &&
      ((i = t[(r = +(t[0] === n[0]))]),
      (o = e[r]),
      (a = n[r]),
      (i <= o && o <= a) || (a <= o && o <= i))
  ...
  function Wu(t) {
    return new Function(
      "d",
      "return {" + t.map((t, n) => JSON.stringify(t) + ": d[" + n + '] || ""').join(",") + "}",
    );
  }
  function Zu(t) {
  ...
  function Ju(t) {
    ...
    function i(n, e) {
      return n.map((n) => e.map((t) => a(n[t])).join(t));
    }
    function o(n) {
    ...
    return {
      ...
      parseRows: r,
      format: (n, e) => (null == e && (e = Zu(n)), [e.map(a).join(t)].concat(i(n, e)).join("\n")),
      formatBody: (t, n) => (null == n && (n = Zu(t)), i(t, n).join("\n")),
      formatRows: (t) => t.map(o).join("\n"),
      formatRow: o,
      formatValue: a,
    };
  }
  ...
  function qf() {}
  function Uf(t, n) {
    t && Object.hasOwn(Of, t.type) && Of[t.type](t, n);
  }
  var If = {
      Feature: (t, n) => {
        Uf(t.geometry, n);
  ...
  function Lf(t, n) {
    t && Object.hasOwn(If, t.type) ? If[t.type](t, n) : Uf(t, n);
  }
  var jf,
    Hf,
    Xf,
  ...
  function ol(t, n) {
    ...
    return (
      t.invert && n.invert && (e.invert = (e, r) => (e = n.invert(e, r)) && t.invert(e[0], e[1])), e
    );
  }
  function al(t, n) {
  ...
  function cl(t) {
    return (n, e) => (xf((n += t)) > gf && (n -= Math.round(n / _f) * _f), [n, e]);
  }
  function fl(t) {
    var n = cl(t);
  ...
  function ll(t) {
    ...
    return (
      ...
      (n.invert = (n) => (((n = t.invert(n[0] * mf, n[1] * mf))[0] *= bf), (n[1] *= bf), n)),
      n
    );
  }
  ...
  function Ll(t, n) {
    return !(!t || !Object.hasOwn(Yl, t.type)) && Yl[t.type](t, n);
  }
  function jl(t, n) {
    return 0 === Ol(t, n);
  }
  ...
  function Kl() {
    ...
    return (
      (v.lines = () => _().map((t) => ({ type: "LineString", coordinates: t }))),
      (v.outline = () => ({
        type: "Polygon",
  ...
  function gd(t, n, e, r, i, o) {
    if (!o)
      return ((t, n, e, r, i) => {
        ...
        return (o.invert = (o, a) => [((o - n) / t) * r, ((e - a) / t) * i]), o;
      })(t, n, e, r, i);
    var a = Tf(o),
      u = Cf(o),
      c = a * t,
    ...
    return (p.invert = (t, n) => [r * (s * t - l * n + h), i * (d - l * t - s * n)]), p;
  }
  function yd(t) {
    return vd(() => t)();
  }
  function vd(t) {
    ...
    return (
      ...
      (E.fitExtent = (t, n) => ud(E, t, n)),
      (E.fitSize = (t, n) => cd(E, t, n)),
      (E.fitWidth = (t, n) => fd(E, t, n)),
      (E.fitHeight = (t, n) => sd(E, t, n)),
      function () {
  ...
  function bd(t, n) {
    ...
    if (xf(r) < df)
      return ((t) => {
        ...
        return (e.invert = (t, e) => [t / n, Rf(e * n)]), e;
      })(t);
    var i = 1 + e * (2 * r - e),
      o = zf(i) / r;
    function a(t, n) {
  ...
  var Td = wd((t) => zf(2 / (1 + t)));
  Td.invert = Md((t) => 2 * Rf(t / 2));
  var Ad = wd((t) => (t = Df(t)) && t / Cf(t));
  function Sd(t, n) {
  ...
  (Ad.invert = Md((t) => t)), (Sd.invert = (t, n) => [t, 2 * wf(Sf(n)) - yf]), (Cd.invert = Cd);
  var zd = 1.340264,
    $d = -0.081106,
    Dd = 893e-6,
    Rd = 0.003796,
  ...
  (qd.invert = (t, n) => {
    ...
    (Od.invert = Md(Rf)),
    (Bd.invert = Md((t) => 2 * wf(t))),
    (Yd.invert = (t, n) => [-n, 2 * wf(Sf(t)) - yf]),
  ...
  function hp(t) {
    switch (t.length) {
      case 1:
        return ((t) => ({ x: t.x, y: t.y, r: t.r }))(t[0]);
      case 2:
        return dp(t[0], t[1]);
      case 3:
  ...
  function bp(t, n) {
    if (!(o = (t = ((t) => ("object" == typeof t && "length" in t ? t : Array.from(t)))(t)).length))
      return 0;
  ...
  var Gp = Math.random,
    ...
    rg = (function t(n) {
      function e(t) {
        ...
        return 0 === t
          ...
          : 1 === t
            ? () => 1
            : ((t = Math.log1p(-t)), () => 1 + Math.floor(Math.log1p(-n()) / t));
      }
      return (e.source = t), e;
    })(Gp),
    ig = (function t(n) {
    ...
    ug = (function t(n) {
      function e(t, e, r) {
        var i;
        return (
          0 == (t = +t) ? (i = (t) => -Math.log(t)) : ((t = 1 / t), (i = (n) => n ** t)),
          (e = null == e ? 0 : +e),
          (r = null == r ? 1 : +r),
          () => e + r * i(-Math.log1p(-n()))
        );
    ...
    cg = (function t(n) {
      function e(t, e) {
        return (
          (t = null == t ? 0 : +t), (e = null == e ? 1 : +e), () => t + e * Math.tan(Math.PI * n())
        );
      }
      return (e.source = t), e;
    })(Gp),
  ...
  function yg() {
    ...
    return (
      ...
      (e.rangeRound = (t) => (([o, a] = t), (o = +o), (a = +a), (u = !0), l())),
      (e.bandwidth = () => n),
      (e.step = () => t),
      (e.round = function (t) {
      ...
      (e.copy = () => yg(r(), [o, a]).round(u).paddingInner(c).paddingOuter(f).align(s)),
  ...
  function wg(t, n, e) {
    var r = t[0],
      ...
      a = n[1];
    return (
      i < r ? ((r = xg(i, r)), (o = e(a, o))) : ((r = xg(r, i)), (o = e(o, a))), (t) => o(r(t))
    );
  }
  function Mg(t, n, e) {
  ...
  function Ag() {
    ...
    function s() {
      ...
      return (
        f !== mg &&
          (f = ((t, n) => {
            var e;
            return t > n && ((e = t), (t = n), (n = e)), (e) => Math.max(t, Math.min(n, e));
          })(a[0], a[t - 1])),
        (r = t > 2 ? Mg : wg),
        (i = o = null),
        l
    ...
    return (
      (l.invert = (e) => f(n((o || (o = r(u, a.map(t), Yr)))(e)))),
      (l.domain = function (t) {
      ...
      (l.rangeRound = (t) => ((u = Array.from(t)), (c = Vr), s())),
      (l.clamp = function (t) {
  ...
  function Fg(n) {
    ...
    function u() {
      return (
        ...
        (o = ((t) => (10 === t ? Dg : t === Math.E ? Math.exp : (n) => t ** n))(a)),
  ...
  function jg() {
    var t = Lg(Ag());
    return (t.copy = () => Tg(t, jg()).exponent(t.exponent())), hg.apply(t, arguments), t;
  }
  function Hg(t) {
  ...
  var $_ = Date.prototype.toISOString ? (t) => t.toISOString() : t.utcFormat(z_),
    D_ = $_;
  ...
  function I_(t, n, e, r, i, o, a, u, c, f) {
    ...
    return (
      ...
      (s.copy = () => Tg(s, I_(t, n, e, r, i, o, a, u, c, f))),
      s
    );
  }
  function O_() {
    ...
    return (
      ...
      (i) => ((r = i), (t = i(o)), (n = i(a)), (e = t === n ? 0 : 1 / (n - t)), f)
    );
  }
  function B_(t, n) {
    return n
  ...
  function Y_() {
    var t = Lg(O_());
    return (t.copy = () => B_(t, Y_()).exponent(t.exponent())), dg.apply(t, arguments);
  }
  function L_() {
    var t,
      n,
  ...
  function j_() {
    var t = Lg(L_());
    return (t.copy = () => B_(t, j_()).exponent(t.exponent())), dg.apply(t, arguments);
  }
  function H_(t) {
  ...
  function Km() {
    ...
    return (
      ...
      (t.outerRadius = t.y1),
      delete t.y1,
      (t.lineStartAngle = () => Wm(e())),
      delete t.lineX0,
      (t.lineEndAngle = () => Wm(r())),
      delete t.lineX1,
      (t.lineInnerRadius = () => Wm(i())),
      delete t.lineY0,
      (t.lineOuterRadius = () => Wm(o())),
      delete t.lineY1,
      (t.curve = function (t) {
        return arguments.length ? n(Vm(t)) : n()._curve;
      }),
  ...
  Wx.prototype = {
    ...
    point: function (t, n) {
      if (((t = +t), (n = +n), this._point)) {
        var e = this._x2 - t,
          r = this._y2 - n;
        this._l23_a = Math.sqrt((this._l23_2a = (e * e + r * r) ** this._alpha));
      }
      switch (this._point) {
        case 0:
          (this._point = 1), this._line ? this._context.lineTo(t, n) : this._context.moveTo(t, n);
  ...
  (Tw.prototype = ww.prototype),
                ...
                if (
                  ...
                  var B = z - F[0],
                    ...
                    H =
                      1 /
                      wm(
                        ((t) => (t > 1 ? 0 : t < -1 ? Am : Math.acos(t)))(
                          (B * L + Y * j) / (Mm(B * B + Y * Y) * Mm(L * L + j * j)),
                        ) / 2,
                      ),
    ...
    (t.axisBottom = (t) => Pt(Mt, t)),
    (t.axisLeft = (t) => Pt(Tt, t)),
    (t.axisRight = (t) => Pt(wt, t)),
    (t.axisTop = (t) => Pt(xt, t)),
    (t.bin = Q),
    (t.bisect = s),
    (t.bisectCenter = f),
    ...
    (t.brushX = () => wa(fa)),
    (t.brushY = () => wa(sa)),
    (t.buffer = (t, n) => fetch(t, n).then(_c)),
    (t.chord = () => za(!1, !1)),
    (t.chordDirected = () => za(!0, !1)),
    (t.chordTranspose = () => za(!1, !0)),
    (t.cluster = () => {
      var t = Ld,
        n = 1,
        e = 1,
      ...
      function i(i) {
        ...
        i.eachAfter((n) => {
          var e = n.children;
          e
            ? ((n.x = ((t) => t.reduce(jd, 0) / t.length)(e)),
              (n.y = ((t) => 1 + t.reduce(Hd, 0))(e)))
    ...
    (t.contours = iu),
    (t.count = v),
    (t.create = (t) => Zn(Yt(t).call(document.documentElement))),
    (t.creator = Yt),
    (t.cross = (...t) => {
      const n =
    ...
    (t.curveBasis = (t) => new Fx(t)),
    (t.curveBasisClosed = (t) => new qx(t)),
    (t.curveBasisOpen = (t) => new Ux(t)),
    (t.curveBumpX = nx),
    (t.curveBumpY = ex),
    (t.curveBundle = Ox),
    (t.curveCardinal = Lx),
    ...
    (t.curveLinear = Im),
    (t.curveLinearClosed = (t) => new nw(t)),
    (t.curveMonotoneX = (t) => new aw(t)),
    (t.curveMonotoneY = (t) => new uw(t)),
    (t.curveNatural = (t) => new fw(t)),
    (t.curveStep = (t) => new lw(t, 0.5)),
    (t.curveStepAfter = (t) => new lw(t, 1)),
    (t.curveStepBefore = (t) => new lw(t, 0)),
    (t.descending = e),
    (t.deviation = w),
    (t.difference = (t, ...n) => {
      t = new InternSet(t);
    ...
    (t.dsv = function (t, n, e, r) {
      ...
      var i = Ju(t);
      return mc(n, e).then((t) => i.parse(t, r));
    }),
    (t.dsvFormat = Ju),
    (t.easeBack = Lo),
    (t.easeBackIn = Bo),
    ...
    (t.easeBackOut = Yo),
    (t.easeBounce = Io),
    (t.easeBounceIn = (t) => 1 - Io(1 - t)),
    (t.easeBounceInOut = (t) => ((t *= 2) <= 1 ? 1 - Io(1 - t) : Io(t - 1) + 1) / 2),
    (t.easeBounceOut = Io),
    (t.easeCircle = No),
    ...
    (t.easeElasticOut = Xo),
    (t.easeExp = Eo),
    (t.easeExpIn = (t) => So(1 - +t)),
    (t.easeExpInOut = Eo),
    (t.easeExpOut = (t) => 1 - So(t)),
    (t.easeLinear = (t) => +t),
    (t.easePoly = wo),
    (t.easePolyIn = mo),
    (t.easePolyInOut = wo),
    ...
    (t.easeSin = Ao),
    (t.easeSinIn = (t) => (1 == +t ? 1 : 1 - Math.cos(t * To))),
    (t.easeSinInOut = Ao),
    (t.easeSinOut = (t) => Math.sin(t * To)),
    (t.every = (t, n) => {
    ...
    (t.flatGroup = (t, ...n) => z(P(t, ...n), n)),
    (t.flatRollup = (t, n, ...e) => z(D(t, n, ...e), e)),
    (t.forceCenter = (t, n) => {
      var e,
        r = 1;
      function i() {
    ...
    (t.forceLink = (t) => {
      var n,
        ...
        a,
        u = Bc,
        c = (t) => 1 / Math.min(i[t.source.index], i[t.target.index]),
        f = qc(30),
        s = 1;
      function l(r) {
    ...
    (t.geoAlbersUsa = () => {
      ...
      return (
        ...
        (s.fitExtent = (t, n) => ud(s, t, n)),
        (s.fitSize = (t, n) => cd(s, t, n)),
        (s.fitWidth = (t, n) => fd(s, t, n)),
        (s.fitHeight = (t, n) => sd(s, t, n)),
        s.scale(1070)
      );
    }),
    (t.geoArea = (t) => ((us = new T()), Lf(t, cs), 2 * us)),
    (t.geoAzimuthalEqualArea = () => yd(Td).scale(124.75).clipAngle(179.999)),
    (t.geoAzimuthalEqualAreaRaw = Td),
    (t.geoAzimuthalEquidistant = () => yd(Ad).scale(79.4188).clipAngle(179.999)),
    ...
    (t.geoClipExtent = () => {
      var t,
        ...
        a = 500;
      return (e = {
        stream: (e) => (t && n === e ? t : (t = zl(r, i, o, a)((n = e)))),
        extent: function (u) {
          return arguments.length
    ...
    (t.geoConicConformal = () => _d(kd).scale(109.5).parallels([30, 30])),
    (t.geoConicConformalRaw = kd),
    (t.geoConicEqualArea = md),
    (t.geoConicEqualAreaRaw = bd),
    (t.geoConicEquidistant = () => _d(Pd).scale(131.154).center([0, 13.9389])),
    (t.geoConicEquidistantRaw = Pd),
    (t.geoContains = (t, n) => (t && Object.hasOwn(Bl, t.type) ? Bl[t.type] : Ll)(t, n)),
    (t.geoDistance = Ol),
    (t.geoEqualEarth = () => yd(qd).scale(177.158)),
    (t.geoEqualEarthRaw = qd),
    (t.geoEquirectangular = () => yd(Cd).scale(152.63)),
    (t.geoEquirectangularRaw = Cd),
    (t.geoGnomonic = () => yd(Ud).scale(144.049).clipAngle(60)),
    (t.geoGnomonicRaw = Ud),
    (t.geoGraticule = Kl),
    (t.geoGraticule10 = () => Kl()()),
    (t.geoIdentity = () => {
      ...
      return (
        ...
        (b.fitExtent = (t, n) => ud(b, t, n)),
        (b.fitSize = (t, n) => cd(b, t, n)),
        (b.fitWidth = (t, n) => fd(b, t, n)),
        (b.fitHeight = (t, n) => sd(b, t, n)),
        b
      );
    }),
    ...
    (t.geoLength = ql),
    (t.geoMercator = () => Ed(Sd).scale(961 / _f)),
    (t.geoMercatorRaw = Sd),
    (t.geoNaturalEarth1 = () => yd(Id).scale(175.295)),
    ...
    (t.geoPath = (t, n) => {
      ...
      return (
        (a.area = (t) => (Lf(t, e(sh)), sh.result())),
        (a.measure = (t) => (Lf(t, e(Kh)), Kh.result())),
        (a.bounds = (t) => (Lf(t, e(mh)), mh.result())),
        (a.centroid = (t) => (Lf(t, e(Oh)), Oh.result())),
    ...
    (t.geoRotation = ll),
    (t.geoStereographic = () => yd(Bd).scale(250).clipAngle(142)),
    (t.geoStereographicRaw = Bd),
    (t.geoStream = Lf),
    (t.geoTransform = (t) => ({ stream: id(t) })),
    ...
    (t.gray = (t, n) => new ur(t, 0, 0, null == n ? 1 : n)),
    (t.greatest = ot),
    (t.greatestIndex = (t, e = n) => {
    ...
    (t.index = (t, ...n) => F(t, k, R, n)),
    (t.indexes = (t, ...n) => F(t, Array.from, R, n)),
    (t.interpolate = Gr),
    (t.interpolateArray = (t, n) => (Ir(n) ? Ur : Or)(t, n)),
    ...
    (t.interpolateLab = (t, n) => {
      ...
      return (n) => ((t.l = e(n)), (t.a = r(n)), (t.b = i(n)), (t.opacity = o(n)), t + "");
    }),
    ...
    (t.lineRadial = Zm),
    (t.link = ax),
    (t.linkHorizontal = () => ax(nx)),
    (t.linkRadial = () => {
      const t = ax(rx);
      return (t.angle = t.x), delete t.x, (t.radius = t.y), delete t.y, t;
    }),
    (t.linkVertical = () => ax(ex)),
    (t.local = Qn),
    (t.map = (t, n) => {
      if ("function" != typeof t[Symbol.iterator]) throw new TypeError("values is not iterable");
    ...
    (t.median = (t, n) => at(t, 0.5, n)),
    (t.medianIndex = (t, n) => ct(t, 0.5, n)),
    (t.merge = ft),
    (t.min = nt),
    (t.minIndex = et),
    (t.mode = (t, n) => {
      const e = new InternMap();
      if (void 0 === n) for (const n of t) null != n && n >= n && e.set(n, (e.get(n) || 0) + 1);
      else {
        let r = -1;
    ...
    (t.packEnclose = (t) => up(t, ap())),
    (t.packSiblings = (t) => (bp(t, ap()), t)),
    (t.pairs = (t, n = st) => {
      const e = [];
      let r,
        i = !1;
    ...
    (t.scaleDiverging = function t() {
      var n = Ng(L_()(mg));
      return (n.copy = () => B_(n, t())), dg.apply(n, arguments);
    }),
    (t.scaleDivergingLog = function t() {
      var n = Fg(L_()).domain([0.1, 1, 10]);
      return (n.copy = () => B_(n, t()).base(n.base())), dg.apply(n, arguments);
    }),
    ...
    (t.scaleDivergingSymlog = function t() {
      var n = Ig(L_());
      return (n.copy = () => B_(n, t()).constant(n.constant())), dg.apply(n, arguments);
    }),
    ...
    (t.scaleLinear = function t() {
      var n = Sg();
      return (n.copy = () => Tg(n, t())), hg.apply(n, arguments), Ng(n);
    }),
    ...
    (t.scaleQuantile = function t() {
      ...
      return (
        ...
        (u.quantiles = () => o.slice()),
        (u.copy = () => t().domain(r).range(i).unknown(e)),
    ...
    (t.scaleQuantize = function t() {
      ...
      return (
        ...
        (u.thresholds = () => o.slice()),
        (u.copy = () => t().domain([e, r]).range(a).unknown(n)),
    ...
    (t.scaleRadial = function t() {
      var n,
        ...
        i = !1;
      function o(t) {
        var r = ((t) => Math.sign(t) * Math.sqrt(Math.abs(t)))(e(t));
        return isNaN(r) ? n : i ? Math.round(r) : r;
      }
      return (
        (o.invert = (t) => e.invert(Hg(t))),
        (o.domain = function (t) {
        ...
        (o.rangeRound = (t) => o.range(t).round(!0)),
        (o.round = function (t) {
        ...
        (o.copy = () => t(e.domain(), r).round(i).clamp(e.clamp()).unknown(n)),
    ...
    (t.scaleSequentialQuantile = function t() {
      ...
      return (
        ...
        (i.range = () => e.map((t, n) => r(n / (e.length - 1)))),
        (i.quantiles = (t) => Array.from({ length: t + 1 }, (n, r) => at(e, r / t))),
        (i.copy = () => t(r).domain(e)),
    ...
    (t.scaleSymlog = function t() {
      var n = Ig(Ag());
      return (n.copy = () => Tg(n, t()).constant(n.constant())), hg.apply(n, arguments);
    }),
    (t.scaleThreshold = function t() {
      ...
      return (
        ...
        (o.copy = () => t().domain(e).range(r).unknown(n)),
        hg.apply(o, arguments)
      );
    }),
    ...
    (t.stackOrderDescending = (t) => _w(t).reverse()),
    ...
    (t.stackOrderNone = dw),
    (t.stackOrderReverse = (t) => dw(t).reverse()),
    (t.stratify = () => {
      var t,
        n = kp,
        e = Cp;
    ...
    (t.symbolsStroke = $x),
    (t.text = mc),
    (t.thresholdFreedmanDiaconis = (t, n, e) => {
      const r = v(t),
        i = at(t, 0.75) - at(t, 0.25);
      return r && i ? Math.ceil((e - n) / (2 * i * r ** (-1 / 3))) : 1;
    }),
        ...
        t.on("start.zoom", function () {
          ...
          .tween("zoom", function () {
            var o = arguments,
              a = w(this, o).event(r),
              u = i.apply(this, o),
              c = null == e ? m(u) : "function" == typeof e ? e.apply(this, o) : e,
              f = Math.max(u[1][0] - u[0][0], u[1][1] - u[0][1]),
              s = this.__zoom,
              h = "function" == typeof n ? n.apply(this, o) : n,
      ...
      function T(t, ...n) {
        if (r.apply(this, arguments)) {
          var e = w(this, n).event(t),
            i = this.__zoom,
            u = Math.max(c[0], Math.min(c[1], i.k * 2 ** a.apply(this, arguments))),
            s = ne(t);
          if (e.wheel)
