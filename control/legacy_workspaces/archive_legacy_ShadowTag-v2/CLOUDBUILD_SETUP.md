...
This guide documents how to set up the CI/CD triggers for `aiyou-fastapi-services` on Google Cloud Build.
...
| **Source** | `pikeymickey/aiyou-fastapi-services` (GitHub) |
| **Branch** | `^main$` |
