...
**Platform**: YouAi Governance Service + LLM Efficiency Optimizations
...
# Should show: .../aiyou-fastapi-services
...
# database_url=sqlite+aiosqlite:///./youai_governance.db
...
INFO:     Starting youai-governance-service v1.0.0
...
```json
{
  "service": "youai-governance-service",
  "version": "1.0.0",
  "description": "YouAi Governance Service - Full compliance & infrastructure management",
  "persona_iq": 160,
  "governance": {
    "eu_ai_act": true,
    "dsa_vlop": false,
