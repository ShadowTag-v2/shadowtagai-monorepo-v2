...
class AuditExporter:
  ...
  def export_evidence_package(
    ...
    # Identify key events
    crisis_events = [
      t for t in timeline if "emergency" in t.get("event_type", "").lower()
    ]
    ...
    report = {
      ...
      "framework_compliance": {
        "SB_243": {
          ...
          "status": "compliant"
          if aggregate_data.get("sb243_violations", 0) == 0
          else "findings",
        },
        "HIPAA": {
          ...
          "status": "compliant"
          if aggregate_data.get("hipaa_violations", 0) == 0
          else "findings",
        },
        "CCPA": {
          ...
          "status": "compliant"
          if aggregate_data.get("ccpa_violations", 0) == 0
          else "findings",
        },
      },
