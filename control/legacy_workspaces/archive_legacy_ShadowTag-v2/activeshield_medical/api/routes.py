...
from src.aiyou.database import get_db
...
class ScanRequest(BaseModel):
    ...
    context: dict[str, Any] = Field(default_factory=dict, description="Session context (ai_disclosure_shown, user_age, etc.)")
...
async def mid_hoc_monitor(
    ...
    return {
        ...
        "warnings": result.warnings,
        "required_actions": result.required_actions,
        "human_review_required": result.gateway_result.human_review_required if result.gateway_result else False,
        "processing_time_ms": result.processing_time_ms,
    }
