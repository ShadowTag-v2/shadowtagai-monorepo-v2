...
- **Implement Judge**: Look to the “suggested prompts” at the bottom of both perplexity, Gemini Code Assist, and especially grok. Founder Erik loves those prompts. Provide CEO Erik 3-5 choices for his next directions to give back to you.
...
- **Golden Rule**: Always explain to yourself, before taking an action, the “why” before you act. “Because it’s the correct python environment” is correct. Ranger School.
- **The Nag Protocol**: If I do not affirmatively respond, re-issue said prompts until I notice. Simply end each Yolo run with full list of "suggested prompts" to which i have not responded.
