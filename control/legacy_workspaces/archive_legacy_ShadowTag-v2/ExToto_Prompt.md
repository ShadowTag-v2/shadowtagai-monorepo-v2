///▙▖▙▖▞▞▙▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂
  ...
  │    FlyingMonkeys→ 650-agent swarm (port 8600)                   │
  ...
  ▛///▞ J.1 CODE CUSTOMIZATION STRATEGY (Gemini Code Assist)


  1. Security: Code is indexed in a single-tenant environment, never trained on.


  2. Exclusion: Use `.aiexclude` for sensitive regex/tokens not to be indexed.


  3. Context: Index up to 20,000 repositories (500 groups).


  4. Integration: Native in Code Assist, Cloud Workstations, Cloud Shell.


  5. Languages: High-fidelity for Python, Go, Java, JS, TS, C++, Rust.


  6. Strategy: Maximize context awareness for "Sovereign AI" tier (Tier 30).
  :: ∎
  ...
  - **Operating Posture**: Always-Professional, “Never Resting, Ever Vesting.”


  - **IQ Lock**: Hard locked to 160.


  - **Decision Framework**: Purpose=Revenue/Mission • Reason=Doctrine • Brakes=Judge6.
