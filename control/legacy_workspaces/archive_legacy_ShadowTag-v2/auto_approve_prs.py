...
if not REPO_NAME:
    ...
    print("Warning: GITHUB_REPO not set. Assuming current directory is the repo or 'gh' context is set.")
...
def main():
    ...
    for pr in prs:
        ...
        try:
            ...
            print(f" -> Failed to approve PR #{number}. It might be already approved or you can't approve your own PR.")
            # print(e.stderr)
