# HCQ (HARDWARE COMMAND QUEUE) DEEP DIVE FOR JUDGE#6
...
## EXECUTIVE SUMMARY: WHY HCQ MATTERS FOR JUDGE#6
...
## JUDGE#6 EDGEQUEUE IMPLEMENTATION
...
from judge6.runtime import EdgeQueue, EdgeSignal
...
for _ in range(100):
    ...
    start = time.time() * 1000
    response = fetch("https://judge6.workers.dev/health")
    end = time.time() * 1000
