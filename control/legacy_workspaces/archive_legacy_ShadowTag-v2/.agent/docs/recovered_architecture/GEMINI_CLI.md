# Gemini CLI & FlyingMonkeys Integration Guide

## Overview
This document outlines the usage of the Gemini CLI and the FlyingMonkeys agent swarm for the Aiyou platform.
...
2. **Start FlyingMonkeys Swarm**:
   ```bash
   docker-compose -f docker-compose.antigravity.yml up -d flyingmonkeys
   ```

## FlyingMonkeys API Usage
