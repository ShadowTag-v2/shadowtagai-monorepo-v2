# Atomic Chat Integration Example - FlyingMonkeys + SwarmOrchestrator

This document demonstrates how to use the Atomic Chat API pipeline
with the FlyingMonkeys swarm and SwarmOrchestrator.
...
fm = FlyingMonkeys(num_agents=600)
...
```python
from src.aiyou.orchestrator.swarm_orchestrator import SwarmOrchestrator
from src.aiyou.services.context_index import ContextIndexService
