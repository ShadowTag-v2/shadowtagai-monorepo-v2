...
3. **FlyingMonkeys** → 600-agent swarm with OPORD coordination
...
```python
from src.aiyou.orchestrator.context_integration import SwarmOrchestratorContextMixin
...
**Built with**: FastAPI, Elasticsearch, PyPDF2, AtomicChatManager, FlyingMonkeys (600 agents), OPORD format, Army Leadership Principles
