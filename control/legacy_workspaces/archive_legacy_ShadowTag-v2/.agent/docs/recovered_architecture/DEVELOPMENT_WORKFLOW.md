# AiYouJR FastAPI Development Workflow

## Overview
This document defines the complete development workflow for the AiYouJR FastAPI services, incorporating SOPs, custom skills, and deployment to Vertex AI Workbench → GKE Native.
...
2. **Deployment Pipeline**:
   ...
   kubectl rollout status deployment/aiyou-api
