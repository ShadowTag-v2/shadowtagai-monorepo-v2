...
The AiYou Intelligence Platform has evolved into a production-ready SaaS offering combining:
...
No changes needed to existing CronJob. All new features integrate seamlessly:
    ...
    spec:
      template:
        spec:
          ...
          - name: collector
            image: gcr.io/aiyou-intelligence/collector:latest
            env:
...
from src.api.monetization_routes import include_monetization_routes

app = FastAPI(title="AiYou Intelligence Platform")

# Include routes

app.include_router(monitoring_router)
include_monetization_routes(app)
