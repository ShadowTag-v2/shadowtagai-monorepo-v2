...
1. SITUATION:
   ...
   Friendly: FlyingMonkeys Shift 0 (200 agents), agent_042 lead
...
Our approach:
1. Comprehensive security audit by FlyingMonkeys swarm
...
## Usage by FlyingMonkeys Swarm

### Integration with Existing Infrastructure

```python
# agents/flying_monkeys.py - Enhanced with unified SOP
...
```python
# src/aiyou/orchestrator/swarm_orchestrator.py
...
1. **Agent behavior** (FlyingMonkeys execute this SOP)
