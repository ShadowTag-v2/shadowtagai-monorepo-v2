...
AiYou systems will target **DAL-C** (Major failure condition):
...
- License their certified platform, integrate AiYou algorithms as "data provider"
...
- Allows commercial operators to install AiYou units
