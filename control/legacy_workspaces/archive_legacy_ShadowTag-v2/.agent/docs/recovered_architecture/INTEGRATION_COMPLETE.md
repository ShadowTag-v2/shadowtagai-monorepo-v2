...
1. `2f91167` - Merge Judge Encode deployment: Production-ready YouAi Governance Service
...
- **Ecosystem Potential**: **$1.72B ARR**
  ...
  - AiYou: $275M ARR (AI-cognition video network)
...
| AiYou (external) | $275M ARR | Video network |
...
4. Deploy AiYou video network beta
...
4. Commercialize ShadowTag + AiYou
