# AiYou Safety-Case SaaS Framework - Tech Stack
...
└─────────────────────────────────────────────────────────────┘
                            ...
                            ↓
┌─────────────────────────────────────────────────────────────┐
│  Production Services (ShadowTag, AiYou)                     │
│  - FastAPI / Next.js                                        │
...
export CU_GOAL="Open docs.aiyou.com and verify header text"
...
```bash
gh repo clone ShadowTag-v2/aiyou-fastapi-services
