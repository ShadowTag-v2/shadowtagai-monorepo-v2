# AiYouJR Claude Code Infrastructure

**Version:** 1.0.0
**Created:** 2025-11-15
**Purpose:** Complete Claude Code infrastructure with AiYouJR governance framework
...
│   │       └── tls-config.md
│   ├── aiyoujr-judge/          # Strategic gates (HIGH)
│   │   ├── SKILL.md
│   │   └── resources/
...
# Should show: aiyoujr-judge, backend-dev-guidelines, frontend-dev-guidelines, security-enforcement, skill-rules.json
...
# Test 2: AiYouJR judge activation

You: "I want to build a new feature for customer analytics"

# Expected: aiyoujr-judge skill should activate
...
#   ├── oauth-auth-plan.md       # Strategic plan with AiYouJR gates
...
Edit thresholds in `.claude/skills/aiyoujr-judge/SKILL.md`:
...
- AiYouJR Decision Framework Documentation
...
2. **Create your first dev docs** - Plan a feature with AiYouJR gates
