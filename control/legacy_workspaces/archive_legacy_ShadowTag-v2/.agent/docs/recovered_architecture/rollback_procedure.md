...
gh api repos/ShadowTag-v2/aiyou-fastapi-services/deployments \
...
curl -X PATCH https://api.aiyou.com/admin/flags/new-feature \
...
curl https://api.aiyou.com/health | jq '.status'
...
**Incident Hotline**: #incidents (Slack) | incidents@aiyou.com
