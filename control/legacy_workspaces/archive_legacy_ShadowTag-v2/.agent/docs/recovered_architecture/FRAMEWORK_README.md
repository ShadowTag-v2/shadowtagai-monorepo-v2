...
The AiYouJR Core Framework is a production-ready implementation of the PRISM kernel, business planning models, operating framework execution engine, and context management system. It translates strategic frameworks into executable code.
...
approved, message = protocol.validate_decision(
    ...
    mission_aligned=True,           # Purpose: AiYouJR alignment
...
context = package.create_context(
    ...
    decision_framework={"purpose": "AiYouJR"},
    actions=[action],
