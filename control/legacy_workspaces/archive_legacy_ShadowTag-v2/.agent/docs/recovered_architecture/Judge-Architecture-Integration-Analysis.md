...
DAY 8-30 (WEEKS 2-4): Regulatory Compliance + Adtech Standards
  ├─ Day 8-10: EU AI Act profile in YouAiNS (risk class, transparency, logging)
  │   Owner: GC + CTO
...
DAY 31-60 (WEEKS 5-8): Product Features + C2PA
  ...
  ├─ Day 36-40: C2PA for YouAi overlays (tamper-evident metadata)
  │   Owner: CTO
...
DAY 61-90 (WEEKS 9-13): Governance Publication + Enterprise Readiness
  ...
  │   Owner: Cofounder + GC
  ├─ Day 71-75: Publish YouAi Governance Report v0.1 (DSA-style risk assessment)
  │   Owner: CEO + GC
