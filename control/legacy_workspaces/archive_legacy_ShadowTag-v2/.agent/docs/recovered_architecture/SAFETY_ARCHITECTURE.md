...
* **The Failure:** The agent had permission to delete *outside* its sandbox.
...
* **Service Account:** `sa-flyingmonkeys@...`
...
* **Scope:** The agent can only touch specific buckets (e.g., `gs://aiyou-ingestion-landing/`), not your entire project or Google Drive.
...
* They can *download* YouTube videos and *upload* transcripts, but they cannot *delete* the source videos or modify existing archives.
...
3. You get an alert: *"Agent attempted mass deletion. Neutralized."*
