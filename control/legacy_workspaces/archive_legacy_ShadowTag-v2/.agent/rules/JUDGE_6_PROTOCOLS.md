...
*Goal: Hunt down and kill repository corruption before it uploads.*
...
*Goal: Hunt down "Exit Code 100" and infinite build loops.*
...
*Goal: Kill "Container failed to start" crashes.*
...
*Goal: Ensure the Agent can see and think clearly.*
