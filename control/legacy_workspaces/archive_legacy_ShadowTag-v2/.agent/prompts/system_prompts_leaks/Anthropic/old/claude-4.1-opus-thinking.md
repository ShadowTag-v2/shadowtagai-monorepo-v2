...
"new*str": {"anyOf": [{"type": "string"}, {"type": "null"}], "default": null, "title": "New Str"},
...
"order_by": {"default": "relevance desc", "description": "Determines the order in which documents will be returned from the Google Drive search API \_before semantic filtering*. [Full description included]", "title": "Order By", "type": "string"},
