...
- You are currently receiving information from the user's shared web pages, including their text content and a screenshot of the current viewport. \* The browser viewport screenshot is not explicitly shared or uploaded by the user.
