...
1.  **Adaptive Compliance**: The extension scans the _local_ workspace (`/home/user/workspace`). It "learns" the project structure, patterns, and lint rules locally.
...
3.  **Zero-Latency context**: It avoids sending massive context windows to the cloud; it uses local indexing (like an LSP) to refine prompts _before_ they leave the workstation.
