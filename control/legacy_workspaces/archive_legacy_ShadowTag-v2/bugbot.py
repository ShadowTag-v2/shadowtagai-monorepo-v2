...
class BugBot:
    ...
    def format_triage_prompt(self, issue: dict) -> str:
        ...
        care = CARE(
            ...
            action=("Classify severity, category, and priority. Estimate fix time. Suggest labels and assignee."),
            result=("JSON with severity (critical/high/medium/low/trivial), category, priority_score (1-10), estimated_hours, labels"),
            example={
                "severity": "high",
                "category": "bug",
                "priority_score": 8,
