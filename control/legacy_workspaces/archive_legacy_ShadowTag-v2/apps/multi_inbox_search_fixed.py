...
def search_inbox(service, target_email, query):
    ...
    try:
        ...
        print(f"   Found {total_messages} matching messages total.")
...
def main():
    ...
    parser.add_argument("--targets", nargs="+", help="List of email addresses to search", required=True)
    ...
    parser.add_argument("--output", help="Output file for results", default="multi_search_results.md")
