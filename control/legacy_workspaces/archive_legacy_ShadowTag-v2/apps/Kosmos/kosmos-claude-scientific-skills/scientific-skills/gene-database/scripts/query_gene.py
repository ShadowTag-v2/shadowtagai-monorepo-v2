...
def search_and_summarize(
    query: str, organism: str | None = None, max_results: int = 20, api_key: str | None = None
) -> None:
    """
  ...
  %(prog)s --id 672,7157,5594
    ...
    if args.id:
        ...
        search_and_summarize(
            args.search, organism=args.organism, max_results=args.max_results, api_key=args.api_key
        )
