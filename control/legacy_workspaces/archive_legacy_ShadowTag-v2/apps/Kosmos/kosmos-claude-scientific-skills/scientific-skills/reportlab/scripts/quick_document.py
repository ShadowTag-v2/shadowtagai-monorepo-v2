...
if __name__ == "__main__":
    ...
    content = [
        ...
        {
            "type": "paragraph",
            "content": "More content here with <b>bold</b> and <i>italic</i> text.",
        },
    ...
    create_simple_document(
        "example_document.pdf", "Sample Document", author="John Doe", content_blocks=content
    )
    ...
    table = create_styled_table(
        data, col_widths=[2 * inch, 1 * inch, 1 * inch, 1 * inch, 1 * inch], style_name="striped"
    )
    story.append(table)
