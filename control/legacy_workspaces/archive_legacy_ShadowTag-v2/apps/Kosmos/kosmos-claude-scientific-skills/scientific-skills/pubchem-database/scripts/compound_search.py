...
def similarity_search(
    ...
    try:
        compounds = pcp.get_compounds(
            smiles, "smiles", searchtype="similarity", Threshold=threshold, MaxRecords=max_records
        )
        return compounds
    except Exception as e:
...
def download_structure(
    identifier: str | int, namespace: str = "name", format: str = "SDF", filename: str | None = None
) -> str | None:
    """
