...
class BioRxivSearcher:
    ...
    def search_by_author(
        self, author_name: str, start_date: str | None = None, end_date: str | None = None
    ) -> list[dict]:
        """
...
def main():
    ...
    filter_group.add_argument(
        "--category", "-c", choices=BioRxivSearcher.CATEGORIES, help="Filter by category"
    )
    filter_group.add_argument(
        "--search-fields",
        nargs="+",
    ...
    output_group.add_argument(
        "--include-abstract", action="store_true", default=True, help="Include abstracts in output"
    )
    output_group.add_argument(
