...
def create_policy(env):
    ...
    return Policy(
        observation_space=env.observation_space, action_space=env.action_space, hidden_size=256
    )
...
def main():
    ...
    parser.add_argument(
        "--project", type=str, default="pufferlib-training", help="Project name for logging"
    )
    ...
    parser.add_argument(
        "--save-freq", type=int, default=100, help="Checkpoint save frequency (iterations)"
    )
