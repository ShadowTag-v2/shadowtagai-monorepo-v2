...
def train_solubility_model(
    data_path=None, smiles_col="smiles", target_col="measured log solubility in mols per litre"
):
    """
...
def main():
    ...
    parser.add_argument(
        "--smiles-col", type=str, default="smiles", help="Name of column containing SMILES strings"
    )
    parser.add_argument(
        "--target-col",
        type=str,
    ...
    parser.add_argument(
        "--predict", nargs="+", default=None, help="SMILES strings to predict after training"
    )
