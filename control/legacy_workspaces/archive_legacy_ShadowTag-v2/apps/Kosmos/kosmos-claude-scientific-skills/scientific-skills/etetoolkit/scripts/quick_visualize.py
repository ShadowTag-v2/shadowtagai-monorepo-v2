...
Examples:
  ...
  %(prog)s tree.nw output.pdf --mode c --arc-start -90 --arc-span 180
    ...
    display.add_argument(
        "--no-names", dest="show_names", action="store_false", help="Don't show leaf names"
    )
    ...
    layout.add_argument(
        "--arc-start", type=int, default=0, help="Circular tree start angle (default: 0)"
    )
    layout.add_argument(
        "--arc-span", type=int, default=360, help="Circular tree arc span (default: 360)"
    )
    ...
    styling.add_argument(
        "--color-by-support", action="store_true", help="Color internal nodes by support value"
    )
