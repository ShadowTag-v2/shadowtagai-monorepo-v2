...
def run_baseline(num_cycles: int = 3, use_literature: bool = False):
    ...
    print("=" * 60)
    print("Research question: How does temperature affect enzyme activity?")
    ...
    hypothesis_agent = HypothesisGeneratorAgent(
        config={"num_hypotheses": 2, "use_literature_context": use_literature}
    )
            ...
            if hypotheses:
                ...
                try:
                    ...
                    if design_response and hasattr(design_response, "protocol"):
                        ...
                        print("  Design returned but no protocol")
                        print(f"  Time: {step_time:.1f}s")
