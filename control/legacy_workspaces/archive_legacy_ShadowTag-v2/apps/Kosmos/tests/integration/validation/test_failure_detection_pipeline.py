...
class TestScholarEvalIntegration:
    ...
    def test_combined_validation_workflow(
        ...
        validation_failed = not scholar_score.passes_threshold or failure_result.has_failures
    ...
    def test_scholar_eval_score_structure_compatible(self, scholar_validator, real_world_finding):
...
class TestResearchLoopIntegration:
    ...
    def test_validation_pipeline_flow(
        ...
        failure_result = failure_detector.detect_failures(task_result["finding"], research_context)

        # Step 3: Combined decision
        should_save = scholar_score.passes_threshold and failure_result.passes_validation
