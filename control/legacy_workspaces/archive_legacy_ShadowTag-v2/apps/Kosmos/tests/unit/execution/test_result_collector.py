...
def sample_protocol():
    ...
    return ExperimentProtocol(
        ...
        resource_requirements=ResourceRequirements(
            cpu_cores=1, memory_gb=1.0, estimated_duration_minutes=10
        ),
        random_seed=42,
...
class TestDatabaseStorage:
    ...
    def test_store_result_called(
        self, mock_db_ops, mock_get_session, sample_protocol, successful_execution_output
    ):
