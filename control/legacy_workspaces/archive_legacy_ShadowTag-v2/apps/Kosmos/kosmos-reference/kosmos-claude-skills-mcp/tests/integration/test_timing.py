...
def test_package_sizes():
    ...
    frontend_wheel = (
        project_root / "packages/frontend/dist/claude_skills_mcp-1.0.5-py3-none-any.whl"
    )
    ...
    backend_wheel = (
        project_root / "packages/backend/dist/claude_skills_mcp_backend-1.0.6-py3-none-any.whl"
    )
