...
export default memo(function Results({
  ...
  return (
    ...
    >
      {/* Game Over Title */}
      <div
        className="mb-10 text-7xl text-red-500 font-bold tracking-widest"
      ...
      <div className="flex items-center justify-center text-center text-white">
        ...
        <div className="mr-16">
          <p
            className="text-gray-400 text-3xl tracking-wider"
            style={{ fontFamily: "Jersey15, sans-serif" }}
          >
            YOUR SCORE
          </p>
      ...
      {/* Performance Message */}
      <div
        className="bg-white text-[#2B374B] text-4xl mt-10 px-10 py-6 shadow-lg text-center "
        style={{ fontFamily: "Jersey15, sans-serif" }}
      >
        YOU PERFORMED <span className="text-blue-500 text-4xl">{playerEfficiency}</span> AS WELL AS
        THE <br />
      ...
      {/* Press S to Retry */}
      <div
        className="flex items-center justify-center mt-12 text-[#4CCF6F] text-5xl tracking-wide"
        style={{ fontFamily: "Jersey15, sans-serif" }}
      >
        PRESS
