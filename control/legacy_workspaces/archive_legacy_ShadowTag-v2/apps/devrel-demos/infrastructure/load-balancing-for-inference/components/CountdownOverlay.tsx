  ...
  return (
    <>
      ...
      {timeElapsed >= 0 && timeRemaining > 0 && (
        <div
          className="absolute top-20 left-10 z-50 text-[#2B374B] font-bold text-5xl"
      ...
      {timeElapsed >= 0 && (
        ...
        >
          <div className="relative" style={{ fontFamily: "Jersey15, sans-serif" }}>
            <Image src="/assets/timer-box.png" alt="Timer Box" width={78} height={60} priority />
      ...
      {timeElapsed >= 0 && timeRemaining > 0 && (
        <div
          className="absolute top-20 right-10 z-50 text-[#2B374B] font-bold text-5xl"
          style={{ fontFamily: "Jersey15, sans-serif" }}
        >
      ...
      {timeElapsed < 0 && (
        ...
        >
          ...
          <div className="relative flex flex-col items-center justify-center mt-24">
            <Image src="/countdown-box.png" alt="Countdown Box" width={240} height={240} priority />
          ...
          {/* "Get Ready!" Text */}
          <p className="text-[#FFB800] text-[3rem] font-bold mt-14">GET READY!</p>
        </div>
      )}
    </>
  );
