...
export default function Chat({
  ...
  async function handleSubmit(evt: React.FormEvent<HTMLFormElement>) {
    ...
    setData([
      ...newData,
      {
        ...
        role: "assistant",
        image: body.image_url.image_url.url,
      },
    ]);
    setShowExtra(true);
  }
  ...
  return (
    <div className={[styles.wrapper, isOpen ? styles.wrapperOpen : ""].join(" ")}>
      <div className={styles.messages}>
        {data.map((item, idx) => (
          <div className={item.role === "assistant" ? styles.assistant : styles.user} key={idx}>
        ...
        {showExtra && (
          <div className={styles.extra}>
            ...
            <Link
              ...
              href="https://toys-uxu5wi2jpa-uc.a.run.app"
              target="_blank"
            >
