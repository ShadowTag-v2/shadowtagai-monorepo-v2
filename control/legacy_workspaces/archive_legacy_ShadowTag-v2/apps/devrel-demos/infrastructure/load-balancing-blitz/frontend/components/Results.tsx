...
export default memo(function Results({
  ...
  return (
    <div
      className={`flex flex-col items-center justify-center transition-opacity fixed top-0 left-0 right-0 bottom-0 bg-gradient-to-t from-white via-white to-transparent duration-1000 ${showResults ? "opacity-100" : "opacity-0"}`}
    >
      <div className="my-12">
        <span className="flex text-5xl font-mono">
          <span className="my-auto mx-20">Game Over</span>
        </span>
      </div>
      <div className="text-7xl font-mono m-16">
        <table className="">
          <tbody>
            <tr>
              <td>Your Score</td>
              <td className="text-right pl-16 font-mono">
