...
| **`add_dependency`** | Manage modules.     | `packages`                    | **Superior to `go get`**: Installs modules and _immediately_ returns their full documentation and API signatures to prevent hallucination. |
