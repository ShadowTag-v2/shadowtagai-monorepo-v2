...
- **Memory Safety:** The `internal/graph` package (recursive AST loader) is deleted. Memory usage is now strictly proportional to the size of the _single file_ being edited/read.
- **Test Coverage:**
