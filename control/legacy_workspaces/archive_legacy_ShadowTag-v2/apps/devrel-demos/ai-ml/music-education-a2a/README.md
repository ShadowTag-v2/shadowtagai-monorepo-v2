...
Rather than running this in the ADK Web UI or with an interactive runner, we'll run this helper agent as a backend _API server_ that our root Music Education Agent can call.
...
```json
{
  ...
  "skills": [
    ...
    {
      "description": "",
      "id": "historical_context_agent-search_agent",
      "name": "search_agent",
      "tags": ["llm", "tools"]
    }
  ],
