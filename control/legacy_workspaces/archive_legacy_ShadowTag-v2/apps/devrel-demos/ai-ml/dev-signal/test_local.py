...
async def main():
    ...
    memory_service = VertexAiMemoryBankService(project=project_id, location=resource_location, agent_engine_id=agent_engine_id)
    ...
    await session_service.create_session(app_name="dev-signal", user_id=user_id, session_id=current_session_id)
