# Develop a Serverless Application with Vision API

---

Discover the functionality of Vision API and KGSearch API and deploy a serverless application to Cloud Run that detects breeds of dogs in an image.
