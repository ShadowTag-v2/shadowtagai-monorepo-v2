...
def check_refund_eligibility(reason: str, shipping_method: str) -> bool:
    ...
    logger.info(f"Checking refund eligibility - Reason: {reason_upper}, Shipping: {shipping_upper}")

    # Check eligibility based on shipping method and reason
    is_eligible = shipping_upper in ELIGIBLE_SHIPPING_METHODS and reason_upper in ELIGIBLE_REASONS
