...
export const updateCargo = createAsyncThunk(
  ...
  async (cargo = [], collectionName = "global") => {
    const cargoRef = firebaseInstance.db.collection(collectionName).doc("cargo");
    try {
 ...
 */
export const stopMission = createAsyncThunk("stopMission", async (collectionName = "global") => {
  const cargoRef = firebaseInstance.db.collection(collectionName).doc("cargo");
  const patternRef = firebaseInstance.db.collection(collectionName).doc("proposal");
 ...
 * -----------------
 */
export const worldStateUpdated = async (dispatch, collectionName = "global") => {
  const ref = firebaseInstance.db.collection(collectionName);
 ...
 * -----------------
 */
export const trainMailboxUpdated = async (callback = () => {}, collectionName = "global") => {
  const ref = firebaseInstance.db.collection(collectionName).doc("train_mailbox");
  try {
 ...
 * -----------------
 */
export const proposalUpdated = async (callback = () => {}, collectionName = "global") => {
 ...
 * -----------------
 */
export const trainUpdated = async (callback = () => {}, collectionName = "global") => {
 ...
 * -----------------
 */
export const cargoUpdated = async (callback = () => {}, collectionName = "global") => {
 ...
 * -----------------
 */
export const signalsUpdated = async (callback = () => {}, collectionName = "global") => {
