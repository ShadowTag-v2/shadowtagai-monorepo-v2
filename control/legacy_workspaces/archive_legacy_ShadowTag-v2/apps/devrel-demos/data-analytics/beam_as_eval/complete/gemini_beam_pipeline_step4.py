  ...
  with beam.Pipeline(options=pipeline_options) as p:
    if known_args.test_mode:
      ...
      parsed_elements = (
        ...
        >> beam.WithTimestamps(lambda s: json.loads(s)["timestamp"])
      )
    ...
    final_results = (
      ...
      # Step 4
      # Windowing and Analyzing Results
      # Write your window code here.
      ############## BEGIN STEP 4 ##############
    ...
    final_results | "LogFinalResults" >> beam.Map(logging.info)
