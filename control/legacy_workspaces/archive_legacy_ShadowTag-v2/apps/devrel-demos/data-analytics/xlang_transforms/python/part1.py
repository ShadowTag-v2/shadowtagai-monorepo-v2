...
def run(input_files, pipeline_args):
    ...
    with beam.Pipeline(options=pipeline_options) as pipeline:
        read_input = pipeline | "Read the files" >> beam.io.textio.ReadFromText(input_files) | "Convert to Row" >> beam.ParDo(ConvertToRow(","))
        read_input | beam.Map(lambda row: logging.info(row))
