...
5.  **Game Logic (Crucial for Smooth Movement):**
    ...
    - **Collision & Movement Algorithm:**
      ...
      - **In Transit (Not at Center):**
        ...
        - Otherwise, **force move** in `currentDirection` until the next center is reached. Do _not_ check for walls while moving between tiles to prevent getting stuck at edges.
    - **Ghost AI:**
