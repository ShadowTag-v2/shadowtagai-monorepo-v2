              ...
              <div className="absolute w-full flex justify-between">
                      ...
                      <Link
                        ...
                        className={mergeClassNames(
                          item.current
                            ...
                            : "text-gray-700 hover:underline hover:decoration-[var(--google-cloud-blue)] hover:text-black",
                ...
                <div className="inset-y-0 left-0 flex items-center sm:hidden">
                  ...
                  <Disclosure.Button
                    ...
                    className="inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:underline hover:decoration-[var(--google-cloud-blue)] hover:text-black"
                  >
