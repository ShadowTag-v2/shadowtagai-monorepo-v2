...
def generate_blog_post():
    ...
    if request.method == "POST":
        ...
        (user_id, session_id, agent_response) = get_agent_response("", "", blog_post_text, "")
        return render_template(
            "blog-post.html",
            title=title,
            blog_post_html=markdown.markdown(blog_post_text, extensions=["tables", "fenced_code"]),
...
def refine():
    ...
    return render_template(
        ...
        blog_post_html=markdown.markdown(agent_response, extensions=["tables", "fenced_code"]),
