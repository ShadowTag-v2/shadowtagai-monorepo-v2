      ...
      for (const s of e)
        switch (((n = n.concat(t.call(this, s))), s.type)) {
          case "table": {
            ...
            for (const r of i.rows) for (const o of r) n = n.concat(this.walkTokens(o.tokens, t));
            break;
          }
          case "list": {
            const i = s;
...
Please report this to https://github.com/markedjs/marked.`),
  ...
  k.options = k.setOptions = (l) => (M.setOptions(l), (k.defaults = M.defaults), N(k.defaults), k);
  k.getDefaults = z;
  k.defaults = w;
  k.use = (...l) => (M.use(...l), (k.defaults = M.defaults), N(k.defaults), k);
