          ...
          <TableHeader>
            <TableRow>
              ...
              {alternatives.map((alt) => (
                <TableHead key={alt} className="text-right px-6">
                  {alt}
                </TableHead>
              ))}
              ...
              <TableRow key={reason}>
                ...
                {alternatives.map((alt) => {
                  ...
                  return (
                    <TableCell
                      key={alt}
                      className="text-right font-mono text-muted-foreground/70 px-6"
                    >
