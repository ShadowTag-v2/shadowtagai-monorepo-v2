...
import type { ConfigBlock } from "@/types/domain";
import { ScenarioData, type TemplateData } from "@/types/domain";
...
function TemplateEditorContent({ name }: { name: string }) {
  ...
  if (loading)
    return <div className="p-20 text-center animate-pulse text-body">Loading Environment...</div>;
