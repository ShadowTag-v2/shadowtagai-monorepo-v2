...
import type { ExperimentRecord } from "@/types/domain";
          ...
          {experiments.map((exp) => (
            <TableRow key={exp.id} className={exp.is_locked ? "border-l-2 border-l-warning" : ""}>
              ...
              <TableCell>
                <Badge
                  variant={
                    exp.status?.toUpperCase() === "COMPLETED"
                      ? "secondary"
                  ...
                  className={cn(
                    ...
                    exp.status?.toUpperCase() === "RUNNING" &&
                      "border-primary/50 text-primary bg-primary/10 animate-pulse",
                    exp.status?.toUpperCase() === "ABORTED" &&
              ...
              <TableCell>
                <Link
                  ...
                  className="hover:text-primary font-bold text-base transition-colors truncate block max-w-[350px]"
                  title={exp.name}
                >
              ...
              <TableCell>
                <p
                  className="text-sm text-muted-foreground truncate max-w-[500px]"
          ...
          {experiments.length === 0 && (
            <TableRow>
              <TableCell colSpan={12} className="h-24 text-center text-muted-foreground">
                ...
                <Link href="/experiments/new" className="text-primary hover:underline font-bold">
