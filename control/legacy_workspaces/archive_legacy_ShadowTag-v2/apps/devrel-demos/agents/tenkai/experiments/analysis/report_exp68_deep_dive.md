...
You asked for concrete scenarios where tool usage made the agent better or worse. My analysis uncovered a fascinating result: **The "Advanced" agent became better by doing _less_.**
...
The critical difference wasn't which tools were _used_, but which were _skipped_.
