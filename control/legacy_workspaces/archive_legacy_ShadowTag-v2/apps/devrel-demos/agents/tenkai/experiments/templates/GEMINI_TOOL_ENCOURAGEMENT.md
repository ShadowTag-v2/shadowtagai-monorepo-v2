...
- _Before_ writing code that imports a new package, search for that package.
- _Before_ calling a complex function, inspect its definition using your tools to verify the arguments and return types.
