...
2.  **Investigate "Context Priming":** This result suggests that we can optimize agent performance simply by curating the _list_ of available tools, independent of their actual utility. Further experiments should test this "Placebo Tool" effect.
