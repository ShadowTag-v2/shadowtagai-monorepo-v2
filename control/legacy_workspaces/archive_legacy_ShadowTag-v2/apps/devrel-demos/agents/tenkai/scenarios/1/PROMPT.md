...
- Unit tests must pass. You must verify that the _total_ project coverage is at least 50% by running: `go test -coverprofile=coverage.out ./... && go tool cover -func=coverage.out`
