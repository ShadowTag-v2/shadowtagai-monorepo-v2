...
!((e, t) => {
  ...
  function R(e, o) {
    const r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : h;
    t && t(e, null);
    let i = o.length;
    for (; i--; ) {
      let t = o[i];
  ...
  var re = (function t() {
    const n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : oe();
    const o = (e) => t(e);
    if (
      ((o.version = "3.3.0"),
      (o.removed = []),
    ...
    const ht = r.createElement("form"),
      gt = (e) => e instanceof RegExp || e instanceof Function,
      Tt = function () {
        ...
        if (!dt || dt !== e) {
          if (
            ...
            (Ne = _(e, "ALLOWED_TAGS") ? R({}, e.ALLOWED_TAGS, ft) : we),
            (Re = _(e, "ALLOWED_ATTR") ? R({}, e.ALLOWED_ATTR, ft) : De),
            ...
            (ve = _(e, "FORBID_TAGS") ? R({}, e.FORBID_TAGS, ft) : C({})),
            (Oe = _(e, "FORBID_ATTR") ? R({}, e.FORBID_ATTR, ft) : C({})),
            ...
            e.ADD_TAGS &&
              ("function" == typeof e.ADD_TAGS
                ...
                : (Ne === we && (Ne = C(Ne)), R(Ne, e.ADD_TAGS, ft))),
            e.ADD_ATTR &&
              ("function" == typeof e.ADD_ATTR
                ? (xe.attributeCheck = e.ADD_ATTR)
                : (Re === De && (Re = C(Re)), R(Re, e.ADD_ATTR, ft))),
            ...
            Ne.table && (R(Ne, ["tbody"]), delete ve.tbody),
      ...
      wt = (e) => "function" == typeof w && e instanceof w;
    function Rt(e, t, n) {
      u(e, (e) => {
        e.call(o, t, n, dt);
      });
    ...
    const Dt = (e) => {
        ...
        if (!(xe.tagCheck instanceof Function && xe.tagCheck(n)) && (!Ne[n] || ve[n])) {
          if (!ve[n] && vt(n)) {
    ...
    return (
      (o.sanitize = function (e) {
        let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
          ...
          i = null,
          l = null;
        if (((it = !e), it && (e = "\x3c!--\x3e"), "string" != typeof e && !wt(e))) {
        ...
        if ((Fe || Tt(t), (o.removed = []), "string" == typeof e && (qe = !1), qe)) {
          if (e.nodeName) {
            ...
            if (!Ne[t] || ve[t]) throw S("root node is forbidden and cannot be sanitized in-place");
          }
        ...
        const c = St(qe ? e : n);
        for (; (i = c.nextNode()); ) Dt(i), Ot(i), i.content instanceof s && xt(i.content);
        if (qe) return e;
        if (Be) {
