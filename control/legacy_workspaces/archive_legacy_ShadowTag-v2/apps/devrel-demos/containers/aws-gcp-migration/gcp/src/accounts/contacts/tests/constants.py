...
EXAMPLE_TOKEN = jwt.encode(EXAMPLE_USER_PAYLOAD, EXAMPLE_PRIVATE_KEY, algorithm="RS256")
...
INVALID_LABELS = [
    ...
    f" {get_random_string(30)}",  # 30 characters + leading space
    f"{get_random_string(30)} ",  # 30 characters + trailing space
    f"{get_random_string(100)}",  # 100 characters
]
