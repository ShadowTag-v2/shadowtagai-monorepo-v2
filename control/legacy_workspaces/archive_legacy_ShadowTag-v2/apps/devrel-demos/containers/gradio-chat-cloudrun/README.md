...
2.  **Destroy Chat App Infrastructure:**
    ...
    _(If it fails because Artifact Registry is not empty, run `gcloud artifacts repositories delete chat-app-repo --location=$TF_VAR_region --quiet` and try again)_
