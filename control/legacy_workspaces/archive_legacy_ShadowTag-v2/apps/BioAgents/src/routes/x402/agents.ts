 ...
 */
function createCompletedTasks(tasks: Array<{ objective: string; output: string }>): PlanTask[] {
  return tasks.map((t) => ({
    id: crypto.randomUUID(),
...
export const x402IndividualAgentsRoute = new Elysia({
  prefix: "/api/x402/agents",
})
