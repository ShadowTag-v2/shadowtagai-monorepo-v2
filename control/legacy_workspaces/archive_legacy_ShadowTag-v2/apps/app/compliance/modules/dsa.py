...
class DSAModule(ComplianceModule):
    ...
    def _define_metadata(self) -> ModuleMetadata:
        return ModuleMetadata(
            ...
            description=("Regulation on a Single Market For Digital Services and amending Directive 2000/31/EC (Digital Services Act)."),
    ...
    async def assess_control(self, control: ControlDefinition, input_data: AssessmentInput) -> ControlResult:
        ...
        if control.control_id in ["DSA-34", "DSA-35", "DSA-37"]:
            if not is_vlop:
