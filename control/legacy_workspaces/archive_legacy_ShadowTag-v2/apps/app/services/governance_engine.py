...
class GovernanceEngine:
  ...
  async def assess(self, request: GovernanceAssessmentRequest) -> dict[str, Any]:
    ...
    requires_human_review = (
      risk_level in [RiskLevel.HIGH, RiskLevel.UNACCEPTABLE]
      or compliance_score < 0.8
      or (request.user_age and request.user_age < 13)
    )
