...
class ShadowTagAttestation:
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "notary_timestamp": self.notary_timestamp.isoformat() if self.notary_timestamp else None,
...
class ShadowTagClient:
    ...
    async def _enhance_attestation(
        ...
        if level >= AttestationLevel.L4_ANCHORED and self.config.enable_blockchain:
            ...
            attestation.blockchain_tx_id = f"0x{self._compute_content_hash(attestation.to_dict())[:64]}"
