...
class PNKLNOrchestrator:
    ...
    async def process_query(self, query: str, enable_review_rotation: bool = False) -> OrchestrationResult:
        """
        ...
        tier_confidences = [t.tier_classification.confidence for t in threads if t.tier_classification is not None]
