...
class UsageTracker:
    ...
    def get_usage(self, platform_id: str) -> UsageMetrics:
        ...
        estimated_cost = regular * self.config.price_per_assessment + cached * self.config.price_per_cached
...
class ReportGenerator:
    ...
    def generate_report(self, request: ComplianceReportRequest) -> ComplianceReport:
        ...
        assessments = [a for a in self._assessment_history if request.start_date <= a.timestamp <= request.end_date]
