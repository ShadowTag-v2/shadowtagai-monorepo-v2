...
class EvidenceService:
    ...
    async def attest_dossier(self, dossier: ComplianceDossier, signatory: str, signature: str) -> ComplianceDossier:
        """
    ...
    async def generate_report(self, assessment_result: ComplianceAssessmentResult, report_type: str = "full") -> dict[str, Any]:
        """
            ...
            report["sections"].append(
                {
                    ...
                    "findings": assessment_result.critical_findings,
                }
            )

        # Recommendations
        report["sections"].append({"title": "Recommendations", "items": assessment_result.recommendations})
    ...
    async def generate_module_report(self, module_result: ModuleResult, include_checklist: bool = True) -> dict[str, Any]:
        """
