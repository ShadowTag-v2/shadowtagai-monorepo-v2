    ...
    try:
      ...
      if isinstance(kernel_input.data, JRClassifyInput):
        ...
        raise KernelChainError(
          f"Invalid input type: expected JRClassifyInput, dict, or NSDetectionOutput, got {type(kernel_input.data)}"
        )
...
class FastPathClassifier:
  ...
  @staticmethod
  def classify(
    ns_output: NSDetectionOutput, user_age: UserAgeCategory
  ) -> JRPolicyOutput | None:
    """
