...
class Violation(BaseModel):
    ...
    description: str
    severity: str = Field(..., description="violation severity: minor, moderate, major, critical")
...
class DecisionContext(BaseModel):
    ...
    context_type: str = Field(default="text", description="Type of context: text, json, xml")
    metadata: dict[str, Any] = Field(default_factory=dict)
