...
async def store_interaction(request: StoreInteractionRequest):
    ...
    """
    success = await gptram.store_interaction(session_id=request.session_id, interaction=request.interaction, ttl=request.ttl)
...
async def moderate_content(request: ModerateContentRequest):
    ...
    Example:
        ...
        {
          "content": "Contact john.doe@example.com for details. SSN: 123-45-6789",
          "scrub_pii": true,
          "check_safety": true
        }
