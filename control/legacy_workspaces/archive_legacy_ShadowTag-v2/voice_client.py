...
class VoiceCapture:
    ...
    def __init__(self, transcription_engine: str = "whisper_local", model_size: str = "base", language: str = "en"):
    ...
    def capture_audio(self, timeout: int | None = None, phrase_time_limit: int | None = None) -> str | None:
        """
...
class VoiceUnGPTClient:
    ...
    def __init__(self, voice_capture: VoiceCapture, orchestrator: Any, use_consensus: bool = False, consensus_orchestrator: Any | None = None):
    ...
    def run_single_query(self):
        ...
        if RICH_AVAILABLE and console:
            console.print(Panel.fit("[bold cyan]Voice UnGPT Orchestrator[/bold cyan]\n[yellow]Speak your query now...[/yellow]", border_style="cyan"))
        else:
            print("=" * 60)
                ...
                if transcript:
                    ...
                    if wake_word.lower() in transcript.lower():
                        ...
                        if query:
                            ...
                            self._print("[yellow]⚠️  Wake word detected but no query provided[/yellow]")
...
def main():
    ...
    parser.add_argument("--mode", choices=["single", "continuous"], default="single", help="Voice capture mode")
    parser.add_argument("--engine", choices=["whisper_local", "google"], default="whisper_local", help="Transcription engine")
    parser.add_argument("--model", default="base", help="Whisper model size (tiny/base/small/medium/large)")
    parser.add_argument("--list-mics", action="store_true", help="List available microphones and exit")
    parser.add_argument("--consensus", action="store_true", help="Use multi-LLM consensus mode (requires API keys)")
