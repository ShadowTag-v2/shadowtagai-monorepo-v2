...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("platform", sa.String(20), default="twitter_x", nullable=False),
        sa.Column("author_id", sa.String(36), sa.ForeignKey("ai_thread_authors.id", ondelete="CASCADE"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.String(36), primary_key=True),
        sa.Column("thread_id", sa.String(36), sa.ForeignKey("ai_threads.id", ondelete="CASCADE"), nullable=False),
        sa.Column("post_id", sa.String(36), sa.ForeignKey("ai_thread_posts.id", ondelete="SET NULL"), nullable=True),
    ...
    op.create_index("idx_embedding_content_hash", "ai_thread_embeddings", ["content_hash"])
