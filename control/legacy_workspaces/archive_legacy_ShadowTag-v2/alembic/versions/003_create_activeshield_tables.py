...
def downgrade():
  op.drop_index(
    "ix_activeshield_adverse_events_audit_log_id",
    table_name="activeshield_adverse_events",
  )
  op.drop_index(
    "ix_activeshield_adverse_events_session_id",
    table_name="activeshield_adverse_events",
  ...
  op.drop_index(
    "idx_activeshield_session_created", table_name="activeshield_audit_logs"
  )
  op.drop_index(
    "ix_activeshield_audit_logs_session_id", table_name="activeshield_audit_logs"
  )
  op.drop_index(
    "ix_activeshield_audit_logs_shield_id", table_name="activeshield_audit_logs"
  )
