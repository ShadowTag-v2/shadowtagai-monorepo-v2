...
**Mission**: Deploy AiYouJR-governed agents to Vertex AI Workbench for rust_scriptbots/Bevy integration
...
- [ ] **Risk assessment completed** per AiYouJR framework
...
- [AiYouJR Doctrine](./AIYOUJR_DOCTRINE.md)
