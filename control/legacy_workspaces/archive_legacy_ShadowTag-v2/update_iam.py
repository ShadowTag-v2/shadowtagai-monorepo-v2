...
USER_EMAIL = "user:founder@shadowtagai.com"
SA_EMAIL = "serviceAccount:kafka-worker-sa@shadowtag-omega-v2.iam.gserviceaccount.com"
...
SA_ROLES = ["roles/run.developer", "roles/artifactregistry.reader", "roles/pubsub.publisher", "roles/pubsub.subscriber", "roles/managedkafka.client"]
