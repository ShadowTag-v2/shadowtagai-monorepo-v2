...
**Created**: 2025-11-22
**Integration**: FlyingMonkeys 200-Agent Swarm + Gemini Antigravity Framework
...
The Antigravity Handoff system is the **routing layer** for FlyingMonkeys swarm:
...
2. FlyingMonkeys Orchestrator (200 agents)
...
# FlyingMonkeys orchestrator receives task
...
{
  "decision": "APPROVE",
  "model_used": "gemini-3.1-flash-exp",
  "latency_ms": 87,
  "cost_usd": 0.0021,
  "compressed": true,
...
3. **[30min]** Integrate with FlyingMonkeys orchestrator
