...
mkdir -p libs/arsenal/{shadowtag_core,tegu_vision,gaas_flight,flying_monkeys,safety_net,jetski}
...
echo "👉 Run 'uv run uvicorn apps.flyingmonkeys-server.src.main:app' to start the system."
