...
#   3. AiYou Video (Cost Gates, Roadmap)
...
mkdir -p "$TARGET_DIR/apps/aiyou-video/inference"
...
# ------------------------------------------------------------------------------
# 3. AIYOU VIDEO (Project B)
# ------------------------------------------------------------------------------
cat <<PYTHON > "$TARGET_DIR/apps/aiyou-video/inference/cost_gate.py"
...
# ------------------------------------------------------------------------------
# 13. MONKEYS WHITEBOARD (Gemini Code Assist Trigger)
# ------------------------------------------------------------------------------
# Usage:
...
def main():
    ...
    # 2. Monkeys Whiteboard Voting (MTOE)
