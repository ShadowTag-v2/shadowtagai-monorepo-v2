...
async def demo_complexity_assessment():
    ...
    test_cases = [
        {"name": "Simple Task", "challenge": "Calculate the compound interest on $10,000 at 5% for 3 years.", "expected": "chain_of_thought"},
        {
...
"""
    ...
    perspectives = [
        {"role": "Growth-Focused CEO", "focus": "long-term revenue potential and market opportunity"},
        {"role": "Cautious CFO", "focus": "financial runway, burn rate, and downside risks"},
        {"role": "Pragmatic CTO", "focus": "technical feasibility, team capacity, and execution timeline"},
    ]
...
async def demo_skills_showcase():
    ...
    skills_demos = [
        {"skill": "research", "task": {"topic": "AI monetization strategies for developer tools in 2024"}},
        {"skill": "prompt", "task": {"goal": "create a prompt for generating product requirement documents"}},
        {"skill": "workflow", "task": {"process": "current CI/CD pipeline with 15-step manual deployment"}},
    ]
...
async def demo_session_tracking():
    ...
    challenges = ["Optimize our pricing page conversion rate", "Design a referral program for B2B SaaS", "Create a growth experiment framework"]
...
async def main():
    """Main entry point"""
    parser = argparse.ArgumentParser(description="pinkln Agent Architecture System - Claude Code Demo")
    parser.add_argument(
        "--demo", choices=["complexity", "revenue", "design", "debate", "refine", "skills", "session", "all"], default="all", help="Which demo to run"
    )
