...
**Architecture:** Factory (Antigravity) != Product (Judge6 on Cloud Run).
...
1.  **Hero Section ("The Hook")**:
    ...
    *   **CTA**: "Initialize Judge6_" (Inverts on hover).

2.  **Feature Grid ("The Bento Box")**:
    *   **Component**: Magic UI `BentoGrid`.
    *   **Cell 1 (Large - Left)**: "The Black Box". Icon of a Brain inside a Server Rack. Copy: "Your Data, Your Skull. No shared weights. No API leakage. Judge6 runs in your VPC."
    *   **Cell 2 (Small - Top Right)**: "Antigravity Protocol". Copy: "Persistent Memory. Unlike APIs that forget you every session, Judge6 maintains a permanent vector store."
...
3.  **Social Proof ("The Terminal")**:
    ...
    *   **Text**:
        ```text
        > KERNEL_BOOT: JUDGE6_ANTIGRAVITY
