...
export const spaceArgsSchema = z.object({
  ...
  space_name: z
    ...
    .optional()
    .describe(
      `Space ID (format: "username/space-name"). Required for operation = ${VIEW_PARAMETERS} or invoke.`,
    ),
  parameters: z
    .string()
    .optional()
    .describe("Required for invoke operation: JSON object string of parameters"),
  search_query: z
    .string()
    .optional()
    .describe(
  ...
  limit: z
    .number()
    .optional()
    .describe("For find operation: Maximum number of results to return (default: 10)"),
});
...
export const dynamicSpaceArgsSchema = z.object({
  ...
  parameters: z
    .string()
    .optional()
    .describe('JSON object string of parameters. Only used for "invoke" operation.'),
});
