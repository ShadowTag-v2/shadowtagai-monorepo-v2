...
import { escapeMarkdown, formatDate, formatNumber, NO_TOKEN_INSTRUCTIONS } from "./utilities.js";
...
export const SPACE_INFO_TOOL_CONFIG = {
  ...
  schema: z.object({
    username: z
      .string()
      .optional()
      .describe("Username to get spaces for (defaults to authenticated user)"),
  }),
  annotations: {
...
export const formatSpaceInfoResult = async (
  tool: SpaceInfoTool,
  params: SpaceInfoParams,
): Promise<string> => {
