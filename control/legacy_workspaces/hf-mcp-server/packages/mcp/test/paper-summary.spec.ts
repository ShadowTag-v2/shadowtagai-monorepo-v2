...
describe("extractArxivIdFromInput", () => {
  ...
  it("should reject invalid formats", () => {
    ...
    // Invalid prefixes
    expect(() => extractArxivIdFromInput("arxiv:2502.161")).toThrow(
      'Invalid arXiv ID format after "arxiv:" prefix',
    );
    expect(() => extractArxivIdFromInput("arxiv.abcd.efgh")).toThrow(
      'Invalid arXiv ID format after "arxiv." prefix',
    );
  ...
  it("should reject obvious domain names without path", () => {
    ...
    expect(() => extractArxivIdFromInput("arxiv.org")).toThrow(
      "arXiv URL must be in format: arxiv.org/abs/YYMM.NNNNN",
    );
  });
