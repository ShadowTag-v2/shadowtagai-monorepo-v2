...
describe("extractUserIdFromInput", () => {
  ...
  describe("invalid inputs", () => {
    it("should reject usernames shorter than 3 characters", () => {
      expect(() => extractUserIdFromInput("ab")).toThrow(
        "User ID must be at least 3 characters long",
      );
      expect(() => extractUserIdFromInput("a")).toThrow(
        "User ID must be at least 3 characters long",
      );
      expect(() => extractUserIdFromInput("")).toThrow(
        "User ID must be at least 3 characters long",
      );
    });

    it("should reject URLs with short usernames", () => {
      expect(() => extractUserIdFromInput("hf.co/ab")).toThrow(
        "User ID must be at least 3 characters long",
      );
      expect(() => extractUserIdFromInput("https://hf.co/a")).toThrow(
        "User ID must be at least 3 characters long",
      );
    });
