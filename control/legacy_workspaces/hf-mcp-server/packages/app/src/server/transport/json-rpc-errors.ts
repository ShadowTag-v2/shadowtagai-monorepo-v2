...
export const JsonRpcErrors = {
  ...
  sessionNotFound: (sessionId: string, id: string | number | null = null) =>
    createJsonRpcError(JSON_RPC_ERROR_CODES.SESSION_NOT_FOUND, "Session not found", id, {
      sessionId,
    }),
  ...
  sessionAlreadyExists: (sessionId: string, id: string | number | null = null) =>
    createJsonRpcError(JSON_RPC_ERROR_CODES.SESSION_ALREADY_EXISTS, "Session already exists", id, {
      sessionId,
    }),
