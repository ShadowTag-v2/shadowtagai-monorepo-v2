...
import { type ApiClientConfig, type GradioEndpoint, McpApiClient } from "./utils/mcp-api-client.js";
...
export class Application {
  ...
  constructor(options: ApplicationOptions) {
    ...
    this.serverFactory = createProxyServerFactory(
      this.webServerInstance,
      this.apiClient,
      originalServerFactory,
    );
    ...
    logger.info(
      {
        ...
        mode: this.isDev ? "development with HMR" : "production",
      },
