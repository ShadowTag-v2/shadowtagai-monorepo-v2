    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="w-96 p-4 overflow-y-auto bg-white border-l border-gray-200">
        ...
        <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg text-blue-700 text-sm">
          <strong>Iframe Mode:</strong> Widget loads in isolated context. Check browser console for
          [Shim] logs.
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          ...
          <div className="space-y-2">
            <button
              onClick={() => {
                setToolOutputJson(
                  JSON.stringify({ url: "https://example.com/audio.wav" }, null, 2),
                );
                sendUpdate();
              }}
            ...
            <button
              onClick={() => {
                setToolOutputJson(
                  JSON.stringify({ url: "https://example.com/video.mp4" }, null, 2),
                );
                sendUpdate();
              }}
              className="w-full px-3 py-2 text-sm bg-gray-100 hover:bg-gray-200 rounded text-left"
