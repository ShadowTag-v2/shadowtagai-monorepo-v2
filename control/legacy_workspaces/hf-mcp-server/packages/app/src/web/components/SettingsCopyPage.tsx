        ...
        <defs>
          ...
          >
            ...
            <feBlend
              ...
              result="effect1_dropShadow_640_684"
            ></feBlend>
  ...
  .61l.56.5c.15.14.37.15.53.03l1.72-1.3 3.94 3.59c.06.06.13.1.21.14Zm.41-7.2L5.5 6l3 2.27V3.73Z"
              ...
              <defs>
                ...
                >
                  ...
                  <feBlend
                    in="SourceGraphic"
                    in2="effect1_dropShadow_640_684"
                    result="shape"
                  ></feBlend>
                </filter>
                <filter
      ...
      steps: [
        {
          ...
          content: (
            <span>
              Add to your VS Code{" "}
              <code className="bg-muted px-1 py-0.5 rounded text-xs font-mono">settings.json</code>{" "}
              file:
            </span>
          ),
        },
  ...
  },
  {
    ...
    icon: (
      ...
      >
        ...
        ></path>
        <path
          d="M10.6523 8.6733V3.31818L6 0.640625V5.99574L10.6523 8.6733Z"
          fill="url(#paint1_linear_640_687)"
        ></path>
        <path
      ...
      steps: [
        {
          ...
          content: (
            <span>
              Edit your Cursor{" "}
              <code className="bg-muted px-1 py-0.5 rounded text-xs font-mono">mcp.json</code>{" "}
      ...
      },
      {
        ...
        content: (
          <span>
            ...
            <code className="bg-muted px-1 py-0.5 rounded text-xs font-mono">&lt;HF_TOKEN&gt;</code>{" "}
            with your READ Hugging Face API token.
          </span>
        ),
      },
    ],
      ...
      <div className="bg-gradient-to-b from-primary/5 to-background px-8 pt-12 pb-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-3xl font-bold text-foreground mb-4">
            Welcome to the Hugging Face MCP Server
          </h2>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <span className="text-lg font-medium text-foreground">
                      Setup your Client with this URL:
                    </span>
                  </div>
                    ...
                    {isExpanded && (
                      <div className="px-4 pb-4 space-y-4 border-t border-border mt-3 pt-4">
                        ...
                        {client.manualConfig && (
                          <div>
                            <h5 className="font-semibold text-sm text-foreground mb-2">
                              {client.manualConfig.title}
                            </h5>
                            <div className="space-y-2">
                              {client.manualConfig.steps.map((step, index) =>
                                renderInstructionStep(step, index),
                              )}
                            </div>
                          </div>
                        )}
          ...
          <Card className="mt-8">
            ...
            <CardContent className="space-y-4">
              <p className="text-base text-muted-foreground leading-relaxed">
                ...
                securely connect to external data sources and tools.
              </p>
              <p className="text-base text-muted-foreground leading-relaxed">
                The Hugging Face MCP Server provides seamless access to Hugging Face's vast
                ecosystem of Models, Datasets, Research Papers and state-of-the-art AI tools. This
                server is Open Source, click the link below for details of alternative deployment
                options, to raise issues or suggest a contribution.
              </p>
