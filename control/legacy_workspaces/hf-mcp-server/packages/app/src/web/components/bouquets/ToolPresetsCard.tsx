...
const EXAMPLE_LINKS = [
  ...
  },
  {
    ...
    footer:
      "Separate multiple Spaces with commas. Use “none” to disable Gradio tools while keeping other overrides.",
        ...
        <CardContent className="space-y-8 pt-0">
            ...
            <div className="grid gap-3 md:grid-cols-1">
              {EXAMPLE_LINKS.map((example) => (
                <div key={example.title} className="space-y-1">
                  ...
                  {example.footer && (
                    <p className="text-xs text-muted-foreground mt-1">{example.footer}</p>
                  )}
                </div>
              ))}
            </div>
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mb-3">
              These presets introduce specialist tools or behavior flags. Mix them with your saved
              settings when you need targeted workflows.
            </p>
            <div className="space-y-3">
