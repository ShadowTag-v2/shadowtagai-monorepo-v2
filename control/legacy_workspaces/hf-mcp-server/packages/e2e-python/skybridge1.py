...
# Define the agent
@fast.agent(
  name="skybridge", instruction="You are a helpful AI Agent", servers=["skybridge"]
)
async def main():
  ...
  async with fast.run() as agent:
    ...
    hf_config: SkybridgeServerConfig = (
      await agent.skybridge._aggregator.get_skybridge_config("skybridge")
    )
