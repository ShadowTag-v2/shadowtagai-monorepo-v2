...
import { disableMouseEvents, enableMouseEvents } from "../src/ui/utils/mouse.js";
      ...
      <KeypressProvider>
        <ScrollProvider>
          <Box flexDirection="column" width={size.columns} height={size.rows - 1} padding={1}>
            <Text>
              Press &apos;A&apos; to add an item. Press &apos;E&apos; to edit last item. Press
              &apos;Ctrl+E&apos; to scroll to end. Press &apos;Esc&apos; to exit. Mouse wheel or
