  ...
  describe("getSettingsSchema", () => {
    ...
    it("should have correct nested setting structure", () => {
      ...
      nestedSettings.forEach((setting) => {
        const definition = getSettingsSchema()[setting as keyof Settings] as SettingDefinition;
    ...
    it("should have accessibility nested properties", () => {
      ...
      expect(
        getSettingsSchema().ui?.properties?.accessibility.properties?.disableLoadingPhrases.type,
      ).toBe("boolean");
    });
    ...
    it("should have checkpointing nested properties", () => {
      ...
      expect(getSettingsSchema().general?.properties?.checkpointing.properties?.enabled.type).toBe(
        "boolean",
      );
    });
    ...
    it("should have fileFiltering nested properties", () => {
      expect(
        getSettingsSchema().context.properties.fileFiltering.properties?.respectGitIgnore,
      ).toBeDefined();
      expect(
        getSettingsSchema().context.properties.fileFiltering.properties?.respectGeminiIgnore,
      ).toBeDefined();
      expect(
        getSettingsSchema().context.properties.fileFiltering.properties?.enableRecursiveFileSearch,
      ).toBeDefined();
    });
    ...
    it("should have showInDialog property configured", () => {
      ...
      expect(
        getSettingsSchema().ui.properties.footer.properties.hideContextPercentage.showInDialog,
      ).toBe(true);
      ...
      expect(getSettingsSchema().privacy.properties.usageStatisticsEnabled.showInDialog).toBe(
        false,
      );
      ...
      expect(getSettingsSchema().advanced.properties.autoConfigureMemory.showInDialog).toBe(false);
    });
    ...
    it("should have loadMemoryFromIncludeDirectories setting in schema", () => {
      ...
      expect(getSettingsSchema().context?.properties.loadMemoryFromIncludeDirectories.type).toBe(
        "boolean",
      );
      expect(
        getSettingsSchema().context?.properties.loadMemoryFromIncludeDirectories.category,
      ).toBe("Context");
      expect(getSettingsSchema().context?.properties.loadMemoryFromIncludeDirectories.default).toBe(
        false,
      );
    });
    ...
    it("should have folderTrustFeature setting in schema", () => {
      ...
      expect(getSettingsSchema().security.properties.folderTrust.properties.enabled.type).toBe(
        "boolean",
      );
      expect(getSettingsSchema().security.properties.folderTrust.properties.enabled.category).toBe(
        "Security",
      );
      expect(getSettingsSchema().security.properties.folderTrust.properties.enabled.default).toBe(
        false,
      );
      expect(
        getSettingsSchema().security.properties.folderTrust.properties.enabled.showInDialog,
      ).toBe(true);
    });
    ...
    it("should have debugKeystrokeLogging setting in schema", () => {
      ...
      expect(getSettingsSchema().general.properties.debugKeystrokeLogging.requiresRestart).toBe(
        false,
      );
    ...
    it("should have previewFeatures setting in schema", () => {
      ...
      expect(getSettingsSchema().general.properties.previewFeatures.description).toBe(
        "Enable preview features (e.g., preview models).",
      );
    });

    it("should have isModelAvailabilityServiceEnabled setting in schema", () => {
      const setting = getSettingsSchema().experimental.properties.isModelAvailabilityServiceEnabled;
