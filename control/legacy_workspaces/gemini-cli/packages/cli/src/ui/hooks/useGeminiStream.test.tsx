...
import type { AnyToolInvocation, Config, EditorType, GeminiClient } from "@google/gemini-cli-core";
import {
  ApprovalMode,
  AuthType,
  debugLogger,
...
describe("useGeminiStream", () => {
  ...
  describe("handleApprovalModeChange", () => {
    ...
    it("should handle errors gracefully when auto-approving tool calls", async () => {
      ...
      const mockOnConfirmError = vi.fn().mockRejectedValue(new Error("Approval failed"));
  ...
  describe("handleFinishedEvent", () => {
    ...
    ])("should handle $reason finish reason correctly", async ({
      reason,
