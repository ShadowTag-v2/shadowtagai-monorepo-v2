  ...
  return (
    <Box flexDirection="column" marginTop={1}>
      ...
      <Box
        ...
        width={nameWidth + requestsWidth + inputTokensWidth + outputTokensWidth + usageLimitWidth}
      ></Box>
      ...
      {Object.entries(models).map(([name, modelMetrics]) => {
        ...
        return (
          <Box key={name}>
            ...
            <Box width={requestsWidth} justifyContent="flex-end">
              <Text color={theme.text.primary}>{modelMetrics.api.totalRequests}</Text>
            </Box>
            <Box width={inputTokensWidth} justifyContent="flex-end">
            ...
            <Box width={usageLimitWidth} justifyContent="flex-end">
              {bucket && bucket.remainingFraction != null && bucket.resetTime && (
                <Text color={theme.text.secondary}>
                  {(bucket.remainingFraction * 100).toFixed(1)}% {formatResetTime(bucket.resetTime)}
                </Text>
              )}
            </Box>
          </Box>
...
export const StatsDisplay: React.FC<StatsDisplayProps> = ({ duration, title, quotas }) => {
