...
import type { AuthClient, Credentials, JWTInput } from "google-auth-library";
import { CodeChallengeMethod, Compute, GoogleAuth, OAuth2Client } from "google-auth-library";
...
import { createInkStdio, writeToStderr, writeToStdout } from "../utils/stdio.js";
import {
