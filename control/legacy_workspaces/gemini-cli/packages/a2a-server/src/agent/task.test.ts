...
import { type Config, GeminiEventType, type ToolCallRequestInfo } from "@google/gemini-cli-core";
...
describe("Task", () => {
  ...
  describe("_schedulerToolCallsUpdate", () => {
    ...
    beforeEach(() => {
      ...
      task = new Task("task-id", "context-id", mockConfig as Config, mockEventBus);
