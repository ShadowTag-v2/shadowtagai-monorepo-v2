...
import type { Part as genAiPart, PartUnion } from "@google/genai";
...
export class Task {
  ...
  private constructor(id: string, contextId: string, config: Config, eventBus?: ExecutionEventBus) {
    this.id = id;
  ...
  async *sendCompletedToolsToLlm(
    ...
    yield* this.geminiClient.sendMessageStream(llmParts, aborted, /*prompt_id*/ "");
  }
