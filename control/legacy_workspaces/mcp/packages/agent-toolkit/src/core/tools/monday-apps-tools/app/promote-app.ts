...
import { type PromoteAppResponse, promoteAppSchema } from "./schemas/app-schemas";

export class PromoteAppTool extends BaseMondayAppsTool<
  typeof promoteAppSchema.shape,
  PromoteAppResponse
> {
