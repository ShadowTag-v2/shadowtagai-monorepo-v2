...
import { FormActions, type updateFormToolSchema } from "./schema";
  ...
  describe("Create Tag Action", () => {
    ...
    describe("Validation Errors", () => {
      it("should return error when tag is missing", async () => {
        ...
        expect(result.content[0].text).toBe(
          'Tag is required for the action "createTag" in the update form tool.',
        );
        expect(mocks.getMockRequest()).not.toHaveBeenCalled();
      });
  ...
  describe("Delete Tag Action", () => {
    ...
    describe("Validation Errors", () => {
      it("should return error when tag is missing", async () => {
        ...
        expect(result.content[0].text).toBe(
          'Tag is required for the action "deleteTag" in the update form tool.',
        );
        expect(mocks.getMockRequest()).not.toHaveBeenCalled();
      });
      ...
      it("should return error when tag id is missing", async () => {
        ...
        expect(result.content[0].text).toBe(
          'Tag id is required for the action "deleteTag" in the update form tool.',
        );
        expect(mocks.getMockRequest()).not.toHaveBeenCalled();
      });
    });
  ...
  describe("Update Tag Action", () => {
    describe("Success Cases", () => {
      it("should update a tag successfully", async () => {
        ...
        expect(result.content[0].text).toBe(
          "Tag with id: tag_123 successfully updated to value: updated_value.",
        );
        expect(mocks.getMockRequest()).toHaveBeenCalledTimes(1);
      ...
      it("should update a tag with different value", async () => {
        ...
        expect(result.content[0].text).toBe(
          "Tag with id: tag_456 successfully updated to value: summer_2024.",
        );
    ...
    describe("Validation Errors", () => {
      it("should return error when tag is missing", async () => {
        ...
        expect(result.content[0].text).toBe(
          'Tag is required for the action "updateTag" in the update form tool.',
        );
        expect(mocks.getMockRequest()).not.toHaveBeenCalled();
      });
  ...
  describe("Unknown Action", () => {
    it("should return error for unknown action", async () => {
      ...
      expect(result.content[0].text).toContain(
        "Failed to execute tool update_form: Invalid arguments",
      );
      expect(mocks.getMockRequest()).not.toHaveBeenCalled();
    });
  });
