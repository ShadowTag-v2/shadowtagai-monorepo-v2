...
export const createAppFeatureSchema = z.object({
  appId: z
    .number()
    .describe("The unique identifier of the app to add the feature to. Get from get_all_apps"),
  appVersionId: z
    .number()
    .describe(
  ...
  data: z
    ...
    .optional()
    .describe(
      "Feature-specific configuration data as a JSON object. The structure depends on the feature type",
    ),
});
