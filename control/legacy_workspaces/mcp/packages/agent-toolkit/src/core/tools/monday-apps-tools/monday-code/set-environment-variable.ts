...
import { type EnvVarResponse, setEnvVarSchema } from "./schemas/code-schemas";

export class SetEnvironmentVariableTool extends BaseMondayAppsTool<
  typeof setEnvVarSchema.shape,
  EnvVarResponse
> {
