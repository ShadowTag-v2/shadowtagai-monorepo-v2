import {
  type AggregateBoardInsightsQuery,
  type AggregateBoardInsightsQueryVariables,
  GetBoardInfoQuery,
...
import {
  BoardInsightsAggregationFunction,
  DEFAULT_LIMIT,
  MAX_LIMIT,
} from "./board-insights.consts";
...
export const boardInsightsToolSchema = {
  ...
  limit: z
    .number()
    .describe("The limit of the results")
    .max(MAX_LIMIT)
    .optional()
