...
export const createDashboardToolSchema = {
  ...
  kind: z
    .nativeEnum(DashboardKind)
    .default(DashboardKind.Public)
    .describe("Visibility level: PUBLIC or PRIVATE"),
  board_folder_id: z
    .string()
    .optional()
    .describe(
...
export class CreateDashboardTool extends BaseMondayApiTool<
  typeof createDashboardToolSchema,
  never
> {
