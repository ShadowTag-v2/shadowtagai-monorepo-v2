...
const backgroundSchema = z.object({
  type: z
    ...
    .describe(GraphQLDescriptions.formSettings.properties.backgroundType)
    .optional(),
  value: z
    .string()
    .describe(GraphQLDescriptions.formSettings.properties.backgroundValue)
    .optional(),
});
...
const layoutSchema = z.object({
  format: z
    .nativeEnum(Format)
    .describe(GraphQLDescriptions.formSettings.properties.format)
    .optional(),
  alignment: z
    .nativeEnum(Alignment)
    .describe(GraphQLDescriptions.formSettings.properties.alignment)
    .optional(),
  direction: z
    .nativeEnum(Direction)
    .describe(GraphQLDescriptions.formSettings.properties.direction)
    .optional(),
});

const logoSchema = z.object({
  position: z
    .nativeEnum(LogoPosition)
    .describe(GraphQLDescriptions.formSettings.properties.logoPosition)
    .optional(),
  size: z
    .nativeEnum(LogoSize)
    .describe(GraphQLDescriptions.formSettings.properties.logoSize)
    .optional(),
});
...
const submitButtonSchema = z.object({
  text: z
    .string()
    .describe(GraphQLDescriptions.formSettings.properties.submitButtonText)
    .optional(),
});
...
const textSchema = z.object({
  ...
  size: z
    .nativeEnum(FontSize)
    .describe(GraphQLDescriptions.formSettings.properties.fontSize)
    .optional(),
});
...
const redirectAfterSubmissionSchema = z.object({
  enabled: z
    .boolean()
    .describe(GraphQLDescriptions.formSettings.properties.redirectAfterSubmissionEnabled)
    .optional(),
  redirectUrl: z
    .string()
    .describe(GraphQLDescriptions.formSettings.properties.redirectUrl)
    .optional(),
});

const afterSubmissionViewSchema = z.object({
  allowEditSubmission: z
    .boolean()
    .describe(GraphQLDescriptions.formSettings.properties.allowEditSubmission)
    .optional(),
  allowResubmit: z
    .boolean()
    .describe(GraphQLDescriptions.formSettings.properties.allowResubmit)
    .optional(),
  allowViewSubmission: z
    .boolean()
    .describe(GraphQLDescriptions.formSettings.properties.allowViewSubmission)
    .optional(),
  description: z
    .string()
    .describe(GraphQLDescriptions.formSettings.properties.postSubmissionDescription)
    .optional(),
  ...
  showSuccessImage: z
    .boolean()
    .describe(GraphQLDescriptions.formSettings.properties.showSuccessImage)
    .optional(),
  title: z
    .string()
    .describe(GraphQLDescriptions.formSettings.properties.postSubmissionTitle)
    .optional(),
});
...
const closeDateSchema = z.object({
  enabled: z
    .boolean()
    .describe(GraphQLDescriptions.formSettings.properties.closeDateEnabled)
    .optional(),
...
const draftSubmissionSchema = z.object({
  enabled: z
    .boolean()
    .describe(GraphQLDescriptions.formSettings.properties.draftSubmissionEnabled)
    .optional(),
});
...
const mondaySchema = z.object({
  itemGroupId: z
    .string()
    .describe(GraphQLDescriptions.formSettings.properties.itemGroupId)
    .optional(),
  includeNameQuestion: z
    .boolean()
    .describe(GraphQLDescriptions.formSettings.properties.includeNameQuestion)
    .optional(),
...
const passwordSchema = z.object({
  enabled: z
    .boolean()
    .describe(GraphQLDescriptions.formSettings.properties.passwordEnabled)
    .optional(),
});
...
const preSubmissionViewSchema = z.object({
  enabled: z
    .boolean()
    .describe(GraphQLDescriptions.formSettings.properties.preSubmissionEnabled)
    .optional(),
  title: z
    .string()
    .describe(GraphQLDescriptions.formSettings.properties.preSubmissionTitle)
    .optional(),
  description: z
    .string()
    .describe(GraphQLDescriptions.formSettings.properties.preSubmissionDescription)
    .optional(),
  startButton: startButtonSchema
    .describe(GraphQLDescriptions.formSettings.properties.startButton)
    .optional(),
});
...
const requireLoginSchema = z.object({
  enabled: z
    .boolean()
    .describe(GraphQLDescriptions.formSettings.properties.requireLoginEnabled)
    .optional(),
  redirectToLogin: z
    .boolean()
    .describe(GraphQLDescriptions.formSettings.properties.redirectToLogin)
    .optional(),
});
...
const responseLimitSchema = z.object({
  enabled: z
    .boolean()
    .describe(GraphQLDescriptions.formSettings.properties.responseLimitEnabled)
    .optional(),
  limit: z
    .number()
    .describe(GraphQLDescriptions.formSettings.properties.responseLimitValue)
    .optional(),
});

const appearanceSchema = z.object({
  background: backgroundSchema
    .describe(GraphQLDescriptions.formSettings.properties.background)
    .optional(),
  hideBranding: z
    .boolean()
    .describe(GraphQLDescriptions.formSettings.properties.hideBranding)
    .optional(),
  ...
  primaryColor: z
    .string()
    .describe(GraphQLDescriptions.formSettings.properties.primaryColor)
    .optional(),
  showProgressBar: z
    .boolean()
    .describe(GraphQLDescriptions.formSettings.properties.showProgressBar)
    .optional(),
  submitButton: submitButtonSchema
    .describe(GraphQLDescriptions.formSettings.properties.submitButton)
    .optional(),
...
const accessibilitySchema = z.object({
  ...
  logoAltText: z
    .string()
    .describe(GraphQLDescriptions.formSettings.properties.logoAltText)
    .optional(),
});
...
const featuresSchema = z.object({
  ...
  closeDate: closeDateSchema
    .describe(GraphQLDescriptions.formSettings.properties.closeDate)
    .optional(),
  ...
  password: passwordSchema
    .describe(GraphQLDescriptions.formSettings.properties.password)
    .optional(),
  preSubmissionView: preSubmissionViewSchema
    .describe(GraphQLDescriptions.formSettings.properties.preSubmissionView)
    .optional(),
  reCaptchaChallenge: z
    .boolean()
    .describe(GraphQLDescriptions.formSettings.properties.reCaptchaChallenge)
    .optional(),
  requireLogin: requireLoginSchema
    .describe(GraphQLDescriptions.formSettings.properties.requireLogin)
    .optional(),
  responseLimit: responseLimitSchema
    .describe(GraphQLDescriptions.formSettings.properties.responseLimit)
    .optional(),
});
...
const formSchema = z.object({
  ...
  accessibility: accessibilitySchema
    .describe(GraphQLDescriptions.form.inputs.form.accessibility)
    .optional(),
  ...
  questions: z
    .array(dehydratedQuestionSchema)
    .describe(GraphQLDescriptions.form.inputs.questions)
    .optional(),
});
...
export const updateFormToolSchema = {
  ...
  formPassword: z
    .string()
    .describe(GraphQLDescriptions.formSettings.operations.setFormPassword)
    .optional(),
