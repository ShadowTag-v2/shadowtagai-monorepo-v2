import type { FetchCustomActivityQuery } from "src/monday-graphql/generated/graphql/graphql";
...
export class FetchCustomActivityTool extends BaseMondayApiTool<
  typeof fetchCustomActivityToolSchema
> {
