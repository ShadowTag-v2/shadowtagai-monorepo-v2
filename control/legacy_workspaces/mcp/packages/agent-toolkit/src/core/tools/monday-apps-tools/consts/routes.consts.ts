...
export const API_ENDPOINTS = {
  ...
  APP_FEATURES: {
    ...
    CREATE: (appId: number, appVersionId: number) =>
      `${APPS_URL}/${appId}/app-versions/${appVersionId}/app-features`,
  },
  ...
  CODE: {
    ...
    GET_DEPLOYMENT_SIGNED_URL: (appVersionId: number) =>
      `${CODE_URL}/${appVersionId}/deployments/signed-url`,
