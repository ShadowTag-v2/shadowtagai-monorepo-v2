...
export const updateFolderToolSchema = {
  ...
  fontWeight: z
    .nativeEnum(FolderFontWeight)
    .optional()
    .describe("The new font weight of the folder"),
  customIcon: z
    .nativeEnum(FolderCustomIcon)
    .optional()
    .describe("The new custom icon of the folder"),
  ...
  accountProductId: z
    .string()
    .optional()
    .describe("The account product ID associated with the folder"),
  ...
  position_is_after: z
    .boolean()
    .optional()
    .describe("Whether to position the folder after the object"),
};
...
export class UpdateFolderTool extends BaseMondayApiTool<UpdateFolderToolInput> {
  ...
  protected async executeInternal(
    input: ToolInputType<UpdateFolderToolInput>,
    ...
    const res = await this.mondayApi.request<{ update_folder: { id: string } }>(
      updateFolder,
      variables,
    );
