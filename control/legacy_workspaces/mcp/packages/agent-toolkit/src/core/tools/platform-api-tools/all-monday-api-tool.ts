...
} from "./base-monday-api-tool";

export const allMondayApiToolSchema = {
  query: z
    .string()
    .describe("Custom GraphQL query/mutation. you need to provide the full query / mutation"),
...
export class AllMondayApiTool extends BaseMondayApiTool<typeof allMondayApiToolSchema> {
  ...
  protected async executeInternal(
    input: ToolInputType<typeof allMondayApiToolSchema>,
