...
export type MondayDevTaskColumnId =
  (typeof MONDAY_DEV_TASK_COLUMN_IDS)[keyof typeof MONDAY_DEV_TASK_COLUMN_IDS];
...
export type { CheckboxValue, DateValue, DocValue, TimelineValue };
