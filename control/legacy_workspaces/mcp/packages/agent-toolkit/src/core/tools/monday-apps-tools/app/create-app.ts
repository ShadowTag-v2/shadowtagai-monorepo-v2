...
import { type CreateAppResponse, createPlainAppSchema } from "./schemas/app-schemas";

export class CreateAppTool extends BaseMondayAppsTool<
  typeof createPlainAppSchema.shape,
  CreateAppResponse
> {
