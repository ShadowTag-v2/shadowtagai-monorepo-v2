export const GraphQLDescriptions = {
  ...
  form: {
    ...
    properties: {
      ...
      token:
        "The unique token used to access and identify the form. Used in public URLs and API calls.",
  ...
  question: {
    ...
    properties: {
      ...
      position:
        "Integer specifying the display order of the question within the form (zero-based).",
      description:
