...
import { SearchTool, type searchSchema } from "./search-tool";
import { GlobalSearchType, ObjectPrefixes, type SearchResult } from "./search-tool.types";
  ...
  describe("Board Search Handler", () => {
    describe("Success Cases", () => {
      ...
      it("should search boards with searchTerm but NOT filter when less than 100 items", async () => {
        ...
        expect(parsedResult.disclaimer).toBe(
