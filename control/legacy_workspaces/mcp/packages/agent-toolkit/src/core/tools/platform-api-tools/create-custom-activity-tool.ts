import { z } from "zod";
import {
  type CreateCustomActivityMutation,
  type CreateCustomActivityMutationVariables,
  CustomActivityColor,
  CustomActivityIcon,
...
export class CreateCustomActivityTool extends BaseMondayApiTool<
  typeof createCustomActivityToolSchema
> {
  ...
  protected async executeInternal(
    ...
    const res = await this.mondayApi.request<CreateCustomActivityMutation>(
