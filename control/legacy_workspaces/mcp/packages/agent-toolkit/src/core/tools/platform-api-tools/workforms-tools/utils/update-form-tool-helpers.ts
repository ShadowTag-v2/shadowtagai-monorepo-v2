...
import type { ToolInputType, ToolOutputType } from "../../../../tool";
import type { updateFormToolSchema } from "../update-form-tool/schema";
import {
  activateForm,
  createFormTag,
  deactivateForm,
...
export class UpdateFormToolHelpers {
  ...
  async setFormPassword(
    input: ToolInputType<typeof updateFormToolSchema>,
  ...
  async updateAppearance(
    ...
    const res = await this.mondayApi.request<UpdateFormAppearanceMutation>(
      updateFormAppearance,
      variables,
    );
  ...
  async updateAccessibility(
    ...
    const res = await this.mondayApi.request<UpdateFormAccessibilityMutation>(
      updateFormAccessibility,
      variables,
    );
  ...
  async updateFeatures(
    ...
    const res = await this.mondayApi.request<UpdateFormFeaturesMutation>(
      updateFormFeatures,
      variables,
    );
  ...
  async updateQuestionOrder(
    ...
    const res = await this.mondayApi.request<UpdateFormQuestionOrderMutation>(
      updateFormQuestionOrder,
      variables,
    );
