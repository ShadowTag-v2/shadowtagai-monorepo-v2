...
import { type AppVersionApiDataResponse, getAppVersionSchema } from "./schemas/app-version-schemas";

export class GetAppVersionTool extends BaseMondayAppsTool<
  typeof getAppVersionSchema.shape,
  AppVersionApiDataResponse
> {
