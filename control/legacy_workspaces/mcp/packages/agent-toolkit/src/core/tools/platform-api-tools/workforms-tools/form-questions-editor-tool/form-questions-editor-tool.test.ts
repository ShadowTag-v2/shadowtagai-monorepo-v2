...
import type { formQuestionsEditorToolSchema } from "./schema";
...
describe("FormQuestionsEditorTool", () => {
  ...
  describe("Create Action", () => {
    describe("Success Cases", () => {
      ...
      it("should create a date question with settings", async () => {
        ...
        expect(result.content[0].text).toBe(
          "Form question created successfully. ID: question_date",
        );
      ...
      it("should create a phone question with prefix settings", async () => {
        ...
        expect(result.content[0].text).toBe(
          "Form question created successfully. ID: question_phone",
        );
      ...
      it("should handle questionStringified parameter for Microsoft Copilot", async () => {
        ...
        expect(result.content[0].text).toBe(
          "Form question created successfully. ID: question_stringified",
        );
    ...
    describe("Validation Errors", () => {
      it("should return error when question is missing", async () => {
        ...
        expect(result.content[0].text).toBe(
          "Must provide a full question payload when creating a question.",
        );
      ...
      it("should return error when title is missing from question", async () => {
        ...
        expect(result.content[0].text).toBe(
          "Must provide a title for the question when creating a question.",
        );
        expect(mocks.getMockRequest()).not.toHaveBeenCalled();
      });
      ...
      it("should handle missing formToken via schema validation", async () => {
        ...
        expect(result.content[0].text).toContain(
          "Failed to execute tool form_questions_editor: Invalid arguments",
        );
  ...
  describe("Update Action", () => {
    describe("Success Cases", () => {
      it("should update a question with all fields", async () => {
        ...
        expect(result.content[0].text).toBe(
          "Form question with id question_123 updated successfully.",
        );
        expect(mocks.getMockRequest()).toHaveBeenCalledTimes(1);
      ...
      it("should update a question with partial fields (patch)", async () => {
        ...
        expect(result.content[0].text).toBe(
          "Form question with id question_456 updated successfully.",
        );
      ...
      it("should update question settings only", async () => {
        ...
        expect(result.content[0].text).toBe(
          "Form question with id question_789 updated successfully.",
        );
      ...
      it("should update visibility and required flags", async () => {
        ...
        expect(result.content[0].text).toBe(
          "Form question with id question_visible updated successfully.",
        );
      ...
      it("should handle questionStringified parameter for Microsoft Copilot", async () => {
        ...
        expect(result.content[0].text).toBe(
          "Form question with id question_stringified updated successfully.",
        );
    ...
    describe("Validation Errors", () => {
      ...
      it("should return error when question is missing", async () => {
        ...
        expect(result.content[0].text).toBe(
          "Must provide updated patch props for the question when updating.",
        );
        expect(mocks.getMockRequest()).not.toHaveBeenCalled();
      });
    });
  ...
  describe("Delete Action", () => {
    describe("Success Cases", () => {
      it("should delete a question successfully", async () => {
        ...
        expect(result.content[0].text).toBe(
          "Form question with id question_to_delete deleted successfully.",
        );
        expect(mocks.getMockRequest()).toHaveBeenCalledTimes(1);
      ...
      it("should delete a question with different questionId", async () => {
        ...
        expect(result.content[0].text).toBe(
          "Form question with id another_question_id deleted successfully.",
        );
  ...
  describe("Different Question Types", () => {
    ...
    it("should create a location question with autofill", async () => {
      ...
      expect(result.content[0].text).toBe(
        "Form question created successfully. ID: question_location",
      );
    ...
    it("should create a long text question", async () => {
      ...
      expect(result.content[0].text).toBe(
        "Form question created successfully. ID: question_longtext",
      );
    ...
    it("should create a number question", async () => {
      ...
      expect(result.content[0].text).toBe(
        "Form question created successfully. ID: question_number",
      );
