...
export const createTimelineItemToolSchema = {
  ...
  summary: z
    .string()
    .optional()
    .describe("The summary of the new timeline item (max 255 characters)"),
  content: z.string().optional().describe("The content of the new timeline item"),
  timestamp: z
    .string()
    .describe(
      "The creation time of the new timeline item in ISO8601 format (e.g., 2024-06-06T18:00:30Z)",
    ),
  start_timestamp: z
    .string()
    .optional()
    .describe("The start time of the timeline item in ISO8601 format"),
  end_timestamp: z
    .string()
    .optional()
    .describe("The end time of the timeline item in ISO8601 format"),
...
export class CreateTimelineItemTool extends BaseMondayApiTool<typeof createTimelineItemToolSchema> {
  ...
  protected async executeInternal(
    ...
    const res = await this.mondayApi.request<CreateTimelineItemMutation>(
      createTimelineItem,
      variables,
    );
