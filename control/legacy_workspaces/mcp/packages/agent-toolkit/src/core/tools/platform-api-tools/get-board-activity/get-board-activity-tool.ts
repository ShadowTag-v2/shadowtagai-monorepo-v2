...
export const getBoardActivityToolSchema = {
  ...
  toDate: z
    .string()
    .optional()
    .describe("End date for activity range (ISO8601DateTime format). Defaults to now"),
};

export class GetBoardActivityTool extends BaseMondayApiTool<
  typeof getBoardActivityToolSchema | undefined
> {
  ...
  protected async executeInternal(
    ...
    const res = await this.mondayApi.request<GetBoardAllActivityQuery>(
      getBoardAllActivity,
      variables,
    );
