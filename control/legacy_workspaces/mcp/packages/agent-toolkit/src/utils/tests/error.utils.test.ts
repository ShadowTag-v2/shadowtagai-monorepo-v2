...
describe("rethrowWithContext", () => {
  describe("GraphQL errors", () => {
    it("should extract and format single GraphQL error", () => {
      ...
      expect(() => rethrowWithContext(error, "create item")).toThrow(
        "Failed to create item: Item not found",
      );
    });
    ...
    it("should handle empty errors array", () => {
      ...
      expect(() => rethrowWithContext(error, "delete column")).toThrow(
        "Failed to delete column: Unknown error",
      );
    });
    ...
    it("should handle GraphQL error response with undefined errors", () => {
      ...
      expect(() => rethrowWithContext(error, "create group")).toThrow(
        "Failed to create group: Unknown error",
      );
    });
  });
  ...
  describe("Standard Error instances", () => {
    it("should handle Error instance", () => {
      ...
      expect(() => rethrowWithContext(error, "fetch data")).toThrow(
  ...
  describe("Non-standard error types", () => {
    it("should handle string error", () => {
      ...
      expect(() => rethrowWithContext(error, "parse data")).toThrow(
        "Failed to parse data: Unknown error",
      );
    });
    ...
    it("should handle number error", () => {
      ...
      expect(() => rethrowWithContext(error, "find resource")).toThrow(
        "Failed to find resource: Unknown error",
      );
    });
    ...
    it("should handle null error", () => {
      ...
      expect(() => rethrowWithContext(error, "execute query")).toThrow(
        "Failed to execute query: Unknown error",
      );
    });
    ...
    it("should handle undefined error", () => {
      ...
      expect(() => rethrowWithContext(error, "run script")).toThrow(
        "Failed to run script: Unknown error",
      );
    });
    ...
    it("should handle plain object error", () => {
      ...
      expect(() => rethrowWithContext(error, "load config")).toThrow(
  ...
  describe("Edge cases", () => {
    ...
    it("should prioritize GraphQL errors over Error message", () => {
      ...
      expect(() => rethrowWithContext(error, "mixed error")).toThrow(
        "Failed to mixed error: This should be used",
      );
    });
    ...
    it("should handle errors with circular references", () => {
      ...
      expect(() => rethrowWithContext(error, "circular test")).toThrow(
        "Failed to circular test: Circular error",
      );
    });
  });
