  ...
  describe("Success scenarios - Direct object (unwrapped)", () => {
    ...
    it("should parse and assign complex nested object successfully", () => {
      const input = {
        data: null,
        dataStringified:
          '{"user":{"id":123,"email":"test@example.com"},"tags":["tag1","tag2","tag3"]}',
      };
    ...
    it("should handle record type with unknown values", () => {
      ...
      const input = {
        data: null,
        dataStringified:
          '{"settings":{"color":"blue","fontSize":14,"enabled":true,"nested":{"key":"value"}}}',
      };
  ...
  describe("Success scenarios - Wrapped object (Copilot format)", () => {
    ...
    it("should unwrap complex nested object from Copilot format", () => {
      const input = {
        data: null,
        dataStringified:
          '{"data":{"user":{"id":456,"email":"copilot@example.com"},"tags":["ai","assistant"]}}',
      };
