...
import type { HttpResponse as __HttpResponse } from "@smithy/protocol-http";
import {
...
export const de_ResponseStream = (
  ...
  return context.eventStreamMarshaller.deserialize(output, async (event) => {
    ...
    if (event["validationException"] != null) {
      return {
        validationException: await de_ValidationException_event(
    ...
    if (event["throttlingException"] != null) {
      return {
        throttlingException: await de_ThrottlingException_event(
