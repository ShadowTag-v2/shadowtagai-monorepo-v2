...
import { Page, type PageParams, type PagePromise } from "../../../core/pagination";
...
import type * as BetaAPI from "../beta";
import type * as BetaMessagesAPI from "./messages";
...
export class Batches extends APIResource {
  ...
  async results(
    ...
    return this._client
      ...
      ) as APIPromise<JSONLDecoder<BetaMessageBatchIndividualResponse>>;
  }
}
