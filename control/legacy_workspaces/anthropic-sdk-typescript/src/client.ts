...
import { isAbsoluteURL, safeJSON, validatePositiveInteger } from "./internal/utils/values";
...
export declare namespace Anthropic {
  ...
  export { type PageParams, PageResponse };

  export import TokenPage = Pagination.TokenPage;
  export { type TokenPageParams, TokenPageResponse };
