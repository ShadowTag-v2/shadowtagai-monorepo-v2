...
def get_next_version(persona_name: str) -> str:
  ...
  existing = sorted(
    d.name for d in run_dir.iterdir() if d.is_dir() and d.name.startswith("v")
  )
  if not existing:
    return "v001"
...
def main():
  ...
  print("    Have a Claude agent write the persona narrative")
  ...
  if existing_versions:
    ...
    print("    python evaluation/personas/compare_runs.py \\")
