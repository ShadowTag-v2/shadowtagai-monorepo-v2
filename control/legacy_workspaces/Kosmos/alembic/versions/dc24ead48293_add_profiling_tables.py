...
def upgrade() -> None:
    ...
    op.create_index("idx_execution_profiles_experiment_id", "execution_profiles", ["experiment_id"], unique=False)
    op.create_index("idx_execution_profiles_profile_type", "execution_profiles", ["profile_type"], unique=False)
    op.create_index("idx_execution_profiles_created_at", "execution_profiles", ["created_at"], unique=False)
    op.create_index("idx_execution_profiles_execution_time", "execution_profiles", ["execution_time"], unique=False)
    op.create_index("idx_execution_profiles_memory_peak", "execution_profiles", ["memory_peak_mb"], unique=False)

    # Composite index for common queries
    op.create_index("idx_execution_profiles_type_created", "execution_profiles", ["profile_type", "created_at"], unique=False)
    op.create_index("idx_execution_profiles_exp_created", "execution_profiles", ["experiment_id", "created_at"], unique=False)
    ...
    op.create_index("idx_profiling_bottlenecks_profile_id", "profiling_bottlenecks", ["profile_id"], unique=False)
    op.create_index("idx_profiling_bottlenecks_severity", "profiling_bottlenecks", ["severity"], unique=False)
    op.create_index("idx_profiling_bottlenecks_time_percent", "profiling_bottlenecks", ["time_percent"], unique=False)
    op.create_index("idx_profiling_bottlenecks_function", "profiling_bottlenecks", ["function_name"], unique=False)
