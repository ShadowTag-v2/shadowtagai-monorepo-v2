...
def upgrade() -> None:
  ...
  op.create_index(
    "idx_experiments_hypothesis_id", "experiments", ["hypothesis_id"], unique=False
  )

  op.create_index(
    "idx_experiments_created_at", "experiments", ["created_at"], unique=False
  )
  ...
  op.create_index(
    "idx_hypotheses_novelty_score", "hypotheses", ["novelty_score"], unique=False
  )
  ...
  op.create_index(
    "idx_hypotheses_created_at", "hypotheses", ["created_at"], unique=False
  )
  ...
  op.create_index(
    "idx_papers_relevance_score", "papers", ["relevance_score"], unique=False
  )

  op.create_index(
    "idx_papers_publication_date", "papers", ["publication_date"], unique=False
  )
  ...
  # Single-column indexes
  op.create_index(
    "idx_results_experiment_id", "results", ["experiment_id"], unique=False
  )
  ...
  # Single-column indexes
  op.create_index(
    "idx_research_sessions_status", "research_sessions", ["status"], unique=False
  )

  op.create_index(
    "idx_research_sessions_domain", "research_sessions", ["domain"], unique=False
  )
  ...
  # Composite indexes for common query patterns
  op.create_index(
    "idx_agents_type_status", "agents", ["agent_type", "status"], unique=False
  )
