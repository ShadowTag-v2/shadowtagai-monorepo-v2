...
class Variable(BaseModel):
  ...
  description: str = Field(
    ..., min_length=10, description="Clear description of the variable"
  )
...
class ControlGroup(BaseModel):
  ...
  description: str = Field(
    ..., min_length=5, description="What this control group represents"
  )

  # Variable values for this control group
  variables: dict[str, Any] = Field(
    ..., description="Variable settings for control group"
  )

  # Why this control group is necessary
  rationale: str = Field(
    ..., min_length=10, description="Scientific rationale for this control"
  )
...
class ResourceRequirements(BaseModel):
  ...
  estimated_cost_usd: float | None = Field(
    None, ge=0, description="Total estimated cost"
  )
...
class StatisticalTestSpec(BaseModel):
  ...
  alternative: str = Field(
    default="two-sided", description="Alternative hypothesis type"
  )
...
class ExperimentProtocol(BaseModel):
  ...
  # Protocol details
  description: str = Field(
    ..., min_length=20, description="Comprehensive experiment description"
  )
  objective: str = Field(
  ...
  steps: list[ProtocolStep] = Field(
    ..., min_items=1, description="Ordered protocol steps"
  )
  ...
  rigor_score: float | None = Field(
    None, ge=0.0, le=1.0, description="Scientific rigor score"
  )
...
class ExperimentDesignResponse(BaseModel):
  ...
  def is_feasible(
    self, max_cost: float | None = None, max_duration: float | None = None
  ) -> bool:
...
class ValidationReport(BaseModel):
  ...
  rigor_score: float = Field(
    ..., ge=0.0, le=1.0, description="Overall scientific rigor score"
  )
