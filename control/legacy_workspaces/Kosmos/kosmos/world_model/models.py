...
class Entity:
  ...
  @classmethod
  def from_hypothesis(
    cls, hypothesis: Any, created_by: str = "hypothesis_generator"
  ) -> "Entity":
    """
    ...
    if (
      hasattr(hypothesis, "testability_score")
      and hypothesis.testability_score is not None
    ):
    ...
    if (
      hasattr(hypothesis, "confidence_score")
      and hypothesis.confidence_score is not None
    ):
  ...
  @classmethod
  def from_protocol(
    cls, protocol: Any, created_by: str = "experiment_designer"
  ) -> "Entity":
    """
  ...
  def from_result(cls, result: Any, created_by: str = "executor") -> "Entity":
    ...
    properties = {
      ...
      "protocol_id": getattr(
        result, "protocol_id", getattr(result, "experiment_id", "")
      ),
      "status": status,
    }
    ...
    if (
      hasattr(result, "supports_hypothesis") and result.supports_hypothesis is not None
    ):
