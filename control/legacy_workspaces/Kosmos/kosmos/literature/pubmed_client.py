...
class PubMedClient(BaseLiteratureClient):
  ...
  def __init__(
    ...
    self.logger.info(
      f"Initialized PubMed client (email={Entrez.email}, rate_limit={self.rate_limit} req/s)"
    )
  ...
  def get_paper_citations(
    ...
    try:
      ...
      self._rate_limit_delay()
      try:
        cite_pmids = self._run_with_timeout(
          self._do_elink, pmid, "pubmed_pubmed_citedin"
        )
