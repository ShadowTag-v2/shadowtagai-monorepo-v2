...
class NotificationManager:
  ...
  def __init__(
    ...
    logger.info(
      f"NotificationManager initialized (channel={default_channel.value}, min_level={min_level.value}, rich={self.use_rich})"
    )
  ...
  def notify(
    ...
    notification = Notification(
      message=message, level=level, title=title, details=details
    )
