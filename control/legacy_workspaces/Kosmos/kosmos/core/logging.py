...
class ExperimentLogger:
  ...
  def log_execution_start(self):
    ...
    self.events.append(event)
    self.logger.info(
      "Execution started", extra={"experiment_id": self.experiment_id, **event}
    )
  ...
  def log_result(self, result: dict[str, Any]):
    ...
    self.events.append(event)
    self.logger.info(
      "Result obtained", extra={"experiment_id": self.experiment_id, **event}
    )
  ...
  def log_error(self, error: str):
    ...
    self.events.append(event)
    self.logger.error(
      f"Error: {error}", extra={"experiment_id": self.experiment_id, **event}
    )
