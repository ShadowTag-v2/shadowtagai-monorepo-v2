...
class MaterialsConcept(BaseModel):
  ...
  type: str = Field(
    ..., description="Concept type (structure, property, material, etc.)"
  )
...
class MaterialsOntology:
  ...
  def _initialize_material_properties(self) -> None:
    ...
    thermal_props = [
      ...
      (
        "melting_point",
        "Melting Point",
        "Solid-liquid phase transition temperature (K)",
      ),
      (
        "thermal_expansion",
  ...
  def _initialize_materials_classes(self) -> None:
    ...
    for class_id, name, desc in materials_classes:
      self.add_concept(
        MaterialsConcept(
          id=class_id, name=name, type="material_class", description=desc
        )
      )
    ...
    for semi_id, name, desc in semiconductor_types:
      self.add_concept(
        MaterialsConcept(
          id=semi_id, name=name, type="material_subclass", description=desc
        )
      )
  ...
  def _initialize_processing_methods(self) -> None:
    ...
    for proc_id, name, desc in processing_methods:
      self.add_concept(
        MaterialsConcept(
          id=proc_id, name=name, type="processing_method", description=desc
        )
      )
  ...
  def get_material_properties(
    ...
    if category:
      ...
      # Get all properties
      return [
        concept for concept in self.concepts.values() if concept.type == "property"
      ]
