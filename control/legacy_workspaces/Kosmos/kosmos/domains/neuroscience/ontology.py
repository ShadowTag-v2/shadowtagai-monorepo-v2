...
class NeuroscienceOntology:
  ...
  def _initialize_brain_regions(self) -> None:
    ...
    for region_id, name, desc in cortical_regions:
      self.add_concept(
        BiologicalConcept(
          id=region_id, name=name, type="cortical_region", description=desc
        )
      )
  ...
  def _initialize_cell_types(self) -> None:
    ...
    for neuron_id, name, desc in neuron_types:
      self.add_concept(
        BiologicalConcept(
          id=neuron_id, name=name, type="neuron_subtype", description=desc
        )
      )
  ...
  def _initialize_neurotransmitters(self) -> None:
    ...
    self.add_relation(
      "glutamatergic_neuron", "glutamate", BiologicalRelationType.ENCODES
    )
  ...
  def _initialize_diseases(self) -> None:
    ...
    self.add_relation(
      "alzheimers_disease", "cortex", BiologicalRelationType.ASSOCIATED_WITH
    )
    self.add_relation(
    ...
    for gene_id, name, desc in ad_genes:
      ...
      self.add_relation(
        gene_id, "alzheimers_disease", BiologicalRelationType.ASSOCIATED_WITH
      )
  ...
  def _initialize_processes(self) -> None:
    ...
    self.add_relation(
      "neuroinflammation", "microglia", BiologicalRelationType.ASSOCIATED_WITH
    )
    self.add_relation(
  ...
  def get_brain_regions(self) -> list[BiologicalConcept]:
    ...
    return [
      c for c in self.concepts.values() if c.type in ["brain_region", "cortical_region"]
    ]
