...
class BiologyOntology:
  ...
  def _initialize_metabolic_pathways(self) -> None:
    ...
    self.add_relation(
      "purine_metabolism", "nucleotide_metabolism", BiologicalRelationType.IS_A
    )
    ...
    self.add_relation(
      "purine_salvage", "purine_metabolism", BiologicalRelationType.PART_OF
    )
    ...
    for met_id, name, mtype, desc, pathways in metabolites:
      self.add_concept(
        BiologicalConcept(id=met_id, name=name, type=mtype, description=desc)
      )
  ...
  def _initialize_genetic_concepts(self) -> None:
    ...
    genes = [
      (
        ...
        "Type 2 diabetes susceptibility gene",
      ),
  ...
  def _initialize_disease_concepts(self) -> None:
    ...
    self.add_relation(
      "TCF7L2", "type_2_diabetes", BiologicalRelationType.ASSOCIATED_WITH
    )
    self.add_relation("SSR1", "type_2_diabetes", BiologicalRelationType.ASSOCIATED_WITH)
    self.add_relation(
      "SOD2", "cardiovascular_disease", BiologicalRelationType.ASSOCIATED_WITH
    )
