...
def run_research(
    ...
    domain: str | None = typer.Option(None, "--domain", "-d", help="Research domain (biology, neuroscience, materials, etc.)"),
    ...
    data_path: Path | None = typer.Option(None, "--data-path", "-D", help="Path to CSV dataset for experiments"),
    no_cache: bool = typer.Option(False, "--no-cache", help="Disable caching"),
    interactive: bool = typer.Option(False, "--interactive", help="Use interactive mode"),
    output: Path | None = typer.Option(None, "--output", "-o", help="Save results to file (JSON or Markdown)"),
