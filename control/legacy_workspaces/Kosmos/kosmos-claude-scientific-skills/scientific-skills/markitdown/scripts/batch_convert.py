...
def convert_file(
  md: MarkItDown, input_path: Path, output_dir: Path, verbose: bool = False
) -> bool:
  """
...
Supported file types:
  ...
  parser.add_argument(
    "-r", "--recursive", action="store_true", help="Recursively search subdirectories"
  )
  parser.add_argument(
    "--llm",
    action="store_true",
  ...
  parser.add_argument(
    "--azure", action="store_true", help="Enable Azure Document Intelligence for PDFs"
  )
  parser.add_argument(
    "--azure-endpoint", help="Azure Document Intelligence endpoint URL"
  )
  ...
  azure_endpoint = args.azure_endpoint or os.getenv(
