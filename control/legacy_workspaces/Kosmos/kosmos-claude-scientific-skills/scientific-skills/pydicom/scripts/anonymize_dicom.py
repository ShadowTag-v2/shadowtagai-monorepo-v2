...
Examples:
  ...
  python anonymize_dicom.py input.dcm output.dcm --patient-id ANON001 --patient-name "Anonymous^Patient"
    ...
    parser.add_argument("--patient-id", type=str, default="ANONYMOUS", help="Replacement patient ID (default: ANONYMOUS)")
    parser.add_argument("--patient-name", type=str, default="ANONYMOUS", help="Replacement patient name (default: ANONYMOUS)")
    parser.add_argument("-v", "--verbose", action="store_true", help="Show detailed anonymization information")
