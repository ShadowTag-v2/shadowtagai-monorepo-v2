...
def main():
    ...
    parser.add_argument("--data", type=str, default=None, help="Path to CSV file with molecular data")
    parser.add_argument("--smiles-col", type=str, default="smiles", help="Name of column containing SMILES strings")
    parser.add_argument("--target-col", type=str, default="solubility", help="Name of column containing target values")
    parser.add_argument("--predict", nargs="+", default=None, help="SMILES strings to predict after training")

    args = parser.parse_args()

    # Train model
    try:
        model, test_set, transformers = train_solubility_model(data_path=args.data, smiles_col=args.smiles_col, target_col=args.target_col)
