...
def run(protocol: protocol_api.ProtocolContext):
    ...
    diluent = protocol.define_liquid(name="Diluent", description="Buffer or growth media", display_color="#B0E0E6")

    stock = protocol.define_liquid(name="Stock Solution", description="Concentrated stock", display_color="#FF6347")
