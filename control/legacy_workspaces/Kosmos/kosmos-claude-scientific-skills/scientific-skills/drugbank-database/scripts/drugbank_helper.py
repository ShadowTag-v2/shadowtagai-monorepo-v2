        ...
        if targets_elem is not None:
            for target in targets_elem.findall("db:target", self.NAMESPACE):
                ...
                if actions_elem is not None:
                    target_data["actions"] = [action.text for action in actions_elem.findall("db:action", self.NAMESPACE)]
                ...
                if polypeptide is not None:
                    ...
                    target_data["gene_name"] = self._get_text_safe(polypeptide.find("db:gene-name", self.NAMESPACE))
