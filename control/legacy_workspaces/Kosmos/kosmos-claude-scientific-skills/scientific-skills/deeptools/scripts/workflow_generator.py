...
Examples:
  ...
  python workflow_generator.py --list
    ...
    parser.add_argument("workflow", nargs="?", choices=list(WORKFLOWS.keys()), help="Workflow type to generate")
    parser.add_argument("-o", "--output", default="deeptools_workflow.sh", help="Output script filename (default: deeptools_workflow.sh)")
    parser.add_argument("--list", action="store_true", help="List all available workflows")

    # Common parameters
    parser.add_argument("--threads", type=int, default=8, help="Number of threads (default: 8)")
    parser.add_argument("--genome-size", type=int, default=2913022398, help="Effective genome size (default: 2913022398 for hg38)")
