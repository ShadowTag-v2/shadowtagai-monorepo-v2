...
class FDAQuery:
  ...
  def query_drug_ndc(
    self, ndc: str | None = None, manufacturer: str | None = None
  ) -> dict:
  ...
  def query_animal_events(
    self, species: str | None = None, drug_name: str | None = None
  ) -> dict:
    ...
    search = (
      "+AND+".join(search_parts) if search_parts else "_exists_:unique_aer_id_number"
    )
