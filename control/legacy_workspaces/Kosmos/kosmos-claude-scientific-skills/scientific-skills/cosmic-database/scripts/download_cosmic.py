...
def get_common_file_path(data_type: str, genome_assembly: str = "GRCh38", version: str = "latest") -> str | None:
    """
...
Examples:
  ...
  %(prog)s user@email.com --data-type gene_census --assembly GRCh37
    ...
    parser.add_argument("--assembly", default="GRCh38", choices=["GRCh37", "GRCh38"], help="Genome assembly (default: GRCh38)")
    ...
    success = download_cosmic_file(
        email=args.email, password=args.password, filepath=filepath, output_filename=args.output, genome_assembly=args.assembly
    )
