...
def visualize_pathways(results: dict[str, Any], output_dir: Path) -> None:
  ...
  print_info(
    "Consider using: NetworkX, matplotlib, or specialized tools like Cytoscape"
  )
...
def main():
  ...
  console.print(
    "[bold bright_blue]  Kosmos Example: Metabolic Pathways[/bold bright_blue]"
  )
  ...
  try:
    ...
    console.print(
      f"Found {len(pathway_analysis['enzyme_differences'])} enzyme differences"
    )
    console.print(
