...
class CircuitBuilder:
  ...
  def add_voltage_source(
    self, label: str, value: str, direction: str = "down"
  ) -> "CircuitBuilder":
    """
  ...
  def add_resistor(
    self, label: str, value: str, direction: str = "right"
  ) -> "CircuitBuilder":
    """
    Add a resistor.
  ...
  def add_line(
    self, direction: str = "right", length: float | None = None
  ) -> "CircuitBuilder":
    """
...
Examples:
  ...
  parser.add_argument(
    "-o", "--output", help="Output filename (default: based on example name)"
  )
  parser.add_argument(
