...
class BriefingGenerator:
    ...
    def __init__(
        ...
        self.visualizer = BriefingVisualizer(output_format=visualization_format) if enable_visualizations else None
    ...
    def _generate_executive_summary(
        ...
        if tier1_items:
            ...
            content += "⚠️ **No Tier 1 items** identified. Consider adjusting collection criteria.\n\n"
