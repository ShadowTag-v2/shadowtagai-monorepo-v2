...
export declare function parse<M extends TypesMap>(lang: NapiLang, src: string): SgRoot<M>;
/**
...
export declare function kind<M extends TypesMap>(lang: NapiLang, kindName: NamedKinds<M>): number;
/** Compile a string to ast-grep Pattern. */
export declare function pattern<M extends TypesMap>(lang: NapiLang, pattern: string): NapiConfig<M>;
/**
