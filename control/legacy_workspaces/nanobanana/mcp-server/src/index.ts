        ...
        switch (name) {
          case "generate_image": {
            const imageRequest: ImageGenerationRequest = {
              ...
              noPreview: (args?.noPreview as boolean) || (args?.["no-preview"] as boolean),
            };
            response = await this.imageGenerator.generateTextToImage(imageRequest);
            break;
          }
          ...
          case "generate_icon": {
            ...
            response = await this.imageGenerator.generateTextToImage(iconRequest);
            break;
          }
          ...
          case "generate_pattern": {
            ...
            response = await this.imageGenerator.generateTextToImage(patternRequest);
            break;
          }
          ...
          case "generate_diagram": {
            ...
            response = await this.imageGenerator.generateTextToImage(diagramRequest);
            break;
          }
