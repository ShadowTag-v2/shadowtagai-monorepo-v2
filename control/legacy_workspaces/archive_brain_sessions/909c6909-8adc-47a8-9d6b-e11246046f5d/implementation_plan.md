...
- **Target**: Find instances of `n-autoresearch/Kosmos/BioAgents` and legacy project descriptors.
- **Correction**: Replace `n-autoresearch/Kosmos/BioAgents` with `https://github.com/karpathy/autoresearch` and ensure `shadowtag-omega-v4` is the unified project ID.
