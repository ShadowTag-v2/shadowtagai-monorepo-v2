...
describe("getServerUrl tests", () => {
  it("basics", async () => {
    ...
    expect(urlHelper.getServerUrl(" ").toString()).toBe("https://github.com/");
    expect(urlHelper.getServerUrl("   ").toString()).toBe("https://github.com/");
    expect(urlHelper.getServerUrl("http://contoso.com").toString()).toBe("http://contoso.com/");
    expect(urlHelper.getServerUrl("https://contoso.com").toString()).toBe("https://contoso.com/");
    expect(urlHelper.getServerUrl("https://contoso.com/").toString()).toBe("https://contoso.com/");
...
describe("getServerApiUrl tests", () => {
  it("basics", async () => {
    ...
    expect(urlHelper.getServerApiUrl("https://src.onpremise.fabrikam.com")).toBe(
      "https://src.onpremise.fabrikam.com/api/v3",
    );
  });
});
