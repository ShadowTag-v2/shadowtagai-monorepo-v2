...
describe("git-directory-helper tests", () => {
  ...
  it(removesContentsWhenCleanFails, async () => {
    ...
    await fs.promises.writeFile(path.join(repositoryPath, "my-file"), "");
    const mockTryClean = git.tryClean as jest.Mock<any, any>;
  ...
  it(removesContentsWhenResetFails, async () => {
    ...
    await fs.promises.writeFile(path.join(repositoryPath, "my-file"), "");
    const mockTryReset = git.tryReset as jest.Mock<any, any>;
  ...
  const cleanWhenSubmoduleStatusIsFalse = "cleans when submodule status is false";
  ...
  const doesNotCleanWhenSubmoduleStatusIsTrue = "does not clean when submodule status is true";
  ...
  it(removesLockFiles, async () => {
    ...
    clean = false;
    await fs.promises.writeFile(path.join(repositoryPath, ".git", "index.lock"), "");
    await fs.promises.writeFile(path.join(repositoryPath, ".git", "shallow.lock"), "");
    await fs.promises.writeFile(path.join(repositoryPath, "my-file"), "");
