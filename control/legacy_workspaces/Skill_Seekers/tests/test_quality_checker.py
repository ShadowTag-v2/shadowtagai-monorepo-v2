...
"""
      ...
      self.assertTrue(
        any("references" in issue.message.lower() for issue in report.warnings)
      )
...
"""
      ...
      self.assertTrue(report.has_errors)
      self.assertTrue(
        any("frontmatter" in issue.message.lower() for issue in report.errors)
      )
...
"""
      ...
      self.assertTrue(report.has_warnings)
      self.assertTrue(
        any("language" in issue.message.lower() for issue in report.warnings)
      )
