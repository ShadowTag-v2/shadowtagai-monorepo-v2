...
class TestPackageStructure(unittest.TestCase):
  ...
  def test_cli_package_exists(self):
    ...
    self.assertTrue(
      init_file.exists(), "src/skill_seekers/cli/__init__.py should exist"
    )
  ...
  def test_mcp_package_exists(self):
    ...
    self.assertTrue(
      init_file.exists(), "src/skill_seekers/mcp/__init__.py should exist"
    )

  def test_main_cli_file_exists(self):
    """Test that main.py unified CLI exists"""
    main_file = (
      Path(__file__).parent.parent / "src" / "skill_seekers" / "cli" / "main.py"
    )
