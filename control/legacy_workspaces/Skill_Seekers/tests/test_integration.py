...
"""
    ...
    def test_full_llms_txt_workflow(self):
        ...
        with patch("cli.llms_txt_downloader.requests.get") as mock_get:
            ...
            self.assertTrue(any(len(page.get("code_samples", [])) > 0 for page in scraper.pages), "At least one page should have code samples")
    ...
    def test_multi_variant_download(self):
        ...
        with patch("cli.llms_txt_detector.requests.head") as mock_head, patch("cli.llms_txt_downloader.requests.get") as mock_get:
