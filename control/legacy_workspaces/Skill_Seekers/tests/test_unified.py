...
def test_detect_missing_in_docs():
        ...
        "pages": [
            {
                ...
                "apis": [{"name": "documented_func", "parameters": [{"name": "x", "type": "int"}], "return_type": "str"}],
            }
        ]
    }
    ...
    github_data = {
        "code_analysis": {
            "analyzed_files": [
                {"functions": [{"name": "undocumented_func", "parameters": [{"name": "y", "type_hint": "float"}], "return_type": "bool"}]}
            ]
        }
    }
...
def test_detect_signature_mismatch():
    ...
    docs_data = {
        "pages": [{"url": "https://example.com/api", "apis": [{"name": "func", "parameters": [{"name": "x", "type": "int"}], "return_type": "str"}]}]
    }
            ...
            "analyzed_files": [
                {
                    "functions": [
                        {
                            "name": "func",
                            "parameters": [{"name": "x", "type_hint": "int"}, {"name": "y", "type_hint": "bool", "default": "False"}],
                            "return_type": "str",
                        }
                    ]
                }
...
def test_rule_based_merge_code_only():
    ...
    github_data = {
        "code_analysis": {
            "analyzed_files": [{"functions": [{"name": "code_only_api", "parameters": [{"name": "y", "type_hint": "float"}], "return_type": "bool"}]}]
        }
    }
...
def test_rule_based_merge_matched():
    ...
    docs_data = {
        "pages": [
            {"url": "https://example.com/api", "apis": [{"name": "matched_api", "parameters": [{"name": "x", "type": "int"}], "return_type": "str"}]}
        ]
    }

    github_data = {
        "code_analysis": {
            "analyzed_files": [{"functions": [{"name": "matched_api", "parameters": [{"name": "x", "type_hint": "int"}], "return_type": "str"}]}]
        }
    }
...
def test_merge_summary():
    ...
    docs_data = {
        "pages": [
            {
                "url": "https://example.com/api",
                "apis": [{"name": "api1", "parameters": [], "return_type": "str"}, {"name": "api2", "parameters": [], "return_type": "int"}],
            }
        ]
    }
...
def test_skill_builder_with_conflicts():
    ...
    config = {
        "name": "test_skill",
        "description": "Test",
        "sources": [{"type": "documentation", "base_url": "https://example.com"}, {"type": "github", "repo": "user/repo"}],
    }
    ...
    conflicts = [
        Conflict(
            type="missing_in_code", severity="high", api_name="test_api", docs_info={"name": "test_api"}, code_info=None, difference="Test difference"
        )
    ]
...
def test_config_file_validation():
    ...
    with tempfile.NamedTemporaryFile(mode="w", suffix=".json", delete=False) as f:
        config = {"name": "test", "description": "Test", "sources": [{"type": "documentation", "base_url": "https://example.com"}]}
        json.dump(config, f)
        config_path = f.name
