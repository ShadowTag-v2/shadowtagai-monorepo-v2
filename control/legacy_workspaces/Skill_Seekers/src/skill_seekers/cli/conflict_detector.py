...
class ConflictDetector:
    ...
    def _extract_docs_apis(self) -> dict[str, dict[str, Any]]:
        ...
        if isinstance(pages, dict):
            ...
            for url, page_data in pages.items():
                ...
                if any(keyword in title.lower() or keyword in url.lower() for keyword in ["api", "reference", "class", "function", "method"]):
            ...
            for page in pages:
                ...
                for api in page_apis:
                    ...
                    if api_name:
                        apis[api_name] = {"parameters": api.get("parameters", []), "return_type": api.get("return_type", "Any"), "source_url": url}
    ...
    def _parse_doc_content_for_apis(self, content: str, source_url: str) -> dict[str, dict]:
        ...
        for pattern in patterns:
            for match in re.finditer(pattern, content):
                ...
                apis[name] = {"name": name, "parameters": params, "return_type": return_type, "source": source_url, "raw_signature": match.group(0)}
    ...
    def generate_summary(self, conflicts: list[Conflict]) -> dict[str, Any]:
        ...
        """
        summary = {"total": len(conflicts), "by_type": {}, "by_severity": {}, "apis_affected": len(set(c.api_name for c in conflicts))}
