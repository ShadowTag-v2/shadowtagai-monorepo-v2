...
For more information: https://github.com/yusufkaraaslan/Skill_Seekers
  ...
  scrape_parser.add_argument(
    "--enhance", action="store_true", help="AI enhancement (API)"
  )
  scrape_parser.add_argument(
  ...
  unified_parser.add_argument(
    "--config", required=True, help="Unified config JSON file"
  )
  unified_parser.add_argument(
    "--merge-mode", help="Merge mode (rule-based, claude-enhanced)"
  )
  ...
  package_parser.add_argument(
    "--no-open", action="store_true", help="Don't open output folder"
  )
  package_parser.add_argument(
    "--upload", action="store_true", help="Auto-upload after packaging"
  )
  ...
  estimate_parser.add_argument(
    "--max-discovery", type=int, help="Max pages to discover"
  )
