...
const useLoadFeatureServices = () => {
  ...
  const data =
    registryQuery.data === undefined ? undefined : registryQuery.data.objects.featureServices;
...
const filterFn = (data: feast.core.IFeatureService[], filterInput: filterInputInterface) => {
  ...
  return (
    <EuiPageTemplate panelled>
      <EuiPageTemplate.Header
        ...
        rightSideItems={[
          <ExportButton data={filterResult ?? []} fileName="feature_services" formats={["json"]} />,
        ]}
      />
      <EuiPageTemplate.Section>
        ...
        {isSuccess && filterResult && (
          <React.Fragment>
            ...
            <EuiSpacer size="m" />
            <FeatureServiceListingTable featureServices={filterResult} tagKeysSet={tagKeysSet} />
          </React.Fragment>
        )}
      </EuiPageTemplate.Section>
    </EuiPageTemplate>
