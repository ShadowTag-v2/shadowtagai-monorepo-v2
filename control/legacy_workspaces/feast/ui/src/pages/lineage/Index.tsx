        ...
        <EuiPageTemplate.Section>
          ...
          <EuiEmptyPrompt
            ...
            body={
              <>
                <p>
                  Lineage visualization requires a specific project context to show the
                  relationships between Feature Views, Entities, and Data Sources.
                </p>
                <p>
                  <strong>Please select a specific project from the dropdown above</strong> to view
                  its lineage graph.
                </p>
              </>
            }
