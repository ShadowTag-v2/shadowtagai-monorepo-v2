...
const useLoadFeatureView = (featureViewName: string) => {
  ...
  const data =
    registryQuery.data === undefined ? undefined : registryQuery.data.mergedFVMap[featureViewName];
...
export { useLoadOnDemandFeatureView, useLoadRegularFeatureView, useLoadStreamFeatureView };
