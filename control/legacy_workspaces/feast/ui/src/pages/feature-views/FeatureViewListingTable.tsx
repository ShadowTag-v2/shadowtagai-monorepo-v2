import { EuiBadge, EuiBasicTable, type EuiTableFieldDataColumnType } from "@elastic/eui";
import type { EuiTableComputedColumnType } from "@elastic/eui/src/components/basic_table";
...
const FeatureViewListingTable = ({ tagKeysSet, featureViews }: FeatureViewListingTableProps) => {
    ...
    columns.push({
      ...
      render: (item: genericFVType) => {
        ...
        if (item.type === "regular") {
          const value = item?.object?.spec!.tags ? item.object.spec.tags[key] : undefined;
  ...
  return <EuiBasicTable columns={columns} items={featureViews} rowProps={getRowProps} />;
};
