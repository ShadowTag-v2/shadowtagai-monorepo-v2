          ...
          <EuiDescriptionList>
            {(batchSource.dataSourceClassType || batchSource.type) && (
              <React.Fragment>
                ...
                {batchSource.dataSourceClassType ? (
                  ...
                  <EuiDescriptionListDescription>{batchSource.type}</EuiDescriptionListDescription>
                ) : (
                  ""
                )}
              </React.Fragment>
            ...
            {batchSource.owner && (
              <React.Fragment>
                ...
                <EuiDescriptionListDescription>{batchSource.owner}</EuiDescriptionListDescription>
              </React.Fragment>
            )}
            ...
            {batchSource.meta?.latestEventTimestamp && (
              <React.Fragment>
                ...
                <EuiDescriptionListDescription>
                  {toDate(batchSource.meta.latestEventTimestamp).toLocaleDateString("en-CA")}
                </EuiDescriptionListDescription>
              </React.Fragment>
            )}
            {batchSource.meta?.earliestEventTimestamp && (
              <React.Fragment>
                <EuiDescriptionListTitle>Earliest Event</EuiDescriptionListTitle>
                <EuiDescriptionListDescription>
                  {toDate(batchSource.meta?.earliestEventTimestamp).toLocaleDateString("en-CA")}
                </EuiDescriptionListDescription>
              </React.Fragment>
            )}
          </EuiDescriptionList>
