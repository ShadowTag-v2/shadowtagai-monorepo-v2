import { EuiInputPopover, EuiSelectable, EuiTitle } from "@elastic/eui";

import type React from "react";
import { useEffect, useRef, useState } from "react";
import type { SuggestionModes, TagSuggestionInstance } from "../hooks/useSearchInputWithTags";
...
const getCursorPosition = (inputNode: React.MutableRefObject<HTMLInputElement | null>) => {
  return inputNode.current?.selectionStart || undefined;
};

const computePlaceholderText = (tagSuggestions: TagSuggestionInstance[] | undefined) => {
...
const generateResultsCount = (
  ...
  const operatingWord = currentTagIsEmpty || currentTagHasNoValue ? "possible" : "matching";
...
const TagSearch = ({
  ...
  const resultsCount = generateResultsCount(currentTag, suggestionMode, tagSuggestions);
