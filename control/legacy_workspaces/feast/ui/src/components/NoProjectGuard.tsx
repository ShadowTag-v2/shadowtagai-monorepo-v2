...
import { ProjectListContext, useLoadProjectsList } from "../contexts/ProjectListContext";
      ...
      <EuiEmptyPrompt
        ...
        body={
          projectListContext?.isCustom ? (
            <p>
              Unable to fetch project list. Check the promise provided to Feast UI in{" "}
              <code>projectListPromise</code>.
            </p>
          ) : (
            <p>
              Unable to find
              <code>projects-list.json</code>. Check that you have a project list file defined.
            </p>
          )
        }
      />
        ...
        body={
          <React.Fragment>
            <p>
              ...
              <code>projects-list.json</code>. Check that you have the correct project id.
            </p>
