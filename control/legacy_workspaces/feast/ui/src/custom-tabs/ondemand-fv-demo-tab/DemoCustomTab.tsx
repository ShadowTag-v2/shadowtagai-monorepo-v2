...
const DemoCustomTab = ({ id, feastObjectQuery }: OnDemandFeatureViewCustomTabProps) => {
  ...
  if (isError) {
    ...
    return (
      <EuiEmptyPrompt
        ...
        body={
          <p>
            There was an error loading the Dashboard application. Contact your administrator for
            help.
          </p>
        }
      />
