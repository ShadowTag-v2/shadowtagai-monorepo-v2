...
class DockerClient:
  ...
  def create_bot_container(
    self, user_id: str, meeting_id: str, meeting_url: str | None = None
  ) -> dict[str, Any]:
    ...
    try:
      ...
      logger.info(
        f"Created container {container_name} with label vexa.user_id={user_id}"
      )
  ...
  def delete_bot_container(
    self, user_id: str, meeting_id: str | None = None
  ) -> dict[str, Any]:
