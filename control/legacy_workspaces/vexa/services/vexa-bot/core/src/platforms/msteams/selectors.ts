...
export const teamsSpeakingIndicators: string[] = ['[data-tid="voice-level-stream-outline"]'];
...
export const teamsContinueButtonSelectors: string[] = ['button:has-text("Continue")'];
...
export const teamsMeetingContainerSelectors: string[] = ['[role="main"]', "body"];

// Teams voice level detection selectors
export const teamsVoiceLevelSelectors: string[] = ['[data-tid="voice-level-stream-outline"]'];
