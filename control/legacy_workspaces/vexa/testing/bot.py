...
class Bot:
    ...
    def __init__(self, user_client: VexaClient, meeting_url: str, bot_id: str | None = None):
        """
    ...
    def update_config(self, language: str | None = None, task: str | None = None) -> dict[str, Any]:
        """
