...
from google.adk.evaluation._retry_options_utils import (
  add_default_retry_options_if_not_present,
)
...
class SimplePromptOptimizer(
  ...
  async def _run_final_validation(
    ...
    logger.info(
      "Optimization loop finished. Running final validation on the best agent found."
    )
  ...
  async def optimize(
    ...
    return OptimizerResult(
      optimized_agents=[
        BaseAgentWithScores(optimized_agent=best_agent, overall_score=final_score)
      ]
    )
