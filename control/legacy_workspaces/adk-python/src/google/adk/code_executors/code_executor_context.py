...
class CodeExecutorContext:
    ...
    def add_input_files(
        ...
        for input_file in input_files:
            self._session_state[_INPUT_FILE_KEY].append(dataclasses.asdict(input_file))
    ...
    def increment_error_count(self, invocation_id: str):
        ...
        self._session_state[_ERROR_COUNT_KEY][invocation_id] = self.get_error_count(invocation_id) + 1
