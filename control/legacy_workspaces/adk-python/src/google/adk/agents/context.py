...
class Context(ReadonlyContext):
  ...
  def request_credential(self, auth_config: AuthConfig) -> None:
    ...
    self._event_actions.requested_auth_configs[self.function_call_id] = AuthHandler(
      auth_config
  ...
  def request_confirmation(
    ...
    *,
    ...
    if not self.function_call_id:
      raise ValueError(
        "request_confirmation requires function_call_id. This method can only be used in a tool context."
      )
