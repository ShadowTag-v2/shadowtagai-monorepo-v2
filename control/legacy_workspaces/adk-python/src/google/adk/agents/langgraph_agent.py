...
class LangGraphAgent(BaseAgent):
    ...
    async def _run_async_impl(
        ...
        messages = [SystemMessage(content=self.instruction)] if self.instruction and not graph_messages else []
    ...
    def _get_messages(self, events: list[Event]) -> list[HumanMessage | AIMessage]:
    ...
    def _get_conversation_with_agent(self, events: list[Event]) -> list[HumanMessage | AIMessage]:
        """Extracts messages from given list of events.
