...
def _setup_instrumentation_lib_if_installed():
  ...
  try:
    ...
    logger.warning(
      "Unable to import GoogleGenAiSdkInstrumentor - some telemetry will be disabled. Make sure to install google-adk[otel-gcp]"
    )
...
class AdkWebServer:
  ...
  def get_fast_api_app(
    ...
    @deprecated(
      "Please use create_session instead. This will be removed in future releases."
    )
    @app.post(
      "/apps/{app_name}/users/{user_id}/sessions/{session_id}",
      response_model_exclude_none=True,
    ...
    @deprecated(
      "Please use create_eval_set instead. This will be removed in future releases."
    )
    @app.post(
    ...
    @deprecated(
      "Please use list_eval_sets instead. This will be removed in future releases."
    )
    @app.get(
    ...
    @deprecated(
      "Please use get_eval_result instead. This will be removed in future releases."
    )
    @app.get(
    ...
    @deprecated(
      "Please use list_eval_results instead. This will be removed in future releases."
    )
    @app.get(
    ...
    async def run_agent_live(
      ...
      async def forward_events():
        ...
        async with Aclosing(
          runner.run_live(session=session, live_request_queue=live_request_queue)
        ) as agen:
          async for event in agen:
