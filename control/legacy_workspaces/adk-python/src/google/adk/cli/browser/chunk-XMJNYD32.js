...
var O = (l, i) => {
  ...
  R = (() => {
    ...
    return (i, e, t) => (e && l(i.prototype, e), t && l(i, t), i);
  })(),
  y = (() => {
    function l(i, e) {
      var t = [],
    ...
    return (i, e) => {
      ...
      if (Symbol.iterator in Object(i)) return l(i, e);
...
String.prototype.padStart =
  String.prototype.padStart ||
  function (l, i) {
    for (var e = this; e.length < l; ) e = i + e;
    return e;
  };
var N = {
  cb: "0f8ff",
...
function A(l) {
  var i = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 1,
    e = i > 0 ? l.toFixed(i).replace(/0+$/, "").replace(/\.$/, "") : l.toString();
  return e || "0";
}
var z = (() => {
    function l(i, e, t, r) {
      ...
      function o(a) {
        if (a.startsWith("hsl")) {
          ...
          var m = a.match(/([-\d.e]+)/g).map(Number),
            ...
            S = h[2],
            k = h[3];
          k === void 0 && (k = 1), (n.rgba = [v, g, S, k]);
        } else
          a.startsWith("#") ? (n.rgba = l.hexToRgb(a)) : (n.rgba = l.nameToRgb(a) || l.hexToRgb(a));
      }
      if (i !== void 0)
        if (Array.isArray(i)) this.rgba = i;
        else if (t === void 0) {
          var c = i && "" + i;
          c && o(c.toLowerCase());
        } else this.rgba = [i, e, t, r === void 0 ? 1 : r];
    }
    return (
      R(
        l,
        [
          ...
          },
          {
            ...
            value: function (e) {
              var t = [360, 100, 100, 1],
                r = ["", "%", "%", ""],
                n = e ? this.hsla : this.hsla.slice(0, 3),
                o = n.map((c, a) => A(c * t[a], a === 3 ? 3 : 1) + r[a]);
          ...
          },
          {
            ...
            get: function () {
              var e = this.rgba,
                t = e.map((r, n) => (n < 3 ? r.toString(16) : Math.round(r * 255).toString(16)));
              return "#" + t.map((r) => r.padStart(2, "0")).join("");
            },
            set: function (e) {
      ...
      R(
        ...
        [
            ...
            value: function (e, t, r) {
              this._events = this._events.filter((n) => {
                ...
                return (
                  ...
                  t && t !== n.type && (o = !1),
                  r && r !== n.handler && (o = !1),
                  o && l._doRemove(n.target, n.type, n.handler),
                  !o
                );
              });
            },
          },
          {
            key: "destroy",
            value: function () {
              this._events.forEach((e) => l._doRemove(e.target, e.type, e.handler)),
                (this._events = []);
            },
          },
        ],
...
function T(l, i, e) {
  ...
  l.add(i, "mousedown", (a) => {
    ...
    l.add(i, "touchstart", (a) => {
      c(a, !0);
    }),
    l.add(window, "mousemove", o),
    l.add(i, "touchmove", c),
    l.add(window, "mouseup", (a) => {
      t = !1;
    }),
    l.add(i, "touchend", (a) => {
      t = !1;
    }),
    l.add(i, "touchcancel", (a) => {
      t = !1;
    });
}
    ...
    R(l, [
      {
        ...
        value: function (e) {
          ...
          var r = this.settings;
          function n(s, p, u) {
            for (var f in s) (u && u.indexOf(f) >= 0) || (p[f] = s[f]);
          }
          ...
          if (c && r.popup && !this._popupInited) {
            var a = (p) => this.openHandler(p);
            this._events.add(c, "click", a),
              D(this._events, c, [" ", "Spacebar", "Enter"], a),
              (this._popupInited = !0);
      ...
      },
      {
        ...
        value: function (e) {
          if (this.show()) {
            ...
            setTimeout(() => t.focus(), 100), this.onOpen && this.onOpen(this.colour);
          }
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          ...
          return (
            (this.domElement = n),
            (this._domH = _(".picker_hue", n)),
            (this._domSL = _(".picker_sl", n)),
            (this._domA = _(".picker_alpha", n)),
            (this._domEdit = _(".picker_editor input", n)),
            (this._domSample = _(".picker_sample", n)),
            (this._domOkay = _(".picker_done button", n)),
            (this._domCancel = _(".picker_cancel button", n)),
            n.classList.add("layout_" + this.settings.layout),
            this.settings.alpha || n.classList.add("no_alpha"),
            this.settings.editor || n.classList.add("no_editor"),
            this.settings.cancelButton || n.classList.add("no_cancel"),
            this._ifPopup(() => n.classList.add("popup")),
            this._setPosition(),
      ...
      },
      {
        ...
        value: function () {
          ...
          o(r, "click", (s) => s.preventDefault()),
            T(n, this._domH, (s, p) => t._setHSLA(s)),
            T(n, this._domSL, (s, p) => t._setHSLA(null, s, 1 - p)),
            this.settings.alpha && T(n, this._domA, (s, p) => t._setHSLA(null, null, null, 1 - p));
          var c = this._domEdit;
          o(c, "input", function (s) {
            ...
            this._ifPopup(() => {
              var s = (f) => this.closeHandler(f);
              o(window, x, s), o(window, H, s), D(n, r, ["Esc", "Escape"], s);
              var p = (f) => {
                this.__containedEvent = f.timeStamp;
              };
              o(r, x, p), o(r, H, p), o(this._domCancel, "click", s);
            });
          var a = (p) => {
            this._ifPopup(() => this.closeHandler(p)), this.onDone && this.onDone(this.colour);
          };
          o(this._domOkay, "click", a), D(n, r, ["Enter"], a);
        },
      },
      {
        key: "_setPosition",
        value: function () {
          ...
          e !== t.parentNode && e.appendChild(t),
            this._ifPopup((r) => {
              ...
              ["popup_top", "popup_bottom", "popup_left", "popup_right"].forEach((o) => {
      ...
      },
      {
        ...
        value: function (e) {
          ...
          var t = this.colour,
            ...
            s = this._domSL,
            p = this._domA,
            u = _(".picker_selector", a),
            f = _(".picker_selector", s),
          ...
          if (((this._domA.style.background = g + ", " + B), !e.fromEditor)) {
            var S = this.settings.editorFormat,
