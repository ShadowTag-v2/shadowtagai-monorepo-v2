...
function ht() {
  ...
  class e {
    ...
    static __load_patch(s, i, r = !1) {
      if (Object.hasOwn(S, s)) {
        const E = ce[te("forceDuplicateZoneCheck")] === !0;
    ...
    getZoneWith(s) {
      let i = this;
      for (; i; ) {
        if (Object.hasOwn(i._properties, s)) return i;
        i = i._parent;
      }
      return null;
    }
    ...
    wrap(s, i) {
      ...
      const r = this._zoneDelegate.intercept(this, s, i),
        E = this;
      return function () {
...
function Ye(t, n, a) {
  ...
  if (Object.hasOwn(t, c) && t[c]) return;
...
function rt(t, n, a) {
  if (n) for (let e = 0; e < n.length; e++) Ye(t, "on" + n[e], a);
    ...
    const e = [];
    for (const c in t) c.slice(0, 2) == "on" && e.push(c);
...
function ye(t) {
  ...
  for (e in n) e !== "prototype" && Object.hasOwn(n, e) && (Y[t][e] = n[e]);
}
function ue(t, n, a) {
  let e = t;
  for (; e && !Object.hasOwn(e, n); ) e = Ae(e);
  !e && t[n] && (e = t);
  let c = j(n),
    f = null;
  if (e && (!(f = e[c]) || !Object.hasOwn(e, c))) {
    f = e[c] = e[n];
    const g = e && pe(e, n);
    if (et(g)) {
      const T = a(f, c, n);
...
function yt() {
  ...
  $e = !0;
  try {
    const t = be.navigator.userAgent;
...
function vt(t, n, a, e) {
  const c = (e && e.add) || je,
    ...
    L = (p, d, A) => {
      ...
      if (F && typeof F == "object" && F.once) {
        const k = p.originalDelegate ? p.originalDelegate : p.callback;
  ...
  function J(p, d) {
    ...
    let k = p;
    for (; k && !Object.hasOwn(k, c); ) k = Ae(k);
    ...
    const s = (o) => {
      ...
      r = (o) => R.call(S.target, S.eventName, o.invoke, S.options),
      E = (o) => W.call(S.target, S.eventName, o.invoke, S.options),
      x = (o) => b.call(o.target, o.eventName, o.invoke, o.options),
      ee = A ? s : r,
      M = A ? i : x,
      he = (o, u) => {
        const v = typeof u;
    ...
    const l = (o, u, v, C, m = !1, O = !1) =>
      function () {
        ...
        qe && (Pe = qe[Z]),
          ...
          (S.eventName = Z),
          (S.isExisting = Ue);
        const me = A ? pt : void 0;
        me && (me.taskData = S), Ee && (S.options.signal = void 0);
        const re = ft.scheduleEventTask(Pe, G, me, v, C);
        if (Ee) {
          S.options.signal = Ee;
          const ie = () => re.zone.cancelTask(re);
...
function bt(t, n) {
  ...
  a &&
    a.prototype &&
    n.patchMethod(a.prototype, "stopImmediatePropagation", (e) => (c, f) => {
      (c[it] = !0), e && e.apply(c, f);
    });
}
function Pt(t, n) {
  n.patchMethod(t, "queueMicrotask", (a) => (e, c) => {
    ...
    if (Je(P[0])) {
      ...
      P[0] = function () {
        try {
          ...
          const { handle: A, handleId: V, isPeriodic: X, isRefreshable: F } = L;
          !X && !F && (V ? delete g[V] : A && (A[Re] = null));
        }
      };
      const z = xe(n, P[0], L, T, y);
      if (!z) return z;
      const { handleId: $, handle: J, isRefreshable: q, isPeriodic: p } = z.data;
      if ($) g[$] = z;
      else if (J && ((J[Re] = z), q && !p)) {
        const d = J.refresh;
        J.refresh = function () {
          const { zone: A, state: V } = z;
          return (
            V === "notScheduled"
...
function St(t) {
  t.__load_patch("legacy", (n) => {
    ...
    t.__load_patch("blocking", (n, a) => {
      ...
      for (let c = 0; c < e.length; c++) {
        const f = e[c];
        ue(n, f, (g, T, y) => (w, _) => a.current.run(g, n, _, y));
      }
    }),
    ...
    t.__load_patch("XHR", (n, a) => {
      ...
      function w(_) {
        ...
        let z = L[Ne],
          $ = L[Ze];
        if (!z) {
          const R = _.XMLHttpRequestEventTarget;
          if (R) {
            const b = R.prototype;
            (z = b[Ne]), ($ = b[Ze]);
          }
        ...
        const V = ue(
            L,
            "open",
            () => (R, b) => ((R[c] = b[2] == !1), (R[T] = b[1]), V.apply(R, b)),
          ),
          ...
          U = ue(L, "send", () => (R, b) => {
            ...
            {
              const D = { target: R, url: R[T], isPeriodic: !1, args: b, aborted: !1 },
                K = xe(X, d, D, p, A);
      ...
      function e(c) {
        return (f) => {
          at(n, c).forEach((T) => {
            ...
            if (y) {
              const w = new y(c, { promise: f.promise, reason: f.rejection });
              T.invoke(w);
            }
          });
        };
...
function Ot(t) {
  t.__load_patch("ZoneAwarePromise", (n, a, e) => {
    ...
    const H = T("unhandledPromiseRejectionHandler");
    function z(h) {
      e.onUnhandledError(h);
      try {
        const l = a[H];
    ...
    function I(h, l, o) {
      ...
      if (h[p] === k) {
        ...
        if (l !== S && o instanceof M && Object.hasOwn(o, p) && Object.hasOwn(o, d) && o[p] !== k)
          i(o), I(h, o[p], o[d]);
          ...
          if (
            ...
            const m = a.currentTask && a.currentTask.data && a.currentTask.data[L];
...
` + o.stack
        ...
        () => {
          try {
            const O = h[d],
              N = !!o && A === o[A];
            N && ((o[V] = O), (o[X] = C));
            const Z = l.run(m, void 0, N && m !== q && m !== J ? [] : [O]);
            I(o, !0, Z);
          } catch (O) {
            I(o, !1, O);
          }
    ...
    const E = "function ZoneAwarePromise() { [native code] }",
      x = () => {},
      ee = n.AggregateError;
    class M {
      static toString() {
      ...
      static resolve(l) {
        return l instanceof M ? l : I(new M(null), U, l);
      }
      static reject(l) {
        return I(new M(null), S, l);
      }
      ...
      static any(l) {
        ...
        let o = [],
          u = 0;
        try {
          for (const m of l) u++, o.push(M.resolve(m));
        } catch {
          return Promise.reject(new ee([], "All promises were rejected"));
        }
      ...
      static race(l) {
        ...
        for (let O of l) $(O) || (O = M.resolve(O)), O.then(C, m);
        return v;
      }
      static all(l) {
      ...
      static allSettled(l) {
        return (M && M.prototype instanceof M ? M : M).allWithCallback(l, {
      ...
      constructor(l) {
        if (!(this instanceof M)) throw new Error("Must be an instanceof Promise.");
        (this[p] = k), (this[d] = []);
        try {
          const u = D();
          l && l(u(b(this, U)), u(b(this, S)));
        } catch (u) {
          I(this, !1, u);
        }
      }
    ...
    const he = (n[_] = n.Promise);
    n.Promise = M;
    const _e = T("thenPatched");
    function Q(h) {
      const l = h.prototype,
        o = c(l, "then");
    ...
    y &&
      ...
      c.forEach((_) => {
        const P = `${a}.${e}::` + _,
          L = y.prototype;
        try {
          if (Object.hasOwn(L, _)) {
            const H = t.ObjectGetOwnPropertyDescriptor(L, _);
            H && H.value
