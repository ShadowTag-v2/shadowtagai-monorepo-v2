...
def _create_symlink(symlink_path: str, target_path: str) -> bool:
    ...
    try:
        if os.path.islink(symlink_path):
            ...
            warnings.warn(f"Cannot create symlink for latest log file: file exists at {symlink_path}")
            return False
...
def _try_create_latest_log_symlink(log_dir: str, log_file_prefix: str, log_filepath: str) -> None:
