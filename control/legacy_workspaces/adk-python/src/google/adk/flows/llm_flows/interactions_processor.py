...
class InteractionsRequestProcessor(BaseLlmRequestProcessor):
    ...
    async def run_async(self, invocation_context: InvocationContext, llm_request: LlmRequest) -> AsyncGenerator[Event, None]:
        ...
        previous_interaction_id = self._find_previous_interaction_id(invocation_context)
    ...
    def _find_previous_interaction_id(self, invocation_context: InvocationContext) -> str | None:
    ...
    def _is_event_in_branch(self, current_branch: str | None, event: Event) -> bool:
