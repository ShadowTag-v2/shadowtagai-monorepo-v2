...
class InMemoryCredentialService(BaseCredentialService):
    ...
    async def save_credential(
        ...
        credential_bucket = self._get_bucket_for_current_context(callback_context)
        credential_bucket[auth_config.credential_key] = auth_config.exchanged_auth_credential

    def _get_bucket_for_current_context(self, callback_context: CallbackContext) -> str:
