    ...
    **apihub_resource_name** is the resource name from API Hub. It must include
    ...
    def __init__(
        ...
        *,
        ...
        apihub_client: APIHubClient | None = None,
    ...
    @override
    async def get_tools(self, readonly_context: ReadonlyContext | None = None) -> list[RestApiTool]:
    ...
    def _prepare_toolset(self) -> None:
        ...
        self.name = self.name or _to_snake_case(spec_dict.get("info", {}).get("title", "unnamed"))
        self.description = self.description or spec_dict.get("info", {}).get("description", "")
