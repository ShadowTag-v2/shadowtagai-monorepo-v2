    ...
    def __init__(
        ...
        if service_account_json:
            ...
            try:
                ...
                raise ValueError(
                    f"'service_account_json' or 'auth_token' are both missing, and error occurred while trying to use default credentials: {e}"
                ) from e

        if not credentials:
            raise ValueError("Must provide either 'service_account_json' or 'auth_token', not both or neither.")
