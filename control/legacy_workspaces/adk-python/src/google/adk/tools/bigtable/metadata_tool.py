...
def list_instances(project_id: str, credentials: Credentials) -> dict:
    ...
    """
    try:
        bt_client = client.get_bigtable_admin_client(project=project_id, credentials=credentials)
...
def get_instance_info(project_id: str, instance_id: str, credentials: Credentials) -> dict:
...
def list_tables(project_id: str, instance_id: str, credentials: Credentials) -> dict:
...
def get_table_info(project_id: str, instance_id: str, table_id: str, credentials: Credentials) -> dict:
