...
class MCPSessionManager:
    ...
    def __init__(
        ...
        if isinstance(connection_params, StdioServerParameters):
            ...
            # other client.
            logger.warning("StdioServerParameters is not recommended. Please use StdioConnectionParams.")
    ...
    def _generate_session_key(self, merged_headers: dict[str, str] | None = None) -> str:
    ...
    def _merge_headers(self, additional_headers: dict[str, str] | None = None) -> dict[str, str] | None:
        ...
        """
        if isinstance(self._connection_params, StdioConnectionParams) or isinstance(self._connection_params, StdioServerParameters):
    ...
    def _create_client(self, merged_headers: dict[str, str] | None = None):
        ...
        if isinstance(self._connection_params, StdioConnectionParams):
            ...
            raise ValueError(
                f"Unable to initialize connection. Connection should be StdioServerParameters or SseServerParams, but got {self._connection_params}"
            )
        return client
            ...
            try:
                ...
                if exit_stack:
                    try:
                        ...
                        logger.warning("Error during session creation cleanup: %s", exit_stack_error)
