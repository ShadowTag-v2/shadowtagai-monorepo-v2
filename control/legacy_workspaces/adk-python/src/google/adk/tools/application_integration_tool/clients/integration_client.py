  ...
  def get_openapi_spec_for_connection(self, tool_name="", tool_instructions=""):
    ...
    for entity, operations in self.entity_operations.items():
      ...
      for operation in operations:
        ...
        if operation_lower == "create":
          ...
          connector_spec["components"]["schemas"][f"create_{entity_lower}_Request"] = (
          ...
          connector_spec["components"]["schemas"][f"update_{entity_lower}_Request"] = (
          ...
          connector_spec["components"]["schemas"][f"delete_{entity_lower}_Request"] = (
          ...
          connector_spec["components"]["schemas"][f"list_{entity_lower}_Request"] = (
          ...
          connector_spec["components"]["schemas"][f"get_{entity_lower}_Request"] = (
    ...
    for action in self.actions:
      ...
      if action == "ExecuteCustomQuery":
        connector_spec["components"]["schemas"][f"{action_display_name}_Request"] = (
      ...
      connector_spec["components"]["schemas"][f"{action_display_name}_Response"] = (
