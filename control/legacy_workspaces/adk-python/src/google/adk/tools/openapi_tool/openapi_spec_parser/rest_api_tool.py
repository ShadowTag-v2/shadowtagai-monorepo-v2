...
class RestApiTool(BaseTool):
    ...
    * Attaches auth credentials to API call.
    ...
    def __init__(
        ...
        auth_scheme: AuthScheme | str | None = None,
        auth_credential: AuthCredential | str | None = None,
    ...
    def configure_auth_scheme(self, auth_scheme: AuthScheme | dict[str, Any]):
    ...
    def configure_auth_credential(self, auth_credential: AuthCredential | str | None = None):
    ...
    async def call(self, *, args: dict[str, Any], tool_context: ToolContext | None) -> dict[str, Any]:
        ...
        tool_auth_handler = ToolAuthHandler.from_tool_context(tool_context, self.auth_scheme, self.auth_credential)
        ...
        for api_param in api_params:
            if api_param.py_name not in api_args:
                if api_param.required and isinstance(api_param.param_schema, Schema) and api_param.param_schema.default is not None:
