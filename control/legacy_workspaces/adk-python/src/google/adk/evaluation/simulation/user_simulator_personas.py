...
class UserBehavior(BaseModel):
  ...
  behavior_instructions: list[str] = Field(
    description=(
      "Instructions the user should follow. These will be included in the instructions for the user simulator."
    )
  )
...
class UserPersona(BaseModel):
  ...
  id: str = Field(
    description=(
      "Human readable identifier for the UserPersona. Persona registries will refer to this identifier."
    )
  )

  description: str = Field(
    description=(
      "Description for the UserPersona. This will be included in the instructions for the user simulator and its verifier."
    )
  )

  behaviors: Sequence[UserBehavior] = Field(
    description=(
      "Sequence of UserBehaviors for the persona. These will be included in the instructions for the user simulator and its verifier."
    )
  )
