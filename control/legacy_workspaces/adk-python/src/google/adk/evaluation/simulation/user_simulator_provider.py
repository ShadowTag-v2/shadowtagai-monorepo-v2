  ...
  def provide(self, eval_case: EvalCase) -> UserSimulator:
    ...
    if eval_case.conversation is None:
      if eval_case.conversation_scenario is None:
        raise ValueError(
          "Neither static invocations nor conversation scenario provided in EvalCase. Provide exactly one."
        )
      ...
      if eval_case.conversation_scenario is not None:
        raise ValueError(
          "Both static invocations and conversation scenario provided in EvalCase. Provide exactly one."
        )
