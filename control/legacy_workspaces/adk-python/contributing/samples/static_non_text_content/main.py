...
def process_arguments():
  ...
  parser.add_argument(
    ...
    type=str,
    help=(
      "Single prompt to send to the agent. If not provided, runs default test prompts."
    ),
  )
...
async def run_default_test_prompts(runner):
  ...
  print(
    "Use 'adk run contributing/samples/static_non_text_content' for interactive mode.\n"
  )
