...
def process_arguments():
    ...
    parser = argparse.ArgumentParser(
        description=("A demo script that tests static instructions with non-text content."),
        epilog=(
    ...
    parser.add_argument(
        "--prompt",
        type=str,
        help=("Single prompt to send to the agent. If not provided, runs default test prompts."),
    )
...
async def run_default_test_prompts(runner):
    ...
    print("Running test prompts to demonstrate inline_data and file_data features...")
    print(f"API Variant: {api_variant}")
    print("Use 'adk run contributing/samples/static_non_text_content' for interactive mode.\n")
    ...
    if api_variant == GoogleLLMVariant.VERTEX_AI:
        ...
        test_prompts.append("What does the contributing guide document say about best practices?")
