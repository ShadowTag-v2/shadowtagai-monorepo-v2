...
def create_static_instruction_with_file_upload():
  ...
  parts = [
    types.Part.from_text(
      text=(
        "You are an AI assistant that analyzes images and documents. You have access to the following reference materials:"
      )
    ),
...
root_agent = Agent(
  ...
  description=(
    "Demonstrates static instructions with non-text content (inline_data and file_data features)"
  ),
