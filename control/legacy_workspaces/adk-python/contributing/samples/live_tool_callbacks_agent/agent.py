...
def before_tool_audit_callback(tool, args: dict[str, Any], tool_context: ToolContext) -> dict[str, Any] | None:
...
def before_tool_security_callback(tool, args: dict[str, Any], tool_context: ToolContext) -> dict[str, Any] | None:
...
async def before_tool_async_callback(tool, args: dict[str, Any], tool_context: ToolContext) -> dict[str, Any] | None:
