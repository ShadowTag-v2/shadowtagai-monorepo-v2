...
def create_full_user_account(profile: UserProfile, preferences: UserPreferences | None = None) -> dict:
    ...
    return {
        ...
        "conversion_demo": {
            ...
            "preferences_converted": ("JSON dict → UserPreferences instance" if preferences else "None → default UserPreferences"),
        },
    }


def create_entity_profile(entity: UserProfile | CompanyProfile) -> dict:
...
root_agent = Agent(
    ...
    name="profile_agent",
    description=("Helpful assistant that helps creating accounts and profiles for users and companies"),
    instruction="""
