    ...
    try:
      ...
      if available_rooms < num_rooms:
        return (
          None,
          (
            f"Not enough rooms available at hotel ID {hotel_id}. Available: {available_rooms}, Requested: {num_rooms}"
          ),
        )
  ...
  def get_booking_details(self, cursor, booking_id=None, guest_name=None):
    ...
    if booking_id:
      ...
      return (
        None,
        (
          "Please provide either a booking ID or a guest name to retrieve booking details."
        ),
      )
    ...
    try:
      ...
      if not rows:
        return (
          None,
          (
            f"No booking found for the given criteria (ID: {booking_id}, Name: {guest_name})."
          ),
        )
