...
def get_weather(city: str, tool_context: ToolContext) -> str:
    ...
    if "weather_queries" not in tool_context.state:
        ...
        tool_context.state["weather_queries"] = tool_context.state["weather_queries"] + [city]
    ...
    return weather_data.get(city, f"Weather data not available for {city}. Try a major city.")
