...
async def list_tools() -> list[Tool]:
    ...
    return [
        Tool(
            ...
            description=("A simulated long-running task that reports progress. Use this to test progress callback functionality."),
            inputSchema={
                "type": "object",
                "properties": {
                    "steps": {
                    ...
                    "delay": {
                        "type": "number",
                        "description": ("Delay in seconds between steps (default: 0.5)"),
                        "default": 0.5,
                    },
                },
            },
