...
def test_migrate_from_sqlalchemy_pickle(tmp_path):
    ...
    app_state = mfsp.OldStorageAppState(app_name="app1", state={"akey": 1}, update_time=now)
    user_state = mfsp.OldStorageUserState(app_name="app1", user_id="user1", state={"ukey": 2}, update_time=now)
