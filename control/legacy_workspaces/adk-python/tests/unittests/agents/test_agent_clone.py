...
def test_clone_shallow_copies_lists_with_sub_agents():
  ...
  assert (
    original_sub_agent.after_agent_callback is not cloned_sub_agent.after_agent_callback
  )
  assert (
  ...
  assert (
    original_sub_agent.after_model_callback is not cloned_sub_agent.after_model_callback
  )
  assert (
    original_sub_agent.before_tool_callback is not cloned_sub_agent.before_tool_callback
  )
  assert (
    original_sub_agent.after_tool_callback is not cloned_sub_agent.after_tool_callback
  )
