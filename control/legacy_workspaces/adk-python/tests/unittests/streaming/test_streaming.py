...
def test_live_streaming_function_call_parallel():
  ...
  live_request_queue = LiveRequestQueue()
  live_request_queue.send_realtime(
    blob=types.Blob(data=b"Compare weather in SF and NYC", mime_type="audio/pcm")
  )
...
def test_live_streaming_function_call_with_error():
  ...
  live_request_queue = LiveRequestQueue()
  live_request_queue.send_realtime(
    blob=types.Blob(data=b"What is weather in Invalid Location?", mime_type="audio/pcm")
  )
...
def test_live_streaming_multiple_streaming_tools():
  ...
  live_request_queue = LiveRequestQueue()
  live_request_queue.send_realtime(
    blob=types.Blob(data=b"Monitor both stock and video", mime_type="audio/pcm")
  )
