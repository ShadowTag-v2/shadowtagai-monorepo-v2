...
def test_streaming():
  ...
  assert (
    llm_request_sent_to_mock.live_connect_config.output_audio_transcription is not None
  )
...
def test_streaming_with_input_audio_transcription():
  ...
  assert llm_request_sent_to_mock.live_connect_config is not None
  assert (
    llm_request_sent_to_mock.live_connect_config.input_audio_transcription is not None
  )
...
def test_streaming_with_session_resumption_config():
  ...
  assert (
    llm_request_sent_to_mock.live_connect_config.session_resumption.transparent is True
  )
...
def test_streaming_with_context_window_compression_config():
  ...
  assert llm_request_sent_to_mock.live_connect_config is not None
  assert (
    llm_request_sent_to_mock.live_connect_config.context_window_compression is not None
  )
  assert (
