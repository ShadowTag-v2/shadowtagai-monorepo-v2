...
def test_streaming():
    ...
    assert llm_request_sent_to_mock.live_connect_config.output_audio_transcription is not None
...
def test_streaming_with_output_audio_transcription():
    ...
    run_config = RunConfig(output_audio_transcription=types.AudioTranscriptionConfig())
...
def test_streaming_with_input_audio_transcription():
    ...
    run_config = RunConfig(input_audio_transcription=types.AudioTranscriptionConfig())
    ...
    # Assert that the request contained the correct configuration
    assert llm_request_sent_to_mock.live_connect_config is not None
    assert llm_request_sent_to_mock.live_connect_config.input_audio_transcription is not None
...
def test_streaming_with_realtime_input_config():
    ...
    # Assert that the request contained the correct configuration
    assert llm_request_sent_to_mock.live_connect_config is not None
    assert llm_request_sent_to_mock.live_connect_config.realtime_input_config.automatic_activity_detection.disabled is True
...
def test_streaming_with_realtime_input_config_vad_enabled():
    ...
    # Assert that the request contained the correct configuration
    assert llm_request_sent_to_mock.live_connect_config is not None
    assert llm_request_sent_to_mock.live_connect_config.realtime_input_config.automatic_activity_detection.disabled is False
...
def test_streaming_with_enable_affective_dialog_true():
    ...
    # Assert that the request contained the correct configuration
    assert llm_request_sent_to_mock.live_connect_config is not None
    assert llm_request_sent_to_mock.live_connect_config.enable_affective_dialog is True
...
def test_streaming_with_enable_affective_dialog_false():
    ...
    # Assert that the request contained the correct configuration
    assert llm_request_sent_to_mock.live_connect_config is not None
    assert llm_request_sent_to_mock.live_connect_config.enable_affective_dialog is False
...
def test_streaming_with_all_configs_combined():
    ...
    # Assert that the request contained the correct configuration
    assert llm_request_sent_to_mock.live_connect_config is not None
    assert llm_request_sent_to_mock.live_connect_config.realtime_input_config is not None
    assert llm_request_sent_to_mock.live_connect_config.proactivity is not None
    assert llm_request_sent_to_mock.live_connect_config.enable_affective_dialog is True
...
def test_streaming_with_session_resumption_config():
    ...
    # Assert that the request contained the correct configuration
    assert llm_request_sent_to_mock.live_connect_config is not None
    assert llm_request_sent_to_mock.live_connect_config.session_resumption is not None
    assert llm_request_sent_to_mock.live_connect_config.session_resumption.transparent is True
...
def test_streaming_with_context_window_compression_config():
    ...
    # Assert that the request contained the correct configuration
    assert llm_request_sent_to_mock.live_connect_config is not None
    assert llm_request_sent_to_mock.live_connect_config.context_window_compression is not None
    assert llm_request_sent_to_mock.live_connect_config.context_window_compression.trigger_tokens == 1000
    assert llm_request_sent_to_mock.live_connect_config.context_window_compression.sliding_window.target_tokens == 500
