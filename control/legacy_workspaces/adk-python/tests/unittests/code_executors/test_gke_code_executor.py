...
class TestGkeCodeExecutor:
  ...
  def test_execute_code_job_failed(
    ...
    mock_k8s_clients[
      "core_v1"
    ].read_namespaced_pod_log.return_value = "Traceback...\nValueError: failure"
  ...
  def test_execute_code_api_exception(self, mock_k8s_clients, mock_invocation_context):
    ...
    mock_k8s_clients["core_v1"].create_namespaced_config_map.side_effect = ApiException(
      reason="Test API Error"
    )
    executor = GkeCodeExecutor()
    result = executor.execute_code(
  ...
  def test_execute_code_timeout(
    ...
    mock_k8s_clients[
      "core_v1"
    ].read_namespaced_pod_log.return_value = "Still running..."
