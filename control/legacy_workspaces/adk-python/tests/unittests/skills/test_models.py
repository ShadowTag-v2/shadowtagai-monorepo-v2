...
def test_skill_properties():
    """Tests Skill model."""
    frontmatter = models.Frontmatter(name="my-skill", description="my description")
...
def test_compatibility_too_long():
    with pytest.raises(ValidationError, match="at most 500 characters"):
        models.Frontmatter(name="my-skill", description="desc", compatibility="c" * 501)
...
def test_allowed_tools_serialization_alias():
    fm = models.Frontmatter(name="my-skill", description="desc", allowed_tools="tool-pattern")
