...
async def test_basic_function_call_response_processing():
    ...
    function_call = types.FunctionCall(id="call_123", name="search_tool", args={"query": "test"})
    ...
    events = [
        ...
        Event(
            invocation_id="inv3",
            author="user",
            content=types.UserContent([types.Part(function_response=function_response)]),
        ),
    ]
    invocation_context.session.events = events

    # Process the request
    async for _ in contents.request_processor.run_async(invocation_context, llm_request):
        pass
...
async def test_rearrangement_with_intermediate_function_response():
    ...
    function_call = types.FunctionCall(id="long_call_123", name="long_running_tool", args={"task": "process"})
    ...
    events = [
        ...
        Event(
            invocation_id="inv3",
            author="user",
            content=types.UserContent([types.Part(function_response=intermediate_response)]),
        ),
        ...
        Event(
            invocation_id="inv5",
            author="user",
            content=types.UserContent([types.Part(function_response=final_response)]),
        ),
    ]
    invocation_context.session.events = events
...
async def test_mixed_long_running_and_normal_function_calls():
    ...
    long_running_call = types.FunctionCall(id="lro_call_456", name="long_running_tool", args={"task": "analyze"})
    normal_call = types.FunctionCall(id="normal_call_789", name="search_tool", args={"query": "test"})
...
async def test_completed_long_running_function_in_history():
    ...
    function_call = types.FunctionCall(id="history_call_123", name="long_running_tool", args={"task": "process"})
    intermediate_response = types.FunctionResponse(
        id="history_call_123",
        name="long_running_tool",
        response={"status": "processing", "progress": 50},
...
async def test_completed_mixed_function_calls_in_history():
    ...
    # Two function calls: one long-running, one normal
    long_running_call = types.FunctionCall(id="history_lro_123", name="long_running_tool", args={"task": "analyze"})
    normal_call = types.FunctionCall(id="history_normal_456", name="search_tool", args={"query": "data"})
...
async def test_function_rearrangement_preserves_other_content():
    ...
    function_call = types.FunctionCall(id="preserve_test", name="long_running_tool", args={"test": "value"})
    intermediate_response = types.FunctionResponse(
        id="preserve_test",
        name="long_running_tool",
...
async def test_error_when_function_response_without_matching_call():
    ...
    events = [
        ...
        Event(
            invocation_id="inv2",
            author="user",
            content=types.UserContent([types.Part(function_response=orphaned_response)]),
        ),
    ]
    invocation_context.session.events = events
