...
class TestTranscriptionManager:
    ...
    async def test_transcription_event_fields(self):
        ...
        transcription = types.Transcription(text="Test transcription content", finished=True)
    ...
    async def test_transcription_with_different_data_types(self):
        ...
        transcription = types.Transcription(text="Advanced transcription", finished=True)
