...
def test_progressive_sse_streaming_function_calls():
  ...
  response2 = LlmResponse(
    content=types.Content(
      role="model",
      parts=[
        types.Part.from_function_call(name="get_weather", args={"location": "Tokyo"})
      ],
    ),
  )
  ...
  response3 = LlmResponse(
    content=types.Content(
      role="model",
      parts=[
        types.Part.from_function_call(name="get_weather", args={"location": "New York"})
      ],
    ),
...
def test_progressive_sse_streaming_function_call_arguments():
  ...
  chunk1 = types.GenerateContentResponse(
    candidates=[
      types.Candidate(
        content=types.Content(role="model", parts=[types.Part(function_call=chunk1_fc)])
      )
    ]
  )
