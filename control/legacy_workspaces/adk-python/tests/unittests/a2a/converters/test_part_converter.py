...
class TestConvertA2aPartToGenaiPart:
  ...
  def test_convert_file_part_with_uri(self):
    ...
    a2a_part = a2a_types.Part(
      root=a2a_types.FilePart(
        file=a2a_types.FileWithUri(uri="gs://bucket/file.txt", mime_type="text/plain")
      )
    )
  ...
  def test_convert_file_part_with_bytes(self):
    ...
    a2a_part = a2a_types.Part(
      root=a2a_types.FilePart(
        file=a2a_types.FileWithBytes(bytes=base64_encoded, mime_type="text/plain")
      )
    )
...
class TestConvertGenaiPartToA2aPart:
  ...
  def test_convert_function_call_part(self):
    ...
    assert (
      result.root.metadata[_get_adk_metadata_key(A2A_DATA_PART_METADATA_TYPE_KEY)]
      == A2A_DATA_PART_METADATA_TYPE_FUNCTION_CALL
    )
...
class TestRoundTripConversions:
  ...
  def test_file_uri_round_trip(self):
    ...
    a2a_part = a2a_types.Part(
      root=a2a_types.FilePart(
        file=a2a_types.FileWithUri(uri=original_uri, mime_type=original_mime_type)
      )
    )
  ...
  def test_file_bytes_round_trip(self):
    ...
    genai_part = genai_types.Part(
      inline_data=genai_types.Blob(data=original_bytes, mime_type=original_mime_type)
    )
  ...
  def test_code_execution_result_round_trip(self):
    ...
    assert (
      result_genai_part.code_execution_result.outcome == code_execution_result.outcome
    )
    assert (
      result_genai_part.code_execution_result.output == code_execution_result.output
    )
