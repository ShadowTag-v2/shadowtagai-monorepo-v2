...
class TestDescriptionBuildingFunctions:
  ...
  def test_get_workflow_description_sequential_agent(self):
    ...
    assert (
      result
      == "First, this agent will First agent Finally, this agent will Second agent."
    )
  ...
  def test_get_workflow_description_loop_agent(self):
    ...
    assert (
      result
      == "This agent will First agent and Second agent in a loop (max 5 iterations)."
    )
  ...
  def test_build_sequential_description_multiple_agents(self):
    ...
    assert (
      result
      == "First, this agent will First agent Then, this agent will Second agent Finally, this agent will Third agent."
    )
  ...
  def test_build_sequential_description_without_descriptions(self):
    ...
    assert (
      result
      == "First, this agent will execute the agent1 agent Finally, this agent will execute the agent2 agent."
    )
  ...
  def test_build_parallel_description_multiple_agents(self):
    ...
    assert (
      result
      == "This agent will First agent , Second agent and Third agent simultaneously."
    )
  ...
  def test_build_loop_description_multiple_agents(self):
    ...
    assert (
      result
      == "This agent will First agent and Second agent in a loop (max 10 iterations)."
    )
  ...
  def test_build_orchestration_skill_with_sub_agents(self):
    ...
    assert (
      result.description
      == "Orchestrates: agent1: First agent description; agent2: Second agent description"
    )
...
class TestExampleExtractionFunctions:
  ...
  def test_extract_examples_from_instruction_with_different_patterns(self):
    ...
    # Arrange
    instruction = (
      'Example: "What is the weather?" Example Response: "The weather is sunny."'
    )
