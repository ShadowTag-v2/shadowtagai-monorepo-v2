...
def gemini_connection(mock_gemini_session):
    ...
    return GeminiLlmConnection(mock_gemini_session, api_backend=GoogleLLMVariant.VERTEX_AI)


@pytest.fixture
def gemini_api_connection(mock_gemini_session):
    """GeminiLlmConnection instance with mocked session for Gemini API."""
    return GeminiLlmConnection(mock_gemini_session, api_backend=GoogleLLMVariant.GEMINI_API)
...
@pytest.mark.asyncio
async def test_send_realtime_default_behavior(gemini_connection, mock_gemini_session, test_blob):
...
async def test_receive_transcript_finished(gemini_connection, mock_gemini_session, tx_direction):
    ...
    msg.server_content.input_transcription = finished_tx if tx_direction == "input" else None
    msg.server_content.output_transcription = finished_tx if tx_direction == "output" else None
...
async def test_receive_usage_metadata_and_server_content(gemini_connection, mock_gemini_session):
    ...
    usage_metadata = types.UsageMetadata(
        ...
        prompt_tokens_details=[types.ModalityTokenCount(modality="text", token_count=10)],
        cache_tokens_details=[types.ModalityTokenCount(modality="text", token_count=5)],
        response_tokens_details=[types.ModalityTokenCount(modality="text", token_count=20)],
    )
    mock_content = types.Content(role="model", parts=[types.Part.from_text(text="response text")])
...
async def test_receive_transcript_finished_on_interrupt(
    ...
    message1.server_content.input_transcription = types.Transcription(text="Hello", finished=False)
    ...
    message2.server_content.output_transcription = types.Transcription(text="How can", finished=False)
...
@pytest.mark.asyncio
async def test_receive_handles_input_transcription_fragments(gemini_connection, mock_gemini_session):
    ...
    message2.server_content.model_turn = None
    message2.server_content.interrupted = False
    message2.server_content.input_transcription = types.Transcription(text=" world", finished=False)
    ...
    message3.server_content.model_turn = None
    message3.server_content.interrupted = False
    message3.server_content.input_transcription = types.Transcription(text=None, finished=True)
    message3.server_content.output_transcription = None
    message3.server_content.turn_complete = False
    message3.server_content.generation_complete = False
    message3.tool_call = None
...
@pytest.mark.asyncio
async def test_receive_handles_output_transcription_fragments(gemini_connection, mock_gemini_session):
    ...
    message1.server_content.output_transcription = types.Transcription(text="How can", finished=False)
    message1.server_content.turn_complete = False
    message1.server_content.generation_complete = False
    message1.tool_call = None
    message1.session_resumption_update = None
    ...
    message2.server_content.interrupted = False
    message2.server_content.input_transcription = None
    message2.server_content.output_transcription = types.Transcription(text=" I help?", finished=False)
    message2.server_content.turn_complete = False
    message2.server_content.generation_complete = False
    message2.tool_call = None
    message2.session_resumption_update = None
    ...
    message3.server_content.interrupted = False
    message3.server_content.input_transcription = None
    message3.server_content.output_transcription = types.Transcription(text=None, finished=True)
    message3.server_content.turn_complete = False
    message3.server_content.generation_complete = False
    message3.tool_call = None
    message3.session_resumption_update = None
