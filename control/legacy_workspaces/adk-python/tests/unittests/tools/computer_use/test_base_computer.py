...
class TestComputerEnvironment:
    ...
    def test_valid_environments(self):
        ...
        assert ComputerEnvironment.ENVIRONMENT_UNSPECIFIED == "ENVIRONMENT_UNSPECIFIED"
    ...
    def test_string_representation(self):
        ...
        assert ComputerEnvironment.ENVIRONMENT_BROWSER.value == "ENVIRONMENT_BROWSER"
        assert ComputerEnvironment.ENVIRONMENT_UNSPECIFIED.value == "ENVIRONMENT_UNSPECIFIED"
...
class MockComputer(BaseComputer):
    ...
    async def current_state(self) -> ComputerState:
        return ComputerState(url="https://example.com", screenshot=b"screenshot_data")
...
class TestBaseComputer:
    ...
    async def test_type_text_at(self, mock_computer):
        ...
        state = await mock_computer.type_text_at(100, 200, "Hello", press_enter=False, clear_before_typing=False)
        assert isinstance(state, ComputerState)
