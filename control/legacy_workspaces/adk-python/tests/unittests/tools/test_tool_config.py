...
args:
  ...
  """
    ...
    assert tool.data_store_specs[0].data_store == "projects/my-project/locations/us-central1/collections/my-collection/dataStores/my-datastore1"
    assert tool.data_store_specs[0].filter == "filter1"
    assert isinstance(tool.data_store_specs[0], types.VertexAISearchDataStoreSpec)
    assert tool.data_store_specs[1].data_store == "projects/my-project/locations/us-central1/collections/my-collection/dataStores/my-dataStore2"
    assert tool.data_store_specs[1].filter == "filter2"
    assert tool.filter == "filter"
    assert tool.max_results == 10
    assert tool.search_engine_id == "projects/my-project/locations/us-central1/collections/my-collection/engines/my-engine"
