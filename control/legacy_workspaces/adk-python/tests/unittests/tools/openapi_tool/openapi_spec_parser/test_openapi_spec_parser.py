...
def test_parse_spec_with_request_body(openapi_spec_generator):
    ...
    parsed_operations = openapi_spec_generator.parse(openapi_spec)
    post_operations = [op for op in parsed_operations if op.endpoint.method == "post"]
            ...
            "/test_ref": {
                "get": {
                    ...
                    "responses": {
                        "200": {
                            "description": "Success",
                            "content": {"application/json": {"schema": {"$ref": "#/components/schemas/MySchema"}}},
                        }
                    },
                }
            }
...
def test_parse_spec_with_global_auth_scheme(openapi_spec_generator):
    ...
    openapi_spec["components"] = {"securitySchemes": {"api_key": {"type": "apiKey", "in": "header", "name": "X-API-Key"}}}
...
def test_parse_spec_with_local_auth_scheme(openapi_spec_generator):
    ...
    openapi_spec["components"] = {"securitySchemes": {"local_auth": {"type": "http", "scheme": "bearer"}}}
...
def test_parse_spec_with_no_description(openapi_spec_generator):
    ...
    assert len(parsed_operations) == 1
    assert parsed_operations[0].description == ""  # it should be initialized with empty string
            ...
            "/external": {
                "get": {
                    "responses": {
                        "200": {
                            "description": "OK",
                            "content": {"application/json": {"schema": {"$ref": "external_file.json#/components/schemas/ExternalSchema"}}},
                        }
                    }
                }
            }
...
def test_parse_spec_with_multiple_paths_deep_refs(openapi_spec_generator):
        ...
        "paths": {
            "/path1": {
                "post": {
                    ...
                    "requestBody": {"content": {"application/json": {"schema": {"$ref": "#/components/schemas/Request1"}}}},
                    "responses": {
                        "200": {
                            "description": "OK",
                            "content": {"application/json": {"schema": {"$ref": "#/components/schemas/Response1"}}},
                        }
                    },
                }
            },
            "/path2": {
                "put": {
                    ...
                    "requestBody": {"content": {"application/json": {"schema": {"$ref": "#/components/schemas/Request2"}}}},
                    "responses": {
                        "200": {
                            "description": "OK",
                            "content": {"application/json": {"schema": {"$ref": "#/components/schemas/Response2"}}},
                        }
                    },
                },
                "get": {
    ...
    assert path1_op.parameters[0].param_schema.properties["level1_1_prop1"].properties["level2_1_prop1"].type == "integer"
    assert path1_op.return_value.param_schema.properties["res1_prop1"].properties["level1_2_prop1"].properties["level2_2_prop1"].type == "string"

    # Verify Path 2
    path2_ops = [op for op in parsed_operations if op.endpoint.path == "/path2" and op.name == "put_path2"]
    ...
    assert path2_op.parameters[0].param_schema.properties["level1_1_prop1"].properties["level2_1_prop1"].type == "integer"
    assert path2_op.return_value.param_schema.properties["res2_prop1"].properties["level1_2_prop1"].properties["level2_2_prop1"].type == "string"
