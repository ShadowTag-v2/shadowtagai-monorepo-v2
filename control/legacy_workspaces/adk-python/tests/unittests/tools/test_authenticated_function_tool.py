...
async def async_function_with_credential(arg1: str, credential: AuthCredential) -> str:
    """Test async function with credential parameter."""
    return f"async_cred_result_{arg1}_{credential.auth_type.value}"


def sync_function_with_tool_context(arg1: str, tool_context: ToolContext) -> str:
    """Test sync function with tool_context parameter."""
    return f"sync_context_result_{arg1}"


async def async_function_with_both(arg1: str, tool_context: ToolContext, credential: AuthCredential) -> str:
...
def function_with_optional_args(arg1: str, arg2: str = "default", credential: AuthCredential = None) -> str:
...
class TestAuthenticatedFunctionTool:
    ...
    def test_init_with_sync_function(self):
        ...
        assert tool.description == "Test sync function without credential parameter."
    ...
    def test_init_with_async_function(self):
        ...
        tool = AuthenticatedFunctionTool(func=async_function_no_credential, auth_config=auth_config)

        assert tool.name == "async_function_no_credential"
        assert tool.description == "Test async function without credential parameter."
    ...
    def test_init_with_callable(self):
        ...
        tool = AuthenticatedFunctionTool(func=test_callable, auth_config=auth_config)
    ...
    def test_init_with_empty_auth_scheme(self):
        ...
        tool = AuthenticatedFunctionTool(func=sync_function_no_credential, auth_config=auth_config)
    ...
    async def test_run_async_with_valid_credential(self):
        ...
        mock_credentials_manager.get_auth_credential = AsyncMock(return_value=credential)

        tool = AuthenticatedFunctionTool(func=sync_function_with_credential, auth_config=auth_config)
    ...
    async def test_run_async_async_function_with_credential(self):
        ...
        tool = AuthenticatedFunctionTool(func=async_function_with_credential, auth_config=auth_config)
        tool._credentials_manager = mock_credentials_manager
    ...
    async def test_run_async_function_with_tool_context(self):
        ...
        tool = AuthenticatedFunctionTool(func=sync_function_with_tool_context, auth_config=auth_config)
        tool._credentials_manager = mock_credentials_manager
    ...
    async def test_run_async_function_with_both_params(self):
        ...
        tool = AuthenticatedFunctionTool(func=async_function_with_both, auth_config=auth_config)
        tool._credentials_manager = mock_credentials_manager
    ...
    async def test_run_async_function_with_optional_credential(self):
        ...
        tool = AuthenticatedFunctionTool(func=function_with_optional_args, auth_config=auth_config)
        tool._credentials_manager = mock_credentials_manager
        ...
        assert result == f"optional_result_test_default_{credential.auth_type.value}"
    ...
    async def test_run_async_propagates_function_exception(self):
        ...
        tool = AuthenticatedFunctionTool(func=failing_function, auth_config=auth_config)
        tool._credentials_manager = mock_credentials_manager
    ...
    async def test_run_async_credentials_manager_exception(self):
        ...
        mock_credentials_manager = AsyncMock()
        mock_credentials_manager.get_auth_credential = AsyncMock(side_effect=RuntimeError("Credential service error"))
