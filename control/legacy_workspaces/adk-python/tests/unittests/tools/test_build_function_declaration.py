...
def test_string_input():
    ...
    function_decl = _automatic_function_calling_util.build_function_declaration(func=simple_function)
...
def test_basemodel_input():
    ...
    assert function_decl.parameters.properties["input"].properties["input_str"].type == "STRING"
...
def test_toolcontext_ignored():
    ...
    function_decl = _automatic_function_calling_util.build_function_declaration(func=simple_function, ignore_params=["tool_context"])
...
def test_basemodel():
    ...
    function_decl = _automatic_function_calling_util.build_function_declaration(func=SimpleFunction, ignore_params=["custom_input"])
...
def test_nested_basemodel_input():
    ...
    assert function_decl.parameters.type == "OBJECT"
    assert function_decl.parameters.properties["input"].type == "OBJECT"
    assert function_decl.parameters.properties["input"].properties["child"].type == "OBJECT"
    assert function_decl.parameters.properties["input"].properties["child"].properties["input_str"].type == "STRING"
...
def test_basemodel_with_nested_basemodel():
    ...
    function_decl = _automatic_function_calling_util.build_function_declaration(func=CustomInput, ignore_params=["custom_input"])

    assert function_decl.name == "CustomInput"
    assert function_decl.parameters.type == "OBJECT"
    assert function_decl.parameters.properties["child"].type == "OBJECT"
    assert function_decl.parameters.properties["child"].properties["input_str"].type == "STRING"
    assert "custom_input" not in function_decl.parameters.properties


def test_list():
    def simple_function(input_str: list[str], input_dir: list[dict[str, str]]) -> str:
        return {"result": input_str}
...
def test_enums():
    ...
    with pytest.raises(ValueError):
        _automatic_function_calling_util.build_function_declaration(func=simple_function_with_wrong_enum)
...
def test_basemodel_list():
    ...
    assert function_decl.parameters.properties["input_str"].items.properties["child"].type == "OBJECT"
    assert function_decl.parameters.properties["input_str"].items.properties["child"].properties["input_str"].type == "STRING"
...
def test_function_no_return_annotation_gemini_api():
    ...
    function_decl = _automatic_function_calling_util.build_function_declaration(func=function_no_return, variant=GoogleLLMVariant.GEMINI_API)
...
def test_function_explicit_none_return_gemini_api():
    ...
    function_decl = _automatic_function_calling_util.build_function_declaration(func=function_none_return, variant=GoogleLLMVariant.GEMINI_API)
...
def test_function_regular_return_type_vertex_ai():
    ...
    function_decl = _automatic_function_calling_util.build_function_declaration(func=function_string_return, variant=GoogleLLMVariant.VERTEX_AI)
