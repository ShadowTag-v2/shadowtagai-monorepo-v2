...
def test_similarity_search_missing_spanner_embedding_model_name_error(
  ...
  assert result["status"] == "ERROR"
  assert (
    "embedding_options['spanner_embedding_model_name'] must be specified for GoogleSQL dialect."
...
def test_similarity_search_missing_vertex_ai_embedding_model_endpoint_error(
  ...
  assert result["status"] == "ERROR"
  assert (
    "embedding_options['vertex_ai_embedding_model_endpoint'] must be specified for PostgreSQL dialect."
    in result["error_details"]
  )
