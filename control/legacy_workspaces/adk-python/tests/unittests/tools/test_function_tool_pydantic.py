...
def function_with_optional_pydantic_model(user: UserModel, preferences: PreferencesModel | None = None) -> dict:
...
def function_with_mixed_args(name: str, user: UserModel, count: int = 5) -> dict:
...
def test_preprocess_args_with_dict_to_pydantic_conversion():
    ...
    input_args = {"user": {"name": "Alice", "age": 30, "email": "alice@example.com"}}
