...
def test_list_accessible_data_agents_success(mock_requests):
  ...
  result = data_agent_tool.list_accessible_data_agents("test-project", mock_creds)
...
def test_ask_data_agent_success(mock_get_agent_info, mock_requests, mock_get_stream):
...
@mock.patch.object(data_agent_tool, "requests", autospec=True)
@mock.patch.object(data_agent_tool, "get_data_agent_info", autospec=True)
def test_ask_data_agent_exception(mock_get_agent_info, mock_requests, mock_get_stream):
