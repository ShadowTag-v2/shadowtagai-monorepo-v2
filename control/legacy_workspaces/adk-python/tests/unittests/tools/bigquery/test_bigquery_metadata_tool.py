...
def test_list_dataset_ids_no_default_auth(mock_default_auth, mock_list_datasets):
    ...
    result = metadata_tool.list_dataset_ids(project, mock_credentials, tool_settings)
...
def test_get_dataset_info_no_default_auth(mock_default_auth, mock_get_dataset):
    ...
    mock_get_dataset.return_value = mock.create_autospec(Credentials, instance=True)
    result = metadata_tool.get_dataset_info("my_project_id", "my_dataset_id", mock_credentials, tool_settings)
    assert result != {
        "status": "ERROR",
...
def test_list_table_ids_no_default_auth(mock_default_auth, mock_list_tables):
    ...
    result = metadata_tool.list_table_ids(project, dataset, mock_credentials, tool_settings)
...
def test_get_job_info_no_default_auth(mock_default_auth, mock_get_job):
    ...
    mock_get_job.return_value = mock.create_autospec(bigquery.QueryJob, instance=True)
...
def test_list_dataset_ids_bq_client_creation(mock_get_bigquery_client):
    ...
    assert mock_get_bigquery_client.call_args.kwargs["credentials"] == bq_credentials
...
def test_get_dataset_info_bq_client_creation(mock_get_bigquery_client):
    ...
    metadata_tool.get_dataset_info(bq_project, bq_dataset, bq_credentials, tool_settings)
    mock_get_bigquery_client.assert_called_once()
    assert len(mock_get_bigquery_client.call_args.kwargs) == 4
    assert mock_get_bigquery_client.call_args.kwargs["project"] == bq_project
    assert mock_get_bigquery_client.call_args.kwargs["credentials"] == bq_credentials
...
def test_list_table_ids_bq_client_creation(mock_get_bigquery_client):
    ...
    metadata_tool.list_table_ids(bq_project, bq_dataset, bq_credentials, tool_settings)
    mock_get_bigquery_client.assert_called_once()
    assert len(mock_get_bigquery_client.call_args.kwargs) == 4
    assert mock_get_bigquery_client.call_args.kwargs["project"] == bq_project
    assert mock_get_bigquery_client.call_args.kwargs["credentials"] == bq_credentials
...
def test_get_table_info_bq_client_creation(mock_get_bigquery_client):
    ...
    metadata_tool.get_table_info(bq_project, bq_dataset, bq_table, bq_credentials, tool_settings)
    mock_get_bigquery_client.assert_called_once()
    assert len(mock_get_bigquery_client.call_args.kwargs) == 4
    assert mock_get_bigquery_client.call_args.kwargs["project"] == bq_project
    assert mock_get_bigquery_client.call_args.kwargs["credentials"] == bq_credentials
...
def test_get_job_info_bq_client_creation(mock_get_bigquery_client):
    ...
    metadata_tool.get_job_info(bq_project, bq_job_id, bq_credentials, tool_settings)
    mock_get_bigquery_client.assert_called_once()
    assert len(mock_get_bigquery_client.call_args.kwargs) == 4
    assert mock_get_bigquery_client.call_args.kwargs["project"] == bq_project
    assert mock_get_bigquery_client.call_args.kwargs["credentials"] == bq_credentials
