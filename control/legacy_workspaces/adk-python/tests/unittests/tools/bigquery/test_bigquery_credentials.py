...
class TestBigQueryCredentials:
    ...
    def test_valid_credentials_object_auth_credentials(self):
        ...
        auth_creds = mock.create_autospec(google.auth.credentials.Credentials, instance=True)
    ...
    def test_missing_client_secret_raises_error(self):
        ...
        with pytest.raises(
            ValueError,
            match=("Must provide either credentials or client_id and client_secret pair"),
        ):
