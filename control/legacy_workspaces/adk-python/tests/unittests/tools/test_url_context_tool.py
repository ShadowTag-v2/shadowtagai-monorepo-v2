...
class TestUrlContextTool:
    ...
    async def test_process_llm_request_with_gemini_1_model_raises_error(self):
        ...
        with pytest.raises(ValueError, match="Url context tool cannot be used in Gemini 1.x"):
            await tool.process_llm_request(tool_context=tool_context, llm_request=llm_request)
    ...
    async def test_process_llm_request_with_none_model_raises_error(self):
        ...
        with pytest.raises(ValueError, match="Url context tool is not supported for model None"):
            await tool.process_llm_request(tool_context=tool_context, llm_request=llm_request)
    ...
    async def test_process_llm_request_with_empty_model_raises_error(self):
        ...
        with pytest.raises(ValueError, match="Url context tool is not supported for model "):
            await tool.process_llm_request(tool_context=tool_context, llm_request=llm_request)
