...
async def async_function_for_testing_with_1_arg_and_tool_context(arg1, tool_context):
...
async def async_function_for_testing_with_4_arg_and_no_tool_context(arg1, arg2, arg3, arg4):
...
async def test_run_async_with_optional_args_not_set_async_func():
    ...
    async def async_func_with_optional_args(arg1, arg2=None, *, arg3, arg4=None, **kwargs):
        return f"{arg1},{arg3}"
...
async def test_run_async_with_require_confirmation():
    ...
    assert tool_context_mock._event_actions.requested_tool_confirmations["test_function_call_id"].hint == (
        "Please approve or reject the tool call sample_func() by responding with a FunctionResponse with an expected ToolConfirmation payload."
    )
