...
class TestLongRunningFunctionTool:
  ...
  def test_init(self):
    ...
    assert "Sample function for testing long running operations." in tool.description
  ...
  def test_get_declaration_with_description(self):
    ...
    assert (
      "Sample function for testing long running operations." in declaration.description
    )
  ...
  def test_get_declaration_without_description(self):
    ...
    expected_warning = "NOTE: This is a long-running operation. Do not call this tool again if it has already returned some intermediate or pending status."
  ...
  def test_get_declaration_returns_none_when_parent_returns_none(self):
    ...
    with pytest.MonkeyPatch.context() as m:
      m.setattr(tool.__class__.__bases__[0], "_get_declaration", lambda self: None)
      declaration = tool._get_declaration()
  ...
  def test_description_modification_preserves_original(self):
    ...
    original_description = "This is a test function for long running operations."
