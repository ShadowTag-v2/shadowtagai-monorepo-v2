...
class TestConvertEvalSetToPydanticSchema:
    ...
    def test_convert_eval_set_to_pydantic_schema_complete(self):
        ...
        eval_set_in_json_format = [
            {
                ...
                "data": [
                    ...
                    },
                    {
                        ...
                        "expected_intermediate_agent_responses": [{"author": "agent1", "text": "thought1"}],
        ...
        eval_set = convert_eval_set_to_pydantic_schema(eval_set_id, eval_set_in_json_format)
        ...
        assert len(eval_set.eval_cases[0].conversation[1].intermediate_data.tool_uses) == 2
        assert len(eval_set.eval_cases[0].conversation[1].intermediate_data.intermediate_responses) == 1
    ...
    def test_convert_eval_set_to_pydantic_schema_minimal(self):
        ...
        assert eval_set.eval_cases[0].conversation[0].user_content.parts[0].text == "Hello"
        assert eval_set.eval_cases[0].conversation[0].final_response.parts[0].text == "World"
    ...
    def test_convert_eval_set_to_pydantic_schema_empty_tool_use_and_intermediate_responses(
        ...
        assert eval_set.eval_set_id == eval_set_id
        assert len(eval_set.eval_cases) == 1
        assert len(eval_set.eval_cases[0].conversation[0].intermediate_data.tool_uses) == 0
        assert len(eval_set.eval_cases[0].conversation[0].intermediate_data.intermediate_responses) == 0
...
class TestLoadEvalSetFromFile:
    ...
    def test_load_eval_set_from_file_new_format(self, tmp_path):
                ...
                EvalCase(
                    ...
                    conversation=[
                        Invocation(
                            ...
                            user_content=genai_types.Content(parts=[genai_types.Part(text="New Format Query")]),
                            final_response=genai_types.Content(parts=[genai_types.Part(text="New Format Reference")]),
                        )
                    ],
                )
            ],
        ...
        loaded_eval_set = load_eval_set_from_file(str(file_path), "new_format_eval_set")
    ...
    def test_load_eval_set_from_file_old_format(self, tmp_path, mocker):
        ...
        old_format_json = [
            {
                ...
                "data": [{"query": "Old Format Query", "reference": "Old Format Reference"}],
            }
        ]
        ...
        loaded_eval_set = load_eval_set_from_file(str(file_path), "old_format_eval_set")
                    ...
                    conversation=[
                        Invocation(
                            ...
                            final_response=genai_types.Content(
                                parts=[genai_types.Part(text="Old Format Reference")],
                                role="model",
                            ),
...
class TestLocalEvalSetsManager:
    ...
    def test_local_eval_sets_manager_get_eval_set_success(self, local_eval_sets_manager, mocker):
        app_name = "test_app"
        eval_set_id = "test_eval_set"
    ...
    def test_local_eval_sets_manager_get_eval_set_not_found(self, local_eval_sets_manager, mocker):
        app_name = "test_app"
        eval_set_id = "test_eval_set"
        mocker.patch(
            "google.adk.evaluation.local_eval_sets_manager.load_eval_set_from_file",
    ...
    def test_local_eval_sets_manager_create_eval_set_success(self, local_eval_sets_manager, mocker):
        mocked_time = 12345678
        mocker.patch("time.time", return_value=mocked_time)
        app_name = "test_app"
        eval_set_id = "test_eval_set"
        mocker.patch("os.path.exists", return_value=False)
        mock_write_eval_set_to_path = mocker.patch("google.adk.evaluation.local_eval_sets_manager.LocalEvalSetsManager._write_eval_set_to_path")
        ...
        created_eval_set = local_eval_sets_manager.create_eval_set(app_name, eval_set_id)
    ...
    def test_local_eval_sets_manager_create_eval_set_invalid_id(self, local_eval_sets_manager):
        app_name = "test_app"
    ...
    def test_local_eval_sets_manager_create_eval_set_already_exists(self, local_eval_sets_manager, mocker):
        app_name = "test_app"
    ...
    def test_local_eval_sets_manager_list_eval_sets_success(self, local_eval_sets_manager, mocker):
        app_name = "test_app"
        mock_listdir_return = [
    ...
    def test_local_eval_sets_manager_list_eval_sets_not_found(self, local_eval_sets_manager, mocker):
        app_name = "test_app"
    ...
    def test_local_eval_sets_manager_add_eval_case_success(self, local_eval_sets_manager, mocker):
        app_name = "test_app"
        eval_set_id = "test_eval_set"
        ...
        mock_write_eval_set_to_path.assert_called_once_with(expected_eval_set_file_path, mock_eval_set)

    def test_local_eval_sets_manager_add_eval_case_eval_set_not_found(self, local_eval_sets_manager, mocker):
        app_name = "test_app"
        eval_set_id = "test_eval_set"
        eval_case_id = "test_eval_case"
        mock_eval_case = EvalCase(eval_id=eval_case_id, conversation=[])
        ...
        with pytest.raises(NotFoundError, match="Eval set `test_eval_set` not found."):
            local_eval_sets_manager.add_eval_case(app_name, eval_set_id, mock_eval_case)

    def test_local_eval_sets_manager_add_eval_case_eval_case_id_exists(self, local_eval_sets_manager, mocker):
        app_name = "test_app"
        eval_set_id = "test_eval_set"
        eval_case_id = "test_eval_case"
        mock_eval_case = EvalCase(eval_id=eval_case_id, conversation=[])
        mock_eval_set = EvalSet(eval_set_id=eval_set_id, eval_cases=[mock_eval_case])
        ...
        with pytest.raises(
            ValueError,
            match=(f"Eval id `{eval_case_id}` already exists in `{eval_set_id}` eval set."),
        ):
            local_eval_sets_manager.add_eval_case(app_name, eval_set_id, mock_eval_case)

    def test_local_eval_sets_manager_get_eval_case_success(self, local_eval_sets_manager, mocker):
        app_name = "test_app"
        eval_set_id = "test_eval_set"
        eval_case_id = "test_eval_case"
        mock_eval_case = EvalCase(eval_id=eval_case_id, conversation=[])
        ...
        eval_case = local_eval_sets_manager.get_eval_case(app_name, eval_set_id, eval_case_id)

        assert eval_case == mock_eval_case

    def test_local_eval_sets_manager_get_eval_case_eval_set_not_found(self, local_eval_sets_manager, mocker):
        app_name = "test_app"
        eval_set_id = "test_eval_set"
        eval_case_id = "test_eval_case"
    ...
    def test_local_eval_sets_manager_get_eval_case_eval_case_not_found(self, local_eval_sets_manager, mocker):
        app_name = "test_app"
        eval_set_id = "test_eval_set"
        eval_case_id = "test_eval_case"
        mock_eval_set = EvalSet(eval_set_id=eval_set_id, eval_cases=[])
    ...
    def test_local_eval_sets_manager_update_eval_case_success(self, local_eval_sets_manager, mocker):
        app_name = "test_app"
        eval_set_id = "test_eval_set"
        eval_case_id = "test_eval_case"
        mock_eval_case = EvalCase(eval_id=eval_case_id, conversation=[], creation_timestamp=456)
        updated_eval_case = EvalCase(eval_id=eval_case_id, conversation=[], creation_timestamp=123)
        mock_eval_set = EvalSet(eval_set_id=eval_set_id, eval_cases=[mock_eval_case])
        ...
        local_eval_sets_manager.update_eval_case(app_name, eval_set_id, updated_eval_case)
    ...
    def test_local_eval_sets_manager_update_eval_case_eval_set_not_found(self, local_eval_sets_manager, mocker):
        app_name = "test_app"
        eval_set_id = "test_eval_set"
        eval_case_id = "test_eval_case"
    ...
    def test_local_eval_sets_manager_update_eval_case_eval_case_not_found(self, local_eval_sets_manager, mocker):
        app_name = "test_app"
        eval_set_id = "test_eval_set"
        eval_case_id = "test_eval_case"
        updated_eval_case = EvalCase(eval_id=eval_case_id, conversation=[])
        ...
        with pytest.raises(
            NotFoundError,
            match=(f"Eval case `{eval_case_id}` not found in eval set `{eval_set_id}`."),
        ):
            local_eval_sets_manager.update_eval_case(app_name, eval_set_id, updated_eval_case)

    def test_local_eval_sets_manager_delete_eval_case_success(self, local_eval_sets_manager, mocker):
        app_name = "test_app"
        eval_set_id = "test_eval_set"
        eval_case_id = "test_eval_case"
        mock_eval_case = EvalCase(eval_id=eval_case_id, conversation=[])
        ...
        local_eval_sets_manager.delete_eval_case(app_name, eval_set_id, eval_case_id)
    ...
    def test_local_eval_sets_manager_delete_eval_case_eval_set_not_found(self, local_eval_sets_manager, mocker):
        app_name = "test_app"
        eval_set_id = "test_eval_set"
        eval_case_id = "test_eval_case"
    ...
    def test_local_eval_sets_manager_delete_eval_case_eval_case_not_found(self, local_eval_sets_manager, mocker):
        app_name = "test_app"
        eval_set_id = "test_eval_set"
        eval_case_id = "test_eval_case"
        mock_eval_set = EvalSet(eval_set_id=eval_set_id, eval_cases=[])
