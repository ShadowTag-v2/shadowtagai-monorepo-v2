...
def test_get_developer_instructions_existing_agent():
    agent_details = {
        "agent1": AgentDetails(name="agent1", instructions="instruction for agent1"),
        "agent2": AgentDetails(name="agent2", instructions="instruction for agent2"),
    }
...
def test_get_tools_by_agent_name():
    tool1 = genai_types.Tool(function_declarations=[genai_types.FunctionDeclaration(name="tool1_func")])
    agent_details = {
