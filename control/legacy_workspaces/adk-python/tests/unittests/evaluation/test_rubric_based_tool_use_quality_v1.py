...
def test_format_auto_rater_prompt_with_app_details(
  ...
  tool = genai_types.Tool(
    function_declarations=[
      genai_types.FunctionDeclaration(name="test_func", description="A test function.")
    ]
  )
...
def test_get_metric_info(evaluator: RubricBasedToolUseV1Evaluator):
  ...
  assert (
    metric_info.metric_name == PrebuiltMetrics.RUBRIC_BASED_TOOL_USE_QUALITY_V1.value
  )
