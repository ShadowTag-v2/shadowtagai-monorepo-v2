...
"""
    expected = [
      ...
      },
      {
        ...
        "label": "disputed",
        "rationale": (
          "The context states that pears are purple but it also states that pears are blue."
        ),
        "supporting_excerpt": "Pears are purple fruits",
        "contradicting_excerpt": "Pears are blue fruits",
      },
  ...
  app_details = AppDetails(
    agent_details={
      "root": AgentDetails(
        ...
        tool_declarations=[
          genai_types.Tool(
            function_declarations=[genai_types.FunctionDeclaration(name="tool1")]
          )
        ],
      ),
    },
  ...
  events = [
    InvocationEvent(
      ...
      content=genai_types.Content(
        parts=[
          genai_types.Part(
            function_call=genai_types.FunctionCall(id="1", name="tool1", args={})
          )
        ]
      ),
    ),
    ...
    InvocationEvent(
      ...
      content=genai_types.Content(
        parts=[
          ...
          genai_types.Part(
            function_call=genai_types.FunctionCall(id="2", name="tool1", args={})
          ),
        ]
      ),
    ),
  ...
  app_details = AppDetails(
    agent_details={
      "root": AgentDetails(
        ...
        tool_declarations=[
          genai_types.Tool(
            function_declarations=[genai_types.FunctionDeclaration(name="tool_root")]
          )
        ],
      ),
      "agent1": AgentDetails(
        ...
        tool_declarations=[
          genai_types.Tool(
            function_declarations=[genai_types.FunctionDeclaration(name="tool_agent1")]
          )
        ],
      ),
      "agent2": AgentDetails(
  ...
  events = [
    ...
    InvocationEvent(
      ...
      content=genai_types.Content(
        parts=[
          genai_types.Part(
            function_call=genai_types.FunctionCall(name="tool_root", args={})
          )
        ]
      ),
    ),
    ...
    InvocationEvent(
      ...
      content=genai_types.Content(
        parts=[
          genai_types.Part(
            function_call=genai_types.FunctionCall(name="tool_agent1", args={"q": 1})
          )
        ]
      ),
    ),
...
def time_weather_data():
  ...
  user_content = genai_types.Content(
    parts=[genai_types.Part(text="Get the current time and weather of San Francisco.")]
  )
      ...
      invocation_events=[
        InvocationEvent(
          ...
          content=genai_types.Content(
            parts=[
              genai_types.Part(
                function_call=genai_types.FunctionCall(name="tool1", args={})
              )
            ]
          ),
        ),
