...
def test_get_express_mode_api_key_value_error():
    with pytest.raises(ValueError) as excinfo:
        vertex_ai_utils.get_express_mode_api_key(project="test-project", location=None, express_mode_api_key="key")
    ...
    with pytest.raises(ValueError) as excinfo:
        vertex_ai_utils.get_express_mode_api_key(project=None, location="test-location", express_mode_api_key="key")
    assert "Cannot specify project or location and express_mode_api_key. Either use project and location, or just the express_mode_api_key." in str(
        excinfo.value
    )
    with pytest.raises(ValueError) as excinfo:
