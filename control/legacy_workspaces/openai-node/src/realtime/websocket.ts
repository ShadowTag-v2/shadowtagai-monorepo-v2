...
import { type AzureOpenAI, OpenAI } from "../index";
import { isRunningInBrowser } from "../internal/detect-platform";
import type { RealtimeClientEvent, RealtimeServerEvent } from "../resources/realtime/realtime";
import { buildRealtimeURL, isAzure, OpenAIRealtimeEmitter } from "./internal-base";
...
export class OpenAIRealtimeWebSocket extends OpenAIRealtimeEmitter {
  ...
  static async create(
    ...
    return new OpenAIRealtimeWebSocket(
      { ...props, __resolvedApiKey: await client._callApiKey() },
      client,
    );
  }
