...
import { ResponseStream, type ResponseStreamParams } from "../../lib/responses/ResponseStream";
...
import type * as ResponsesAPI from "./responses";
...
export class Responses extends APIResource {
  ...
  >(body: Params, options?: RequestOptions): APIPromise<ParsedResponse<ParsedT>> {
...
export declare namespace Responses {
  export {
    ...
    Response,
    ResponseApplyPatchToolCall,
    type ResponseApplyPatchToolCallOutput,
    ...
    type ToolChoiceApplyPatch,
    type ToolChoiceCustom,
    type ToolChoiceFunction,
    type ToolChoiceMcp,
    type ToolChoiceOptions,
    type ToolChoiceShell,
