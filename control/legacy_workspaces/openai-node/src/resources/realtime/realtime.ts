...
import type * as ResponsesAPI from "../responses/responses";
...
export interface RealtimeResponseCreateMcpTool {
   ...
   */
  require_approval?:
    | RealtimeResponseCreateMcpTool.McpToolApprovalFilter
    | "always"
    | "never"
    | null;
...
export declare namespace Realtime {
  export {
    ...
    type RealtimeAudioConfigOutput,
    ...
    type RealtimeToolsConfig,
    RealtimeToolsConfigUnion,
    RealtimeTracingConfig,
    type RealtimeTranscriptionSessionAudio,
