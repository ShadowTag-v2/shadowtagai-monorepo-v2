...
import type * as AudioAPI from "./audio";
import type * as TranscriptionsAPI from "./transcriptions";
...
export namespace TranscriptionCreateParams {
  ...
  export type TranscriptionCreateParamsNonStreaming =
    TranscriptionsAPI.TranscriptionCreateParamsNonStreaming;
  export type TranscriptionCreateParamsStreaming =
    TranscriptionsAPI.TranscriptionCreateParamsStreaming;
}
