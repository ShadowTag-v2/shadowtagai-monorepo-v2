...
import { type AutoParseableResponseTool, makeParseableResponseTool } from "../lib/ResponsesParser";
import { toStrictJsonSchema } from "../lib/transform";
import type { ResponseFormatJSONSchema } from "../resources/index";
import type { ResponseFormatTextJSONSchemaConfig } from "../resources/responses/responses";

type InferZodType<T> = T extends z4.ZodType
  ? z4.infer<T>
  : T extends z3.ZodType
    ? z3.infer<T>
    : never;
  ...
  return makeParseableResponseFormat(
    {
      ...
      json_schema: {
        ...
        name,
        strict: true,
        schema: isZodV4(zodObject)
          ? zodV4ToJsonSchema(zodObject)
