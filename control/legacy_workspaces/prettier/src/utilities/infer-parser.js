import { fileURLToPath, getFileBasename, getInterpreter, isUrl } from "#universal";
...
const getLanguageByInterpreter =
  process.env.PRETTIER_TARGET === "universal" ? undefined : getLanguageByInterpreterNodejs;
