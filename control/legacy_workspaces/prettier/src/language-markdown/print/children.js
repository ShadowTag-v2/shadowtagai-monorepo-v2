...
import { INLINE_NODE_TYPES, INLINE_NODE_WRAPPER_TYPES, isPrettierIgnore } from "../utilities.js";
...
function shouldPrePrintDoubleHardline({ node, previous, parent }, options) {
  if (
    ...
    (node.type === "list" && parent.type === "listItem" && previous.type === "code")
  ) {
    return true;
  }
  ...
  const isInTightListItem =
    parent.type === "listItem" && (node.type === "list" || !isLooseListItem(parent, options));
