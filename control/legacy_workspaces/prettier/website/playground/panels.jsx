...
class CodeMirrorPanel extends React.Component {
  ...
  componentDidMount() {
    ...
    this._codeMirror = CodeMirror.fromTextArea(this._textareaRef.current, options);
  ...
  componentDidUpdate(prevProps) {
    ...
    if (
      ...
      !isEqualSelection(this.props.selection, this._codeMirror.listSelections()[0])
    ) {
      this.updateSelection();
    }
    if (
...
function makeGutters(props) {
  return props.foldGutter ? ["CodeMirror-linenumbers", "CodeMirror-foldgutter"] : [];
}
