        ...
        <div className="container">
            ...
            <ul>
              <li>
                <Link to="https://2021.stateofjs.com/en-US/other-tools/#utilities">
                  More than <strong>83%</strong> of respondents to State of JS 2021 (10282
                  developers out of 12360).
                </Link>
              </li>
              <li>
                <Link to="https://2020.stateofjs.com/en-US/other-tools/#utilities">
                  More than <strong>70%</strong> of respondents to State of JS 2020 (14880
                  developers out of 20974).
                </Link>
              </li>
            </ul>
          </Admonition>
          ...
          <section>
            ...
            <div className="text--center margin-bottom--lg">
              ...and{" "}
              <Link to="https://www.npmjs.com/browse/depended/prettier">many more projects</Link>
            </div>
          </section>
        </div>
      </main>
