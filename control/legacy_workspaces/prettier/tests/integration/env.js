...
const prettierCliEntry = path.join(PRETTIER_DIR, typeof bin === "object" ? bin.prettier : bin);
...
export { isProduction, prettierCliEntry, prettierCliMockableEntry, prettierMainEntry, projectRoot };
