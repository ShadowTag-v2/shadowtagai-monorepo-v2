describe("multiple patterns", () => {
  runCli("cli/patterns", ["directory/**/*.js", "other-directory/**/*.js", "-l"]).test({
    status: 1,
  });
});
...
describe("multiple patterns by with ignore pattern, doesn't ignore node_modules with --with-node-modules flag", () => {
  runCli("cli/patterns", ["**/*.js", "!directory/**", "-l", "--with-node-modules"]).test({
    status: 1,
  });
});
...
describe("multiple patterns, throw error and exit with non zero code on non existing files", () => {
  runCli("cli/patterns", ["non-existent.js", "other-non-existent.js", "-l"]).test({
    status: 2,
  });
});
