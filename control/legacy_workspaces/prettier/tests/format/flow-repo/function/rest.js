...
function array_rest_t<T: Array<mixed>
>(...xs: T): void
{
}
function roarray_rest_t<T: $ReadOnlyArray<mixed>
>(...xs: T): void
{
}
function iterable_rest_t<T: Iterable<mixed>
>(...xs: T): void
{
}
...
function empty_rest<T:Array<mixed>
>(...xs: T): T
{
  return xs;
}
(empty_rest()
: empty) // Error Array ~> empty
