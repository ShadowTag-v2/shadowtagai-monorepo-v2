...
set;
propWithSubtypingGetterAndSetter(x: number)
{
}

// The getter and setter need not have the same type - no error
set;
propWithSubtypingGetterAndSetterReordered(x: number)
{
}
get;
propWithSubtypingGetterAndSetterReordered();
: ?number
{
  return 4;
}
...
set;
propWithMismatchingGetterAndSetter(x: string)
{
} // doesn't match getter (OK)

propOverriddenWithGetter: number;
get;
propOverriddenWithGetter();
{
  return "hello";
}
...
set;
propOverriddenWithSetter(x: string)
{
}
