...
import CJS_Named, { num1, str1 } from "CJS_Named";
...
import { num2, numExport } from "CJS_Clobbered";
...
: numType)
('asdf'
: numType) // Error: string ~> number

import { str3, strHidden } from "ES";
