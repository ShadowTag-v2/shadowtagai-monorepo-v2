...
class Base {
  ...
  base_annotatedInitializedFieldValid:
  ?number = 42
  ...
  static base_annotatedInitializedFieldValid:
  ?number = 42
...
class Child extends Base {
  ...
  child_annotatedInitializedFieldValid:
  ?number = 42
  ...
  static child_annotatedInitializedFieldValid:
  ?number = 42
 ...
 */
(o.base_unannotatedField
: string)
(o.base_unannotatedField
: number)
(Child.base_unannotatedField
: string)
(Child.base_unannotatedField
: number)

(o.child_unannotatedField
: string)
(o.child_unannotatedField
: number)
(Child.child_unannotatedField
: string)
(Child.child_unannotatedField
: number)
 ...
 */
(o.base_annotatedField
: number)
(o.base_annotatedField
: string) // Error: number ~> string
(Child.base_annotatedField
: number)
(Child.base_annotatedField
: string) // Error: number ~> string

(o.child_annotatedField
: number)
(o.child_annotatedField
: string) // Error: number ~> string
(Child.child_annotatedField
: number)
(Child.child_annotatedField
: string) // Error: number ~> string
 ...
 */
(o.base_initializedField
: number)
(o.base_initializedField
: string) // Error: number ~> string
(Child.base_initializedField
: string)
(Child.base_initializedField
: number) // Error: string ~> number

(o.child_initializedField
: number)
(o.child_initializedField
: string) // Error: number ~> string
(Child.child_initializedField
: string)
(Child.child_initializedField
: number) // Error: string ~> number
 ...
 */
(o.base_initializedFieldWithThis
: number)
(o.base_initializedFieldWithThis
: string) // Error: number ~> string
(Child.base_initializedFieldWithThis
: string)
(Child.base_initializedFieldWithThis
: number) // Error: string ~> number

(o.child_initializedFieldWithThis
: number)
(o.child_initializedFieldWithThis
: string) // Error: number ~> string
(Child.child_initializedFieldWithThis
: string)
(Child.child_initializedFieldWithThis
: number) // Error: string ~> number
 ...
 *  the initializer)
 */
(o.base_annotatedInitializedFieldValid
: ?number)
(o.base_annotatedInitializedFieldValid
: number) // Error: ?number ~> number
(Child.base_annotatedInitializedFieldValid
: ?number)
(Child.base_annotatedInitializedFieldValid
: number) // Error: ?number ~> number

(o.child_annotatedInitializedFieldValid
: ?number)
(o.child_annotatedInitializedFieldValid
: number) // Error: ?number ~> number
...
(o.child_annotatedInitializedFieldInvalid
: number)
(o.child_annotatedInitializedFieldInvalid
: string) // Error: number ~> string
 ...
 */
(o.inherited_initializer
: number)
(o.inherited_initializer
: string) // Error: number ~> string
(Child.inherited_initializer
: number)
(Child.inherited_initializer
: string) // Error: number ~> string
