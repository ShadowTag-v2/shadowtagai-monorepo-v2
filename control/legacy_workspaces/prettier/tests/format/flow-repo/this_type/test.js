...
(new InheritOverride().bar_caller()
: InheritOverride) // error
// blame flips below
...
(new InheritOverride2().bar_caller()
: InheritOverride2) // exploits error above

(new Override2()
: Base2).corge(new Base2()) // exploits error above
