const example1 = (): ({ p: string => string }) => (0;
: any)
const example2 = (): ({ p: { p: string => string } }) => (0;
: any)
const example3 = (): ({ p: { p: { p: string => string } } }) => (0;
: any)
const example4 = (): ({ p: { p: ?{ p: string => string } };
}) => (0: any)
...
const example11 = (): ({ p: string => string } & string) => (0;
: any)
const example12 = (): ({ p: string => string } | string) => (0;
: any)
const example13 = (): ([{ p: string => string }, string]) => (0;
: any)
const example14 = (): ({ p: string => string }[]) => (0;
: any)
