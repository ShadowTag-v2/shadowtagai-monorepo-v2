...
type T = hook <T: Fooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo>
() => void;
...
type T = hook
(...restProps: $ReadOnly<{k: string}>) => {k: string};

type T = hook
(...$ReadOnly<{k: string}>) => {k: string};

type T = hook
(bar: string, baz: $ReadOnly<{k: string}>) => void;

type T = hook
(bar: string, baz: $ReadOnly<{k: string}>, realllllllllllllllllllyLong: string) => void;
...
class Y {
  constructor(
    ideConnectionFactory: hook (child_process$ChildProcess)
  =>
