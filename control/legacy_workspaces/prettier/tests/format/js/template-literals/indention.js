[
  `
      ...
      )}" ${chalk.green.underline("https://www.example.com/drupedalKangarooTransformer")}
  `,
  `
...
# blabla ${a} ${chalk.green.underline("https://www.example.com/drupedalKangarooTransformer")}
    ...
    2. Go to "${chalk.green.underline("https://www.example.com/drupedalKangarooTransformer")}"
