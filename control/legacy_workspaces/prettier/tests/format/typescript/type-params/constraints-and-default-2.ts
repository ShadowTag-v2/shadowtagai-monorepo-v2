...
a = {
  parseFunctionBodyAndFinish<
    T = N.Function | N.TSDeclareMethod | N.TSDeclareFunction | N.ClassPrivateMethod,
  >() {},
};
...
>();
function parseFunctionBodyAndFinish<
  T = N.Function | N.TSDeclareMethod | N.TSDeclareFunction | N.ClassPrivateMethod | Foo | Bar | Baz,
>();
