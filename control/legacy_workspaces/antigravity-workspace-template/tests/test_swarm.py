...
class TestAgents:
  ...
  def test_reviewer_agent_init(self):
    ...
    assert (
      "review" in reviewer.system_prompt.lower()
      or "quality" in reviewer.system_prompt.lower()
    )
  ...
  def test_researcher_agent_init(self):
    ...
    assert (
      "research" in researcher.system_prompt.lower()
      or "information" in researcher.system_prompt.lower()
    )
