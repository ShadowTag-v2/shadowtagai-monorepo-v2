...
TEST: Compare "test@example.com" vs "Test@Example.com"
...
1. **Explain the bug in simple terms**
   ...
   4. Therefore, 'Test@Example.com' != 'test@example.com'
   ```

2. **Predict the behavior**
   ```
   "If I'm right, then:
   - Logging in with 'test@example.com' will work
   - Logging in with 'Test@Example.com' will fail
...
3. **Test your prediction**
   ...
   def test_email_case_sensitivity():
       ...
       result1 = login(email="test@example.com", password="pass")
       assert result1.success is True  # Test prediction

       # Predict: original case will fail (hypothesis)
       result2 = login(email="Test@Example.com", password="pass")
...
2. **Write a test that verifies the fix**
   ...
   def test_login_case_insensitive():
       ...
       assert login("test@example.com", "pass123").success is True
       assert login("Test@Example.com", "pass123").success is True
       assert login("TEST@EXAMPLE.COM", "pass123").success is True
   ```
