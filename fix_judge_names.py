...
def replace_in_file(filepath):
    ...
    content = re.sub(r"Judge\s*#?6\s*[—\-]\s*BLOCK/ALLOW", "Claude_Code_6 — BLOCK/ALLOW", content, flags=re.IGNORECASE)
    content = re.sub(r"Judge\s*#?6\s*BLOCK/ALLOW", "Claude_Code_6 BLOCK/ALLOW", content, flags=re.IGNORECASE)
    content = re.sub(r"Judge\s*#?6\s*Gate", "Claude_Code_6 Gate", content, flags=re.IGNORECASE)
