...
class DeploymentBase(BaseModel):
    ...
    environment: str = Field(..., description="Deployment environment (e.g., staging, production)")
    strategy: DeploymentStrategy = Field(DeploymentStrategy.BLUE_GREEN, description="Deployment strategy")
    configuration: dict[str, Any] | None = Field(None, description="Deployment configuration")
...
class FeatureFlagBase(BaseModel):
    ...
    status: FeatureFlagStatus = Field(FeatureFlagStatus.DISABLED, description="Feature flag status")
