...
def get_video_info(video_path: str) -> dict:
    ...
    try:
        ...
        return {"duration": 8.0, "fps": 30.0, "width": 1920, "height": 1080, "total_frames": 240}
...
Examples:
  ...
  python scripts/veo_frame_extract.py \\
    ...
    input_group.add_argument("--veo-prompt", help="Generate video with Veo 3.1 first, then extract")
    input_group.add_argument("--preset", choices=list(SCROLL_PRESETS), help="Use a preset")
