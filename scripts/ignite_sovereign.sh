...
# Backend (FastAPI)
BACKEND_DIR=""
for candidate in "apps/ShadowTag-v2_stack/ShadowTag-v2-fastapi-services" "apps/counselconduit/backend" "apps/ShadowTag-v2_stack/Pipeline"; do
...
# Frontend (Next.js)
FRONTEND_DIR=""
for candidate in "apps/counselconduit" "apps/counselconduit/frontend" "apps/ShadowTag-v2_stack/nascent-apollo"; do
