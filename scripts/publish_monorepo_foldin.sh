...
REPOS=(
  ...
  "Claude_Code_6|https://github.com/ehanc69/Claude_Code_6.git|$REFERENCE_ROOT/Claude_Code_6"
...
present = []
missing = []
for name in ["antigravity-go", "codepmcs", "Claude_Code_6", "kosmos", "shadowtag_v2"]:
