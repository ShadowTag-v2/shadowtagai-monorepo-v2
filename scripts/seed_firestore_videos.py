...
SEED_VIDEOS = [
    ...
    {"title": "I Built a House Using Only AI Blueprints", "author": "Builder Mike", "views": "1.8M"},
    {"title": "The Science Behind Viral Videos", "author": "Veritasium", "views": "4.1M"},
    {"title": "Perfect Sourdough in Under 4 Hours", "author": "Joshua Weissman", "views": "890K"},
    {"title": "Why Studios Now Use AI Actors", "author": "Film Theory", "views": "3.2M"},
    {"title": "Day in My Life: Remote Dev in Tokyo", "author": "Joma Tech", "views": "1.5M"},
    {"title": "Biggest Startup Mistakes to Avoid", "author": "Graham Stephan", "views": "2.1M"},
    {"title": "We Tested 50 AI Image Generators", "author": "MKBHD", "views": "5.7M"},
    {"title": "How to Actually Get Good at Chess", "author": "GothamChess", "views": "1.3M"},
    {"title": "I Survived 100 Days in an AI Minecraft World", "author": "Luke TheNotable", "views": "8.9M"},
    {"title": "Living on $1/Day in Different Countries", "author": "Nas Daily", "views": "6.2M"},
    {"title": "Why Airlines Are Getting Worse", "author": "Wendover Productions", "views": "2.8M"},
    {"title": "10-Minute Full Body Workout — No Equipment", "author": "Chloe Ting", "views": "14.2M"},
    {"title": "How This 19-Year-Old Makes $50K/Month AI", "author": "Ali Abdaal", "views": "3.4M"},
    {"title": "Every Fast Food Chicken Sandwich Ranked", "author": "Good Mythical Morning", "views": "4.5M"},
    {"title": "Learn Python in 1 Hour — 2026 Edition", "author": "Programming with Mosh", "views": "9.1M"},
    {"title": "I Let AI Control My Life for 30 Days", "author": "Yes Theory", "views": "7.3M"},
    {"title": "The Most Satisfying Machines Ever Made", "author": "SmarterEveryDay", "views": "11.6M"},
...
def main() -> None:
    ...
    for i, meta in enumerate(SEED_VIDEOS):
        ...
        print(f"  video_{i}: AI={votes['voteAI']:,}  Human={votes['voteHuman']:,}  → {meta['title'][:50]}")
    ...
    if not meta_snap.exists:
        batch.set(meta_ref, {"totalAI": total_ai + 68_200_000, "totalHuman": total_human + 31_800_000})
