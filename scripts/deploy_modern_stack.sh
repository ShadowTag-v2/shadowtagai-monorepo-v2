...
REGION="us-central1"
CLUSTER_NAME="Cor.Claude_Code_6-sovereign-cloud"
NETWORK="default"
...
cat <<EOF > k8s/deployments/Cor.Claude_Code_6-core.yaml
apiVersion: apps/v1
kind: Deployment
metadata:
  name: Cor.Claude_Code_6-core
  labels:
...
kubectl apply -f k8s/deployments/Cor.Claude_Code_6-core.yaml
