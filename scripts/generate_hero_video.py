...
class Veo31Pipeline:
  ...
  def generate_reference_image(
    self, prompt: str, output_path: str = "reference_frame.png"
  ) -> str:
  ...
  def run_full_pipeline(
    ...
    if not skip_reference:
      ref_dir = os.path.join(
        os.path.dirname(os.path.dirname(__file__)), "apps", "shadowtagai", "public"
      )
...
def main() -> None:
  parser = argparse.ArgumentParser(
    description="Generate Veo 3.1 hero background video for ShadowTagAI"
  )
  parser.add_argument(
    "--prompt",
