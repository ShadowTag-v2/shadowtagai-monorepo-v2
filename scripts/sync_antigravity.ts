...
async function sync() {
    ...
    console.log(`🎉 Selective Mirroring Complete. ${count} servers safely injected into Antigravity.`);
    console.log("⚠️ gemini-github-mcp intentionally omitted to protect Antigravity's 100-tool platform budget.");
}
