...
def update_manifests():
    ...
    manifest = {
        ...
        "policy": {"goal": "Every listed repo is canonically rooted, explicitly archived, or explicitly reference-only inside the monorepo."},
        "repos": [],
    }
        ...
        manifest["repos"].append(
            {
                ...
                "status": c["desired_status"] if c["desired_status"] != "unclassified" else "queued_for_fold_in",
