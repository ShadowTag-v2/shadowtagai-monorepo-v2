...
""",
  ...
  gen.add_argument(
    "--last-image", help="Last frame image for interpolation (with --image)"
  )
  ...
  ext.add_argument(
    "--fps", type=int, default=30, help="FPS for frame extraction (default: 30)"
  )
  ext.add_argument("--output", help="Output directory for frames")

  # Info
  parser.add_argument(
    "--list", action="store_true", help="List available presets and models"
  )
