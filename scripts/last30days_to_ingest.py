...
sys.path.insert(
  0, str(REPO_ROOT / "apps/ShadowTag-v2_stack/ShadowTag-v2-fastapi-services")
)
...
def main() -> None:
  parser = argparse.ArgumentParser(
    description="Pipe last30days research into IngestStore"
  )
  ...
  parser.add_argument(
    "--dry-run", action="store_true", help="Print items without saving"
  )
