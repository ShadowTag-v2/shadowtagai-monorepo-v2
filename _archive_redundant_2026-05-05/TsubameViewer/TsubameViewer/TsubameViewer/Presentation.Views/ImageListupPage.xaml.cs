    ...
    public sealed partial class ImageListupPage : Page
    {
        ...
        private void ImageListItem_Clicked(object sender, RoutedEventArgs e)
        {
            if (IsSelectionModeEnabled
                || ((uint)Microsoft.UI.Input.InputKeyboardSource.GetKeyStateForCurrentThread(Windows.System.VirtualKey.Control) & 0x01) != 0
                )
            {
        ...
        private void ItemSelectedProcess(StorageItemViewModel itemVM)
        {
            ...
            //    && Microsoft.UI.Input.InputKeyboardSource.GetKeyStateForCurrentThread(Windows.System.VirtualKey.Shift) != CoreVirtualKeyStates.None
            //    )
            //{
