...
class TestClaudeClientInitialization:
    ...
    def test_custom_parameters(self, api_env):
        ...
        client = ClaudeClient(model="claude-3-haiku-20240307", max_tokens=8192, temperature=0.5)
...
class TestClaudeClientGeneration:
    ...
    def test_generate_with_system_prompt(self, api_env):
        ...
        assert (
            "math" in response.lower() or "tutor" in response.lower() or "help" in response.lower()
        )
