...
class TestBaseEvent:
    ...
    def test_to_dict(self):
        ...
        event = BaseEvent(type=EventType.WORKFLOW_STARTED, process_id="test_proc")
        data = event.to_dict()
...
class TestWorkflowEvent:
    ...
    def test_workflow_event_creation(self):
        ...
        event = WorkflowEvent(
            type=EventType.WORKFLOW_STARTED, research_question="Test question", domain="biology"
        )
        assert event.type == EventType.WORKFLOW_STARTED
    ...
    def test_workflow_event_to_dict(self):
        ...
        event = WorkflowEvent(
            type=EventType.WORKFLOW_COMPLETED, research_question="Test", findings_count=10
        )
        data = event.to_dict()
...
class TestCycleEvent:
    ...
    def test_cycle_event_creation(self):
        ...
        event = CycleEvent(type=EventType.CYCLE_STARTED, cycle=1, max_cycles=5)
...
class TestLLMEvent:
    ...
    def test_llm_token_event(self):
        ...
        event = LLMEvent(type=EventType.LLM_TOKEN, model="claude-3-5-sonnet", token="Hello")
...
class TestExecutionEvent:
    ...
    def test_execution_started(self):
        ...
        event = ExecutionEvent(type=EventType.CODE_EXECUTING, code_hash="abc123", language="python")
    ...
    def test_execution_completed(self):
        ...
        event = ExecutionEvent(
            type=EventType.CODE_COMPLETED, code_hash="abc123", exit_code=0, duration_ms=5000
        )
...
class TestStageEvent:
    ...
    def test_stage_started(self):
        ...
        event = StageEvent(type=EventType.STAGE_STARTED, stage="GENERATE_HYPOTHESIS", iteration=1)
...
class TestParseEvent:
    ...
    def test_parse_llm_event(self):
        ...
        data = {"type": "llm.token", "model": "claude-3-5-sonnet", "token": "Hello"}
        event = parse_event(data)
    ...
    def test_parse_stage_event(self):
        ...
        data = {"type": "stage.completed", "stage": "TEST_STAGE", "duration_ms": 1000}
        event = parse_event(data)
    ...
    def test_parse_ignores_extra_fields(self):
        ...
        data = {"type": "workflow.started", "research_question": "Test", "extra_field": "ignored"}
        event = parse_event(data)
        assert isinstance(event, WorkflowEvent)
