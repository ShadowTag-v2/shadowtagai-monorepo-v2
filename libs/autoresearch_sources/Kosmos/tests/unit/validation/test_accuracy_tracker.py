...
class TestAccuracyReport:
    ...
    def test_all_types_meet_targets_true(self):
        ...
        by_type = {
            ...
            "literature": TypeAccuracyResult("literature", 10, 8, 0.8, 0.75, True, 0.821, -0.021),
        }
    ...
    def test_all_types_meet_targets_false(self):
        ...
        by_type = {
            ...
            "literature": TypeAccuracyResult("literature", 10, 6, 0.6, 0.75, False, 0.821, -0.221),
        }
...
class TestAccuracyReporter:
    ...
    def sample_report(self):
        ...
        by_type = {
            ...
            "literature": TypeAccuracyResult("literature", 35, 28, 0.80, 0.75, True, 0.821, -0.021),
