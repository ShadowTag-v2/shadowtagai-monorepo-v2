...
class TestOverInterpretationDetection:
    ...
    def test_strong_claims_weak_stats_detected(self, failure_detector, over_interpretation_finding):
...
class TestRabbitHoleDetection:
    ...
    def test_relevant_finding_passes(self, failure_detector, clean_finding, research_question):
        """Test that relevant finding passes."""
        result = failure_detector.detect_rabbit_hole(clean_finding, research_question)
    ...
    def test_irrelevant_finding_detected(
        ...
        result = failure_detector.detect_rabbit_hole(rabbit_hole_finding, research_question)
    ...
    def test_high_generation_penalty(
        ...
        # Without hypothesis
        result1 = failure_detector.detect_rabbit_hole(clean_finding, research_question)
    ...
    def test_evolution_history_tracking(self, failure_detector, clean_finding):
        ...
        result1 = failure_detector.detect_rabbit_hole(clean_finding, "Cancer genetics", hypothesis)

        # Higher generation
        hypothesis["generation"] = 5
        result2 = failure_detector.detect_rabbit_hole(clean_finding, "Cancer genetics", hypothesis)
    ...
    def test_combined_score_calculation(self, failure_detector, rabbit_hole_finding):
        ...
        result = failure_detector.detect_rabbit_hole(
            rabbit_hole_finding, "Cancer genetics research", hypothesis
        )
...
class TestBatchProcessing:
    ...
    def test_get_failure_statistics(
        self, failure_detector, clean_finding, over_interpretation_finding
    ):
