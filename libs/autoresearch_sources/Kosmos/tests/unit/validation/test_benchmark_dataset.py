...
def sample_dataset():
    ...
    findings = [
        ...
        BenchmarkFinding(
            "b006", "Interp finding 1", "interpretation", True, "biology", "synthetic"
        ),
        BenchmarkFinding(
            "b007", "Interp finding 2", "interpretation", False, "biology", "synthetic"
        ),
        BenchmarkFinding(
            "b008", "Interp finding 3", "interpretation", False, "biology", "synthetic"
        ),
    ]
...
class TestBenchmarkGenerator:
    ...
    def test_create_generator_with_seed(self):
        ...
        for f1, f2 in zip(dataset1.findings, dataset2.findings, strict=False):
    ...
    def test_synthetic_benchmark_custom_accuracy(self):
        ...
        generator = BenchmarkGenerator(seed=42)
        custom_rates = {"data_analysis": 0.90, "literature": 0.80, "interpretation": 0.70}

        dataset = generator.create_synthetic_benchmark(n_per_type=100, accuracy_rates=custom_rates)
    ...
    def test_create_from_findings(self):
        ...
        ground_truth = {"f_000": True, "f_001": True, "f_002": False, "f_003": True, "f_004": False}

        generator = BenchmarkGenerator()
        dataset = generator.create_from_findings(findings, ground_truth, name="custom_benchmark")
