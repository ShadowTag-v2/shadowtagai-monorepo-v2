...
"""
    ...
    try:
        ...
        assert any("os" in v.lower() or "import" in v.lower() for v in validation.violations), (
            "Should identify prohibited import"
        )
        assert any("system" in v.lower() or "eval" in v.lower() for v in validation.violations), (
