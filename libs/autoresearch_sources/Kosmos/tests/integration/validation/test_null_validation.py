...
from kosmos.validation import NullModelValidator, ScholarEvalValidator
...
class TestFindingIntegration:
    ...
    def test_finding_stores_null_model_result(self):
        ...
        assert finding.null_model_result["passes_null_test"]
...
class TestFullPermutationValidation:
    ...
    def test_full_permutation_with_correlation(self):
        ...
        result = validator.validate_finding(finding, data=data, analysis_func=correlation_analysis)
    ...
    def test_full_permutation_detects_noise(self):
        ...
        assert not result.passes_null_test or result.persists_in_noise
...
class TestValidationResultQuality:
    ...
    def test_consistency_of_results(self):
        ...
        finding = {
            "statistics": {"test_type": "t_test", "statistic": 3.0, "degrees_of_freedom": 50}
        }
