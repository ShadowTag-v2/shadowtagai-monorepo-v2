...
class TestResearchConvergence:
    ...
    def test_research_reaches_convergence_via_iteration_limit(self, convergence_detector):
        ...
        research_plan = ResearchPlan(research_question="Test research", max_iterations=5)
        research_plan.iteration_count = 5

        # Create some hypotheses and results
        factory = ResearchScenarioFactory()
        hypotheses = [factory.create_simple_hypothesis(hypothesis_id=f"hyp_{i}") for i in range(3)]
        results = []

        # Check convergence
        decision = convergence_detector.check_convergence(
            research_plan=research_plan, hypotheses=hypotheses, results=results
        )
    ...
    def test_research_reaches_convergence_via_hypothesis_exhaustion(self, convergence_detector):
        ...
        research_plan = ResearchPlan(research_question="Test research", max_iterations=10)
        ...
        factory = ResearchScenarioFactory()
        hypotheses = [
            factory.create_simple_hypothesis(hypothesis_id=f"hyp_{i}") for i in range(1, 4)
        ]

        # Create results
        results = [
            factory.create_successful_result(factory.create_experiment_protocol(h))
            for h in hypotheses
        ]
...
class TestConvergenceReportCompleteness:
    ...
    def test_convergence_report_complete(self, convergence_detector):
        ...
        scenario = factory.create_complete_scenario(
            domain="biology", num_hypotheses=5, num_results_per_hypothesis=1
        )
    ...
    def test_convergence_report_markdown_export(self, convergence_detector):
        ...
        # Create scenario
        factory = ResearchScenarioFactory()
        scenario = factory.create_complete_scenario(domain="biology", num_hypotheses=3)
...
class TestHypothesisRefinement:
    ...
    def test_hypothesis_refinement_across_iterations(self, convergence_detector):
        ...
        iteration1_hypotheses = [
            factory.create_simple_hypothesis(hypothesis_id="hyp_iter1_1", novelty_score=0.9),
            factory.create_simple_hypothesis(hypothesis_id="hyp_iter1_2", novelty_score=0.85),
        ]
...
class TestKnowledgeAccumulation:
    ...
    def test_knowledge_accumulates_across_iterations(self, convergence_detector):
        ...
        for iteration in range(1, 4):
            ...
            factory = ResearchScenarioFactory()
            new_hyp = factory.create_simple_hypothesis(hypothesis_id=f"hyp_iter{iteration}")
            ...
            research_plan = ResearchPlan(
                research_question="Cumulative knowledge test", max_iterations=10
            )
...
class TestEarlyConvergenceDetection:
    ...
    def test_early_convergence_detection_novelty_decline(self):
        ...
        detector = ConvergenceDetector(
            ...
            config={"novelty_decline_threshold": 0.3, "novelty_decline_window": 3},
        )
        ...
        research_plan = ResearchPlan(research_question="Early convergence test", max_iterations=10)
        research_plan.iteration_count = 3
...
class TestMaxIterationsReached:
    ...
    def test_max_iterations_reached_graceful_stop(self, convergence_detector):
        ...
        research_plan = ResearchPlan(research_question="Max iterations test", max_iterations=5)
        research_plan.iteration_count = 5
    ...
    def test_continues_before_max_iterations(self, convergence_detector):
        ...
        research_plan = ResearchPlan(research_question="Continue test", max_iterations=10)
    ...
    def test_convergence_metrics_at_max_iterations(self, convergence_detector):
        ...
        scenario = factory.create_complete_scenario(
            domain="biology", num_hypotheses=5, num_results_per_hypothesis=2
        )
