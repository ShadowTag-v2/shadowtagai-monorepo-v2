...
world_model:
  ...
  production:
    postgres:
      url: postgresql://REDACTED_USER:REDACTED_PASS@staticmethod
...
world_model:
  ...
  production:
    ...
    postgres:
      url: postgresql://REDACTED_USER:REDACTED_PASS@localhost:5432/kosmos
      pool_size: 10
      max_overflow: 20
...
world_model:
  ...
  production:
    postgres:
      url: postgresql://REDACTED_USER:REDACTED_PASS@kosmos.abc123.us-west-2.rds.amazonaws.com:5432/kosmos
      pool_size: 20
