...
DATABASE_URL=postgresql://REDACTED_USER:REDACTED_PASS@postgres:5432/kosmos
...
export DATABASE_WRITE_URL=postgresql://REDACTED_USER:REDACTED_PASS@primary:5432/kosmos
export DATABASE_READ_URL=postgresql://REDACTED_USER:REDACTED_PASS@replica:5432/kosmos
```
