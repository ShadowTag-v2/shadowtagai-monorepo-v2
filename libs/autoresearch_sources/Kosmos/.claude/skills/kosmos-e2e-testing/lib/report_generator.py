...
def generate_dependency_report(project_root: str = ".", output_path: str | None = None) -> str:
    ...
    service_issues = sum(
        1 for key in ["neo4j", "redis", "chromadb"] if not detection.get(key, False)
    )
    ...
    config_vars = [
        ...
        (
            ...
            detection.get("semantic_scholar", False),
    ...
    from .provider_detector import recommend_provider, recommend_test_tier
