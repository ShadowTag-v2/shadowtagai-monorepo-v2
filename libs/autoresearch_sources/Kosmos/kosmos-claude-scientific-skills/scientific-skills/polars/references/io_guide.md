...
# Read entire table
df = pl.read_database("SELECT * FROM users", connection_uri="postgresql://REDACTED_USER:REDACTED_PASS@localhost/db"
)
```
...
engine = create_engine("postgresql://REDACTED_USER:REDACTED_PASS@localhost/db")
...
**PostgreSQL:**
```python
uri = "postgresql://REDACTED_USER:REDACTED_PASS@localhost:5432/database"
