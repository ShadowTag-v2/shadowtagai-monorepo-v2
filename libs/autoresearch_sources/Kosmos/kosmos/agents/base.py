...
class BaseAgent:
    ...
    def __init__(
        ...
        self._message_router: (
            Callable[[AgentMessage], None] | Callable[[AgentMessage], Awaitable[None]] | None
        ) = None
    ...
    def send_message_sync(
        ...
        try:
            ...
            future = asyncio.run_coroutine_threadsafe(
                self.send_message(to_agent, content, message_type, correlation_id), loop
            )
    ...
    def set_message_router(
        self, router: Callable[[AgentMessage], None] | Callable[[AgentMessage], Awaitable[None]]
    ):
        """
