...
class NotebookMetadata:
    ...
    cell_line_mappings: list[dict] | None = None  # [{cell_index, start_line, end_line, code_hash}]
...
class NotebookGenerator:
    ...
    def _create_header(
        self, title: str, hypothesis: str | None, analysis_type: str, cycle: int, task_id: int
    ) -> str:
