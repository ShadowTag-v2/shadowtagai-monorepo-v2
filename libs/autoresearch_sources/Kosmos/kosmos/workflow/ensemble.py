...
class ConvergenceAnalyzer:
    ...
    def _create_finding_match(
        ...
        run_indices = sorted({run_idx for run_idx, _ in cluster})
...
class EnsembleRunner:
    ...
    def __init__(
        ...
        self.run_configs = [
            RunConfig(
                run_id=f"run_{i}", seed=self.seeds[i], temperature=self.temperatures[i], run_index=i
            )
...
class ConvergenceReporter:
    ...
    def save_report(
        self, result: EnsembleResult, output_path: str | None = None, format: str = "markdown"
    ) -> str:
        """
        Save report to file.
