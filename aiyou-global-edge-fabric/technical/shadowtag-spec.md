# ShadowTagAI Specification — Cryptographic Provenance Layer
...
ShadowTagAI provides **L0→L4 attestation** for every data artifact:
...
- **In-band:** HTTP header `X-ShadowTagAI: <base64(cbor_manifest)>`
...
```json
{
  ...
  "issuer": "did:web:shadowtag-omega-v4.global",
  ...
  "proof": {
    ...
    "verificationMethod": "did:web:shadowtag-omega-v4.global#key-1",
...
4. Emit L4 record
5. Push to Kafka/NATS + ShadowTagAI ledger API
...
```typescript
import { verify } from '@shadowtag-omega-v4/shadowtag';
