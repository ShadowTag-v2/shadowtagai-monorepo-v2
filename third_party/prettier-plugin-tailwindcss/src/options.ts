...
export function createMatcher(
  ...
  const staticAttrsRegex: RegExp[] = [...defaults.staticAttrsRegex];
  const functionsRegex: RegExp[] = [...defaults.functionsRegex];
  ...
  return {
    hasStaticAttr: (name: string) => {
      ...
      const newName = nameFromDynamicAttr(name, parser);
