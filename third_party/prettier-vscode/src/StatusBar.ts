...
export class StatusBar implements Disposable {
  ...
  constructor() {
    ...
    this.languageStatusItem = languages.createLanguageStatusItem("prettier.status", []);
  ...
  public update(result: FormatterStatus): void {
    ...
    switch (result) {
      ...
      case FormatterStatus.Error:
        ...
        break;
      default:
        this.statusBarItem.backgroundColor = new ThemeColor("statusBarItem.fourgroundBackground");
