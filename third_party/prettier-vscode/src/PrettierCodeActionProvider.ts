...
export class PrettierCodeActionProvider implements CodeActionProvider {
  public static readonly providedCodeActionKinds = [CodeActionKind.SourceFixAll.append("prettier")];
  ...
  private shouldProvideCodeActions(document: TextDocument): boolean {
    ...
    const codeActionsOnSave = editorConfig.get<Record<string, string>>("codeActionsOnSave", {});
