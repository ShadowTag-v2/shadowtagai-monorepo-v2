...
export function getWorkspaceConfig(scope?: TextDocument | Uri): PrettierVSCodeConfig {
  const config = workspace.getConfiguration("prettier", scope) as unknown as PrettierVSCodeConfig;
