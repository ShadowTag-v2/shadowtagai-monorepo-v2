 ...
 */
function resolveNodeModule(moduleName: string, parent: string): string | undefined {
  try {
 ...
 */
export function resolveConfigPlugins(config: PrettierOptions, fileName: string): PrettierOptions {
