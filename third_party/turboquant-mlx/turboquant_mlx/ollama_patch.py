...
class OllamaStats:
    ...
    def summary(self) -> Dict[str, Any]:
        ...
        savings_mb = (self.estimated_kv_bytes_uncompressed - self.estimated_kv_bytes_compressed) / (1024 * 1024)
...
class TurboQuantOllamaClient:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if not HAS_OPENAI:
            raise ImportError("openai package is required for TurboQuantOllamaClient. Install it with: pip install openai")
