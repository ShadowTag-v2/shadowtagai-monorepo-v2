...
class WalshHadamardRotation:
    ...
    def __init__(self, dim: int, seed: int = 42):
        ...
        mx.random.seed(seed)
        self.d1 = mx.where(mx.random.uniform(shape=(self.padded_dim,)) > 0.5, mx.array(1.0, dtype=mx.float32), mx.array(-1.0, dtype=mx.float32))
        self.d2 = mx.where(mx.random.uniform(shape=(self.padded_dim,)) > 0.5, mx.array(1.0, dtype=mx.float32), mx.array(-1.0, dtype=mx.float32))
