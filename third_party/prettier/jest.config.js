...
let PRETTIER_DIR = isProduction ? path.join(PROJECT_ROOT, "dist/prettier") : PROJECT_ROOT;
let PRETTIER_INSTALLED_DIR = "";
if (
  INSTALL_PACKAGE ||
  (isProduction && !TEST_STANDALONE && !SKIP_PRODUCTION_INSTALL && TEST_RUNTIME === "nodejs")
) {
...
const config = {
  ...
  testPathIgnorePatterns: testPathIgnorePatterns.map((file) => `<rootDir>/${file}`),
  // collectCoverage: ENABLE_CODE_COVERAGE,
  collectCoverageFrom: ["<rootDir>/src/**/*.js", "<rootDir>/bin/**/*.js"],
  coveragePathIgnorePatterns: ["<rootDir>/src/standalone.js", "<rootDir>/src/document/debug.js"],
  ...
  modulePathIgnorePatterns: ["<rootDir>/dist", "<rootDir>/website", "<rootDir>/scripts/release"],
  transform: {},
