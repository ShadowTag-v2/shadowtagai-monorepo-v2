...
export default function SidebarOptions({ categories, availableOptions, optionValues }, { emit }) {
  const onOptionValueChange = (option, value) => emit("option-value-change", option, value);
