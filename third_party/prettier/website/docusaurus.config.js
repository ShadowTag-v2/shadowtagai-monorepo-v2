...
const config = {
  ...
  stylesheets: ["https://unpkg.com/@sandhose/prettier-animated-logo@1.0.3/dist/wide.css"],
    ...
    [
      ...
      /** @type {import('@docusaurus/preset-classic').Options} */
      {
        docs: {
          ...
          breadcrumbs: false,
          lastVersion: process.env.PULL_REQUEST === "true" ? "current" : undefined,
          versions: {
            current: {
              label: "next",
              badge: false,
        ...
        theme: {
          customCss: ["./src/css/custom.css", require.resolve("react-tweet/theme.css")],
        },
        gtag: {
