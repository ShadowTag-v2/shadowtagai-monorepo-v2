  ...
  invalid: [
    {
      ...
      output: 'return ((  ((key === "object")) && (( parent.type === "MemberExpression" ))  ));',
...
test("massage-ast-parameter-names", {
  valid: ["function notMatchedName(a, b) {}", "function massageAstNode(original, cloned) {}"],
  invalid: [
    {
      code: "function massageAstNode(theOriginalNode, cloned) {delete theOriginalNode.property}",
      output: "function massageAstNode(original, cloned) {delete original.property}",
      errors: 1,
    },
    {
      code: "function massageAstNode(original, theClonedNode) {delete theClonedNode.property}",
      output: "function massageAstNode(original, cloned) {delete cloned.property}",
      errors: 1,
    },
    {
      code: "function massageAstNode(original, cloned, theParentNode) {delete theParentNode.property}",
      output: "function massageAstNode(original, cloned, parent) {delete parent.property}",
      errors: 1,
    },
  ],
});
