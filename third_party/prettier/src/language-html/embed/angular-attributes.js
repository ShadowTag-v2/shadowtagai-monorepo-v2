...
import { getTextValueParts, getUnescapedAttributeValue } from "../utilities/index.js";
import { isAngularInterpolation, printAngularInterpolation } from "./angular-interpolation.js";
import { formatAttributeValue, printExpand, shouldHugJsExpression } from "./utilities.js";

/**
@import {AttributeValuePrinter} from "./attribute.js"
*/

const createAngularPrinter = (parser) => (textToDoc, print, path /* , options*/) =>
...
const printers = [
  ...
  test: (path, options) => options.parser === "angular" && test(path /* , options */),
  print,
}));
