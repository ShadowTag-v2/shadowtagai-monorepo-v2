import { fill, group, hardline, ifBreak, indent, line, softline } from "../../document/index.js";
...
import { printDanglingCommentsInList, printOptionalToken } from "./miscellaneous.js";
        ...
        [
          ...
          indent([
            ...
            shouldUseConciseFormatting
              ...
              : [
                  printArrayElements(path, options, print, elementsProperty, node.inexact),
                  trailingComma,
                ],
