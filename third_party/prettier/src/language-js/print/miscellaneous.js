import { group, hardline, ifBreak, indent, softline } from "../../document/index.js";
import { printDanglingComments } from "../../main/comments/print.js";
import { CommentCheckFlags, hasComment } from "../utilities/comments.js";
import { createTypeCheckFunction } from "../utilities/create-type-check-function.js";
import { isCallExpression, isMemberExpression } from "../utilities/node-types.js";
...
const isLogicalNot = (node) => node.type === "UnaryExpression" && node.operator === "!";
...
function printDanglingCommentsInList(path, options, filter) {
  ...
  return hasComment(node, CommentCheckFlags.Dangling, filter)
    ? [
        ...
        hasComment(node, CommentCheckFlags.Dangling | CommentCheckFlags.Line, filter)
          ? hardline
          : softline,
      ]
    : "";
