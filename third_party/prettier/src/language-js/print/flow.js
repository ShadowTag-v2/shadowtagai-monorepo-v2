...
import { printClass, printClassBody, printClassMemberSemicolon } from "./class.js";
import {
  printComponent,
  printComponentParameter,
  printComponentTypeParameter,
} from "./component.js";
import { printEnumDeclaration, printEnumMember, printFlowEnumBody } from "./enum.js";
...
import { printDeclareToken, printOptionalToken, printSemicolon } from "./miscellaneous.js";
...
import { printTypeAnnotation, printTypeAnnotationProperty } from "./type-annotation.js";
...
function printFlow(path, options, print, args) {
  ...
  switch (node.type) {
    ...
    case "RecordExpression":
      return [print("recordConstructor"), print("typeArguments"), " ", print("properties")];
