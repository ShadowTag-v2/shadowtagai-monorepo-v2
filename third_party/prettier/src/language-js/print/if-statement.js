...
import { printIfStatementAlternate, printIfStatementConsequent } from "./clause.js";
...
function printIfStatement(path, options, print) {
  ...
  parts.push(needSpace ? " " : "", "else", group(printIfStatementAlternate(path, options, print)));
