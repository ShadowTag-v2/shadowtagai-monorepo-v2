...
export const __ng_interpolation = /* @__PURE__ */ createParser(parseInterpolationExpression);
export const __ng_directive = /* @__PURE__ */ createParser(parseTemplateBindings);
