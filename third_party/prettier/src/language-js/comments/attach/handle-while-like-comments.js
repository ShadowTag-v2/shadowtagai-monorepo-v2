import { addLeadingComment, addTrailingComment } from "../../../main/comments/utilities.js";
...
*/
function handleWhileLikeComments({ comment, precedingNode, enclosingNode, followingNode, text }) {
  if (
    !(
      (enclosingNode?.type === "WhileStatement" || enclosingNode?.type === "WithStatement") &&
      followingNode
    )
  ) {
    return false;
