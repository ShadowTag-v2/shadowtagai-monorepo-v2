import { group, hardline, indent, label, line, mapDoc } from "../../document/index.js";
      ...
      if (i % 2 === 0) {
        if (component) {
          ...
          if (options.__embeddedInHtml) {
            component = component.replaceAll(/<\/(?=script\b)/gi, String.raw`<\/`);
          }
...
export { isAngularComponentTemplate, isEmbedHtml, printEmbedAngular, printEmbedHtml };
