...
export type DestructuringPattern = BindingName | AssignmentPattern | MemberExpression | RestElement;
...
export type AFunction = FunctionDeclaration | FunctionExpression | ArrowFunctionExpression;
...
export type StatementParentArray = SwitchCase | Program | BlockStatement | StaticBlock;
...
export type ObjectPropertyKey = Identifier | StringLiteral | NumericLiteral | BigIntLiteral;
...
export type PropertyName = ClassPropertyNameComputed | ClassPropertyNameNonComputed;
export type ClassPropertyNameComputed = Expression;
export type ClassPropertyNameNonComputed = PrivateIdentifier | ObjectPropertyKey;
...
export interface EnumDeclaration extends BaseNode {
  ...
  id: Identifier;
  body: EnumNumberBody | EnumBigIntBody | EnumStringBody | EnumBooleanBody | EnumSymbolBody;
}
...
export interface DeclareExportDefaultDeclaration extends DeclareExportDeclarationBase {
  type: "DeclareExportDeclaration";
  declaration: DeclareClass | DeclareFunction | DeclareComponent | DeclareHook | TypeAnnotationType;
  default: true;
...
export type JSXChild = JSXElement | JSXExpression | JSXFragment | JSXText | JSXSpreadChild;
...
export interface RecordDeclarationBody extends BaseNode {
  ...
  elements: ReadonlyArray<
    RecordDeclarationProperty | RecordDeclarationStaticProperty | MethodDefinition
  >;
}
