...
import { getLeftSidePathName, hasNakedLeftSide } from "../utilities/left-side.js";
import {
  isCallExpression,
  isMemberExpression,
    ...
    case "ClassExpression":
      ...
      if (key === "superClass") {
        ...
        if (
          ...
          (superClass.type === "ClassExpression" && isNonEmptyArray(superClass.decorators))
        ) {
          return true;
        }
      }
...
function willReturnOrThrowStatementBreak(path, options) {
  ...
  */
  ...
  if (
    (node.type === "SequenceExpression" || node.type === "AssignmentExpression") &&
