...
describe("AstPath", () => {
  ...
  test("AstPath#call()", () => {
    ...
    expect(path.call(() => path.getValue(), "noneExitsProperty")).toBeUndefined();
    expect(path.call(() => path.getValue(), "propertyWithUndefinedValue")).toBeUndefined();
    expect(path.call(() => path.getValue(), "propertyWithNullValue")).toBeNull();
    expect(
      path.call(() => path.getValue(), "noneExitsProperty", "noneExitsPropertyChild"),
    ).toBeUndefined();
  });
  ...
  test("AstPath#map()", () => {
    ...
    expect(path.map(() => path.getValue(), "children")).toStrictEqual(ast.children);
