...
export const FORMAT_TEST_DIRECTORY = normalizeDirectory(path.join(__dirname, "../../format/"));

export const { FULL_TEST, TEST_STANDALONE, NODE_ENV, TEST_RUNTIME } = process.env;
