...
describe("apply editorconfig for stdin-filepath with nonexistent directory", () => {
  runCli("cli", ["--stdin-filepath", "config/editorconfig/nonexistent/one/two/three.js"], {
    input: outdent`
        function f() {
          console.log("should be indented with a tab");
        }
...
describe("apply editorconfig for stdin-filepath with a deep path", () => {
  runCli("cli", ["--stdin-filepath", "config/editorconfig/" + "a/".repeat(30) + "three.js"], {
    input: outdent`
        function f() {
          console.log("should be indented with a tab");
        }
...
describe("don’t apply editorconfig outside project for stdin-filepath with nonexistent directory", () => {
  runCli(
    "cli",
    ["--stdin-filepath", "config/editorconfig/repo-root/nonexistent/one/two/three.js"],
    {
      input: outdent`
        function f() {
