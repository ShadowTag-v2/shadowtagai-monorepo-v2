...
class Refinements {
  ...
  // Refinements work properly
}
else
{
  (this.#p
  : number) // Error #p is null or undefined
}
}
}
...
class RefinementClashes {
  ...
  test1() {
    if (this.#p === 3) {
      (this.p
      : 3) // Error, this.#p doesn't refine this.p
      (this.#p
      : 3)
      this.p = 4
      (this.p
      : 4)
      (this.#p
      : 4) // Error, this.p doesnt refine this.#p
      (this.#p
      : 3) // this.p doesnt havoc this.#p
      this.#p = 3
      (this.p
      : 3) // Error, this.#p doesnt refine this.p
      (this.p
      : 4) // this.#p doesnt havoc this.p
    }
    (this.#p
    : 3) // Error, Havoc happens as normal
  }
  test2() {
