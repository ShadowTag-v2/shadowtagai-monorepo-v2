...
class Base {
  ...
  annotatedInitializedFieldValid:
  ?number = 42
  ...
  static annotatedInitializedFieldValid:
  ?number = 42
 ...
 */
(o.initializedFieldWithThis
: number)
(o.initializedFieldWithThis
: string) // Error: number ~> string
(Base.initializedFieldWithThis
: string)
(Base.initializedFieldWithThis
: number) // Error: string ~> number
 ...
 *  the initializer)
 */
(o.annotatedInitializedFieldValid
: ?number)
(o.annotatedInitializedFieldValid
: number) // Error: ?number ~> number
(Base.annotatedInitializedFieldValid
: ?number)
(Base.annotatedInitializedFieldValid
: number) // Error: ?number ~> number
 ...
 */
(o.annotatedInitializedFieldInvalid
: number)
(o.annotatedInitializedFieldInvalid
: string) // Error: number ~> string
(Base.annotatedInitializedFieldInvalid
: number)
(Base.annotatedInitializedFieldInvalid
: string) // Error: number ~> string
