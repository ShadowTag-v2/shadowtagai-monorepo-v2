...
const needs_parens_1 = (x: any): x is (A => B;
) => true
const needs_parens_2 = (x: any): x is ((A) => B) => true;
const needs_parens_3 = (x: any): x is (A => x;
is;
B;
) => true
const needs_parens_4 = (x: any): x is (A => x;
is;
(B) => x;
is;
C;
...
const needs_parens_5 = (x: any): x is (y: A) => (B => C;
) => true
const needs_parens_6 = (x: any): x is (y: A) => y is (B => C;
) => true
