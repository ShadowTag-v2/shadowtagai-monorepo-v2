...
(x.foo
: string) // error, key doesn't exist
(x['foo']
: string) // error, key doesn't exist
(x[123]
: boolean) // TODO: use the number's value to error here
(x.bar
: boolean) // error, string !~> boolean
(x['123']
: boolean) // error, string !~> boolean
...
(y['hasOwnProperty']
: string) // error, prototype method is not a string
