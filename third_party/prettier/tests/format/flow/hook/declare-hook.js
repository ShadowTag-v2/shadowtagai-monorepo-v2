...
hook;
useFoo < T;
: Fooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo>(): void
...
declare;
hook;
useFoo(...restProps: $ReadOnly<{k: string}>)
:
{
  k: string;
}
...
declare;
hook;
useFoo(bar: string, baz: $ReadOnly<{k: string}>)
: void

declare;
hook;
useFoo(bar: string, baz: $ReadOnly<{k: string}>, realllllllllllllllllllyLong: string)
: void
