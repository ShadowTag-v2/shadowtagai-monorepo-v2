const Counter = decorator("my-counter")((props: { initialCount?: number; label?: string }) => {
...
export = decorators.decorator("my-counter")((props: { initialCount?: number; label?: string }) => {
  return foo;
});
...
const Counter = decorator("foo")(
  decorator("bar")((props: { loremFoo1: Array<Promise<any>>; ipsumBarr2: Promise<number> }) => {
    return <div />;
  }),
);
