...
function y() {
  ...
  const stillTooLong = <
    Immutable.Map<string, boolean, number, object, null, undefined, any, void, never>
  >someExistingConfigMap.mergeDeep(fallbackOptions);

  const stillTooLong2 = <
    Immutable.Map<string, boolean, number, object, null, undefined, any, void, never> | undefined
  >someExistingConfigMap.mergeDeep(fallbackOptions);

  const stillTooLong3 = <Immutable.Map<string>>(
    someExistingConfigMap.mergeDeep(fallbackOptions.someMethodWithLongName(param1, param2))
  );
  ...
  const testObjLiteral2 = <
    Immutable.Map<string, any, number, boolean, object, null, undefined, never, "extra long">
...
function x() {
  ...
  const stillTooLong = <PermissionsChecker<object> | undefined | number | string | boolean>(
  ...
  const stillTooLong3 = <PermissionsChecker<object> | undefined>(
    (<any>permissions.someMethodWithLongName(parameter1, parameter2))[receiverTypeLongName]
  );
  ...
  const testObjLiteral2 = <
    PermissionsChecker<object> | undefined | number | string | boolean | null | never | object
  >{ prop1: "myPropVal" };
