export const getVehicleDescriptor = async (vehicleId: string): Promise<Descriptor> => {};
...
export const getVehicleDescriptor = async (vehicleId: string): Promise<keyof Descriptor> => {};
