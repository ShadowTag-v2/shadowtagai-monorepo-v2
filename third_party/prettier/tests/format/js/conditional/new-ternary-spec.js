...
const lessShort = isLoudReallyLoud() ? makeNoiseReallyLoudly.omgSoLoud() : silent();
...
const inReturn = () => {
  ...
  return typeof row[aVeryLongFieldName] !== "undefined" ? row[aVeryLongFieldName] : null;
};
...
const someJSX = (
  <div>
    ...
    When the consequent is `null` and the alternate breaks, hug it with parens to match boolean
    behavior:
    {!thing ? null : <TheThing thing={thing} someVeryLongPropertyThatBreaksTheAlternate="hello" />}
  </div>
);
