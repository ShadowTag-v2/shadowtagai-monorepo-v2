...
const inlineComment = /* some comment */ someReallyLongFunctionCall(withLots, ofArguments);
...
const assignment = /** @type {string} */ (getValue());
const value = /** @type {string} */ (this.members[0]).functionCall();
