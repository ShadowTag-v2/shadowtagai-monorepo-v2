...
not_broken_end = (
  <div>
    long text long text long text long text long text long text long text long text <link>url</link>{" "}
    long text long text
  </div>
);
...
not_broken_begin = (
  <div>
    <br /> long text long text long text long text long text long text long text long text
