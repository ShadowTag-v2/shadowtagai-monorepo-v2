...
"""
    ...
    def generate_visualizations(self, analysis_report: str) -> str:
        ...
        scores = {"Architecture": 85, "Ethical Compliance": 92, "Coverage": 78, "Performance": 80, "Quality": 83, "Edge Case Readiness": 75}
...
def main():
    parser = argparse.ArgumentParser(description="Run Gemini 2.0 Pro analysis on Intelligence Pipeline")
    parser.add_argument(
        "--output",
        type=Path,
    ...
    parser.add_argument("--base-path", type=Path, default=Path(__file__).parent.parent, help="Base path to intelligence-pipeline directory")
