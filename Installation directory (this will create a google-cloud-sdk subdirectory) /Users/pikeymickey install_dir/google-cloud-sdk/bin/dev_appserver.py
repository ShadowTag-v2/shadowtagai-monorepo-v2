...
def main():
  ...
  update_manager.UpdateManager.EnsureInstalledAndRestart(components, command=__file__)
  ...
  emulator_script = (
    "cloud_datastore_emulator.cmd"
    if platforms.OperatingSystem.IsWindows()
    else "cloud_datastore_emulator"
  )
  args.append(
    "--datastore_emulator_cmd={}".format(os.path.join(emulator_dir, emulator_script))
  )
