...
class ChromaStore(VectorStore):
    ...
    def query(self, vector: list[float], top_k: int = 5, filters: dict | None = None, **kwargs) -> list[RetrievedChunk]:
        ...
        if results and results["ids"] and results["ids"][0]:
            for i, result_id in enumerate(results["ids"][0]):
                ...
                chunks.append(RetrievedChunk(id=result_id, text=text_content, score=1.0, metadata=meta))
        return chunks
