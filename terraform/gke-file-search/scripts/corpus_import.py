...
def import_files(project_id: str, region: str, vertical: str, gcs_path: str, chunk_size: int = 512, chunk_overlap: int = 100) -> None:
...
Examples:
  ...
  python corpus_import.py --vertical defense \\
    ...
    parser.add_argument("--chunk-size", type=int, default=512, help="Document chunk size (default: 512)")
    ...
    import_files(args.project, args.region, args.vertical, args.path, args.chunk_size, args.chunk_overlap)
