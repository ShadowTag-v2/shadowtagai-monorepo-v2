...
# GCP Service Account for pnkln orchestrator
resource "google_service_account" "pnkln_orchestrator" {
  account_id   = "pnkln-orchestrator"
  display_name = "Pnkln Orchestrator Service Account"
  description  = "Service account for pnkln orchestrator workloads"
...
resource "google_service_account_iam_member" "workload_identity_binding" {
  service_account_id = google_service_account.pnkln_orchestrator.name
  role               = "roles/iam.workloadIdentityUser"
  member             = "serviceAccount:${var.project_id}.svc.id.goog[pnkln-production/pnkln-orchestrator]"
...
output "service_account_email" {
  value       = google_service_account.pnkln_orchestrator.email
  description = "GCP Service Account email for pnkln orchestrator"
}

output "workload_identity_annotation" {
  value       = "iam.gke.io/gcp-service-account: ${google_service_account.pnkln_orchestrator.email}"
