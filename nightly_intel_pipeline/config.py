...
ARXIV_CONFIG = {
    ...
    "search_terms": ["MLOps", "LLM", "large language model", "model serving", "ML infrastructure", "AI governance", "model monitoring"],
}
...
ATP_RISK_LEVELS = {
    ...
    "RA-2": {"severity": "Critical", "controls": ["Automated monitoring", "Rollback capability"], "review": "Senior engineer approval"},
    "RA-3": {"severity": "Moderate", "controls": ["Standard testing", "Code review"], "review": "Peer review"},
...
AGENT_PROPERTIES = {
    "autonomy": {"enabled": True, "description": "Agent operates independently with sequential decision-making"},
...
PIPELINE_SCHEDULE = {
    ...
    "enabled": True,
    "steps": ["ingestion", "jr_scoring", "tier_classification", "synthesis", "tier2_actions", "storage", "briefing_delivery"],
}

# GKE Deployment Configuration
GKE_CONFIG = {
    "enabled": os.getenv("EXECUTION_MODE") == "gke",
    "cluster": {"name": "nightly-intel-cluster", "zone": "us-central1-a", "project_id": os.getenv("GCP_PROJECT_ID", ""), "namespace": "default"},
    "cronjob": {
    ...
    "monitoring": {
        ...
        "alerts": {"runtime_exceeded_minutes": 60, "failure_rate_threshold_percent": 5, "cost_spike_multiplier": 2.0},
    },
    "cost_model": {
