...
class JREngine:
  ...
  def _build_scoring_prompt(
    self, content: str, content_type: str, content_id: str
  ) -> str:
    """
...
"""
  ...
  def score_content(self, content: str, content_type: str, content_id: str) -> JRScore:
    ...
    try:
      logger.info(
        "jr_scoring_started", content_type=content_type, content_id=content_id
      )
  ...
  def _create_error_score(
    self, content_type: str, content_id: str, error: str
  ) -> JRScore:
