...
class IntelDatabase:
    ...
    def _init_database(self):
        ...
        with self._get_connection() as conn:
            ...
            cursor.execute("CREATE INDEX IF NOT EXISTS idx_repos_score ON repositories(total_score)")
    ...
    def store_repository_score(self, repo_name: str, score: JRScore, metadata: dict | None = None):
        ...
        with self._get_connection() as conn:
            ...
            logger.info("repository_score_stored", repo_name=repo_name, score=score.total_score, tier=score.tier.value)
    ...
    def store_paper_score(self, arxiv_id: str, score: JRScore, metadata: dict | None = None):
        ...
        with self._get_connection() as conn:
            ...
            logger.info("paper_score_stored", arxiv_id=arxiv_id, score=score.total_score, tier=score.tier.value)
    ...
    def get_tier_summary(self) -> dict[int, dict[str, int]]:
        ...
        with self._get_connection() as conn:
            ...
            for tier in [1, 2, 3, 4]:
                ...
                summary[tier] = {"repositories": repo_count, "papers": paper_count, "total": repo_count + paper_count}

            return summary

    def store_briefing(self, date_range_start: str, date_range_end: str, briefing_file_path: str, summary: str, tier_counts: dict[int, int]):
