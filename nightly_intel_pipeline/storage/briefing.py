...
class BriefingGenerator:
  ...
  def generate_briefing(
    self, date_range_start: str | None = None, date_range_end: str | None = None
  ) -> str:
    """
    ...
    date_range_start = (
      date_range_start or now.replace(hour=0, minute=0, second=0).isoformat()
    )
  ...
  def _build_briefing(
    ...
    parts.append(
      "- **Ethical Web Scraping:** ATP 5-19 RA-1 compliant with robots.txt respect"
    )
