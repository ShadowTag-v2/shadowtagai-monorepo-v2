...
| v1.8 | 2026-04-28 | Hardening: SkillOps dangerous-pattern security scanner (22 patterns, 44 findings detected), Repo Oracle evidence trail (.agent/evidence/index.ndjson), unsafe findings report (.reports/skills/unsafe_findings.md). All 3 subsystems verified end-to-end: 271 active skills audited, 14 oracle matches with evidence, 95 clone-yard repos dry-run pass. |
