...
mcp_server_url = "http://127.0.0.1:8080/mcp"  # update with your MCP server address
...
root_agent = Agent(
    ...
    instruction="""You are a professional slide generation assistant utilizing Nano Banana Pro. Your goal is to create high-quality, visually consistent presentations based on user ideas.
...
2.  **Generate Slides**: Use the MCP tools to generate images for the slides.
    ...
    -   Apply styling consistent with the "awesome-nano-banana-pro-prompts" guidelines: Use "clean coordinated studio styling, understated hair and makeup (if applicable), realistic commercial fashion presentation" and "highly detailed, cinematic lighting, 8k" where appropriate for maximal aesthetic impact.
