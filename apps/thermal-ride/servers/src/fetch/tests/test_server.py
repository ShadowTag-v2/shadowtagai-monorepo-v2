...
class TestCheckMayAutonomouslyFetchUrl:
    ...
    async def test_allows_when_robots_txt_404(self):
        ...
        with patch("httpx.AsyncClient") as mock_client_class:
            ...
            # Should not raise
            await check_may_autonomously_fetch_url("https://example.com/page", DEFAULT_USER_AGENT_AUTONOMOUS)
...
class TestFetchUrl:
    ...
    async def test_fetch_html_page(self):
        ...
        with patch("httpx.AsyncClient") as mock_client_class:
            ...
            content, prefix = await fetch_url("https://example.com/page", DEFAULT_USER_AGENT_AUTONOMOUS)
    ...
    async def test_fetch_html_page_raw(self):
        ...
        with patch("httpx.AsyncClient") as mock_client_class:
            ...
            content, prefix = await fetch_url("https://example.com/page", DEFAULT_USER_AGENT_AUTONOMOUS, force_raw=True)
    ...
    async def test_fetch_json_returns_raw(self):
        ...
        with patch("httpx.AsyncClient") as mock_client_class:
            ...
            content, prefix = await fetch_url("https://api.example.com/data", DEFAULT_USER_AGENT_AUTONOMOUS)
    ...
    async def test_fetch_404_raises_error(self):
        ...
        with patch("httpx.AsyncClient") as mock_client_class:
            ...
            with pytest.raises(McpError):
                await fetch_url("https://example.com/notfound", DEFAULT_USER_AGENT_AUTONOMOUS)
    ...
    async def test_fetch_500_raises_error(self):
        ...
        with patch("httpx.AsyncClient") as mock_client_class:
            ...
            with pytest.raises(McpError):
                await fetch_url("https://example.com/error", DEFAULT_USER_AGENT_AUTONOMOUS)
    ...
    async def test_fetch_with_proxy(self):
        ...
        with patch("httpx.AsyncClient") as mock_client_class:
            ...
            await fetch_url("https://example.com/data", DEFAULT_USER_AGENT_AUTONOMOUS, proxy_url="http://proxy.example.com:8080")
