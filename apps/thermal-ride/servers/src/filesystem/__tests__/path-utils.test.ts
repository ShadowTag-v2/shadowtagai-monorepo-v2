...
describe('Path Utilities', () => {
  describe('convertToWindowsPath', () => {
    ...
    it('never converts WSL paths (they work correctly in WSL with Node.js fs)', () => {
      ...
      expect(convertToWindowsPath('/mnt/c/NS/MyKindleContent')).toBe('/mnt/c/NS/MyKindleContent');
  ...
  describe('normalizePath', () => {
    it('preserves Unix paths', () => {
      ...
      expect(normalizePath('/usr/local//bin/app///')).toBe('/usr/local/bin/app');
    ...
    it('always preserves WSL paths (they work correctly in WSL)', () => {
      ...
      expect(normalizePath('/mnt/c/NS/MyKindleContent')).toBe('/mnt/c/NS/MyKindleContent');
    ...
    it('handles paths with spaces and mixed slashes', () => {
      ...
      expect(normalizePath('/mnt/c/NS/My Kindle Content')).toBe('/mnt/c/NS/My Kindle Content');
    ...
    it('preserves spaces in all path formats', () => {
      // WSL paths should always be preserved
      expect(normalizePath('/mnt/c/Program Files/App Name')).toBe('/mnt/c/Program Files/App Name');
    ...
    it('handles special characters in paths', () => {
      ...
      expect(normalizePath('C:/NS/Sub&Folder')).toBe('C:\\NS\\Sub&Folder');
      // WSL paths should always be preserved
      expect(normalizePath('/mnt/c/NS/Sub&Folder')).toBe('/mnt/c/NS/Sub&Folder');
  ...
  describe('WSL path handling (issue #2795 fix)', () => {
    ...
    it('should NEVER convert WSL paths - they work correctly in WSL with Node.js fs', () => {
      ...
      expect(normalizePath('/mnt/c/Users/username/folder')).toBe('/mnt/c/Users/username/folder');
    ...
    it('should convert Unix-style Windows paths (/c/) only when running on Windows (win32)', () => {
      ...
      expect(normalizePath('/c/Users/username/folder')).toBe('C:\\Users\\username\\folder');
