...
namespace TsubameViewer.Presentation.Views.Flyouts
{
    public sealed partial class StorageItemMenuFlyout : MenuFlyout
    {
        ...
        public StorageItemMenuFlyout()
        {
            ...
            OpenListupItem.Command = container.GetService<OpenListupCommand>();
            SetThumbnailImageMenuItem.Command = container.GetService<ChangeStorageItemThumbnailImageCommand>();
            AddFavariteImageMenuItem.Command = container.GetService<FavoriteAddCommand>();
            SelectedItems_AddFavariteImageMenuItem.Command = AddFavariteImageMenuItem.Command;
            RemoveFavariteImageMenuItem.Command = container.GetService<FavoriteRemoveCommand>();
            AlbamItemEditMenuItem.Command = container.GetService<AlbamItemEditCommand>();
            SelectedItems_AlbamItemEditMenuItem.Command = AlbamItemEditMenuItem.Command;
            AlbamItemRemoveMenuItem.Command = container.GetService<AlbamItemRemoveCommand>();
            ...
            OpenWithExternalAppMenuItem.Command = container.GetService<OpenWithExternalApplicationCommand>();
            _secondaryTileManager = container.GetService<SecondaryTileManager>();
            _favoriteAlbam = container.GetService<FavoriteAlbam>();
        }
