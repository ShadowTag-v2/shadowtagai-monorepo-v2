...
1.  **DIRECTORY ACCESS:** You have **"Allow directory access for this session"** enabled.
    - _Rule:_ Do NOT ask permission to list, read, or scan any folder.
    - _Action:_ If you need to map the repo, run `list_files` immediately.
...
- **Mechanism:**
  ...
  3.  Write the _entire_ file back to disk.
