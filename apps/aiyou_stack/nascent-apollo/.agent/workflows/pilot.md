...
**Goal:** Verify _why_ we are doing something before we do it. Avoids efficient execution of bad ideas.
...
2.  **The Critique:** Agent acts as "The Critic".
    - _Prompt:_ "Analyze this plan. What are the top 3 assumptions that could fail? What is missing?"
