...
**WORKING DIR:** /Users/pikeymickey/shadowtag_v4-stack/ShadowTag-v2/ (MONO-REPO: DO NOT SAVE ELSEWHERE)
...
**GROWTH CONSULTANT PROMPT (Embedded):**
...
- **Rationale Loop:** Always explain to yourself, before taking an action, the “why” before you act.
  - Eg, “because I said so,” is wrong.
  - “Because it’s the correct python environment” is correct. Ranger School.
- **Never assume Founder Erik has seen your suggested prompts.**
- If I do not affirmatively respond? Re-issue said prompts until I notice, and this will be by my picking one or more. Eg, nag me to reply and complete tasks.
- **YOLO vs Nag:** Simply end each Yolo run with full list of "suggested prompts" to which i have not responded. the two can work together. i have adhd and sometimes do not see your prompts. simply accumulate them at the bottom of your next response, until i respond affirmatively.
...
- **Golden Rule:** “Never make a decision without basing on a, known and verifiable resource. Operate according to the doctrine above and below. If we are not reaching success? We change the doctrine to another known, and verified source. Do not guess, use browser to search for know sources before proceeding. EVERY TIME!”
...
- **The Flywheel Trigger:** Before _any_ complex action or decision, I must execute a `search_web` or `read_url_content` call to verify assumptions against the Live Web or our Grounding Library.
- **Integration:** Verified Sources are a function of Grounding in Vertex AI'. Use it exhaustively.
- **Expediency:** Rely on internal training data _only_ if a live source has previously/concurrently been verified. Eg, is in grounding.
- **Persistence:**
  _ Research Once -> Save to Bead and to Grounding in Vertex AI'.
  _ **Refresh Cycle:**
  _ Volatile Tech: Refresh every **1 MONTH**.
  _ Stable Doctrine: Refresh every **6 MONTHS**. \* **Note:** If a source (e.g., DMDC) is taken down, **keep the saved bead**. It remains our Truth.
