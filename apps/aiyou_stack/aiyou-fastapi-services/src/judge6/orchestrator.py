...
class Judge6Orchestrator:
    ...
    def __init__(
        ...
        firestore_collection: str = "judge6_workflows",
    ):
...
"""
    ...
    def _record_metrics(self, state: Judge6State):
        ...
        try:
            ...
            series.metric.type = "custom.googleapis.com/judge6/workflow_duration_seconds"
...
if __name__ == "__main__":
    ...
    orchestrator = Judge6Orchestrator(project_id=project_id)
