...
def generate_landing_page(
    ...
    custom_domain: str = "ShadowTag-v2-intelligence.com",
) -> str:
...
<body>
    ...
    <pre>curl -H "X-API-Key: your_api_key_here" https://api.ShadowTag-v2-intelligence.com/v1/ingestion/summary</pre>
  ...
  "priority_sources_only": false
    ...
    <h2>Support</h2>
    <p>Need help? Contact us at <a href="mailto:support@ShadowTag-v2-intelligence.com">support@ShadowTag-v2-intelligence.com</a></p>
</body>
</html>"""
