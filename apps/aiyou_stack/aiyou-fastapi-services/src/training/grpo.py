...
class GRPOConfig(BaseModel):
    ...
    epsilon: float = Field(0.2, description="Clipping parameter (for comparison with PPO)")
...
class GRPOSimulator:
    ...
    def compute_grpo_loss(
        ...
        for log_p, adv, old_log_p in zip(log_probs, advantages, old_log_probs, strict=False):
