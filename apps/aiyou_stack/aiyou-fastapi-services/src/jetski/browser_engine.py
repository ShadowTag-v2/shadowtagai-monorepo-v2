...
class JetskiEngine:
    """Browser-based reality check for minion."""
    ...
    def verify_endpoint(self, url: str, expected_status: int = 200) -> dict:
        ...
        # print to standard out so it can be captured by the loop
    ...
    def intercept_and_modify(self, url: str, modifications: dict) -> dict:
        ...
        def interceptor(request):
            ...
            if (
                modifications.get("block_pattern")
                and modifications.get("block_pattern") in request.url
            ):
