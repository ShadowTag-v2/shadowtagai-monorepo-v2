...
class AnalyticsEngineerAgent(BaseAgent):
    ...
    def get_metadata(self) -> AgentMetadata:
        return AgentMetadata(
            ...
            description="Tracks what actually matters. Shows you user behavior, conversion funnels, and real insights.",
...
class SupportBuilderAgent(BaseAgent):
    """Creates help systems that reduce support tickets by 80%. FAQs, chat widgets, documentation."""

    def get_metadata(self) -> AgentMetadata:
        return AgentMetadata(
            name="Support Builder",
            description="Creates help systems that reduce support tickets by 80%. FAQs, chat widgets, documentation.",
            category=AgentCategory.BUSINESS_ANALYTICS,
            icon="💬",
...
class SEOMasterAgent(BaseAgent):
    """Makes Google love your site. Meta tags, schema markup, sitemaps, Core Web Vitals."""

    def get_metadata(self) -> AgentMetadata:
        return AgentMetadata(
            name="SEO Master",
            description="Makes Google love your site. Meta tags, schema markup, sitemaps, Core Web Vitals.",
            category=AgentCategory.BUSINESS_ANALYTICS,
            icon="🔍",
...
class CommunityFeaturesAgent(BaseAgent):
...
class LandingPageOptimizerAgent(BaseAgent):
    """Writes copy that converts visitors to users. Headlines, CTAs, social proof that works."""

    def get_metadata(self) -> AgentMetadata:
        return AgentMetadata(
            name="Landing Page Optimizer",
            description="Writes copy that converts visitors to users. Headlines, CTAs, social proof that works.",
            category=AgentCategory.BUSINESS_ANALYTICS,
            icon="📄",
