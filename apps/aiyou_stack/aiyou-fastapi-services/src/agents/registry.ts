...
export class AgentRegistry implements IAgentRegistry {
  ...
  private registerAllAgents(): void {
    ...
    // Register PNKLN Stack agents
    this.registerAgent(new PNKLNStack.GeminiIngestionAnalyzerAgent());
    this.registerAgent(new PNKLNStack.JudgeSixAnalyzerAgent());
    this.registerAgent(new PNKLNStack.ComponentComparisonAnalyzerAgent());
  }
