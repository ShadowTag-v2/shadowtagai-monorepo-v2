...
def test_llm_rotation_config():
    ...
    from erik_hancock_llm_memory.scripts.llm_blender_rotation import LLM_CONFIGS, LLMProvider
...
async def test_end_to_end_inference():
    ...
    result = orchestrator.execute(
        ...
        context={"use_debate": False, "enable_kernels": True, "trace_id": "test-trace-001"},
    )
