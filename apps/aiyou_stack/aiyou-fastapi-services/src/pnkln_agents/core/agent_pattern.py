...
from .jr_engine import JRDecision, JREngine, Purpose, Reason, get_model_allocation
...
class ShadowTagAiAgent:
    ...
    def _escalate_to_human(
        ...
        result = AgentResult(
            ...
            execution_time_ms=execution_time_ms,
            metadata={
                "escalation_reason": jr_decision.brakes[0].reason
                if jr_decision.brakes
                else "Unknown",
            },
        )
