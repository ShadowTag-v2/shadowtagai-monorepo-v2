...
Indexes PDFs for Flying minion research corpus.
...
from src.ShadowTag-v2.services.corpus_indexer import CorpusIndexer
from src.ShadowTag-v2.services.safety_scanner import SafetyScanner
...
class PDFIndexer:
    """
    Scholarly PDF indexer for Flying minion corpus.
