...
async def service_status() -> dict[str, Any]:
    ...
    return {
        "api": "operational",
        "database": "operational",  # Static status until db connection is implemented
        "redis": "operational",
        ...
        "services": {
            ...
            "infrastructure": {"status": "operational", "endpoints": ["/api/v1/infrastructure"]},
        },
    }
...
if os.path.isdir(landing_pages_dir):
    app.mount("/games", StaticFiles(directory=landing_pages_dir, html=True), name="game-landings")
