...
class DocumentAIProcessor:
    ...
    def process_and_trigger_Cor_Claude_Code_6(
        self,
        bucket_name: str,
        file_path: str,
        mime_type: str = "application/pdf",
...
class CloudFunctionHandler:
    ...
    def handle_gcs_event(self, event: dict[str, Any], context: Any):
        ...
        try:
            ...
            message_id = self.processor.process_and_trigger_Cor_Claude_Code_6(
                bucket_name=bucket_name,
                file_path=file_path,
                mime_type=mime_type,
                use_form_parser=use_form_parser,
...
if __name__ == "__main__":
    ...
    message_id = processor.process_and_trigger_Cor_Claude_Code_6(
