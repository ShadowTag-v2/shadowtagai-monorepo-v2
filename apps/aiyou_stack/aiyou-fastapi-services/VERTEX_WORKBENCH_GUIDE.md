...
```bash
git clone https://github.com/your-org/shadowtag_v4-fastapi-services.git
...
ANTHROPIC_VERTEX_MODEL=claude-3-5-sonnet-v2@20241022
...
- [pinkln Repository Issues](https://github.com/your-org/shadowtag_v4-fastapi-services/issues)
