...
gh api repos/ShadowTag-v2/shadowtag_v4-fastapi-services/deployments \
...
curl -X PATCH https://api.shadowtag_v4.com/admin/flags/new-feature \
...
curl https://api.shadowtag_v4.com/health | jq '.status'
...
**Incident Hotline**: #incidents (Slack) | incidents@shadowtag_v4.com
