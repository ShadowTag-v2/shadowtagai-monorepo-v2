...
class Model:
    ...
    def compile(
        ...
        self.data_loader = partial(dataloader_cls, batch_size=batch_size, repeat=True, shuffle=True)
        ...
        self.optimizer = partial(
            ...
            c1=c1,
            c2=c2,
            n_particles=n_workers,
            compare_fn=lambda x, y: x < y,
            n_iter=batches_per_epoch,
            dims=self._calc_dims(),
            random=True,
    ...
    def fit(self, X, y, epochs=1):
        ...
        for epoch in range(epochs):
            ...
            if self.metric_fn is not None:
                print(f"Metric: {self.metric_fn(y, self.predict(X))}", end="\t")
