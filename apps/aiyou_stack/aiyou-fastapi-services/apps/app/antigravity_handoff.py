...
class TaskType(StrEnum):
    ...
    COR.CLAUDE_CODE_6_BINARY = "Cor.Claude_Code_6_binary"  # <35ms governance
...
class AntigravityRouter:
    ...
    def decide_routing(
        ...
        routing_map = {
            ...
            TaskType.COR.CLAUDE_CODE_6_BINARY: (ModelChoice.GEMINI, 35, 0.0003),
        ...
        use_mcp = context_size_bytes > 10_000 or task_type == TaskType.COR.CLAUDE_CODE_6_BINARY
    ...
    async def _call_gpt5(self, prompt: str, context: dict[str, Any]) -> str:
        ...
        try:
            # Using GPT-4o as proxy for GPT-5
            async with httpx.AsyncClient() as client:
                response = await client.post(
