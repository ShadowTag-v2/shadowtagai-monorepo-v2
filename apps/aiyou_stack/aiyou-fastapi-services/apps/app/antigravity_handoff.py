...
class TaskType(StrEnum):
    ...
    CLAUDE_CODE_6_BINARY = "Claude_Code_6_binary"  # <35ms governance
...
class AntigravityRouter:
    ...
    def decide_routing(
        ...
        routing_map = {
            ...
            TaskType.CLAUDE_CODE_6_BINARY: (ModelChoice.GEMINI, 35, 0.0003),
        ...
        use_mcp = context_size_bytes > 10_000 or task_type == TaskType.CLAUDE_CODE_6_BINARY
