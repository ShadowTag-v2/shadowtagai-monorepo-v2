...
- docs/cor8-shadowtag_v4-global-edge-fabric/03-technical-architecture/gemini-ingestion-layer.md
- docs/cor8-shadowtag_v4-global-edge-fabric/03-technical-architecture/judge-six-validation.md
- docs/cor8-shadowtag_v4-global-edge-fabric/09-implementation/api-schemas.md
"""
...
app = FastAPI(
    title="ShadowTag-v4 PNKLN Core Stack™ API",
    description="""
    **PNKLN Core Stack™** — Intelligence Collection & Validation Pipeline
    ...
    architecture for ShadowTag-v4's verified AI mesh.
