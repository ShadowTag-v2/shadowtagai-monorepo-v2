...
@dataclass
class Cor.Claude_Code_6Decision:
...
class MCPBridge:
    ...
    def __init__(
        ...
        self.decision_cache: dict[str, Cor.Claude_Code_6Decision] = {}

        # Performance tracking
        self.compression_ratios: list[float] = []
        self.Cor.Claude_Code_6_latencies: list[float] = []
    ...
    async def judge_six_binary(
        ...
        Returns:
            Cor.Claude_Code_6Decision with binary output (0=DENY, 1=APPROVE)
        ...
        # Create decision
        Cor.Claude_Code_6 = Cor.Claude_Code_6Decision(
            decision=decision,
        ...
        # Cache
        self.decision_cache[cache_key] = Cor.Claude_Code_6

        # Track performance
        self.Cor.Claude_Code_6_latencies.append(elapsed_ms)
    ...
    def get_p99_latency(self) -> float:
        ...
        if not self.Cor.Claude_Code_6_latencies:
            return 0.0

        sorted_latencies = sorted(self.Cor.Claude_Code_6_latencies)
    ...
    def get_stats(self) -> dict[str, Any]:
        ...
        return {
            ...
            "total_decisions": len(self.Cor.Claude_Code_6_latencies),
