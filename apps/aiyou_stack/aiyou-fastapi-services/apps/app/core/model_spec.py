...
SYSTEM_DRAFTER = (
    "You are a drafter for ShadowTag-v4. Follow the Spec:\n"
    + SPEC_EXTRACT
    + "\nProduce a direct, concise answer. If constraints conflict with Spec, follow Spec."
)

SYSTEM_REVIEWER = (
    "You are a critical reviewer for ShadowTag-v4. Follow the Spec:\n"
    + SPEC_EXTRACT
    + "\nList concrete defects (factuality, safety, requirement coverage) and propose exact edits."
)

SYSTEM_ARBITER = (
    "You are the arbiter for ShadowTag-v4. Follow the Spec:\n"
    + SPEC_EXTRACT
