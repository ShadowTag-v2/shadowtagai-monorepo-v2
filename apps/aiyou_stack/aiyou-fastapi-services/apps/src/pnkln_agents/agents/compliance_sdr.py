...
class LeadGenerationResult:
    ...
    def to_a2ui_payload(self) -> dict[str, Any]:
        ...
        stats = [
            ...
            {"label": "Blocked", "value": len(self.blocked_leads)},
            {"label": "Review", "value": len(self.needs_review_leads)},
        ]
        ...
        components = [
            {
                ...
                "children": ["header", "stats_chart", "cost_summary", "action_bar"],
            },
            {
                "id": "header",
                "type": "Text",
                "props": {
                    "content": f"Lead Gen Report: {len(self.approved_leads)} Approved",
                    "variant": "h1",
                },
            },
            {
            ...
            },
            {
                ...
                "type": "Text",
                "props": {
                    "content": f"Total Cost: ${self.total_cost_usd:.2f} | Price/Lead: ${self.audit_report.get('price_per_lead', 0.10):.2f}",
                    "variant": "body",
                },
            },
            {
                ...
                "type": "Container",
                "props": {"direction": "row"},
                "children": ["download_btn", "restart_btn"],
            },
            {
                "id": "download_btn",
                "type": "Button",
...
class ComplianceSDRAgent(ShadowTagAiAgent):
    ...
    def _is_eu_lead(self, lead: Lead) -> bool:
        ...
        if lead.country_code in self.eu_countries:
            return True
