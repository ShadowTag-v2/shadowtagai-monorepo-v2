...
COR_CLAUDE_CODE_6_URL = "http://localhost:8080/validate"


def check_with_Cor_Claude_Code_6(operation: str, confidence: float, vertical: str) -> bool:
    ...
    try:
        ...
        response = requests.post(COR_CLAUDE_CODE_6_URL, json=payload)
