...
# =============================================================================
# KILL CHAIN PHASE 2: SWARM VOTING (n-autoresearch/Kosmos/BioAgents2 - Default)
# =============================================================================
...
async def _async_swarm_vote(state: GovernanceState) -> GovernanceState:
    ...
    the n-autoresearch/Kosmos/BioAgents swarm with tier-weighted voting.
    """
    start_time = time.perf_counter()
    debate = state.debate
    debate.status = DebateStatus.IN_PROGRESS
...
async def _async_debate(state: GovernanceState) -> GovernanceState:
    ...
    if voting_mode == VotingMode.SWARM:
        # Default: n-autoresearch/Kosmos/BioAgents2 swarm voting
