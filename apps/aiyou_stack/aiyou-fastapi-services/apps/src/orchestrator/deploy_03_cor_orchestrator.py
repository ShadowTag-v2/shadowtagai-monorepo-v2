...
{{
  "steps": [
    {{
      "action": "call_service",
      "service": "Cor.Claude_Code_6-layer1",
      "method": "POST",
      "endpoint": "/infer",
      "payload": {{"key": "value"}},
      "timeout_ms": 100,
...
def deploy_to_vertex_training(
    ...
    job.run(
        ...
        service_account=f"Cor.Claude_Code_6@{project_id}.iam.gserviceaccount.com",
    )
...
def main():
    ...
    job_name = deploy_to_vertex_training(
        ...
        location=location,
        display_name="Cor.Claude_Code_6-orchestrator-v1",
        container_image_uri=f"gcr.io/{project_id}/Cor.Claude_Code_6-orchestrator:latest",
