...
if not os.path.exists("Cor_Claude_Code_6_pipeline.py"):
    print("   >> 'Cor_Claude_Code_6_pipeline.py' missing. Generating Judge 6 Orchestration...")
    with open("Cor_Claude_Code_6_pipeline.py", "w") as f:
        f.write("""
import time
import torch
try:
...
print("   - Model: jura/Cor_Claude_Code_6 (Loading weights...)")
...
subprocess.run([sys.executable, "Cor_Claude_Code_6_pipeline.py"])
