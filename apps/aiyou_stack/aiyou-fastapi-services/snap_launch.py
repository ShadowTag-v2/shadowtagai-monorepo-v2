...
if not os.path.exists("Cor.Claude_Code_6_pipeline.py"):
    print("   >> 'Cor.Claude_Code_6_pipeline.py' missing. Generating Judge 6 Orchestration...")
    with open("Cor.Claude_Code_6_pipeline.py", "w") as f:
        f.write("""
import time
import torch
try:
...
print("   - Model: jura/Cor.Claude_Code_6 (Loading weights...)")
...
subprocess.run([sys.executable, "Cor.Claude_Code_6_pipeline.py"])
