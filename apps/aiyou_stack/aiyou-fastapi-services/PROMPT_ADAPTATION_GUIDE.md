...
### Distribution
- Tier 1 (High Value): __%
  - Characteristics: {criteria}
  - Sources: {primary sources}

- Tier 2 (Medium Value): __%
  - Characteristics: {criteria}
  - Sources: {sources}
...
**Remember**: The best adaptation maps equivalent concepts, not just swaps words. Think about *why* each element exists in the original prompt, then find the equivalent *why* in your target domain.
