...
- **Staging:** <https://staging.omega.example.com>
- **Production:** <https://api.omega.example.com>
...
- [ ] Create GKE deployments: `omega-fastapi-staging`, `omega-fastapi-production`
...
- [ ] Test authentication: `curl -H "X-API-Key: test-key" https://staging.omega.example.com/health`
...
**Branch C (ShadowTag-v4):** 1 gap remaining
