...
{
  "content": "Contact redacted@shadowtag-v4.local for details. SSN: 123-45-6789. Credit card: 4532-1234-5678-9010.",
  "scrub_pii": true,
  "check_safety": true
}
...
Raw Intel: "Source: John Doe (redacted@shadowtag-v4.local, SSN: 123-45-6789)"
...
User Query: "Check status for email redacted@shadowtag-v4.local"
→ PII detected: email
...
curl -X POST http://localhost:8080/api/v1/cor17/safety/moderate \
  -H "Content-Type: application/json" \
  -d '{"content": "Email: redacted@shadowtag-v4.local"}'
