# ShadowTag-v4 Safety-Case SaaS Framework - Tech Stack
...
└─────────────────────────────────────────────────────────────┘
                            ...
                            ↓
┌─────────────────────────────────────────────────────────────┐
│  Production Services (ShadowTag, ShadowTag-v4)                     │
│  - FastAPI / Next.js                                        │
...
export CU_GOAL="Open docs.shadowtag_v4.com and verify header text"
...
```bash
gh repo clone ShadowTag-v2/shadowtag_v4-fastapi-services
...
- **Slack**: #shadowtag_v4-eng (internal)
