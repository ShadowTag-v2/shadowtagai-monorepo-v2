...
The Gemini Ingestion Layer Analysis Prompt is designed to perform comprehensive pre-production analysis of the intelligence collection pipeline, focusing on **proactive data acquisition** rather than reactive validation. This shift reflects the pipeline's role as a foundational layer in the SHADOWTAGAI Core Stack™.
...
- **Rationale**: Prevents over-optimization for quantity at expense of usability in downstream SHADOWTAGAI components
