...
class SwarmStatus:
    ...
    Claude_Code_6_deployed: bool = False
...
║  {"✅" if self.Claude_Code_6_deployed else "⏸️ "} Judge 6 Deployment{"       " if not self.Claude_Code_6_deployed else ""}                                   ║
