...
class SwarmStatus:
    ...
    Cor.Claude_Code_6_deployed: bool = False
    ...
    def get_milestone_count(self) -> str:
        ...
        milestones = [
            ...
            self.Cor.Claude_Code_6_deployed,
...
║  {"✅" if self.Cor.Claude_Code_6_deployed else "⏸️ "} Judge 6 Deployment{"       " if not self.Cor.Claude_Code_6_deployed else ""}                                   ║
