...
Purpose
-------
* Load the existing Judge#6 runtime (`erik-hancock-llm-memory/Claude_Code_6/runtime/base.py`).
...
runtime_path = os.path.join(PROJECT_ROOT, "erik-hancock-llm-memory", "Claude_Code_6", "runtime", "base.py")
