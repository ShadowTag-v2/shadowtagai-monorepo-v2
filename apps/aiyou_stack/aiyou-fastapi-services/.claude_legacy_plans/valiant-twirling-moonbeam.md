...
| File                                          | Changes                         |
| --------------------------------------------- | ------------------------------- |
| `k8s/ShadowTag-v2jr-governance/Cor.Claude_Code_6-enforcer.yaml` | Right-size CPU/Memory           |
...
- `k8s/ShadowTag-v2jr-governance/Cor.Claude_Code_6-enforcer.yaml` - Right-size
