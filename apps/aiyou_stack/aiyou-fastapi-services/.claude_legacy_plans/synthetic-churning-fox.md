...
| 19692984473 | ShadowTag-v4 CI Pipeline               | ❌ FAILED | Billing limit reached     |
...
- `src/shadowtag_v4/routes/cineverse.py` - Add upload endpoints
- `src/shadowtag_v4/services/cineverse/upload.py` - New file
...
```
src/shadowtag_v4/services/revenue/
├── __init__.py
...
| File                            | Purpose                   |
| ------------------------------- | ------------------------- |
| `src/shadowtag_v4/models/cineverse.py` | Content model structure   |
| `src/shadowtag_v4/services/cineverse/` | Existing service patterns |
...
```
src/shadowtag_v4/services/contracts/
├── __init__.py
