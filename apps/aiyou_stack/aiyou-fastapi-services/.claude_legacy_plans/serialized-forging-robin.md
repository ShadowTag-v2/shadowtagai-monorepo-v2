...
```json
{
  ...
  "artifacts": ["terraform/main.tf", "terraform/secrets.tf", "scripts/deploy-all.sh"]
}
```
...
| ---------------------- | -------------- | --------------------------------- |
| n-autoresearch/Kosmos/BioAgents Squadron | ✅ OPERATIONAL | 650 agents, 100% ready, :8600     |
...
- `ca8117` - n-autoresearch/Kosmos/BioAgents server :8600
- `a8b078` - n-autoresearch/Kosmos/BioAgents server :8600
- `b1334d` - n-autoresearch/Kosmos/BioAgents server :8600
