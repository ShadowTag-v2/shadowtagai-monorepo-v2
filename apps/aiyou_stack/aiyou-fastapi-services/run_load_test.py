...
from load_tests.scenarios import LoadTestScenario, get_scenario, list_scenarios
...
class LoadTestRunner:
    ...
    def run_scenario(self, scenario: LoadTestScenario, headless: bool = True) -> bool:
        ...
        if scenario.user_class and scenario.user_class != "ShadowTag-v2User":
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Load Test Runner for ShadowTag-v2 FastAPI Services",
...
Examples:
  ...
  python run_load_test.py --scenario medium --no-headless
    ...
    parser.add_argument(
        "--user-class",
        default="ShadowTag-v2User",
        choices=["ShadowTag-v2User", "QuickLoadUser", "StressTestUser"],
