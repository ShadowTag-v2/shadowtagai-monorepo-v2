# Getting Started — ShadowTag-v4 Global Edge Fabric
...
✅ Technical specs         — ShadowTag, PNT, edge orchestrator
...
ShadowTag-v4 Monte Carlo Simulation Results (10,000 runs)
================================================================
...
| ShadowTag enterprise | $50K/yr   | 85%          | 350:1   |
| PNT site             | $12K/yr   | 70%          | —       |
...
### ShadowTag Cryptographic Provenance
...
- [ ] File provisional patents (ShadowTag, PNT)
...
- [ ] Build ShadowTag L0–L2 (hashing + signing + Merkle tree)
...
1. **Start with:** ShadowTag spec (`technical/shadowtag-spec.md`)
...
2. **ShadowTag audit:** How provenance works

3. **Security:** Multi-source PNT resilience

### For Partners (Starlink / CoreWeave / FAANG)

1. **Value prop:** How ShadowTag-v4 reduces your costs

2. **Integration:** Technical specs (ShadowTag, edge orchestrator)

3. **Economics:** Revenue share models in unit economics

4. **Contact:** <founder@shadowtag_v4.global>
...
- Deck request: [Click here](mailto:founder@shadowtag_v4.global?subject=Investor%20Deck%20Request)

- Partnership inquiries: [Click here](mailto:founder@shadowtag_v4.global?subject=Partnership%20Inquiry)
...
- ✅ Build MVP (ShadowTag + edge orchestrator)
