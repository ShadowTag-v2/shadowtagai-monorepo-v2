...
## 🧩 ShadowTag-v4 PNT Solution — Hybrid Multi-Source Architecture
...
| ShadowTag-v4 edge nodes | Ed25519     | ShadowTag-v4 root key          |
...
```json
{
  ...
  "sources_used": {
    "gnss": { "confidence": 0.7, "satellites": 8 },
    "leo": { "confidence": 0.9, "satellites": 4 },
