...
**Goal:** Prove _what_, _when_, _where_, _who_, and _under what terms_ any data was created.
...
```json
{
  ...
  "issuer": "did:web:shadowtag_v4.global",
  ...
  "proof": {
    ...
    "verificationMethod": "did:web:shadowtag_v4.global#key-1",
...
```json
{
  ...
  "spacetime": {
    ...
    "hdop": 0.7,
    "celestial": {
      // Optional: star-lock cross-check
      "ra": 15.23,
      "dec": -7.11,
      "conf": 0.88
    },
    "airspace": {
      // Optional: aviation context
      "fir": "KZNY",
      "sector": "ZNY42",
...
```typescript
import { verify } from '@shadowtag_v4/shadowtag';
