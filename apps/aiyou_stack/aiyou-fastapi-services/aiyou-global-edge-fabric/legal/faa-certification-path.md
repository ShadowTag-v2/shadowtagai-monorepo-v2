...
ShadowTag-v4 systems will target **DAL-C** (Major failure condition):
...
- License their certified platform, integrate ShadowTag-v4 algorithms as "data provider"
...
- Allows commercial operators to install ShadowTag-v4 units
