...
class EUAIActModule(ComplianceModule):
    ...
    def _define_controls(self) -> list[ControlDefinition]:
        return [
            ...
            ControlDefinition(
                ...
                required_evidence=["Data quality metrics", "Representativeness analysis"],
            ),
            ...
            ControlDefinition(
                ...
                required_evidence=["User documentation", "Interpretability documentation"],
            ),
            ...
            ControlDefinition(
                ...
                required_evidence=["Operator training materials", "Capability documentation"],
            ),
    ...
    async def _check_validation_rule(
        ...
        if rule.rule_id == "EU-AI-VAL-001":
            ...
            has_disclosure = any(ind in content_lower for ind in ai_indicators)
