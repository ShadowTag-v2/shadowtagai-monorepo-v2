    ...
    def _define_controls(self) -> list[ControlDefinition]:
        return [
            ...
            ControlDefinition(
                ...
                required_evidence=["Risk assessment procedures", "Mitigation workflows"],
            ),
            ControlDefinition(
                ...
                required_evidence=["RACI matrix", "Role definitions", "Reporting structure"],
            ),
            ControlDefinition(
            ...
            ControlDefinition(
                ...
                article_ref="MAP 1.1",
                required_evidence=["System description", "Use case documentation", "User profiles"],
            ),
            ControlDefinition(
            ...
            ControlDefinition(
                ...
                required_evidence=["Trustworthiness assessment", "Characteristic scores"],
            ),
            ControlDefinition(
            ...
            ControlDefinition(
                ...
                required_evidence=["Monitoring dashboard", "Alert thresholds", "Incident logs"],
            ),
            # MANAGE Function
            ControlDefinition(
                ...
                required_evidence=["Risk prioritization matrix", "Treatment priorities"],
            ),
            ControlDefinition(
