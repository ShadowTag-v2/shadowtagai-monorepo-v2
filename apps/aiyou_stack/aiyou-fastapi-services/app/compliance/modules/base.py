...
class ComplianceModule(ABC):
    ...
    async def assess(self, input_data: AssessmentInput) -> ModuleResult:
        ...
        avg_score = (
            sum(r.score for r in control_results) / total_assessed if total_assessed > 0 else 0.0
        )
    ...
    def generate_report_template(self) -> dict[str, Any]:
        ...
        return {
            ...
            "sections": [
                ...
                {"title": "Control Assessment Results", "controls": self.generate_checklist()},
                {"title": "Findings and Recommendations", "content": ""},
                {"title": "Evidence Summary", "artifacts": []},
                {"title": "Attestation", "signatory": "", "date": "", "signature_hash": ""},
            ],
        }
    ...
    def _requires_human_review(
        ...
        avg_score = (
            sum(r.score for r in control_results) / len(control_results) if control_results else 0
        )
