...
class HIPAAModule(ComplianceModule):
    ...
    def _define_metadata(self) -> ModuleMetadata:
        return ModuleMetadata(
            ...
            description=(
                "Federal law protecting sensitive patient health information from "
                "disclosure without patient consent or knowledge."
            ),
    ...
    def _define_controls(self) -> list[ControlDefinition]:
        return [
            ...
            ControlDefinition(
                ...
                required_evidence=["Access control documentation", "Role-based access matrix"],
            ),
            ControlDefinition(
            ...
            ControlDefinition(
                ...
                required_evidence=["Training program", "Training records", "Security reminders"],
            ),
            ControlDefinition(
    ...
    async def assess_control(
        ...
        # Minimum Necessary
        if control.control_id == "HIPAA-PR-2" and input_data.contains_phi:
        ...
        if control.control_id == "HIPAA-TS-1" and input_data.contains_phi:
        ...
        if rule.rule_id == "HIPAA-VAL-003":
            ...
            for condition in self.SENSITIVE_CONDITIONS:
                if condition in content_lower:
                    ...
                    personal_indicators = ["my", "their", "patient", "client", "mr.", "mrs.", "ms."]
