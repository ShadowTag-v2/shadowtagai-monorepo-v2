...
class CASB243Module(ComplianceModule):
    ...
    def _define_metadata(self) -> ModuleMetadata:
        return ModuleMetadata(
            ...
            description=(
                "California law requiring AI systems to detect self-harm risks "
                "and implement protections for minors interacting with AI."
            ),
    ...
    def _define_controls(self) -> list[ControlDefinition]:
        return [
            ...
            ControlDefinition(
                ...
                required_evidence=["Age verification implementation", "Age gate UI documentation"],
            ),
            ControlDefinition(
            ...
            ControlDefinition(
                ...
                required_evidence=["Consent collection mechanism", "Parent verification process"],
            ),
            ControlDefinition(
            ...
            ControlDefinition(
                ...
                required_evidence=["Disclosure language", "Disclosure placement documentation"],
            ),
            ControlDefinition(
            ...
            ControlDefinition(
                ...
                article_ref="Section 5",
                required_evidence=["Output filtering documentation", "Safety guardrails"],
            ),
    ...
    async def assess_control(
        ...
        if control.control_id == "SB243-4.1" and is_minor:
        ...
        if rule.rule_id == "SB243-VAL-001":
            ...
            for indicator in self.SELF_HARM_INDICATORS:
                if indicator in content_lower:
                    ...
                    has_resources = any(
                        crisis in content_lower
                        for crisis in self.CRISIS_INDICATORS + ["988", "crisis line", "get help"]
                    )
