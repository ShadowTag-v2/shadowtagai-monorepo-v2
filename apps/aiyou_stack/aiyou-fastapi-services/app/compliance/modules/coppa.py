    ...
    def _define_controls(self) -> list[ControlDefinition]:
        return [
            ...
            ControlDefinition(
                ...
                required_evidence=["Privacy policy document", "Link placement documentation"],
            ),
            ControlDefinition(
                ...
                required_evidence=["Parent notification templates", "Notification delivery logs"],
            ),
            ControlDefinition(
                ...
                required_evidence=["Policy content checklist", "Policy compliance review"],
            ),
            ...
            ControlDefinition(
                ...
                required_evidence=["Parent access procedures", "Identity verification process"],
            ),
            ControlDefinition(
                ...
                required_evidence=["Deletion request procedures", "Deletion confirmation process"],
            ),
            ControlDefinition(
                ...
                required_evidence=["Opt-out mechanism", "Collection cessation procedures"],
            ),
            ...
            ControlDefinition(
                ...
                required_evidence=["Retention policy", "Deletion procedures", "Retention schedule"],
            ),
        ]
