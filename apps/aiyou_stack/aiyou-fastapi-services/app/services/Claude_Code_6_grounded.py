...
class Claude_Code_6Grounded:
    ...
    def __init__(
        ...
        self.datastore_id = datastore_id or os.getenv(
            "CLAUDE_CODE_6_DATASTORE_ID",
            "Claude_Code_6-doctrine-store",
        )
...
# Global instance
_judge: Claude_Code_6Grounded | None = None


async def get_judge() -> Claude_Code_6Grounded:
    """Get or create global Judge 6 instance."""
    global _judge
    if _judge is None:
        _judge = Claude_Code_6Grounded()
