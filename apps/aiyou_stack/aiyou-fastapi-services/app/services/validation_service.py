...
class ATP519RuleEngine:
    ...
    def rate_credibility(
        ...
        primary_indicators = ["foia", "filing", "official statement", "press release", "patent"]
    ...
    def check_completeness(self, item_data: dict) -> float:
        ...
        required_fields = ["title", "summary", "full_text", "published_at", "tags", "source"]
...
class JRComplianceChecker:
    ...
    ITAR_KEYWORDS = {
        ...
        "Category_VIII": ["avionics architecture", "flight control source code", "ejection seat"],
        "Category_XI": ["encrypted communications", "gps receiver design", "radar cross-section"],
    }
...
class ValidationService:
    ...
    async def validate(self, request: ValidationRequest, item_data: dict) -> ValidationResponse:
        ...
        result, failure_reasons, flag_reasons, next_action, recommended_action = (
