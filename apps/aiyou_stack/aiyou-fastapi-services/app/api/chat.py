...
async def chat_completion(request: ChatRequest, db: AsyncSession = Depends(get_db)):  # noqa: B008
...
@router.post("/stream")
async def chat_stream(request: ChatRequest, db: AsyncSession = Depends(get_db)):  # noqa: B008
...
async def create_conversation(
    ...
    assistant: AIAssistant = Depends(get_ai_assistant),  # noqa: B008
):
...
async def get_conversation(session_id: str, assistant: AIAssistant = Depends(get_ai_assistant)):  # noqa: B008
...
async def delete_conversation(session_id: str, assistant: AIAssistant = Depends(get_ai_assistant)):  # noqa: B008
