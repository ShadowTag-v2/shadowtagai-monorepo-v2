...
class PerplexityMCPServer:
    ...
    def __init__(
        ...
        print(f"  Judge 6 target: <{Claude_Code_6_latency_target_ms}ms")
    ...
    async def governance_score(
        ...
        # SLA check
        if latency_ms > self.Claude_Code_6_latency_target:
            print(
                f"  SLA BREACH: Judge 6 took {latency_ms:.1f}ms (target: {self.Claude_Code_6_latency_target}ms)",
            )
