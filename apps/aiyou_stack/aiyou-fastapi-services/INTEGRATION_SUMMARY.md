...
3. **ShadowTag-v4 Global Edge Fabric** (Infrastructure layer)
...
### Layer 3: ShadowTag-v4 Global Edge Fabric (Infrastructure)

**Commit:** `0e278b4` — "Add ShadowTag-v4 Global Edge Fabric"
...
- `shadowtag_v4-global-edge-fabric/docs/00-executive-summary.md` — Business overview

- `shadowtag_v4-global-edge-fabric/technical/shadowtag-spec.md` — L0→L4 attestation

- `shadowtag_v4-global-edge-fabric/technical/pnt-architecture.md` — Anti-spoofing GPS

- `shadowtag_v4-global-edge-fabric/models/revenue-projections.json` — Financial model

- `shadowtag_v4-global-edge-fabric/scripts/monte-carlo-simulator.py` — Exit valuation
...
3. ShadowTag-v4 provides edge compute + ShadowTag attestation
          ↓
...
# pinkln-reasoning-engine/integrations/shadowtag_v4.py
...
# Verifiable at: https://shadowtag.shadowtag_v4.global/verify/{cid}
...
2. **Deploy to ShadowTag-v4 edge nodes** (distributed inference)
...
- Pinkln→ShadowTag-v4 latency: <100ms (attestation generation)
...
│   ├── integrations/               ← TODO: PNKLN + ShadowTag-v4 bridges
│   └── requirements.txt
│
├── pinkln-intelligence-pipeline/   ← NEW
│   └── DEPLOYMENT.md               ← Production GKE deployment
│
├── shadowtag_v4-global-edge-fabric/       ← NEW
│   ├── docs/
...
| `0e278b4` | Add ShadowTag-v4 Global Edge Fabric | 12 | +3,499 |
...
- ShadowTag-v4 Global Edge Fabric: $2.4B ARR
