...
**Goal**: Connect `src/agent.py` to the `n-autoresearch/Kosmos/BioAgents` swarm logic.

- [ ] Update `src/agent.py` to import `n-autoresearch/Kosmos/BioAgents` from `agents/autoresearch.py`.
