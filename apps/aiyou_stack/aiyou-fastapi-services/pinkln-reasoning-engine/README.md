...
> Integrated with PNKLN data layer and ShadowTag-v4 infrastructure
...
- ShadowTag-v4 ShadowTag SDK (optional, for attestation)
...
cd shadowtag_v4-fastapi-services/pinkln-reasoning-engine
...
## 🔗 Integration with ShadowTag-v4 & PNKLN
...
### ShadowTag-v4 ShadowTag Attestation

```python
from integrations.shadowtag_v4 import PinklnShadowTagBridge
...
- [ ] **ShadowTag-v4 ShadowTag** (attestation layer)
...
**Issues:** https://github.com/ShadowTag-v2/shadowtag_v4-fastapi-services/issues
**Email:** pinkln@shadowtag_v4.global
