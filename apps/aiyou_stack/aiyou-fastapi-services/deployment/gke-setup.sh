...
gsutil mb -p $PROJECT_ID -c STANDARD -l $REGION gs://ShadowTag-v2-data-bucket || echo "Data bucket already exists"
gsutil mb -p $PROJECT_ID -c STANDARD -l $REGION gs://ShadowTag-v2-models-bucket || echo "Model bucket already exists"
