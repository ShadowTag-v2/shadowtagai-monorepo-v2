# ShadowTag-v4 Services - Complete System Overview
...
├── Cor.Claude_Code_6/                    # AI Governance & Risk Management (Python)
...
```typescript
import { Cor.Claude_Code_6Adapter, CopilotRouter } from "@pnkln/universal-copilot";
...
const governance = new Cor.Claude_Code_6Adapter("prod-001");
...
```bash
# Judge 6
cd Cor.Claude_Code_6
python -m Cor.Claude_Code_6.main
...
```dockerfile
# Multi-stage build
FROM python:3.11-alpine AS Cor.Claude_Code_6
WORKDIR /Cor.Claude_Code_6
COPY Cor.Claude_Code_6/ .
...
# Runtime
FROM node:18-alpine
COPY --from=Cor.Claude_Code_6 /Cor.Claude_Code_6 /app/Cor.Claude_Code_6
...
```bash
cd Cor.Claude_Code_6
python -m pytest tests/ --cov=Cor.Claude_Code_6
```
...
- **Judge 6**
  - [README.md](./Cor.Claude_Code_6/README.md) - Package documentation
  - [IMPROVEMENTS.md](./Cor.Claude_Code_6/IMPROVEMENTS.md) - v2.0 refactoring details
