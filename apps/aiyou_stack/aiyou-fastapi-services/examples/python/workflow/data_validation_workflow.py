...
def classify_input_validate(result: Any) -> bool:
    ...
    return (
        result
        and "format" in result
        and "schema" in result
        and "rules" in result
        and isinstance(result["rules"], list)
    )
...
def schema_validation_validate(result: Any) -> bool:
    ...
    return (
        result
        and "valid" in result
        and isinstance(result["valid"], bool)
...
def business_rule_validation_validate(result: Any) -> bool:
    ...
    return (
        ...
        and "valid" in result
        and isinstance(result["valid"], bool)
        and "violations" in result
        and isinstance(result["violations"], list)
    )


business_rule_validation_step = WorkflowStep(
    name="business_rule_validation",
    execute=business_rule_validation_execute,
    validate=business_rule_validation_validate,
)
...
def generate_report_validate(result: Any) -> bool:
    ...
    return (
        result and "valid" in result and isinstance(result["valid"], bool) and "summary" in result
    )
