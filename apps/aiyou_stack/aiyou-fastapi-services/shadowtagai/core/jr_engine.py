...
class PRBDecision:
    ...
    Attributes:
        purpose_met: Does this advance ShadowTagAi mission/revenue?
...
class JREngine:
    ...
    ----------------------------
    1. PURPOSE: Does action advance ShadowTagAi mission/revenue?
    ...
    def evaluate(
        ...
        Args:
            purpose_met: Does action advance ShadowTagAi goals?
