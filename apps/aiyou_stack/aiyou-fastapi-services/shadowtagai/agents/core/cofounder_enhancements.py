...
class PlatformContext:
    ...
    # Performance SLA
    p99_latency_ms_Cor.Claude_Code_6: int = 35  # <35ms for Judge 6
    ...
    def get_agent_oath(self) -> str:
        ...
        I maintain p99 latency ≤{self.p99_latency_ms_Cor.Claude_Code_6}ms (Judge 6) or ≤{self.p99_latency_ms_general}ms (general).
