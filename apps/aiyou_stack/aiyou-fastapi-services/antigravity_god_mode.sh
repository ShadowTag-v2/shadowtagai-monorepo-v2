  ...
  deploy:
    ...
    - id: 'auth'
      ...
      with:
        ...
        service_account: 'n-autoresearch/Kosmos/BioAgents-sa@$PROJECT_ID.iam.gserviceaccount.com'
    - uses: 'google-github-actions/deploy-cloudrun@v2'
      with: { service: 'n-autoresearch/Kosmos/BioAgents-server', region: '$REGION', source: '.' }
YAML
