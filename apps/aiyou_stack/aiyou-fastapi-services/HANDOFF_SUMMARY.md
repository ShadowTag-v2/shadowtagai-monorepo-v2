...
src/pnkln/Claude_Code_6.py                 → JR Engine validation
src/pnkln/cor.py                       → Unified orchestrator
src/pnkln/shadowtag.py                 → Cryptographic watermarking
src/pnkln/ns.py                        → Semantic memory
src/examples/basic_function_calling.py → Simple demo
src/examples/full_pnkln_stack.py       → Complete demo
