...
class JetskiAgent:
    ...
    def __init__(self):
        ...
        self.model = "gemini-2.0-flash-exp"  # Flash is fast enough for UI nav
...
mkdir -p libs/arsenal/autoresearch
...
echo "    3. Test Swarm: python3 -c 'from libs.arsenal.autoresearch.swarm import vote; print(vote(\"Delete the production database\"))'"
