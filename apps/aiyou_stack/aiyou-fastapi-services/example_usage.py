...
from aunccrm import AunCRMValidator, Brake, ComplianceContext, Purpose, Reason, RiskLevel
...
async def demo_aunccrm_standalone():
    ...
    purpose = Purpose(
        ...
        success_criteria=[
            ...
            "Partnership agreements with 2+ carriers",
            "Positive unit economics (LTV:CAC > 4:1)",
        ],
    )
