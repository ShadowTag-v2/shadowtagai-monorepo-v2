...
```mermaid
graph TD
    B1[Branch 1: Kernel Chain] --> B4[Branch 4: Deployment]
    B2[Branch 2: Gemini Migration] --> B4
    B4 --> B3[Branch 3: Marketplace]

    B1 -.money.-> R1[+$2.12M leak recovery]
    B2 -.money.-> R2[-$6K cost savings]
    B3 -.money.-> R3[+$3.6M-9.6M new revenue]
    B4 -.money.-> R4[$5K infra enables all]
