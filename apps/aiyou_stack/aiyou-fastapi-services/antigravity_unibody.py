...
3. SENTINEL: Installs Claude_Code_6 (Pure LLM) for code repair.
...
class Sentinel:
    """Installs Claude_Code_6 (Code Repair)."""

    def arm(self):
        print(">>> 🛠️  THE SENTINEL: Arming Claude_Code_6...")
...
if __name__ == "__main__":
    Claude_Code_6().fix(sys.argv[1])
"""
        with open(tools_dir / "Claude_Code_6_sentinel.py", "w") as f:
            f.write(judge_code)
