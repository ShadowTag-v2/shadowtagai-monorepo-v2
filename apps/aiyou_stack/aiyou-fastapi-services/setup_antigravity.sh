...
# ================================
# Configures Gemini API failover and activates n-autoresearch/Kosmos/BioAgents
...
echo "  • n-autoresearch/Kosmos/BioAgents 650-agent swarm"
echo ""
...
echo ""
echo "📋 Next Steps:"
echo "  1. Start n-autoresearch/Kosmos/BioAgents: ./run_n-autoresearch/Kosmos/BioAgents_api.sh"
echo "  2. Check status: python3 antigravity_status.py"
echo "  3. View docs: http://localhost:8888/docs"
echo ""
echo "🔍 Test Gemini failover:"
echo "  python3 -c 'from src.ShadowTag-v2.services.gemini_failover import get_failover_client; print(get_failover_client().health_check())'"
echo ""
