...
(async function extractClaudeWebConversations() {
    ...
    console.log('%cThese are from the website\'s background checks, NOT this script.', 'color: yellow;');
    console.log('%c-----------------------------------------', 'color: #888;');
    ...
    try {
        ...
        console.error('   ✗ Could not list databases (browser security restriction likely):', e.message);
    }
