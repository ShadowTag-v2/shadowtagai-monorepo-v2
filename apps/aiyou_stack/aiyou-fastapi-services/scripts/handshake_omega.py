...
sys.path.append(
    os.path.abspath(os.path.join(os.path.dirname(__file__), "../apps/n-autoresearch/Kosmos/BioAgents-server"))
)
try:
    ...
    sys.path.append(
        os.path.abspath(os.path.join(os.path.dirname(__file__), "../apps/n-autoresearch/Kosmos/BioAgents-server/src"))
    )
