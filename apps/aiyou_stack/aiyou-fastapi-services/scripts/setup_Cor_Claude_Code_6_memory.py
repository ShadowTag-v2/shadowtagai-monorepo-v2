...
DATA_STORE_ID = "Cor_Claude_Code_6-doctrine-store"  # We will create/use this ID
DOCS_DIR = "docs"
...
def import_documents(project_id: str, location: str, data_store_id: str, input_dir: str):
    ...
    print(f"  gsutil mb -l {location} gs://{project_id}-Cor_Claude_Code_6-docs")
    print(f"  gsutil cp {input_dir}/* gs://{project_id}-Cor_Claude_Code_6-docs/")
...
if __name__ == "__main__":
    ...
    query_Cor_Claude_Code_6_grounded(PROJECT_ID, LOCATION, DATA_STORE_ID, query)
