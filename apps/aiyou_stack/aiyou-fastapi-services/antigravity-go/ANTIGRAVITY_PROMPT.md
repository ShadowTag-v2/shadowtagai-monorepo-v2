...
1.  SOP-C Decision Protocol:
        ...
        - Root repo: /Users/pikeymickey/Documents/Claude Code/Code/Claude Demo/shadowtag_v4-fastapi-services.”
...
{"name":"pnkln:Claude_Code_6","prompt":"ROLE:Governance; MISSION:Risk Gating; TACTIC:ATP 5-19 Check; IF Confidence<0.75 THEN Freeze"}
]
JSON
...
Finally, note at the beginning of your response, whether you are utilizing "n-autoresearch/Kosmos/BioAgents" or not. Must declare as, "Monkey's activated / not activated, standing by." Monkey's are to always be activated.
