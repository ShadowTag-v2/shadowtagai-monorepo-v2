...
curl -s -H "Authorization: Bearer $(gcloud auth print-identity-token)" \
  https://n-autoresearch/Kosmos/BioAgents-server-dev-215390634092.us-central1.run.app/health | python3 -m json.tool
...
Services:
- n-autoresearch/Kosmos/BioAgents: [status]
- CodePMCS: [status]
...
Co-Authored-By: Claude <redacted@shadowtag-v4.local>
EOF
)"
```
