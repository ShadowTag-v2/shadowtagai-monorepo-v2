...
CONSTRAINTS:
- Focus on PNKLN Core Stack™ components only
...
CONSTRAINTS:
- PNKLN security standards (AES-256-GCM, TLS 1.3, zero-trust)
...
2. Add contact email to user-agent string
   ...
   - Fix: Update UA to include +https://pnkln.ai/crawler-info
   - Effort: 1 hour
...
- **E**xplicit constraints: Platform (GCP), standards (PNKLN), limits (top 3 recommendations)
...
**For most PNKLN analyses:** Use Gemini 2.0 Pro (best quality/cost balance)
