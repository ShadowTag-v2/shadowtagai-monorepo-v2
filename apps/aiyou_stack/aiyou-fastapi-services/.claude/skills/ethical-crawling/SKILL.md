...
```python
headers = {
    'User-Agent': 'YourCompanyBot/1.0 (+https://yourcompany.com/bot; redacted@shadowtag-v4.local)'
}
...
```python
headers = {
    'User-Agent': 'CompanyBot/1.0 (+https://company.com/bot; redacted@shadowtag-v4.local)',
