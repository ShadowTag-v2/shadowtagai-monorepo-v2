# Agent Orchestration - n-autoresearch/Kosmos/BioAgents Swarm Patterns
...
This skill enforces **Army Operations Order (OPORD)** format and **Army Leadership Principles** for commanding the n-autoresearch/Kosmos/BioAgents swarm. Every atomic thread follows the 5-paragraph OPORD structure for perfect uniformity.
...
- [n-autoresearch/Kosmos/BioAgents-api.md](n-autoresearch/Kosmos/BioAgents-api.md) - Server API Reference & Usage
...
- Keywords: `flying.*n-autoresearch/Kosmos/BioAgents`, `swarm`, `orchestrat`, `agent.*spawn`, `shift.*rotation`

- File paths: `agents/**/*.py`, `src/shadowtag_v4/orchestrator/**/*.py`
