...
def test_login_case_insensitive():
    create_user("redacted@shadowtag-v4.local", "pass")
    assert login("redacted@shadowtag-v4.local", "pass").success
...
def test_login_with_wrong_password_still_fails():
    ...
    create_user("redacted@shadowtag-v4.local", "pass")
    assert not login("redacted@shadowtag-v4.local", "wrong").success
```
...
✓ 5. Tested in staging:
   - Logged in with redacted@shadowtag-v4.local ✓
   - Logged in with redacted@shadowtag-v4.local ✓
