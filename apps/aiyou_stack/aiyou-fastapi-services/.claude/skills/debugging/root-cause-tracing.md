...
```python
# Data flow:
User submits email: "redacted@shadowtag-v4.local"
  ↓
Form handler receives: "redacted@shadowtag-v4.local"
  ↓
Validation: passes (email looks valid)
  ↓
Signup function: email.lower() → "redacted@shadowtag-v4.local"
  ↓
Database saves: "redacted@shadowtag-v4.local"

# Later, during login:
User submits email: "redacted@shadowtag-v4.local"
  ↓
Login function: queries with "redacted@shadowtag-v4.local" (❌ not lowercased)
  ↓
