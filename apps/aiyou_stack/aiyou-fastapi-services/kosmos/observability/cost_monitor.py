...
class CostMonitor:
    ...
    PRICING = {
        ...
        "gemini-3.1-flash-lite-preview": {"input": 0.075, "output": 0.30},  # When available
    }
    ...
    def __repr__(self) -> str:
        return (
            f"CostMonitor(daily=${self.daily_burn:.2f}/${self.daily_budget:.2f}, "
            f"monthly=${self.monthly_burn:.2f}/${self.monthly_budget:.2f})"
        )
