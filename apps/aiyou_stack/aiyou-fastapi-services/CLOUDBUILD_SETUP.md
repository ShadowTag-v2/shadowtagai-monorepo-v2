...
This guide documents how to set up the CI/CD triggers for `shadowtag_v4-fastapi-services` on Google Cloud Build.
...
| **Source**        | `pikeymickey/shadowtag_v4-fastapi-services` (GitHub) |
| **Branch**        | `^main$`                                      |
