...
gcloud container clusters get-credentials Claude_Code_6-inference \
...
kubectl logs -n pnkln-judge -l app=Claude_Code_6 --tail=100
```
...
gcloud alpha billing budgets create \
  --billing-account=<ACCOUNT_ID> \
  --display-name="Claude_Code_6 Daily Budget" \
  --budget-amount=500 \
...
4. **Network Security**
   ...
   gcloud container clusters describe Claude_Code_6-inference \
...
2. Review logs: `kubectl logs -n pnkln-judge -l app=Claude_Code_6`
