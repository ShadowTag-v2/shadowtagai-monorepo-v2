...
class MemoryAsAService:
  ...
  async def extract_and_store_entities(
    self, attorney_id: str, case_id: str, document_text: str
  ):
    """
    ...
    """
    logger.info(
      f"MaaS: Extracting entities for Attorney {attorney_id} | Case {case_id}"
    )
  ...
  async def inject_context(
    self, attorney_id: str, case_id: str, current_prompt: str
  ) -> str:
    """
