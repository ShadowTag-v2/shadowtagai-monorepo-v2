(globalThis["TURBOPACK"] || (globalThis["TURBOPACK"] = [])).push([
  ...
  (__turbopack_context__, module, exports) => {
    ...
    _export(exports, {
      ...
      dispatchGestureState: () => dispatchGestureState,
      refreshOnInstantNavigationUnlock: () => refreshOnInstantNavigationUnlock,
  ...
  (__turbopack_context__, module, exports) => {
    ...
    _export(exports, {
      ...
      startListeningForInstantNavigationCookie: () => startListeningForInstantNavigationCookie,
      transitionToCapturedSPA: () => transitionToCapturedSPA,
      updateCapturedSPAToTree: () => updateCapturedSPAToTree,
...
`.replace(/\n\s*/g, "");
  ...
  (__turbopack_context__, module, exports) => {
    ...
    _export(exports, {
      ...
      pingPrefetchScheduler: () => pingPrefetchScheduler,
    ...
    function pingStaticHead(now, task, route) {
      ...
      pingStaticSegmentData(
        ...
        task,
        route,
        (0, _cache.readOrCreateSegmentCacheEntry)(now, _types.FetchStrategy.PPR, route.metadata),
        task.key,
        route.metadata,
      );
    }
     ...
     */ function collectInlinedEntries(now, route) {
      ...
      if (headEntry.status === _cache.EntryStatus.Empty) {
        entries.set(
          ...
          (0, _cache.upgradeToPendingSegment)(headEntry, _types.FetchStrategy.PPR),
        );
      }
      return entries;
    }
  ...
  (__turbopack_context__, module, exports) => {
    ...
    _export(exports, {
      ...
      clonePageVaryPathWithNewSearchParams: () => clonePageVaryPathWithNewSearchParams,
      ...
      getFulfilledSegmentVaryPath: () => getFulfilledSegmentVaryPath,
      getPartialLayoutVaryPath: () => getPartialLayoutVaryPath,
      getPartialPageVaryPath: () => getPartialPageVaryPath,
      getRenderedSearchFromVaryPath: () => getRenderedSearchFromVaryPath,
  ...
  (__turbopack_context__, module, exports) => {
    ...
    _export(exports, {
      ...
      getLinkForCurrentNavigation: () => getLinkForCurrentNavigation,
  ...
  (__turbopack_context__, module, exports) => {
    ...
    _export(exports, {
      UnknownDynamicStaleTime: () => UnknownDynamicStaleTime,
      computeDynamicStaleAt: () => computeDynamicStaleAt,
      invalidateBfCache: () => invalidateBfCache,
      readFromBFCache: () => readFromBFCache,
      readFromBFCacheDuringRegularNavigation: () => readFromBFCacheDuringRegularNavigation,
      updateBFCacheEntryStaleAt: () => updateBFCacheEntryStaleAt,
      writeHeadToBFCache: () => writeHeadToBFCache,
  ...
  (__turbopack_context__, module, exports) => {
    ...
    _export(exports, {
      discoverKnownRoute: () => discoverKnownRoute,
      matchKnownRoute: () => matchKnownRoute,
  ...
  (__turbopack_context__, module, exports) => {
    ...
    _export(exports, {
      ...
      attemptToFulfillDynamicSegmentFromBFCache: () => attemptToFulfillDynamicSegmentFromBFCache,
      ...
      convertReusedFlightRouterStateToRouteTree: () => convertReusedFlightRouterStateToRouteTree,
      convertRootFlightRouterStateToRouteTree: () => convertRootFlightRouterStateToRouteTree,
      convertRouteTreeToFlightRouterState: () => convertRouteTreeToFlightRouterState,
      createDetachedSegmentCacheEntry: () => createDetachedSegmentCacheEntry,
      createMetadataRouteTree: () => createMetadataRouteTree,
      deprecated_requestOptimisticRouteCacheEntry: () =>
        deprecated_requestOptimisticRouteCacheEntry,
      fetchInlinedSegmentsOnCacheMiss: () => fetchInlinedSegmentsOnCacheMiss,
      fetchRouteOnCacheMiss: () => fetchRouteOnCacheMiss,
      fetchSegmentOnCacheMiss: () => fetchSegmentOnCacheMiss,
      fetchSegmentPrefetchesUsingDynamicRequest: () => fetchSegmentPrefetchesUsingDynamicRequest,
      fulfillRouteCacheEntry: () => fulfillRouteCacheEntry,
      getCurrentRouteCacheVersion: () => getCurrentRouteCacheVersion,
      getCurrentSegmentCacheVersion: () => getCurrentSegmentCacheVersion,
      getStaleAt: () => getStaleAt,
      getStaleTimeMs: () => getStaleTimeMs,
      invalidateEntirePrefetchCache: () => invalidateEntirePrefetchCache,
      invalidateRouteCacheEntries: () => invalidateRouteCacheEntries,
      invalidateSegmentCacheEntries: () => invalidateSegmentCacheEntries,
      markRouteEntryAsDynamicRewrite: () => markRouteEntryAsDynamicRewrite,
      overwriteRevalidatingSegmentCacheEntry: () => overwriteRevalidatingSegmentCacheEntry,
      pingInvalidationListeners: () => pingInvalidationListeners,
      processRuntimePrefetchStream: () => processRuntimePrefetchStream,
      readOrCreateRevalidatingSegmentEntry: () => readOrCreateRevalidatingSegmentEntry,
      ...
      writeDynamicRenderResponseIntoCache: () => writeDynamicRenderResponseIntoCache,
      writeRouteIntoCache: () => writeRouteIntoCache,
    ...
    async function fetchSegmentOnCacheMiss(route, segmentCacheEntry, routeKey, tree) {
      ...
      try {
        ...
        if (
          (response.headers.get(_constants.NEXT_NAV_DEPLOYMENT_ID_HEADER) ?? serverData.buildId) !==
          (0, _navigationbuildid.getNavigationBuildId)()
        ) {
          // The server build does not match the client. Treat as a 404. During
          // an actual navigation, the router will trigger an MPA navigation.
    ...
    async function fetchInlinedSegmentsOnCacheMiss(route, routeKey, tree, spawnedEntries) {
      ...
      try {
        ...
        if (
          (response.headers.get(_constants.NEXT_NAV_DEPLOYMENT_ID_HEADER) ??
            serverData.tree.segment.buildId) !== (0, _navigationbuildid.getNavigationBuildId)()
        ) {
          rejectSegmentEntriesIfStillPending(spawnedEntries, Date.now() + 10 * 1000);
          return null;
        }
    ...
    function fulfillEntrySpawnedByRuntimePrefetch(
      ...
      if (ownedEntry !== undefined) {
        ...
        if (possiblyNewEntry.status === 0) {
          ...
          const newEntry = fulfillSegmentCacheEntry(
            upgradeToPendingSegment(createDetachedSegmentCacheEntry(now), fetchStrategy),
            rsc,
            staleAt,
            isPartial,
          );
  ...
  (__turbopack_context__, module, exports) => {
    ...
    _export(exports, {
      ...
      decodeStaticStage: () => decodeStaticStage,
    ...
    async function createFetch(url, headers, fetchPriority, shouldImmediatelyDecode, signal) {
      ...
      const processed = fetch(fetchUrl, fetchOptions).then(processFetch);
      const fetchPromise = processed.then(({ response }) => response);
  ...
  (__turbopack_context__, module, exports) => {
    ...
    function isNavigatingToNewRootLayout(currentTree, nextTree) {
      ...
      const currentIsRootLayout =
        ((currentTree[4] ?? 0) & _approutertypes.PrefetchHint.IsRootLayout) !== 0;
      const nextIsRootLayout =
        (nextTree.prefetchHints & _approutertypes.PrefetchHint.IsRootLayout) !== 0;
  ...
  (__turbopack_context__, module, exports) => {
    ...
    _export(exports, {
      getLastCommittedTree: () => getLastCommittedTree,
      setLastCommittedTree: () => setLastCommittedTree,
    });
  ...
  (__turbopack_context__, module, exports) => {
    ...
    _export(exports, {
      ...
      createInitialCacheNodeForHydration: () => createInitialCacheNodeForHydration,
      isDeferredRsc: () => isDeferredRsc,
      spawnDynamicRequests: () => spawnDynamicRequests,
    ...
    function updateCacheNodeOnNavigation(
      ...
      const childDidFindRootLayout =
        didFindRootLayout ||
        (newRouteTree.prefetchHints & _approutertypes.PrefetchHint.IsRootLayout) !== 0;
      ...
      if (newSlots !== null) {
        ...
        for (const parallelRouteKey in newSlots) {
  ...
  (__turbopack_context__, module, exports) => {
    ...
    _export(exports, {
      ...
      extractSourcePageFromFlightRouterState: () => extractSourcePageFromFlightRouterState,
  ...
  (__turbopack_context__, module, exports) => {
    ...
    _export(exports, {
      ...
      completeSoftNavigation: () => completeSoftNavigation,
      completeTraverseNavigation: () => completeTraverseNavigation,
  ...
  (__turbopack_context__, module, exports) => {
    ...
    _export(exports, {
      refreshDynamicData: () => refreshDynamicData,
  ...
  (__turbopack_context__, module, exports) => {
    ...
    _export(exports, {
      ...
      ReadonlyURLSearchParams: () => _hooksclientcontextsharedruntime.ReadonlyURLSearchParams,
      RedirectType: () => _navigationreactserver.RedirectType,
      ServerInsertedHTMLContext: () => _serverinsertedhtmlsharedruntime.ServerInsertedHTMLContext,
  ...
  (__turbopack_context__, module, exports) => {
    ...
    _export(exports, {
      createNestedLayoutNavigationPromises: () => createNestedLayoutNavigationPromises,
...
//# sourceMappingURL=0qqu_next_dist_client_0s4auwh._.js.map
