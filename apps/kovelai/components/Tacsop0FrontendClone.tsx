      ...
      <div className="w-full max-w-md">
        <Card className="shadow-lg border-gray-200">
          <CardHeader>
            ...
            <CardDescription className="text-gray-500">Frontend module specification implementation based on TACSOP 0</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <label htmlFor="password" className="text-sm font-medium leading-none text-gray-700">Password</label>
          ...
          <CardFooter className="flex justify-between">
            ...
            <Button variant="default" className="bg-blue-600 hover:bg-blue-700 text-white">Submit</Button>
          </CardFooter>
        </Card>
      </div>
    </div>
