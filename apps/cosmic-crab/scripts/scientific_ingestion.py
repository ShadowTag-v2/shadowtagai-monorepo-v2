...
class StrategicIngester:
  ...
  def __init__(self):
    ...
    self.resources = [
      # Kosmos & LangExtract Core
      {
        ...
        "desc": "Kosmos Swarm Discovery Framework",
      },
      {
        "url": "https://arxiv.org/abs/2511.02824",
        "desc": "LangExtract Scientific Ingestion (arXiv)",
      },
      ...
      },
      {
        ...
        "desc": "ADP 5-0 The Operations Process",
      },
      {
        "url": "https://www.first.army.mil/Portals/102/Users/231/99/999/Risk%20Management%20ATP%205-19.pdf",
        "desc": "ATP 5-19 Risk Management",
      },
      ...
      },
      {
        ...
        "desc": "NIST SP 1302 Hardware Root of Trust",
      },
      {
      ...
      {
        "url": "https://info.publicintelligence.net/USArmy-SF-Ops.pdf",
        "desc": "US Army Special Forces Operations",
      },
      {
        "url": "https://info.publicintelligence.net/USArmy-SpecialForcesIO.pdf",
        "desc": "US Army Special Forces IO",
      },
      {
      ...
      {
        "url": "https://info.publicintelligence.net/JCS-MILDEC.pdf",
        "desc": "JCS Military Deception (MILDEC)",
      },
      {
  ...
  async def run_batch(self):
    ...
    logger.info(
      "✅ BATCH INGESTION COMPLETE. Audit Vault populated with strategic doctrine."
    )
