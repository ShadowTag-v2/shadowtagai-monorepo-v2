  ...
  return (
    <section className="relative w-full py-24 md:py-32 lg:py-48 flex flex-col items-center justify-center text-center px-4 bg-gradient-to-b from-background to-muted overflow-hidden">
      ...
      <div className="z-10 flex flex-col items-center space-y-6 max-w-4xl">
        <Badge
          variant="secondary"
          className="px-4 py-1 text-sm rounded-full backdrop-blur-md bg-secondary/50 border-secondary/20"
        >
        ...
        <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl leading-relaxed">
          The ultimate boilerplate and deployment engine for your next big idea. Engineered for
          scale and design perfection.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-8">
          ...
          <Button
            size="lg"
            variant="outline"
            className="h-12 px-8 text-lg rounded-full backdrop-blur-md bg-background/50"
          >
            Read Docs
          </Button>
        </div>
