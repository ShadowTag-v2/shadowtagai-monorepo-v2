...
# apps/counselconduit/api/Claude_Code_6.py
...
logger = logging.getLogger("counselconduit.Claude_Code_6")
...
def _step_gate(risk_score: int) -> tuple[RiskLevel, bool, str]:
    ...
    if risk_score <= 9:
        ...
        return RiskLevel.RED, False, f"Risk score {risk_score} exceeds threshold (15). Requires attorney review."
