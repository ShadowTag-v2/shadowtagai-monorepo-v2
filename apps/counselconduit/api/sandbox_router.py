...
TIER_QUOTAS = {
    ...
    "solo": {
        ...
        "models": ["gemini-3.1-flash-lite-preview", "gemini-3.1-flash-lite-preview-thinking"],
    },
    "practice": {
        "max_api_calls_per_hour": 1000,
        "max_daily_tokens": 2_000_000,
        "max_concurrent_sessions": 10,
        "models": ["gemini-3.1-flash-lite-preview", "gemini-3.1-flash-lite-preview-thinking", "claude-sonnet-4-5"],
    },
    "enterprise": {
