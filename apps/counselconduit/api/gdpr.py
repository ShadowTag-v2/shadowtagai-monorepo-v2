...
class DeletionReceipt(BaseModel):
  ...
  receipt_id: str
  message: str = "Your account and all associated data will be permanently deleted within 30 days. You will receive a confirmation email when complete."
...
async def _schedule_hard_delete(
  receipt_id: str, firm_id: str, deletion_date: str
) -> bool:
  ...
  try:
    ...
    if not doc.exists:
      raise HTTPException(
        ...
        detail={
          ...
          "message": "No pending deletion found for this receipt ID.",
        },
      )
    ...
    if current_status == "completed":
      raise HTTPException(
        ...
        detail={
          "code": "DELETION_ALREADY_COMPLETED",
          "message": "This deletion has already been executed and cannot be reversed.",
        },
      )
  ...
  try:
    ...
    try:
      ...
      bucket = client.bucket(
        f"{os.environ.get('GCP_PROJECT_ID', 'shadowtag-omega-v4')}.firebasestorage.app"
      )
