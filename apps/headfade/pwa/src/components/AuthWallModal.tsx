...
export function AuthWallModal({ isOpen, onClose, onSignedIn }: AuthWallModalProps) {
  ...
  return (
    <div
      ...
      onKeyDown={(e) => {
        if ((e.key === 'Escape' || e.key === 'Enter') && e.target === e.currentTarget) onClose();
      }}
      tabIndex={-1}
    >
      <div
      ...
      >
        ...
        <div className="p-8 flex flex-col items-center gap-5 text-center">
          ...
          >
            ...
            <span className="text-white font-semibold">Forensics Tribunal</span> and reveal the
            truth. Were your eyes deceived?
          </p>
          ...
          >
            ...
            <ul className="text-[12px] space-y-1" style={{ color: 'rgba(255,255,255,0.72)' }}>
              <li>
                ⚡ Earn your <strong className="text-white">Forensic Elo</strong> rating
              </li>
