 ...
 *
 * Static Export Note:
 *   Dynamic route with 'use client' + useParams(). Works client-side
 *   via Next.js hash-based routing in static export mode. The route
 *   pattern /embed/[videoId] resolves at runtime in the browser.
 * ======================================================================= */
...
async function fetchEmbedData(videoId: string): Promise<EmbedVideoData> {
  try {
    ...
    // Fallback for demo / static export
    return {
      id: videoId,
...
// Required for Next.js static export — enables client-side dynamic routing
