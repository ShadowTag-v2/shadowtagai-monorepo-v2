                  ...
                  return (
                    <Tile
                      ...
                      onVote={(choice) => {
                        ...
                        // accent=true means AI-generated content; choice='ai' means user thinks it's AI
                        const actualIsAI = thread.accent ?? false;
                        const isCorrect = (choice === 'ai') === actualIsAI;
                        recordVoteOutcome(
                          `video_${index}`,
                          isCorrect,
                          0, // initial foolRate — Firestore computes the real value atomically
                        );
                      }}
                      onClick={() => {}}
                    />
