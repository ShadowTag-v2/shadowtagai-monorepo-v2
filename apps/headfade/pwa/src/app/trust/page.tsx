  ...
  const threads = [
    {
      ...
      thumbnail:
        'https://images.unsplash.com/photo-1589994965851-a8f479c573a9?w=600&h=340&fit=crop',
    ...
    },
    {
      ...
      // biome-ignore lint/security/noSecrets: Unsplash CDN URL — not a secret
      thumbnail:
        'https://images.unsplash.com/photo-1606189934390-7ad2a910b785?w=600&h=340&fit=crop',
      type: 'insight' as const,
    },
    {
      id: '340-attorney-roi',
    ...
    },
    {
      ...
      // biome-ignore lint/security/noSecrets: Unsplash CDN URL — not a secret
      thumbnail:
        'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=600&h=340&fit=crop',
      type: 'video' as const,
    },
    {
    ...
    },
    {
      ...
      // biome-ignore lint/security/noSecrets: Unsplash CDN URL — not a secret
      thumbnail:
        'https://images.unsplash.com/photo-1423592707957-763b527f6f64?w=600&h=340&fit=crop',
      type: 'thread' as const,
      accent: true,
    },
  ];
    ...
    <div className="min-h-screen bg-white text-[#0A2540]">
      ...
      <div className="sticky top-0 z-50 bg-white/95 backdrop-blur border-b border-[#E0E5EE]">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              type="button"
              className="px-6 py-2 bg-[#C9A227] hover:bg-[#B38B1F] text-white rounded-xl font-medium transition-all active:scale-[0.985]"
            >
              Start New Thread
            </button>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-6 pt-12 pb-8">
        <div className="max-w-2xl">
          ...
          <p className="mt-4 text-xl text-[#3B4C6B]">
            Real-time risk mitigation for law firms. Built for the United States v. Heppner era.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 pb-24">
        <div className="flex items-end justify-between mb-6">
          ...
          <div className="text-sm text-[#3B4C6B] hover:text-[#0A2540] cursor-pointer">
            See all →
          </div>
        </div>
