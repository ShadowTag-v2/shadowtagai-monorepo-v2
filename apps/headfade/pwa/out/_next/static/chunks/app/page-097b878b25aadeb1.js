(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [974],
  {
    9547: (e, t, a) => {
      ...
      function s() {
        const [e, t] = (0, r.useState)('/media/genesis_clip_01.mp4'),
          [a, s] = (0, r.useState)(''),
          [i, c] = (0, r.useState)(!1),
            ...
            try {
              await fetch('/api/vote', {
                ...
                body: new URLSearchParams({
                  ...
                  user_vote: t,
                  actual_truth: 'AI',
                  latency_ms: String(Math.round(performance.now() - a)),
                }),
              }),
                s(
                  (e) =>
              ...
              const n = await fetch('/api/analyze', {
                  method: 'POST',
                  headers: { 'Content-Type': 'application/json' },
                  body: JSON.stringify({
                    video_uri: 'gs://headfade-cdn-origin/'.concat(o(e)),
                    actual_truth: 'AI',
                    user_vote: t,
                  }),
                }),
                r = Math.round(performance.now() - a);
              if (!n.ok) {
                const e = await n.json().catch(() => ({ detail: 'Unknown error' }));
                s(
              ...
              x(i ? 'correct' : 'fooled'),
                s(
                  '> ■ ANALYSIS COMPLETE ['.concat(r, 'ms]\n') +
                    '> ■ YOUR VOTE: '.concat(t, ' | GROUND TRUTH: ').concat('AI', '\n') +
                    '> '.concat(
                      i
              ...
              s('> ✗ FATAL FORENSIC ARBITER ERROR: '.concat(e));
            } finally {
              c(!1);
            }
          },
        ...
        return (0, n.jsxs)('div', {
          ...
          children: [
                  ...
                  (0, n.jsx)('div', {
                    ...
                    children: (0, n.jsxs)('div', {
                      ...
                      children: [
                        (0, n.jsx)('div', {
                          className:
                            'w-8 h-8 border-2 border-cyan-400 border-t-transparent rounded-full animate-spin',
                        }),
                        (0, n.jsx)('p', {
                          className: 'text-cyan-400 text-xs font-mono tracking-wider animate-pulse',
                          children: 'FORENSIC ANALYSIS IN PROGRESS',
                        }),
                      ],
                    }),
                  }),
            ...
            (0, n.jsx)('div', {
              ...
              children: a || '> SECURE TERMINAL: Awaiting Human Deception Input...',
            }),
            (0, n.jsxs)('div', {
              className: 'mt-8 w-full max-w-md flex flex-col items-center gap-3',
              children: [
                (0, n.jsx)('a', {
                  href: l.env.NEXT_PUBLIC_STRIPE_HEADFADE_PRO_LINK || '#pricing',
                  target: '_blank',
            ...
            (0, n.jsxs)('div', {
              ...
              children: [
                (0, n.jsx)('a', {
                  href: '/marketplace',
                  className:
                    'text-zinc-500 text-xs border border-zinc-800 px-4 py-2 rounded-lg hover:text-[#00FF41] hover:border-[#00FF41]/30 transition-all',
                  children: '\uD83D\uDD00 Creator Marketplace',
                }),
                (0, n.jsx)('a', {
                  href: '/embed/demo',
                  className:
                    'text-zinc-500 text-xs border border-zinc-800 px-4 py-2 rounded-lg hover:text-cyan-400 hover:border-cyan-400/30 transition-all',
                  children: '\uD83D\uDCE1 Embed Player Demo',
                }),
              ],
            }),
            (0, n.jsx)('footer', {
              className: 'mt-12 text-zinc-700 text-xs text-center',
              children: (0, n.jsxs)('p', {
                children: [
                  '\xa9 2026 ShadowTag AI \xb7 Powered by Gemini 3.1 Flash Lite \xb7',
                  ' ',
                  (0, n.jsx)('a', {
    ...
    9627: (e, t, a) => {
      Promise.resolve().then(a.bind(a, 9547));
    },
  },
  (e) => {
    e.O(0, [441, 255, 358], () => e((e.s = 9627))), (_N_E = e.O());
  },
]);
