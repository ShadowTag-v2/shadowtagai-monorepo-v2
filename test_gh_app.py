...
if installations:
    ...
    headers2 = {"Authorization": f"token {token}", "Accept": "application/vnd.github.v3+json"}

    res3 = requests.get("https://api.github.com/installation/repositories?per_page=100", headers=headers2)
