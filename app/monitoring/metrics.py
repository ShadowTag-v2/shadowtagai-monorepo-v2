...
class MetricsCollector:
  ...
  def __init__(self):
    ...
    self.kernel_executions = Counter(
      "pnkln_kernel_executions_total",
      "Total kernel executions",
      ["kernel_name", "status"],
    )

    self.kernel_tokens = Counter(
      "pnkln_kernel_tokens_total",
  ...
  def record_kernel_execution(
    ...
    if tokens_input is not None:
      self.kernel_tokens.labels(kernel_name=kernel_name, direction="input").inc(
        tokens_input
      )
