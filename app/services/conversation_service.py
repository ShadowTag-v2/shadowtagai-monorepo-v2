...
class ConversationService:
  ...
  async def create_conversation(
    self, db: AsyncSession, user_id: int, conversation_data: ConversationCreate
  ) -> Conversation:
    ...
    conversation = Conversation(
      ...
      is_incognito=conversation_data.is_incognito,
    )
  ...
  async def get_recent_conversations(
    self, db: AsyncSession, user_id: int, query: RecentChatsQuery
  ) -> list[Conversation]:
    ...
    stmt = (
      stmt.where(Conversation.is_active == True)
  ...
  async def add_message(
    self, db: AsyncSession, user_id: int, message_data: MessageCreate
  ) -> Message | None:
    """
