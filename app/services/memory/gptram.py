...
class GPTRAMMemory:
    ...
    async def store_interaction(self, session_id: str, interaction: dict[str, Any], ttl: int | None = None) -> bool:
        """
    ...
    async def retrieve_session_history(self, session_id: str, limit: int = 100, min_timestamp: datetime | None = None) -> list[dict[str, Any]]:
        """
        ...
        try:
            ...
            keys = await self.redis_client.zrangebyscore(f"gptram:index:{session_id}", min_score, "+inf", start=0, num=limit)
