...
class ROSBridge:
  ...
  def __init__(
    ...
    logger.info(
      "ros_bridge_initialized", ros_master=ros_master_uri, port=rosbridge_port
    )
  ...
  async def connect(self):
    ...
    try:
      ...
      raise ImportError(
        "websockets not installed. Install with: pip install websockets>=10.0"
      )
  ...
  async def call_service(
    ...
    try:
      ...
      logger.info(
        "ros_service_response_received", service=service, request_id=request_id
      )
