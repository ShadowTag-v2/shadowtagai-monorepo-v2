...
class ImageClassificationRequest(BaseModel):
  ...
  image_url: str | None = Field(
    None, description="URL to image (alternative to base64)"
  )
  image_base64: str | None = Field(None, description="Base64-encoded image")
  model: str = Field(
    "resnet50", description="Model to use (resnet50, vgg16, inception_v3)"
  )
...
class FaceRecognitionRequest(BaseModel):
  ...
  feature_library_id: str | None = Field(
    None, description="Feature library for matching"
  )
