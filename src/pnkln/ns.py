...
class Memory:
    ...
    id: str = field(default_factory=lambda: hashlib.sha256(f"{datetime.now().isoformat()}".encode()).hexdigest()[:16])
...
class SemanticMemory:
    ...
    def retrieve(self, query: str, top_k: int = 5, similarity_threshold: float = 0.5) -> list[dict[str, Any]]:
        """
