...
from .mad_consensus import DecisionType, MADConsensus, MADEngine
...
class MADDecisionEngine(GlickoEnhancedFailover):
  ...
  def _convert_mad_to_judge_decision(
    self, consensus: MADConsensus, start_time: float
  ) -> JudgeDecision:
    """
    Convert MADConsensus to JudgeDecision format.
...
if __name__ == "__main__":
  ...
  routine_context = {
    "user_request": "Update user email address",
    "risk_level": "low",
    "user_id": "user_123",
  }
