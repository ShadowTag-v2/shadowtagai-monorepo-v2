...
class PipelineMetrics:
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "items_by_tier": {str(tier.name): count for tier, count in self.items_by_tier.items()},
            "total_cost": round(self.total_cost, 4),
            "cost_by_source": {source: round(cost, 4) for source, cost in self.cost_by_source.items()},
    ...
    def record_items(self, source: str, items: list[IngestedItem]):
        ...
        logger.info(
            ...
            extra={
                ...
                "tier_distribution": {str(tier.name): count for tier, count in tier_counts.items()},
            },
        )
