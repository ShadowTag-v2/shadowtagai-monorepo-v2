...
def function_caller():
    ...
    tools = [
        FunctionTool(name="fast_function", description="Double a number", function=fast_function, parameters={"x": {"type": "integer"}}),
        FunctionTool(
            name="instant_function", description="Convert text to uppercase", function=instant_function, parameters={"text": {"type": "string"}}
        ),
    ]
