...
class TestLatencyBenchmarks:
    ...
    def test_kernel_chain_latency(self, orchestrator):
        ...
        start = time.time()
        orchestrator.execute("Analyze decision context for ATP 5-19 violations: $2M unauthorized purchase")
    ...
    def test_debate_latency(self, orchestrator):
        ...
        start = time.time()
        orchestrator.execute("Have 3 experts debate: Should we prioritize speed or accuracy?")
        latency_ms = (time.time() - start) * 1000
