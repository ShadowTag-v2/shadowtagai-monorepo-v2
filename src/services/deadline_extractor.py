...
class DeadlineExtractor:
    ...
    def extract_from_text(
        self, text: str, jurisdiction: str, document_type: str, service_date: date | None = None, filing_date: date | None = None
    ) -> list[dict[str, Any]]:
        """
    ...
    def _extract_rule_based(self, text: str, service_date: date | None, filing_date: date | None) -> list[dict[str, Any]]:
        ...
        for pattern in self.deadline_patterns:
            ...
            for match in matches:
                ...
                deadline_date = self._calculate_deadline_date(match.group(0), service_date, filing_date, trigger_event)
                    ...
                    deadlines.append(
                        {
                            ...
                            "confidence_factors": {"pattern_match": True, "context_clarity": self._assess_context_clarity(context)},
                        }
                    )

        return deadlines

    def _extract_ner_based(self, text: str, service_date: date | None, filing_date: date | None) -> list[dict[str, Any]]:
                            ...
                            deadlines.append(
                                {
                                    ...
                                    "confidence_factors": {"ner_score": entity.get("score", 0.0), "keyword_match": True},
                                }
                            )
    ...
    def _calculate_deadline_date(self, match_text: str, service_date: date | None, filing_date: date | None, trigger_event: str) -> date | None:
    ...
    def _deduplicate_deadlines(self, deadlines: list[dict[str, Any]]) -> list[dict[str, Any]]:
        ...
        deadlines.sort(
            key=lambda x: (x.get("confidence_factors", {}).get("pattern_match", False), x.get("confidence_factors", {}).get("ner_score", 0.0)),
            reverse=True,
        )
