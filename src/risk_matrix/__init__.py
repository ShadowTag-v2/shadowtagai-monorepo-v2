...
class RiskAssessment(BaseModel):
    ...
    mitigations: list[str] = Field(default_factory=list, description="Risk mitigation measures")
...
def determine_approval_authority(risk_level: RiskLevel, amount_usd: float = 0) -> tuple[str, bool]:
    """
...
def assess_risk(probability: Probability, severity: Severity, rationale: str, mitigations: list[str] = None, amount_usd: float = 0) -> RiskAssessment:
    """
