...
class PersonalizationStage(str, Enum):
...
class PersuasionTarget(str, Enum):
...
class Video(Base):
    ...
    personalization_stage = Column(SQLEnum(PersonalizationStage), default=PersonalizationStage.RULES)
