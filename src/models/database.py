...
class LegalDocument(Base):
  ...
  deadlines = relationship(
    "Deadline", back_populates="document", cascade="all, delete-orphan"
  )
...
class Deadline(Base):
  ...
  reminders = relationship(
    "ReminderLog", back_populates="deadline", cascade="all, delete-orphan"
  )
...
class DeadlineRule(Base):
  ...
  service_method_additions = Column(
    JSON, nullable=True
  )  # Dict of service method -> days
