...
class JREngine:
    ...
    def validate(self, purpose: Purpose, reasons: list[Reason], context: dict[str, Any] | None = None) -> JRDecision:
        """
    ...
    def _validate_reasons(self, reasons: list[Reason], purpose: Purpose, context: dict[str, Any]) -> Brake | None:
    ...
    def _build_constraints(self, purpose: Purpose, reasons: list[Reason], context: dict[str, Any]) -> dict[str, Any]:
        """Build constraints for approved actions"""
        constraints = {
    ...
    def _build_audit_trail(self, purpose: Purpose, reasons: list[Reason], brakes: list[Brake], context: dict[str, Any]) -> dict[str, Any]:
