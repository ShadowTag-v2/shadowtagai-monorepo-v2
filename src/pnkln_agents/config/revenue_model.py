...
Defines pricing tiers and projections for Pnkln agent platform
"""
...
class RevenueModel:
    ...
    def calculate_break_even_timeline_days(self, tier: PricingTier, actual_cac: float = None) -> int:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            "projections": {
                ...
                "sales_cycle_days_range": [self.expected_sales_cycle_days, self.conservative_sales_cycle_days],
            },
        }
