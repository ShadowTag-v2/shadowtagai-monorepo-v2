...
Enforces operational gates for Pnkln agent platform
"""
...
class BootstrapConstraints:
    ...
    def get_total_operational_cost_range(self) -> tuple[float, float]:
        ...
        min_cost = self.gemini_flash_min_usd + self.chromadb_hosting_usd + self.cloudflare_workers_min_usd + self.judge_six_maintenance_usd
        max_cost = self.gemini_flash_max_usd + self.chromadb_hosting_usd + self.cloudflare_workers_max_usd + self.judge_six_maintenance_usd
