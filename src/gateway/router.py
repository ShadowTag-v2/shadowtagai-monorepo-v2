...
class GovernanceRouter:
  ...
  ) -> tuple[RoutingDecision, GovernanceResponse]:
    """
  ...
  async def _execute_fast_path(
    self, request: GovernanceRequest, risk: RiskAssessment
  ) -> GovernanceResponse:
    """
    ...
    if self.opa_client is None:
      ...
      return self._create_fallback_response(
        request, "OPA client unavailable - defaulting to DENY"
      )
    ...
    try:
      ...
      return GovernanceResponse(
        ...
        outcome=(
          DecisionOutcome.APPROVED if opa_result["allow"] else DecisionOutcome.DENIED
        ),
    ...
    try:
      ...
      return GovernanceResponse(
        ...
        outcome=(
          ...
          if agent_result["decision"] == "approve"
  ...
  def _create_fallback_response(
    self, request: GovernanceRequest, reason: str
  ) -> GovernanceResponse:
    """
