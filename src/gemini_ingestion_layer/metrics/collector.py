...
class MetricsCollector:
  ...
  def get_prometheus_format(self) -> str:
    ...
    lines.append(
      f'gemini_ingestion_tier_count{{tier="1"}} {self.metrics["tier_1_count"]}'
    )
    lines.append(
      f'gemini_ingestion_tier_count{{tier="2"}} {self.metrics["tier_2_count"]}'
    )
    lines.append(
      f'gemini_ingestion_tier_count{{tier="3"}} {self.metrics["tier_3_count"]}'
    )
