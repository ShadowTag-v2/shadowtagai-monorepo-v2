...
def research_topic(query: str) -> dict:
    ...
    return {
        ...
        "key_points": ["Point 1 about the topic", "Point 2 about the topic", "Point 3 about the topic"],
    }
...
def main():
    ...
    tools = [
        ...
        FunctionTool(name="summarize", description="Summarize research data", function=summarize, parameters={"data": {"type": "object"}}),
    ]
    ...
    judge = JudgeSix(
        caller=caller, mission_statement="Research topics and provide summaries", purpose_threshold=0.3, reasons_threshold=0.5, brakes_threshold=0.8
    )
    ...
    try:
        ...
        for validation in judge.audit_log:
            ...
            print(f"  Purpose: {validation.purpose_score:.2f} | Reasons: {validation.reasons_score:.2f} | Brakes: {validation.brakes_score:.2f}")
        print()
