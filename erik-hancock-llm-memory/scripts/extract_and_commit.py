...
# Configuration
CURSOR_DB_PATHS = [Path.home() / "Library/Application Support/Cursor/User/workspaceStorage", Path.home() / ".cursor/workspaceStorage"]
...
class ConversationExtractor:
    ...
    def _extract_tags(self, messages: list[dict]) -> list[str]:
        ...
        tags = set()
        keywords = ["pnkln", "judge-6", "shadowtag", "cor_ns", "jr_framework"]
    ...
    memory_data = {
        **schema,
        ...
        "statistics": {
            ...
            "extraction_cost": round(extractor.total_tokens * COST_PER_1K_TOKENS / 1000, 2),
        },
    }
