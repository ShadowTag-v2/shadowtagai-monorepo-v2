...
**Repository**: `ehanc69/aiyou-fastapi-services`
...
1. **Claude Code Memory** (`~/.claude-code/memory.md`)
   - Auto-loads Pnkln architecture on Claude Code startup
   - Judge #6, ShadowTag 2.0, Cor/NS, JR Framework always available
   - Cost: $0.45 one-time

2. **Vertex AI Workbench** (GCS-backed)
   - Auto-loads `pnkln_memory` variable in Jupyter notebooks
...
| `memory/schema.json` | Pnkln architecture definition |
...
- ✅ Tag extraction (pnkln, judge-6, shadowtag, cor_ns, jr_framework)
...
- ✅ IPython startup script (`00-load-pnkln-memory.py`)
...
## Pnkln Architecture (Loaded into Memory)
...
- [ ] Startup script: `~/.ipython/profile_default/startup/00-load-pnkln-memory.py`
- [ ] Restart Jupyter kernel
- [ ] Variable available: `pnkln_memory`
...
**Branch**: `claude/add-superpowers-marketplace-011CUuLnhzCNrXYhosFmMAt9`
**PR URL**: https://github.com/ehanc69/aiyou-fastapi-services/pull/new/claude/add-superpowers-marketplace-011CUuLnhzCNrXYhosFmMAt9
