...
def decode_video(
  ...
  verify_hash: str | None = typer.Option(
    None, "--verify", "-v", help="Expected hash for verification"
  ),
...
def _create_decode_receipt(
  media_type: str, input_file: Path, payload: bytes, stats: dict
):
