...
class Glicko2Player:
    ...
    def __init__(self, rating: float = DEFAULT_RATING, rd: float = DEFAULT_RD, vol: float = DEFAULT_VOLATILITY):
        """
    ...
    def _compute_new_volatility(self, v: float, delta: float, tau: float = TAU, tol: float = 1e-6) -> float:
        """
