...
class PromptDumper:
    ...
    def dump_request(self, model: str, messages: list[dict], params: dict[str, Any] | None = None) -> Path | None:
    ...
    def dump_response(self, response: dict[str, Any], latency_ms: float = 0) -> Path | None:
