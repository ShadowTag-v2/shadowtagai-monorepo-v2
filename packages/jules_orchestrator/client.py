...
class JulesClient:
    ...
    def create_session(self, source_name: str, automation_mode: str = "AUTO_CREATE_PR", task_description: str = "") -> dict[str, Any]:
    ...
    def poll_session(self, session_name: str, timeout: int = 300, interval: int = 5) -> dict[str, Any]:
