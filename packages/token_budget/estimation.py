...
def rough_token_count(content: str, bytes_per_token: int = _DEFAULT_BYTES_PER_TOKEN) -> int:
...
def bytes_per_token_for_file_type(file_extension: str) -> int:
    ...
    """
    return _FILE_TYPE_RATIOS.get(file_extension.lower().lstrip("."), _DEFAULT_BYTES_PER_TOKEN)
