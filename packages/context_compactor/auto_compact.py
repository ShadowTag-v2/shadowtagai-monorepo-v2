...
def calculate_token_warning_state(
  ...
  *,
  ...
  """
  threshold = (
    get_auto_compact_threshold(max_context_tokens)
    if auto_compact_enabled
    else get_effective_context_window(max_context_tokens)
  )
  ...
  blocking_limit = (
    get_effective_context_window(max_context_tokens) - MANUAL_COMPACT_BUFFER_TOKENS
  )
  ...
  return TokenWarningState(
    ...
    is_above_auto_compact_threshold=(
      ...
      and token_usage >= get_auto_compact_threshold(max_context_tokens)
    ),
