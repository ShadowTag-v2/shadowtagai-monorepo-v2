...
def count_tool_calls_since(messages: list[dict[str, Any]], since_uuid: str | None) -> int:
...
class SessionMemoryManager:
    ...
    async def wait_for_extraction(self, timeout: float = EXTRACTION_WAIT_TIMEOUT_S) -> None:
