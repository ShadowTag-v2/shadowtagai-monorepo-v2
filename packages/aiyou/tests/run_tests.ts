...
import { InsertDoc } from "../src/graph/RagGraph";

async function runTests() {
  console.log("[Test Harness] Starting ShadowTag-v2 PgRagGraph tests...");
  ...
  try {
    ...
    console.log("[Test Harness] Test 3: Retrieving without filter (returns both based on distance limits if k=2)");
    ...
    console.log("[Test Harness] SUCCESS: ShadowTag-v2 PgRagGraph tests passed. Segregated AI-RAG verified.");
  } catch (err) {
