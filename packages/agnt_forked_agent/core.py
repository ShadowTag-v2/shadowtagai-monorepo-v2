...
def create_subagent_context(
    ...
    return SubagentContext(
        ...
        tool_decisions=None,
        denial_tracking={} if not overrides.share_app_state else copy.copy(parent.denial_tracking),
        metadata={
    ...
    async def execute(
        ...
        *,
        ...
        return ForkedAgentResult(
            ...
            turns_used=len([m for m in self._messages if m.get("role") in ("assistant", "model")]),
            state=self._state,
        )
