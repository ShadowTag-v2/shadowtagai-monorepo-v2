...
class TestWorkspaceCLIConfirmationProvider:
    ...
    def test_deny_when_gws_not_found(self, workspace_provider: WorkspaceCLIConfirmationProvider) -> None:
    ...
    def test_deny_when_post_fails(self, workspace_provider: WorkspaceCLIConfirmationProvider) -> None:
    ...
    def test_deny_when_response_missing_thread(self, workspace_provider: WorkspaceCLIConfirmationProvider) -> None:
    ...
    def test_deny_on_subprocess_timeout(self, workspace_provider: WorkspaceCLIConfirmationProvider) -> None:
    ...
    def test_deny_on_os_error(self, workspace_provider: WorkspaceCLIConfirmationProvider) -> None:
    ...
    def test_args_are_redacted_in_message(self, workspace_provider: WorkspaceCLIConfirmationProvider) -> None:
...
class TestOfflineConfirmationProvider:
    ...
    @patch("socket.socket")
    def test_deny_when_connection_refused(self, mock_socket_cls: MagicMock, offline_provider: OfflineConfirmationProvider) -> None:
...
class TestSovereignConfirmationProvider:
    ...
    def test_uses_gws_when_available(self, sovereign_provider: SovereignConfirmationProvider) -> None:
    ...
    def test_falls_back_to_ipc_when_gws_unavailable(self, sovereign_provider: SovereignConfirmationProvider) -> None:
