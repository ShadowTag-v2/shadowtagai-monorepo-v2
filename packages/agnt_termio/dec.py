...
Port of Claude Code's ink/termio/dec.ts.
...
"""Begin Synchronized Update — tells terminal to buffer output."""

ESU = decreset(DEC.SYNCHRONIZED_UPDATE)
"""End Synchronized Update — tells terminal to flush buffered output."""
