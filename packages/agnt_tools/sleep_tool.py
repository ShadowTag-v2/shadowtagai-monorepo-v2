...
class SleepTool:
    ...
    name = "SleepTool"
    description = (
        "Pause execution for a specified duration without consuming tokens. Use when waiting for external processes, rate limits, or user input."
    )
    ...
    def execute(
        ...
        actual = (datetime.fromisoformat(woke_at) - datetime.fromisoformat(slept_at)).total_seconds()
