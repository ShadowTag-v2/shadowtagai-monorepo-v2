...
class TestAsyncEvidenceLogger:
  ...
  @pytest.mark.asyncio
  async def test_log_check_creates_file(
    self, beads_dir: Path, mock_decision: MagicMock
  ):
  ...
  @pytest.mark.asyncio
  async def test_multiple_entries_append(
    self, beads_dir: Path, mock_decision: MagicMock
  ):
  ...
  @pytest.mark.asyncio
  async def test_non_serializable_context_stringified(
    self, beads_dir: Path, mock_decision: MagicMock
  ):
  ...
  @pytest.mark.asyncio
  async def test_beads_dir_created_if_missing(
    self, tmp_path: Path, mock_decision: MagicMock
  ):
