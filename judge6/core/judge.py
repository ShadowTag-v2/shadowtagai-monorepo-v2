...
class Judge:
    ...
    async def assess(
        ...
        layer3_result = await self._run_layer3(prompt, context, layer1_result, layer2_result)
        ...
        final_confidence = layer1_result.confidence * 0.4 + layer2_result.confidence * 0.4 + layer3_result.confidence * 0.2
    ...
    def _aggregate_risk_levels(self, level1: RiskLevel, level2: RiskLevel, level3: RiskLevel) -> RiskLevel:
        """
