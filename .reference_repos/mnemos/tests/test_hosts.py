...
def test_cursor_integration_apply_writes_minimal_config_and_backup(
  tmp_path: Path,
) -> None:
...
def test_codex_integration_replaces_existing_mnemos_agents_block(
  tmp_path: Path,
) -> None:
  home_dir = tmp_path / "home"
  repo_dir = tmp_path / "repo"
...
def test_claude_integration_prefers_plugin_wrapper_when_available(
  tmp_path: Path,
) -> None:
  repo_dir = tmp_path / "repo"
