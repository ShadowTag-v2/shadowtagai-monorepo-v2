...
""")
  ...
  gate.add_to_history(
    Interaction(role="assistant", content="Python is a versatile language")
  )
...
""")
  ...
  if changed:
    ...
    print("   Old: 'User uses React for frontend development'")
...
""")
  ...
  crisis_memory = MemoryChunk(
    ...
    embedding=embedder.embed(
      "Fixed production outage by rolling back deployment v2.3.1"
    ),
