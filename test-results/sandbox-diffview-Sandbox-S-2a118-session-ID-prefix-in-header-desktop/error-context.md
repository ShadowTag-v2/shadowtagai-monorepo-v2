...
- Name: sandbox-diffview.spec.ts >> Sandbox Session — Attorney DiffView Flow >> shows session ID prefix in header
- Location: tests/e2e/sandbox-diffview.spec.ts:138:7
