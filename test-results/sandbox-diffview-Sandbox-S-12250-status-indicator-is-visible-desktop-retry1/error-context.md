...
- Name: sandbox-diffview.spec.ts >> Sandbox Session — Attorney DiffView Flow >> WebSocket status indicator is visible
- Location: tests/e2e/sandbox-diffview.spec.ts:192:7
