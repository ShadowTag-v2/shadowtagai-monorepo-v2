...
- Name: sandbox-diffview.spec.ts >> Sandbox Session — Attorney DiffView Flow >> reject decision submits correctly
- Location: tests/e2e/sandbox-diffview.spec.ts:180:7
