...
- Name: sandbox-diffview.spec.ts >> Sandbox Session — Attorney DiffView Flow >> navigating files scrolls to selected file
- Location: tests/e2e/sandbox-diffview.spec.ts:146:7
