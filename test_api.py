...
"""
Quick API test script for YouAi Governance Service
"""

import sys
import asyncio
from app.main import app
from app.models.governance import GovernanceAssessmentRequest, ComplianceFramework
...
async def test_governance():
    ...
    request = GovernanceAssessmentRequest(
        content_type="video", is_ai_generated=True, frameworks=[ComplianceFramework.EU_AI_ACT, ComplianceFramework.NIST_RMF]
    )
...
async def main():
    """Run all tests"""
    print("=" * 60)
    print("🧪 YouAi Governance Service - API Tests")
    print("=" * 60)
