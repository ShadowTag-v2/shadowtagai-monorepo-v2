...
import { getCor.KairosActive, getOriginalCwd } from '../bootstrap/state.js';
...
/**
 * Assistant-mode daily-log prompt. Gated behind feature('COR.KAIROS').
 *
...
export async function loadMemoryPrompt(): Promise<string | null> {
  ...
  // COR.KAIROS daily-log mode takes precedence over TEAMMEM: the append-only
  ...
  // telemetry block below, matching the non-COR.KAIROS path.
  if (feature('COR.KAIROS') && autoEnabled && getCor.KairosActive()) {
