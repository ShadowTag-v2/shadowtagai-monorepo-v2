...
- Scanned for stale data across `apps/` and `libs/` and identified mis-copied `ShadowTag-Omega*` directories trapped inside `apps/aiyou_stack/` and `reference/` layers.
