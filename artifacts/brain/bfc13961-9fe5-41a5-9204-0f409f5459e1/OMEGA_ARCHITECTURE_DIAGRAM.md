...
graph TD
    ...
    Antigravity -- "Dispatch Task" --> Monkeys
    Monkeys -- "Research / Verify" --> Jetski
    Jetski -- "Ground Truth" --> Monkeys

    Monkeys -- "Proposed Code/Action" --> Judge
    ...
    style Monkeys fill:#99ff99,stroke:#333,stroke-width:2px,color:black
