...
This document maps the **YOUAI Business Plan** (Strategy) directly to the **ShadowTag v2 Codebase** (Execution). This is the "God Mode" view of the system.
...
*   **Code Modules**:
    ...
    *   `src/libs/aiyou/agents/beads_agent.py`: The consumer-facing agent ("The Body").
...
*   **Code Modules**:
    *   `bin/flyingmonkeys-server`: The Swarm Server (Cloud Run).
