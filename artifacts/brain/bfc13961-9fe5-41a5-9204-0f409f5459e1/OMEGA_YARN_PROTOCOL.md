...
*   **The Monkeys (The Swarm)**: Vote on the motion (Pass/Fail/Refine).
...
3.  **Monkeys Vote (Round 3)**: Final Ratification.
...
*   **Workers**: Cloud Functions (or FlyingMonkeys Agents) process individual messages.
