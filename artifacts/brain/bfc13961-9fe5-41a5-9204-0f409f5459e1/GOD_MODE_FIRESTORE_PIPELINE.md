...
*   **Scalable**: You can have 10,000 monkeys voting. The Firestore Query Engine aggregates them instantly ($0.00 cost for the query calculation logic basically).
