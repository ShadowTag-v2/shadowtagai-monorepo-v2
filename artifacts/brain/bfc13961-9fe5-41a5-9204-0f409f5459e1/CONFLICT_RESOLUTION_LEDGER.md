...
- **Location**: `/Users/pikeymickey/aiyou-stack/ShadowTag-v2`
- **Status**: **LIVE WRITING**
...
- **Projects**:
  - `aiyou-fastapi-services` (Direct User Path)
  - `.antigravity` (Config)
...
- **Projects**:
  - `aiyou-fastapi-services` (legacy versions)
  - `judge6-mcp` (legacy)
...
| :--- | :--- | :--- |
| **Agent Core** | `ShadowTag-v2/agents/flying_monkeys.py` | `antigravity-agent` (repo) |
| **Memory** | `ShadowTag-v2/.gemini/` | `erik-hancock-llm-memory` |
| **Backend** | `ShadowTag-v2/src/libs/aiyou` | `aiyou-fastapi-services` (old) |
| **Infrastructure** | `ShadowTag-v2/infrastructure` | `google-cloud-sdk` (old) |
| **Governance** | `ShadowTag-v2/agents/flying_monkeys.py` (Judge6) | `judge6-mcp` (old) |
