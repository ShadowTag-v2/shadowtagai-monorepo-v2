...
- `ehanc69/aiyou-fastapi-services` -> `apps/aiyou_stack/aiyou-fastapi-services`
- `ehanc69/Pipeline` -> `apps/aiyou_stack/Pipeline`
- `ehanc69/cosmic-crab-payload` -> `apps/aiyou_stack/cosmic-crab-payload`
- `ehanc69/nascent-apollo` -> `apps/aiyou_stack/nascent-apollo`

**Unresolved Duplicate Families (`duplicate_family_checked: false`):**
These twin repositories exist in a split-brain state where the legacy bare-name repo competes with the `aiyou-*` prefixed repo. Neither has been fully superseded or eliminated.
- **fastapi-services:** `ehanc69/aiyou-fastapi-services` vs `ehanc69/fastapi-services`
- **core:** `ehanc69/aiyou-core` vs `ehanc69/core`
- **security:** `ehanc69/aiyou-security` vs `ehanc69/security`
- **sre:** `ehanc69/aiyou-sre` vs `ehanc69/sre`
- **observability:** `ehanc69/aiyou-observability` vs `ehanc69/observability`
- **mlops:** `ehanc69/aiyou-mlops` vs `ehanc69/mlops`
- **docs:** `ehanc69/aiyou-docs` vs `ehanc69/docs`
- **infra:** `ehanc69/aiyou-infra` vs `ehanc69/infra`
...
**For the 4 Canonical Roots (`aiyou-fastapi-services`, `Pipeline`, `cosmic-crab-payload`, `nascent-apollo`):**
