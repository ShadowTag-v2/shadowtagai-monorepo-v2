...
#### [NEW] [bigquery_omniscience.tf](file:///Users/pikeymickey/aiyou-stack/ShadowTag-v2/infrastructure/terraform/bigquery_omniscience.tf)
Terraform definitions for the BigQuery connection to Vertex AI, IAM permissions, and the `omniscience_lake` dataset.

#### [NEW] [bq_autonomous_lake.sql](file:///Users/pikeymickey/aiyou-stack/ShadowTag-v2/schema/bq_autonomous_lake.sql)
...
### Python Services
#### [NEW] [data_router.py](file:///Users/pikeymickey/aiyou-stack/ShadowTag-v2/src/brain/data_router.py)
...
#### [NEW] [bq_omni_search.py](file:///Users/pikeymickey/aiyou-stack/ShadowTag-v2/src/tools/bq_omni_search.py)
...
#### [NEW] [deploy_bigquery.sh](file:///Users/pikeymickey/aiyou-stack/ShadowTag-v2/scripts/deploy_bigquery.sh)
Terminal commands to run `terraform apply` for the BigQuery infra and execute the SQL schema. (Vector 1)

#### [NEW] [test_zero_etl_router.py](file:///Users/pikeymickey/aiyou-stack/ShadowTag-v2/scripts/test_zero_etl_router.py)
...
#### [MODIFY] [settings.json](file:///Users/pikeymickey/aiyou-stack/ShadowTag-v2/.vscode/settings.json)
