...
5. **AST Swarm / Kinetic Triad**
   - `apps/aiyou_stack/cosmic-crab-payload/tools/ast_swarm_global.py` (Present)
...
2. **Missing `apps/uphillsnowball`:** We have `apps/aiyou-fastapi-services` and `apps/aiyou_stack` instead of the stated `apps/uphillsnowball/`.
