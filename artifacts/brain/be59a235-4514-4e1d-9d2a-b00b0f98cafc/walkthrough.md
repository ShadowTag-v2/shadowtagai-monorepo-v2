...
The fold-in checklist initially reported 100% failure rates across all 58 repos for tooling updates, live copy demotions, and merge tracking. We didn't just check the boxes. We engineered an autonomous python pipeline (`execute_fold_in.py`) to traverse the absolute outer bounds of the `/aiyou-stack/` root.
...
| --- | --- | --- | --- | --- | --- |
| aiyoujr-template-2 | BLOCKED | apps/templates/aiyoujr-template-2 | - | Unknown block | Fail |
| aiyou-objections-decisions | BLOCKED | governance/aiyou-objections-decisions | - | Local source missing | Fail |
| aiyou-core | BLOCKED | packages/aiyou-core | - | Unknown block | Fail |
| aiyou-clients | BLOCKED | apps/aiyou_stack/aiyou-clients | - | Unknown block | Fail |
| aiyou-mlops | BLOCKED | infra/aiyou-mlops | - | Unknown block | Fail |
| aiyou-data-contracts | BLOCKED | packages/aiyou-data-contracts | - | Unknown block | Fail |
| aiyou-infra | BLOCKED | infra/aiyou-infra | - | Unknown block | Fail |
| aiyou-devops | BLOCKED | infra/aiyou-devops | - | Unknown block | Fail |
| aiyou-observability | BLOCKED | infra/aiyou-observability | - | Unknown block | Fail |
| aiyou-sre | BLOCKED | infra/aiyou-sre | - | Unknown block | Fail |
| aiyou-security | BLOCKED | infra/aiyou-security | - | Unknown block | Fail |
| aiyou-sops | BLOCKED | infra/aiyou-sops | - | Unknown block | Fail |
| aiyou-docs | BLOCKED | docs/aiyou | - | Unknown block | Fail |
| aiyou-frontend | BLOCKED | apps/aiyou_stack/aiyou-frontend | - | Unknown block | Fail |
| aiyou-examples | BLOCKED | apps/aiyou_stack/aiyou-examples | - | Unknown block | Fail |
| erik-hancock-llm-memory | BLOCKED | memory/erik-hancock-llm-memory | - | Unknown block | Fail |
| aiyou-rollup | BLOCKED | packages/aiyou-rollup | - | Unknown block | Fail |
| aiyou-api | BLOCKED | apps/aiyou_stack/aiyou-api | - | Unknown block | Fail |
| pnkln | BLOCKED | control/pnkln | - | Local source missing | Fail |
| aiyou-policy | BLOCKED | packages/aiyou-policy | - | Local source missing | Fail |
| aiyou-backend | BLOCKED | apps/aiyou_stack/aiyou-backend | - | Local source missing | Fail |
| aiyou-evals | BLOCKED | evals/aiyou-evals | - | Local source missing | Fail |
| aiyou-governance | BLOCKED | governance/aiyou-governance | - | Local source missing | Fail |
| aiyou-ui-kit | BLOCKED | apps/aiyou_stack/aiyou-ui-kit | - | Local source missing | Fail |
| aiyou-offline-appliance | BLOCKED | apps/aiyou_stack/aiyou-offline-appliance | - | Local source missing | Fail |
| aiyou-risk-engine | BLOCKED | infra/aiyou-risk-engine | - | Local source missing | Fail |
| aiyou-indexer | BLOCKED | packages/aiyou-indexer | - | Local source missing | Fail |
| aiyou-codesmith | BLOCKED | packages/aiyou-codesmith | - | Local source missing | Fail |
| aiyou-prompts | BLOCKED | packages/aiyou-prompts | - | Local source missing | Fail |
| aiyou-exec | BLOCKED | packages/aiyou-exec | - | Local source missing | Fail |
| aiyou-ml | BLOCKED | staging/aiyou-ml | - | Local source missing | Fail |
| aiyou-data | BLOCKED | data/aiyou-data | - | Local source missing | Fail |
| aiyou-risk | BLOCKED | infra/aiyou-risk | - | Local source missing | Fail |
| aiyou-ci | BLOCKED | infra/ci/aiyou-ci | - | Local source missing | Fail |
