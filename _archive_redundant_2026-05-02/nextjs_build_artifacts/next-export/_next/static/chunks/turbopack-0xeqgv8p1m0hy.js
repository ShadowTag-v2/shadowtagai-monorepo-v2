(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  {
    otherChunks: [
      'static/chunks/16zqzdg1n588e.js',
  ...
  (() => {
    ...
    async function T(e, t, r) {
      ...
      if (s.length > 0) {
        ...
        const r = new Set();
        for (const e of l) _.has(e) || r.add(e);
        for (const n of r) {
          const r = M(e, t, q(n));
          _.set(n, r), s.push(r);
        }
        ...
        for (const o of ((n = M(e, t, q(r.path))), l)) _.has(o) || _.set(o, n);
      }
      for (const e of o) E.has(e) || E.set(e, n);
      await n;
    }
    R.l = function (e) {
    ...
    e = {
      async registerChunk(e, r) {
        ...
        if ((D('string' == typeof e ? q(e) : e.src).resolve(), null != r)) {
          for (const e of r.otherChunks) D(q('string' == typeof e ? e : e.path));
          if (
